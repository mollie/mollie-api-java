...
public class MollieAutoConfig {
    ...
    public SecuritySource securitySource(MollieAutoConfigProperties properties) {MollieAutoConfigProperties.Security securityProps = properties.getSecurity();
        ...
        // Build advancedAccessToken security from direct properties (primitive value)
        if (securityProps.getAdvancedAccessToken() != null) {
            securityBuilder.advancedAccessToken(securityProps.getAdvancedAccessToken());
            hasAnySecurityConfiguration = true;
        }
    ...
    @Bean
    @ConditionalOnMissingBean
    public Payouts payouts(Client client) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncPayouts asyncPayouts(AsyncClient asyncClient) {
        return asyncClient.payouts();
    }
}