...
public class AsyncClientLinks {
     ...
     * Create client link
     * 
     * <p>Link a new or existing organization to your OAuth application, in effect creating a new client. The response
     * contains a `clientLink` where you should redirect your customer to.
     * 
     * <p>## Redirecting the Customer
     * 
     * <p>The `clientLink` URL behaves similarly to a standard OAuth authorization URL. Therefore, after receiving the
     ...
     * 
     * <p>  The client ID you received when you registered your OAuth app. The ID starts with `app_`. For example:
     *   `app_abc123qwerty`.
     * 
     * <p>* `state` _string (required)_
     * 
     * <p>  A random string **generated by your app** to prevent CSRF attacks. This will be reflected in the `state` query
     ...
     * 
     * <p>  Can be set to `force` to force showing the consent screen to the merchant, *even when it is not necessary*. If you
     ...
     * 
     * <p>After adding the above url parameter your URL will look something like this and you can redirect your client to this
     * page:
     * 
     * <p>```
     ...
     * <p>## Error Handling
     * 
     * <p>Error handling is also dealt with similar to the [Authorize](https://docs.mollie.com/reference/authorize) endpoint:
