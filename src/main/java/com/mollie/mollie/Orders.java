...
public class Orders implements
     ...
     */
    public CreateOrderResponse createDirect() throws Exception {
    ...
    * `payments`: Include all payments created for this order.
    ...
    public GetOrderResponse get(
        ...
        return get(id, JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty());
    }
    ...
    * `shipments`: Include all shipments created for this order.
    ...
    public UpdateOrderResponse update(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                UpdateOrderOrdersResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<UpdateOrderOrdersResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public CancelOrderResponse cancel(
            String id) throws Exception {
        return cancel(id, JsonNullable.undefined(), Optional.empty());
    }
    ...
    public CancelOrderResponse cancel(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                CancelOrderOrdersResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CancelOrderOrdersResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public ManageOrderLinesResponse manageLines(
        ...
        return manageLines(orderId, Optional.empty(), Optional.empty());
    }
    ...
    public CancelOrderLinesResponse cancelLines(
            String orderId) throws Exception {
        return cancelLines(orderId, Optional.empty(), Optional.empty());
    }
    ...
    public CancelOrderLinesResponse cancelLines(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                CancelOrderLinesOrdersResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CancelOrderLinesOrdersResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public UpdateOrderLineResponse updateLine(
            String orderId,
            String id) throws Exception {
        return updateLine(orderId, id, Optional.empty(), Optional.empty());
    }
    ...
    public UpdateOrderLineResponse updateLine(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                UpdateOrderLineOrdersResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<UpdateOrderLineOrdersResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public CreateOrderPaymentResponse createPayment(
            String orderId) throws Exception {
        return createPayment(orderId, Optional.empty(), Optional.empty());
    }
