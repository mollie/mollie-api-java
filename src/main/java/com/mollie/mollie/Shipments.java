...
public class Shipments implements
    ...
    public CreateShipmentResponse create(
        ...
        return create(orderId, Optional.empty(), Optional.empty());
    }
    ...
    public CreateShipmentResponse create(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                CreateShipmentShipmentsResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CreateShipmentShipmentsResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public ListShipmentsResponse list(
            String orderId) throws Exception {
        return list(orderId, Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty());
    }
    ...
    public ListShipmentsResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "404")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                ListShipmentsShipmentsResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ListShipmentsShipmentsResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
    ...
    public GetShipmentResponse get(
        ...
        return get(orderId, id, JsonNullable.undefined(), Optional.empty());
    }
    ...
    public UpdateShipmentResponse update(
            String orderId,
            String id) throws Exception {
        return update(orderId, id, JsonNullable.undefined(), Optional.empty(), Optional.empty());
    }
