...
import com.mollie.mollie.models.operations.async.CancelPayoutRequestBuilder;
import com.mollie.mollie.models.operations.async.CancelPayoutResponse;
import com.mollie.mollie.models.operations.async.CreatePayoutRequestBuilder;
import com.mollie.mollie.models.operations.async.CreatePayoutResponse;
import com.mollie.mollie.models.operations.async.GetPayoutRequestBuilder;
import com.mollie.mollie.models.operations.async.GetPayoutResponse;
import com.mollie.mollie.models.operations.async.ListPayoutsRequestBuilder;
import com.mollie.mollie.models.operations.async.ListPayoutsResponse;
...
public class AsyncPayouts {
     ...
     */
    public CompletableFuture<CreatePayoutResponse> create(PayoutRequest payoutRequest) {
        return create(
                Optional.empty(), Optional.empty(), payoutRequest,
                Optional.empty());
    }
     ...
     * @return {@code CompletableFuture<CreatePayoutResponse>} - The async response
     */
    public CompletableFuture<CreatePayoutResponse> create(
    ...
    public CompletableFuture<GetPayoutResponse> get(String payoutId) {
        return get(
                payoutId, Optional.empty(), Optional.empty(),
                Optional.empty());
    }
     ...
     */
    public CompletableFuture<CancelPayoutResponse> cancel(String payoutId) {
        return cancel(
                payoutId, Optional.empty(), Optional.empty(),
                Optional.empty());
    }
     ...
     * @return {@code CompletableFuture<CancelPayoutResponse>} - The async response
     */
    public CompletableFuture<CancelPayoutResponse> cancel(
            String payoutId, Optional<Boolean> testmode,
            Optional<String> idempotencyKey, Optional<Options> options) {
        CancelPayoutRequest request =
            CancelPayoutRequest
                ...
                .idempotencyKey(idempotencyKey)
                .build();
        AsyncRequestOperation<CancelPayoutRequest, CancelPayoutResponse> operation
              = new CancelPayout.Async(
                                    sdkConfiguration, options, sdkConfiguration.retryScheduler(),
                                    _headers);
        return operation.doRequest(request)
            .thenCompose(operation::handleResponse);
