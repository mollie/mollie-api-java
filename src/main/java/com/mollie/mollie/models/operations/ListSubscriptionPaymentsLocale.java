...
public enum ListSubscriptionPaymentsLocale {
    ...
    ListSubscriptionPaymentsLocale(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionPaymentsLocale> fromValue(String value) {
        for (ListSubscriptionPaymentsLocale o: ListSubscriptionPaymentsLocale.values()) {
