...
public class CreateCaptureSettlementAmount {
    ...
    @JsonCreator
    public CreateCaptureSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public CreateCaptureSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public CreateCaptureSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCaptureSettlementAmount other = (CreateCaptureSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCaptureSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
