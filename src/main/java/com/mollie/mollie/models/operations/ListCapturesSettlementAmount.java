...
public class ListCapturesSettlementAmount {
    ...
    @JsonCreator
    public ListCapturesSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListCapturesSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListCapturesSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCapturesSettlementAmount other = (ListCapturesSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCapturesSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListCapturesSettlementAmount build() {
            return new ListCapturesSettlementAmount(
                currency,
                value);
        }
    }
