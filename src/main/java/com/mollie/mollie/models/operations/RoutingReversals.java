...
public class RoutingReversals {
    ...
    @JsonProperty("amount")
    private Optional<? extends CreateRefundRefundsAmount> amount;
    ...
    public RoutingReversals(
            @JsonProperty("amount") Optional<? extends CreateRefundRefundsAmount> amount,
    ...
    @JsonIgnore
    public Optional<CreateRefundRefundsAmount> amount() {
        return (Optional<CreateRefundRefundsAmount>) amount;
    }
     ...
     * The amount that will be pulled back.
     */
    public RoutingReversals withAmount(CreateRefundRefundsAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The amount that will be pulled back.
     */
    public RoutingReversals withAmount(Optional<? extends CreateRefundRefundsAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The amount that will be pulled back.
         */
        public Builder amount(CreateRefundRefundsAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * The amount that will be pulled back.
         */
        public Builder amount(Optional<? extends CreateRefundRefundsAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
