...
public class ListPaymentsTerminal {
     ...
     * The actual URL string.
     */
    public ListPaymentsTerminal withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListPaymentsTerminal withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListPaymentsTerminal withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListPaymentsTerminal withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentsTerminal other = (ListPaymentsTerminal) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentsTerminal.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentsTerminal build() {
            return new ListPaymentsTerminal(
                href,
                type);
        }
    }
