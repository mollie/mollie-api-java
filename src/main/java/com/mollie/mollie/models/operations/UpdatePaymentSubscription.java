...
public class UpdatePaymentSubscription {
    ...
    @JsonCreator
    public UpdatePaymentSubscription(
     ...
     * The actual URL string.
     */
    public UpdatePaymentSubscription withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public UpdatePaymentSubscription withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentSubscription withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentSubscription withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentSubscription other = (UpdatePaymentSubscription) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentSubscription.class,
                "href", href,
                "type", type);
    }
