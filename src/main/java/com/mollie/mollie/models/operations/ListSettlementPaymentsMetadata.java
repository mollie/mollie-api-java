 ...
 */
@JsonDeserialize(using = ListSettlementPaymentsMetadata._Deserializer.class)
public class ListSettlementPaymentsMetadata {

    @JsonValue
    private TypedObject value;
    
    private ListSettlementPaymentsMetadata(TypedObject value) {
        this.value = value;
    }

    public static ListSettlementPaymentsMetadata of(String value) {
    ...
    public static ListSettlementPaymentsMetadata of(List<String> value) {
        Utils.checkNotNull(value, "value");
        return new ListSettlementPaymentsMetadata(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<String>>(){}));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementPaymentsMetadata other = (ListSettlementPaymentsMetadata) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<ListSettlementPaymentsMetadata> {
    ...
    public String toString() {
        return Utils.toString(ListSettlementPaymentsMetadata.class,
                "value", value);
    }
