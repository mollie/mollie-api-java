 ...
 */
public enum GetBalanceReportTransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportTransactionType> fromValue(String value) {
        for (GetBalanceReportTransactionType o: GetBalanceReportTransactionType.values()) {
