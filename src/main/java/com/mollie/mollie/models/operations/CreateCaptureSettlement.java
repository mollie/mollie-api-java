...
public class CreateCaptureSettlement {
    ...
    @JsonCreator
    public CreateCaptureSettlement(
     ...
     * The actual URL string.
     */
    public CreateCaptureSettlement withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public CreateCaptureSettlement withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CreateCaptureSettlement withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CreateCaptureSettlement withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCaptureSettlement other = (CreateCaptureSettlement) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCaptureSettlement.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public CreateCaptureSettlement build() {
            return new CreateCaptureSettlement(
                href,
                type);
        }
    }
