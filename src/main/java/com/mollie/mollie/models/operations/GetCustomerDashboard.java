...
public class GetCustomerDashboard {
     ...
     * The actual URL string.
     */
    public GetCustomerDashboard withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetCustomerDashboard withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerDashboard withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerDashboard withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomerDashboard other = (GetCustomerDashboard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomerDashboard.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetCustomerDashboard build() {
            return new GetCustomerDashboard(
                href,
                type);
        }
    }
