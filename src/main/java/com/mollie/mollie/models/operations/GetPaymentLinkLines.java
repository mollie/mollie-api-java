...
public class GetPaymentLinkLines {
    /**
    ...
    private Optional<? extends GetPaymentLinkDiscountAmount> discountAmount;
    ...
    private Optional<? extends GetPaymentLinkVatAmount> vatAmount;
    ...
    private Optional<? extends List<GetPaymentLinkCategories>> categories;
    ...
    public GetPaymentLinkLines(
            ...
            @JsonProperty("unitPrice") GetPaymentLinkUnitPrice unitPrice,
            @JsonProperty("discountAmount") Optional<? extends GetPaymentLinkDiscountAmount> discountAmount,
            @JsonProperty("totalAmount") GetPaymentLinkTotalAmount totalAmount,
            @JsonProperty("vatRate") Optional<String> vatRate,
            @JsonProperty("vatAmount") Optional<? extends GetPaymentLinkVatAmount> vatAmount,
            @JsonProperty("sku") Optional<String> sku,
            @JsonProperty("categories") Optional<? extends List<GetPaymentLinkCategories>> categories,
    ...
    public GetPaymentLinkLines(
            String description,
            long quantity,
            GetPaymentLinkUnitPrice unitPrice,
            GetPaymentLinkTotalAmount totalAmount) {
     ...
     */
    @JsonIgnore
    public GetPaymentLinkUnitPrice unitPrice() {
        return unitPrice;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkDiscountAmount> discountAmount() {
        return (Optional<GetPaymentLinkDiscountAmount>) discountAmount;
    }
     ...
     */
    @JsonIgnore
    public GetPaymentLinkTotalAmount totalAmount() {
        return totalAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkVatAmount> vatAmount() {
        return (Optional<GetPaymentLinkVatAmount>) vatAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<GetPaymentLinkCategories>> categories() {
        return (Optional<List<GetPaymentLinkCategories>>) categories;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public GetPaymentLinkLines withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public GetPaymentLinkLines withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public GetPaymentLinkLines withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public GetPaymentLinkLines withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * <p>The unit price can be zero in case of free items.
     */
    public GetPaymentLinkLines withUnitPrice(GetPaymentLinkUnitPrice unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
     */
    public GetPaymentLinkLines withTotalAmount(GetPaymentLinkTotalAmount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public GetPaymentLinkLines withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public GetPaymentLinkLines withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public GetPaymentLinkLines withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public GetPaymentLinkLines withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public GetPaymentLinkLines withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public GetPaymentLinkLines withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkLines other = (GetPaymentLinkLines) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkLines.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetPaymentLinkType> type = Optional.empty();
        ...
        private Optional<? extends GetPaymentLinkDiscountAmount> discountAmount = Optional.empty();

        private GetPaymentLinkTotalAmount totalAmount;

        private Optional<String> vatRate = Optional.empty();

        private Optional<? extends GetPaymentLinkVatAmount> vatAmount = Optional.empty();

        private Optional<String> sku = Optional.empty();

        private Optional<? extends List<GetPaymentLinkCategories>> categories = Optional.empty();
         ...
         * <p>The unit price can be zero in case of free items.
         */
        public Builder unitPrice(GetPaymentLinkUnitPrice unitPrice) {
            Utils.checkNotNull(unitPrice, "unitPrice");
            this.unitPrice = unitPrice;
            return this;
        }
         ...
         * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
         */
        public Builder totalAmount(GetPaymentLinkTotalAmount totalAmount) {
            Utils.checkNotNull(totalAmount, "totalAmount");
            this.totalAmount = totalAmount;
            return this;
        }
