...
public class GetClientAddress {
     ...
     * A street and street number.
     */
    public GetClientAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * A street and street number.
     */
    public GetClientAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * A postal code. This field may be required if the provided country has a postal code system.
     */
    public GetClientAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * A postal code. This field may be required if the provided country has a postal code system.
     */
    public GetClientAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public GetClientAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public GetClientAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public GetClientAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public GetClientAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetClientAddress.class,
    ...
    public final static class Builder {
        ...
        public GetClientAddress build() {

            return new GetClientAddress(
                streetAndNumber, postalCode, city,
                country);
        }
