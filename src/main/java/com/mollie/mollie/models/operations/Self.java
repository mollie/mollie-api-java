...
/**
 * Self - The URL to the current set of items.
 */
...
public class Self {
     ...
     * The actual URL string.
     */
    public Self withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Self withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Self.class,
                "href", href,
                "type", type);
    }
