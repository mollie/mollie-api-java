...
public class ListSalesInvoicesMetadata {
    ...
    @JsonCreator
    public ListSalesInvoicesMetadata() {
    ...
    public String toString() {
        return Utils.toString(ListSalesInvoicesMetadata.class);
    }
    ...
    public final static class Builder {
        ...
        public ListSalesInvoicesMetadata build() {
            return new ListSalesInvoicesMetadata(
                );
        }
    }
}
