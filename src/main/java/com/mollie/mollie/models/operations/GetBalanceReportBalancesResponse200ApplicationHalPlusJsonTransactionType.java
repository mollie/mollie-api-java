 ...
 */
public enum GetBalanceReportBalancesResponse200ApplicationHalPlusJsonTransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportBalancesResponse200ApplicationHalPlusJsonTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonTransactionType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200ApplicationHalPlusJsonTransactionType o: GetBalanceReportBalancesResponse200ApplicationHalPlusJsonTransactionType.values()) {
