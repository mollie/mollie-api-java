...
public class GetPaymentTerminal {
     ...
     * The actual URL string.
     */
    public GetPaymentTerminal withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetPaymentTerminal withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentTerminal withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentTerminal withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentTerminal other = (GetPaymentTerminal) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentTerminal.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentTerminal build() {
            return new GetPaymentTerminal(
                href,
                type);
        }
    }
