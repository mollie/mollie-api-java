...
public class UpdatePaymentBillingAddress {
    ...
    @JsonCreator
    public UpdatePaymentBillingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public UpdatePaymentBillingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public UpdatePaymentBillingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public UpdatePaymentBillingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public UpdatePaymentBillingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdatePaymentBillingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdatePaymentBillingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public UpdatePaymentBillingAddress withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public UpdatePaymentBillingAddress withPhone(Optional<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public UpdatePaymentBillingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public UpdatePaymentBillingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public UpdatePaymentBillingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentBillingAddress other = (UpdatePaymentBillingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentBillingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public UpdatePaymentBillingAddress build() {

            return new UpdatePaymentBillingAddress(
                title, givenName, familyName,
                organizationName, streetAndNumber, streetAdditional,
                postalCode, email, phone,
                city, region, country);
