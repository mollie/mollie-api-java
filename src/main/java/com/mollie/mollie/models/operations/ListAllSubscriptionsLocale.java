...
public enum ListAllSubscriptionsLocale {
    ...
    ListAllSubscriptionsLocale(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAllSubscriptionsLocale> fromValue(String value) {
        for (ListAllSubscriptionsLocale o: ListAllSubscriptionsLocale.values()) {
