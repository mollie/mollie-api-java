...
public class ListProfilesCheckoutPreviewUrl {
    ...
    @JsonCreator
    public ListProfilesCheckoutPreviewUrl(
     ...
     * The actual URL string.
     */
    public ListProfilesCheckoutPreviewUrl withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListProfilesCheckoutPreviewUrl withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListProfilesCheckoutPreviewUrl withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListProfilesCheckoutPreviewUrl withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListProfilesCheckoutPreviewUrl other = (ListProfilesCheckoutPreviewUrl) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListProfilesCheckoutPreviewUrl.class,
                "href", href,
                "type", type);
    }
