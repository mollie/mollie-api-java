...
public class ListRefundsRefunds {
     ...
     * <p>Possible values: `live` `test`
     */
    public ListRefundsRefunds withMode(String mode) {
        Utils.checkNotNull(mode, "mode");
     ...
     * <p>Possible values: `live` `test`
     */
    public ListRefundsRefunds withMode(Optional<String> mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * <p>Possible values: `queued` `pending` `processing` `refunded` `failed` `canceled`
     */
    public ListRefundsRefunds withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * <p>Possible values: `queued` `pending` `processing` `refunded` `failed` `canceled`
     */
    public ListRefundsRefunds withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
