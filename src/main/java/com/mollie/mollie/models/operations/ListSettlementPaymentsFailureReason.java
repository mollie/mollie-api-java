...
public enum ListSettlementPaymentsFailureReason {
    ...
    ListSettlementPaymentsFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSettlementPaymentsFailureReason> fromValue(String value) {
        for (ListSettlementPaymentsFailureReason o: ListSettlementPaymentsFailureReason.values()) {
