...
public class CreateCustomerPaymentQrCode {
    ...
    @JsonCreator
    public CreateCustomerPaymentQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public CreateCustomerPaymentQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public CreateCustomerPaymentQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public CreateCustomerPaymentQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public CreateCustomerPaymentQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public CreateCustomerPaymentQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public CreateCustomerPaymentQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerPaymentQrCode other = (CreateCustomerPaymentQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerPaymentQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public CreateCustomerPaymentQrCode build() {

            return new CreateCustomerPaymentQrCode(
                height, width, src);
        }
