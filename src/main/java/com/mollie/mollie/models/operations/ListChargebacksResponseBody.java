...
public class ListChargebacksResponseBody {
    ...
    private ListChargebacksEmbedded embedded;
    ...
    public ListChargebacksResponseBody(
            ...
            @JsonProperty("_embedded") ListChargebacksEmbedded embedded,
    ...
    @JsonIgnore
    public ListChargebacksEmbedded embedded() {
        return embedded;
    }
