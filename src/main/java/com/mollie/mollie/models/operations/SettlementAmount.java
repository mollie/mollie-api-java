...
/**
 * SettlementAmount - This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
 * 
...
public class SettlementAmount {
     ...
     * A three-character ISO 4217 currency code.
     */
    public SettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public SettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SettlementAmount other = (SettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SettlementAmount.class,
                "currency", currency,
                "value", value);
    }
