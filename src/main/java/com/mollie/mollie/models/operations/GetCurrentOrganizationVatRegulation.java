...
public enum GetCurrentOrganizationVatRegulation {
    ...
    GetCurrentOrganizationVatRegulation(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetCurrentOrganizationVatRegulation> fromValue(String value) {
        for (GetCurrentOrganizationVatRegulation o: GetCurrentOrganizationVatRegulation.values()) {
