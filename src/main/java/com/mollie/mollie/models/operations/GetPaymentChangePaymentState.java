...
public class GetPaymentChangePaymentState {
    ...
    @JsonCreator
    public GetPaymentChangePaymentState(
     ...
     * The actual URL string.
     */
    public GetPaymentChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetPaymentChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentChangePaymentState other = (GetPaymentChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentChangePaymentState build() {
            return new GetPaymentChangePaymentState(
                href,
                type);
        }
    }
