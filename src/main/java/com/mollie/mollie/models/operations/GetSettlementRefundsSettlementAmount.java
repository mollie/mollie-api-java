...
public class GetSettlementRefundsSettlementAmount {
    ...
    @JsonCreator
    public GetSettlementRefundsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public GetSettlementRefundsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public GetSettlementRefundsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementRefundsSettlementAmount other = (GetSettlementRefundsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementRefundsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public GetSettlementRefundsSettlementAmount build() {
            return new GetSettlementRefundsSettlementAmount(
                currency,
                value);
        }
    }
