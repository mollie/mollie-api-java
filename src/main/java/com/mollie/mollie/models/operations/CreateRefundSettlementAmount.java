...
public class CreateRefundSettlementAmount {
    ...
    @JsonCreator
    public CreateRefundSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public CreateRefundSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public CreateRefundSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateRefundSettlementAmount other = (CreateRefundSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateRefundSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public CreateRefundSettlementAmount build() {
            return new CreateRefundSettlementAmount(
                currency,
                value);
        }
    }
