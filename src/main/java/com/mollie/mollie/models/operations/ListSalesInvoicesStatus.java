...
public enum ListSalesInvoicesStatus {
    ...
    ListSalesInvoicesStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSalesInvoicesStatus> fromValue(String value) {
        for (ListSalesInvoicesStatus o: ListSalesInvoicesStatus.values()) {
