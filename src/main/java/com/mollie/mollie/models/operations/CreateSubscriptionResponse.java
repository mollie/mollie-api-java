...
public class CreateSubscriptionResponse implements Response {
    ...
    /**
     * The newly created subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
     ...
     * The newly created subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
    public CreateSubscriptionResponse withAny(Object any) {
        Utils.checkNotNull(any, "any");
     ...
     * The newly created subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
    public CreateSubscriptionResponse withAny(Optional<? extends Object> any) {
        Utils.checkNotNull(any, "any");
        this.any = any;
        return this;
    }
