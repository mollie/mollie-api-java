...
public enum UpdatePaymentCaptureDelay {
    ...
    UpdatePaymentCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdatePaymentCaptureDelay> fromValue(String value) {
        for (UpdatePaymentCaptureDelay o: UpdatePaymentCaptureDelay.values()) {
