 ...
 */
public enum CreateCustomerPaymentCustomersSequenceType {
    ONEOFF("oneoff"),
    FIRST("first"),
    RECURRING("recurring");
    ...
    CreateCustomerPaymentCustomersSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentCustomersSequenceType> fromValue(String value) {
        for (CreateCustomerPaymentCustomersSequenceType o: CreateCustomerPaymentCustomersSequenceType.values()) {
