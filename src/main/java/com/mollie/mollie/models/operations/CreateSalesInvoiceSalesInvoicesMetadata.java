...
public class CreateSalesInvoiceSalesInvoicesMetadata {
    ...
    @JsonCreator
    public CreateSalesInvoiceSalesInvoicesMetadata() {
    ...
    public String toString() {
        return Utils.toString(CreateSalesInvoiceSalesInvoicesMetadata.class);
    }
    ...
    public final static class Builder {
        ...
        public CreateSalesInvoiceSalesInvoicesMetadata build() {
            return new CreateSalesInvoiceSalesInvoicesMetadata(
                );
        }
    }
}
