...
public class ListChargebacksRequestBuilder {
    ...
    public CompletableFuture<ListChargebacksResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListChargebacksResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListChargebacksResponse&gt;() {
     ...
     */
    public Publisher<ListChargebacksResponse> callAsPublisher() {
        ListChargebacksRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListChargebacksResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
