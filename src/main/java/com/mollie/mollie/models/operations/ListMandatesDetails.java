...
public class ListMandatesDetails {
    ...
    private JsonNullable<? extends ListMandatesCardLabel> cardLabel;
    ...
    public ListMandatesDetails(
            ...
            @JsonProperty("cardLabel") JsonNullable<? extends ListMandatesCardLabel> cardLabel,
    ...
    @JsonIgnore
    public JsonNullable<ListMandatesCardLabel> cardLabel() {
        return (JsonNullable<ListMandatesCardLabel>) cardLabel;
    }
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public ListMandatesDetails withConsumerName(String consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public ListMandatesDetails withConsumerName(JsonNullable<String> consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
        this.consumerName = consumerName;
        return this;
    }
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public ListMandatesDetails withConsumerAccount(String consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public ListMandatesDetails withConsumerAccount(JsonNullable<String> consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
        this.consumerAccount = consumerAccount;
        return this;
    }
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public ListMandatesDetails withConsumerBic(String consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public ListMandatesDetails withConsumerBic(JsonNullable<String> consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
        this.consumerBic = consumerBic;
        return this;
    }
     ...
     * The card holder's name. Available for card mandates.
     */
    public ListMandatesDetails withCardHolder(String cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
     ...
     * The card holder's name. Available for card mandates.
     */
    public ListMandatesDetails withCardHolder(JsonNullable<String> cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
        this.cardHolder = cardHolder;
        return this;
    }
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public ListMandatesDetails withCardNumber(String cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public ListMandatesDetails withCardNumber(JsonNullable<String> cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
        this.cardNumber = cardNumber;
        return this;
    }
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public ListMandatesDetails withCardExpiryDate(String cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public ListMandatesDetails withCardExpiryDate(JsonNullable<String> cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
        this.cardExpiryDate = cardExpiryDate;
        return this;
    }
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public ListMandatesDetails withCardLabel(ListMandatesCardLabel cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public ListMandatesDetails withCardLabel(JsonNullable<? extends ListMandatesCardLabel> cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
        this.cardLabel = cardLabel;
        return this;
    }
     ...
     * returning customers.
     */
    public ListMandatesDetails withCardFingerprint(String cardFingerprint) {
        Utils.checkNotNull(cardFingerprint, "cardFingerprint");
     ...
     * returning customers.
     */
    public ListMandatesDetails withCardFingerprint(JsonNullable<String> cardFingerprint) {
        Utils.checkNotNull(cardFingerprint, "cardFingerprint");
        this.cardFingerprint = cardFingerprint;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMandatesDetails other = (ListMandatesDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMandatesDetails.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListMandatesCardLabel> cardLabel = JsonNullable.undefined();
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(ListMandatesCardLabel cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = JsonNullable.of(cardLabel);
            return this;
        }
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(JsonNullable<? extends ListMandatesCardLabel> cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = cardLabel;
            return this;
        }
        ...
        public ListMandatesDetails build() {

            return new ListMandatesDetails(
                consumerName, consumerAccount, consumerBic,
                cardHolder, cardNumber, cardExpiryDate,
                cardLabel, cardFingerprint);
        }
