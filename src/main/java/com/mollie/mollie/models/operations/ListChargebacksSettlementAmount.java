...
public class ListChargebacksSettlementAmount {
    ...
    @JsonCreator
    public ListChargebacksSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListChargebacksSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListChargebacksSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListChargebacksSettlementAmount other = (ListChargebacksSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListChargebacksSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListChargebacksSettlementAmount build() {
            return new ListChargebacksSettlementAmount(
                currency,
                value);
        }
    }
