...
public enum GetWebhookEventWebhookEventTypes {
    ...
    GetWebhookEventWebhookEventTypes(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetWebhookEventWebhookEventTypes> fromValue(String value) {
        for (GetWebhookEventWebhookEventTypes o: GetWebhookEventWebhookEventTypes.values()) {
