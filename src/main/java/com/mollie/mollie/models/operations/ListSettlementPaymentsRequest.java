...
public class ListSettlementPaymentsRequest {
     ...
     * newest to oldest.
     */
    public ListSettlementPaymentsRequest withSort(Sorting sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public ListSettlementPaymentsRequest withSort(Optional<? extends Sorting> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
