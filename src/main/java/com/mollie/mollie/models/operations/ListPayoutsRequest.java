...
public class ListPayoutsRequest {
     ...
     * token in the format `bal_*`.
     */
    public ListPayoutsRequest withBalanceId(String balanceId) {
        Utils.checkNotNull(balanceId, "balanceId");
     ...
     * token in the format `bal_*`.
     */
    public ListPayoutsRequest withBalanceId(JsonNullable<String> balanceId) {
        Utils.checkNotNull(balanceId, "balanceId");
        this.balanceId = balanceId;
        return this;
    }
     ...
     * result set.
     */
    public ListPayoutsRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * result set.
     */
    public ListPayoutsRequest withFrom(JsonNullable<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListPayoutsRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * newest to oldest.
     */
    public ListPayoutsRequest withSort(Sorting sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public ListPayoutsRequest withSort(Optional<? extends Sorting> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListPayoutsRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListPayoutsRequest withTestmode(Optional<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListPayoutsRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListPayoutsRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
