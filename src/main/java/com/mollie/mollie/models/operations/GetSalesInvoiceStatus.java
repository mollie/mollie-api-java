...
public enum GetSalesInvoiceStatus {
    ...
    GetSalesInvoiceStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetSalesInvoiceStatus> fromValue(String value) {
        for (GetSalesInvoiceStatus o: GetSalesInvoiceStatus.values()) {
