...
public class ListSettlementsRequestBuilder {
    ...
    public ListSettlementsResponse call() {
    ...
    * <pre><code>
    * for (ListSettlementsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListSettlementsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListSettlementsResponse> callAsStream() {
