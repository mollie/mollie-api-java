 ...
 * 
 * <p>The recipient object should contain all the information relevant to create an invoice for an intended
...
public class UpdateSalesInvoiceRecipient {
     ...
     */
    @JsonProperty("type")
    private UpdateSalesInvoiceType type;
     ...
     */
    @JsonProperty("locale")
    private UpdateSalesInvoiceLocale locale;

    @JsonCreator
    public UpdateSalesInvoiceRecipient(
            @JsonProperty("type") UpdateSalesInvoiceType type,
            ...
            @JsonProperty("locale") UpdateSalesInvoiceLocale locale) {
    ...
    public UpdateSalesInvoiceRecipient(
            UpdateSalesInvoiceType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            UpdateSalesInvoiceLocale locale) {
     ...
     */
    @JsonIgnore
    public UpdateSalesInvoiceType type() {
        return type;
    }
     ...
     */
    @JsonIgnore
    public UpdateSalesInvoiceLocale locale() {
        return locale;
    }
     ...
     * required on the `recipient` object.
     */
    public UpdateSalesInvoiceRecipient withType(UpdateSalesInvoiceType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public UpdateSalesInvoiceRecipient withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public UpdateSalesInvoiceRecipient withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceRecipient withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceRecipient withGivenName(JsonNullable<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceRecipient withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceRecipient withFamilyName(JsonNullable<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The trading name of the `business` type recipient.
     */
    public UpdateSalesInvoiceRecipient withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The trading name of the `business` type recipient.
     */
    public UpdateSalesInvoiceRecipient withOrganizationName(JsonNullable<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceRecipient withOrganizationNumber(String organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceRecipient withOrganizationNumber(JsonNullable<String> organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
        this.organizationNumber = organizationNumber;
        return this;
    }
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceRecipient withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceRecipient withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * The email address of the recipient.
     */
    public UpdateSalesInvoiceRecipient withEmail(String email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * The phone number of the recipient.
     */
    public UpdateSalesInvoiceRecipient withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * The phone number of the recipient.
     */
    public UpdateSalesInvoiceRecipient withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * A street and street number.
     */
    public UpdateSalesInvoiceRecipient withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdateSalesInvoiceRecipient withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdateSalesInvoiceRecipient withStreetAdditional(JsonNullable<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * A postal code.
     */
    public UpdateSalesInvoiceRecipient withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The recipient's city.
     */
    public UpdateSalesInvoiceRecipient withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The recipient's region.
     */
    public UpdateSalesInvoiceRecipient withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The recipient's region.
     */
    public UpdateSalesInvoiceRecipient withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public UpdateSalesInvoiceRecipient withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * The locale for the recipient, to be used for translations in PDF generation and payment pages.
     */
    public UpdateSalesInvoiceRecipient withLocale(UpdateSalesInvoiceLocale locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSalesInvoiceRecipient other = (UpdateSalesInvoiceRecipient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSalesInvoiceRecipient.class,
                "type", type,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(UpdateSalesInvoiceType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The locale for the recipient, to be used for translations in PDF generation and payment pages.
         */
        public Builder locale(UpdateSalesInvoiceLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }
