...
public class CancelPaymentSettlementAmount {
    ...
    @JsonCreator
    public CancelPaymentSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public CancelPaymentSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public CancelPaymentSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentSettlementAmount other = (CancelPaymentSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public CancelPaymentSettlementAmount build() {
            return new CancelPaymentSettlementAmount(
                currency,
                value);
        }
    }
