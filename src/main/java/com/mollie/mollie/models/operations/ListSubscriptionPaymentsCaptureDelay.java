...
public enum ListSubscriptionPaymentsCaptureDelay {
    ...
    ListSubscriptionPaymentsCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionPaymentsCaptureDelay> fromValue(String value) {
        for (ListSubscriptionPaymentsCaptureDelay o: ListSubscriptionPaymentsCaptureDelay.values()) {
