 ...
 */
public enum CreateCustomerPaymentSequenceType {
    ONEOFF("oneoff"),
    FIRST("first"),
    RECURRING("recurring");
    ...
    CreateCustomerPaymentSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentSequenceType> fromValue(String value) {
        for (CreateCustomerPaymentSequenceType o: CreateCustomerPaymentSequenceType.values()) {
