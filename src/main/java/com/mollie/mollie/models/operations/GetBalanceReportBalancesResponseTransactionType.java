 ...
 */
public enum GetBalanceReportBalancesResponseTransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportBalancesResponseTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponseTransactionType> fromValue(String value) {
        for (GetBalanceReportBalancesResponseTransactionType o: GetBalanceReportBalancesResponseTransactionType.values()) {
