 ...
 */
public enum CreateCustomerPaymentCaptureDelay {
    ...
    CreateCustomerPaymentCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentCaptureDelay> fromValue(String value) {
        for (CreateCustomerPaymentCaptureDelay o: CreateCustomerPaymentCaptureDelay.values()) {
