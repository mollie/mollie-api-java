...
public class GetPaymentLinkPaymentsEmbedded {
     ...
     * An array of payment objects.
     */
    public GetPaymentLinkPaymentsEmbedded withPayments(List<ListPaymentResponse> payments) {
        Utils.checkNotNull(payments, "payments");
     ...
     * An array of payment objects.
     */
    public GetPaymentLinkPaymentsEmbedded withPayments(Optional<? extends List<ListPaymentResponse>> payments) {
        Utils.checkNotNull(payments, "payments");
        this.payments = payments;
        return this;
    }
