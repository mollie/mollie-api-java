 ...
 */
public enum GetBalanceReportFeeType {
    ...
    GetBalanceReportFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportFeeType> fromValue(String value) {
        for (GetBalanceReportFeeType o: GetBalanceReportFeeType.values()) {
