...
public class GetRefundPayment {
     ...
     * The actual URL string.
     */
    public GetRefundPayment withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetRefundPayment withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetRefundPayment withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetRefundPayment withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRefundPayment other = (GetRefundPayment) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRefundPayment.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetRefundPayment build() {
            return new GetRefundPayment(
                href,
                type);
        }
    }
