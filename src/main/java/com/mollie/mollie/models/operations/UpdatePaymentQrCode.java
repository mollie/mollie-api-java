...
public class UpdatePaymentQrCode {
     ...
     * The height of the QR code image in pixels.
     */
    public UpdatePaymentQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public UpdatePaymentQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public UpdatePaymentQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public UpdatePaymentQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public UpdatePaymentQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public UpdatePaymentQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentQrCode other = (UpdatePaymentQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public UpdatePaymentQrCode build() {

            return new UpdatePaymentQrCode(
                height, width, src);
        }
