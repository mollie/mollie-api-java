...
public enum ListCustomerPaymentsFailureReason {
    ...
    ListCustomerPaymentsFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListCustomerPaymentsFailureReason> fromValue(String value) {
        for (ListCustomerPaymentsFailureReason o: ListCustomerPaymentsFailureReason.values()) {
