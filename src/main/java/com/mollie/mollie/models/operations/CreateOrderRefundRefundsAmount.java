 ...
 * 
 * <p>The amount that you want to refund. In almost all cases, Mollie can determine the amount automatically.
 * 
 ...
 */
public class CreateOrderRefundRefundsAmount {
    ...
    @JsonCreator
    public CreateOrderRefundRefundsAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public CreateOrderRefundRefundsAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public CreateOrderRefundRefundsAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateOrderRefundRefundsAmount other = (CreateOrderRefundRefundsAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateOrderRefundRefundsAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public CreateOrderRefundRefundsAmount build() {
            return new CreateOrderRefundRefundsAmount(
                currency,
                value);
        }
    }
