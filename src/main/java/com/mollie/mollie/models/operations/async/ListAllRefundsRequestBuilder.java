...
public class ListAllRefundsRequestBuilder {
    ...
    public CompletableFuture<ListAllRefundsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListAllRefundsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListAllRefundsResponse&gt;() {
     ...
     */
    public Publisher<ListAllRefundsResponse> callAsPublisher() {
        ListAllRefundsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListAllRefundsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
