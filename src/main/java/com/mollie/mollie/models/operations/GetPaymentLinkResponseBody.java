...
public class GetPaymentLinkResponseBody {
     ...
     */
    @JsonProperty("mode")
    private GetPaymentLinkMode mode;
    ...
    @JsonProperty("amount")
    private Optional<? extends GetPaymentLinkAmount> amount;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("lines")
    private JsonNullable<? extends List<GetPaymentLinkLines>> lines;
    ...
    private Optional<? extends GetPaymentLinkBillingAddress> billingAddress;
    ...
    private Optional<? extends GetPaymentLinkShippingAddress> shippingAddress;
    ...
    private JsonNullable<? extends GetPaymentLinkSequenceType> sequenceType;
     ...
     */
    @JsonProperty("_links")
    private GetPaymentLinkLinks links;

    @JsonCreator
    public GetPaymentLinkResponseBody(
            @JsonProperty("resource") String resource,
            @JsonProperty("id") String id,
            @JsonProperty("mode") GetPaymentLinkMode mode,
            @JsonProperty("description") String description,
            @JsonProperty("amount") Optional<? extends GetPaymentLinkAmount> amount,
            ...
            @JsonProperty("lines") JsonNullable<? extends List<GetPaymentLinkLines>> lines,
            @JsonProperty("billingAddress") Optional<? extends GetPaymentLinkBillingAddress> billingAddress,
            @JsonProperty("shippingAddress") Optional<? extends GetPaymentLinkShippingAddress> shippingAddress,
            ...
            @JsonProperty("sequenceType") JsonNullable<? extends GetPaymentLinkSequenceType> sequenceType,
            @JsonProperty("customerId") JsonNullable<String> customerId,
            @JsonProperty("_links") GetPaymentLinkLinks links) {
    ...
    public GetPaymentLinkResponseBody(
            String resource,
            String id,
            GetPaymentLinkMode mode,
            String description,
            boolean archived,
            String createdAt,
            GetPaymentLinkLinks links) {
     ...
     */
    @JsonIgnore
    public GetPaymentLinkMode mode() {
        return mode;
    }
    ...
    @JsonIgnore
    public Optional<GetPaymentLinkAmount> amount() {
        return (Optional<GetPaymentLinkAmount>) amount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetPaymentLinkLines>> lines() {
        return (JsonNullable<List<GetPaymentLinkLines>>) lines;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkBillingAddress> billingAddress() {
        return (Optional<GetPaymentLinkBillingAddress>) billingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkShippingAddress> shippingAddress() {
        return (Optional<GetPaymentLinkShippingAddress>) shippingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkSequenceType> sequenceType() {
        return (JsonNullable<GetPaymentLinkSequenceType>) sequenceType;
    }
     ...
     */
    @JsonIgnore
    public GetPaymentLinkLinks links() {
        return links;
    }
     ...
     * amount.
     */
    public GetPaymentLinkResponseBody withAmount(Optional<? extends GetPaymentLinkAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * the customer will be shown a generic message after completing the payment.
     */
    public GetPaymentLinkResponseBody withRedirectUrl(Optional<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * local machine.
     */
    public GetPaymentLinkResponseBody withWebhookUrl(Optional<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetPaymentLinkResponseBody withLines(List<GetPaymentLinkLines> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetPaymentLinkResponseBody withLines(JsonNullable<? extends List<GetPaymentLinkLines>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetPaymentLinkResponseBody withBillingAddress(GetPaymentLinkBillingAddress billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetPaymentLinkResponseBody withBillingAddress(Optional<? extends GetPaymentLinkBillingAddress> billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
        this.billingAddress = billingAddress;
        return this;
    }
     ...
     * `country`.
     */
    public GetPaymentLinkResponseBody withShippingAddress(GetPaymentLinkShippingAddress shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
     ...
     * `country`.
     */
    public GetPaymentLinkResponseBody withShippingAddress(Optional<? extends GetPaymentLinkShippingAddress> shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
        this.shippingAddress = shippingAddress;
        return this;
    }
     ...
     * required.
     */
    public GetPaymentLinkResponseBody withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * <p>If no value is specified, the field defaults to `false`, allowing only a single payment per link.
     */
    public GetPaymentLinkResponseBody withReusable(Optional<Boolean> reusable) {
        Utils.checkNotNull(reusable, "reusable");
        this.reusable = reusable;
        return this;
    }
     ...
     * The date and time the payment link became paid, in ISO 8601 format.
     */
    public GetPaymentLinkResponseBody withPaidAt(Optional<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * the payment link will not expire automatically.
     */
    public GetPaymentLinkResponseBody withExpiresAt(Optional<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * 'in3', 'riverty', 'klarna', 'billie'.
     */
    public GetPaymentLinkResponseBody withAllowedMethods(List<String> allowedMethods) {
        Utils.checkNotNull(allowedMethods, "allowedMethods");
     ...
     * 'in3', 'riverty', 'klarna', 'billie'.
     */
    public GetPaymentLinkResponseBody withAllowedMethods(Optional<? extends List<String>> allowedMethods) {
        Utils.checkNotNull(allowedMethods, "allowedMethods");
        this.allowedMethods = allowedMethods;
        return this;
    }
     ...
     * [Payment Link Payments Endpoint](get-payment-link-payments).
     */
    public GetPaymentLinkResponseBody withSequenceType(JsonNullable<? extends GetPaymentLinkSequenceType> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * the payment is made.
     */
    public GetPaymentLinkResponseBody withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetPaymentLinkAmount> amount = Optional.empty();
        ...
        private JsonNullable<? extends List<GetPaymentLinkLines>> lines = JsonNullable.undefined();

        private Optional<? extends GetPaymentLinkBillingAddress> billingAddress = Optional.empty();

        private Optional<? extends GetPaymentLinkShippingAddress> shippingAddress = Optional.empty();
        ...
        private JsonNullable<? extends GetPaymentLinkSequenceType> sequenceType = JsonNullable.undefined();
         ...
         * amount.
         */
        public Builder amount(Optional<? extends GetPaymentLinkAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(List<GetPaymentLinkLines> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = JsonNullable.of(lines);
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(JsonNullable<? extends List<GetPaymentLinkLines>> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = lines;
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(GetPaymentLinkBillingAddress billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = Optional.ofNullable(billingAddress);
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(Optional<? extends GetPaymentLinkBillingAddress> billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = billingAddress;
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(GetPaymentLinkShippingAddress shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = Optional.ofNullable(shippingAddress);
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(Optional<? extends GetPaymentLinkShippingAddress> shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = shippingAddress;
            return this;
        }
         ...
         * [Payment Link Payments Endpoint](get-payment-link-payments).
         */
        public Builder sequenceType(JsonNullable<? extends GetPaymentLinkSequenceType> sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = sequenceType;
            return this;
        }
