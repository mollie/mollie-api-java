...
public class ListSettlementsResponseBody {
    ...
    private ListSettlementsEmbedded embedded;
    ...
    public ListSettlementsResponseBody(
            ...
            @JsonProperty("_embedded") ListSettlementsEmbedded embedded,
    ...
    @JsonIgnore
    public ListSettlementsEmbedded embedded() {
        return embedded;
    }
