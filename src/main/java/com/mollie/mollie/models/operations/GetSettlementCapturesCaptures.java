...
public class GetSettlementCapturesCaptures {
    /**
    ...
    private JsonNullable<? extends GetSettlementCapturesSettlementAmount> settlementAmount;
    ...
    private JsonNullable<? extends GetSettlementCapturesMetadata> metadata;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementCapturesSettlementAmount> settlementAmount() {
        return (JsonNullable<GetSettlementCapturesSettlementAmount>) settlementAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementCapturesMetadata> metadata() {
        return (JsonNullable<GetSettlementCapturesMetadata>) metadata;
    }
     ...
     * The description of the capture.
     */
    public GetSettlementCapturesCaptures withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * The description of the capture.
     */
    public GetSettlementCapturesCaptures withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * <p>Since the field contains an estimated amount during capture processing, it may change over time. To retrieve accurate settlement amounts we recommend using the [List balance transactions endpoint](list-balance-transactions) instead.
     */
    public GetSettlementCapturesCaptures withSettlementAmount(GetSettlementCapturesSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * <p>Since the field contains an estimated amount during capture processing, it may change over time. To retrieve accurate settlement amounts we recommend using the [List balance transactions endpoint](list-balance-transactions) instead.
     */
    public GetSettlementCapturesCaptures withSettlementAmount(JsonNullable<? extends GetSettlementCapturesSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetSettlementCapturesCaptures withMetadata(GetSettlementCapturesMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetSettlementCapturesCaptures withMetadata(JsonNullable<? extends GetSettlementCapturesMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The unique identifier of the shipment that triggered the creation of this capture, if applicable. For example: `shp_gNapNy9qQTUFZYnCrCF7J`.
     */
    public GetSettlementCapturesCaptures withShipmentId(String shipmentId) {
        Utils.checkNotNull(shipmentId, "shipmentId");
     ...
     * The unique identifier of the shipment that triggered the creation of this capture, if applicable. For example: `shp_gNapNy9qQTUFZYnCrCF7J`.
     */
    public GetSettlementCapturesCaptures withShipmentId(JsonNullable<String> shipmentId) {
        Utils.checkNotNull(shipmentId, "shipmentId");
        this.shipmentId = shipmentId;
        return this;
    }
     ...
     * The identifier referring to the settlement this capture was settled with. For example, `stl_BkEjN2eBb`. This field is omitted if the capture is not settled (yet).
     */
    public GetSettlementCapturesCaptures withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * The identifier referring to the settlement this capture was settled with. For example, `stl_BkEjN2eBb`. This field is omitted if the capture is not settled (yet).
     */
    public GetSettlementCapturesCaptures withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementCapturesCaptures other = (GetSettlementCapturesCaptures) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementCapturesCaptures.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
         ...
         * <p>Since the field contains an estimated amount during capture processing, it may change over time. To retrieve accurate settlement amounts we recommend using the [List balance transactions endpoint](list-balance-transactions) instead.
         */
        public Builder settlementAmount(GetSettlementCapturesSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = JsonNullable.of(settlementAmount);
            return this;
        }
         ...
         * <p>Since the field contains an estimated amount during capture processing, it may change over time. To retrieve accurate settlement amounts we recommend using the [List balance transactions endpoint](list-balance-transactions) instead.
         */
        public Builder settlementAmount(JsonNullable<? extends GetSettlementCapturesSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
         ...
         * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(GetSettlementCapturesMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = JsonNullable.of(metadata);
            return this;
        }
         ...
         * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(JsonNullable<? extends GetSettlementCapturesMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
