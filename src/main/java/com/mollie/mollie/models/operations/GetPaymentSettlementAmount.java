...
public class GetPaymentSettlementAmount {
    ...
    @JsonCreator
    public GetPaymentSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public GetPaymentSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public GetPaymentSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentSettlementAmount other = (GetPaymentSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentSettlementAmount build() {

            return new GetPaymentSettlementAmount(
                currency, value);
        }
