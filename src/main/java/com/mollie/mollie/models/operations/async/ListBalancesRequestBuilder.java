...
public class ListBalancesRequestBuilder {
    ...
    public CompletableFuture<ListBalancesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListBalancesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListBalancesResponse&gt;() {
     ...
     */
    public Publisher<ListBalancesResponse> callAsPublisher() {
        ListBalancesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListBalancesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
