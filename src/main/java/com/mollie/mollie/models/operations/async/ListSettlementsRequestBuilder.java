...
public class ListSettlementsRequestBuilder {
     ...
     * <pre><code>
     * Publisher&lt;ListSettlementsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSettlementsResponse&gt;() {
     ...
     */
    public Publisher<ListSettlementsResponse> callAsPublisher() {
        ListSettlementsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListSettlementsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
