...
public class TerminalsListPairingCodesRequest {
    ...
    @JsonCreator
    public TerminalsListPairingCodesRequest(
     ...
     * result set.
     */
    public TerminalsListPairingCodesRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * result set.
     */
    public TerminalsListPairingCodesRequest withFrom(JsonNullable<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public TerminalsListPairingCodesRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public TerminalsListPairingCodesRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * newest to oldest.
     */
    public TerminalsListPairingCodesRequest withSort(Sorting sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public TerminalsListPairingCodesRequest withSort(Optional<? extends Sorting> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * The identifier referring to the [profile](get-profile) you wish to retrieve pairing codes for.
     */
    public TerminalsListPairingCodesRequest withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
     ...
     * The identifier referring to the [profile](get-profile) you wish to retrieve pairing codes for.
     */
    public TerminalsListPairingCodesRequest withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public TerminalsListPairingCodesRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public TerminalsListPairingCodesRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TerminalsListPairingCodesRequest other = (TerminalsListPairingCodesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TerminalsListPairingCodesRequest.class,
                "from", from,
                "limit", limit,
                "sort", sort,
                "profileId", profileId,
    ...
    public final static class Builder {
        ...
        public TerminalsListPairingCodesRequest build() {

            return new TerminalsListPairingCodesRequest(
                from, limit, sort,
                profileId, idempotencyKey);
        }
