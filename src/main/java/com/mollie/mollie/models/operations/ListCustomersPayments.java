...
public class ListCustomersPayments {
     ...
     * The actual URL string.
     */
    public ListCustomersPayments withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListCustomersPayments withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCustomersPayments withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCustomersPayments withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCustomersPayments other = (ListCustomersPayments) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCustomersPayments.class,
                "href", href,
                "type", type);
    }
