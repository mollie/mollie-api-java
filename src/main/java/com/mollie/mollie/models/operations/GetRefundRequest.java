...
public class GetRefundRequest {
     ...
     * Provide the ID of the item you want to perform this operation on.
     */
    public GetRefundRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * * `payment`: Include the payment this refund was created for.
     */
    public GetRefundRequest withInclude(String include) {
        Utils.checkNotNull(include, "include");
     ...
     * * `payment`: Include the payment this refund was created for.
     */
    public GetRefundRequest withInclude(JsonNullable<String> include) {
        Utils.checkNotNull(include, "include");
        this.include = include;
        return this;
    }
