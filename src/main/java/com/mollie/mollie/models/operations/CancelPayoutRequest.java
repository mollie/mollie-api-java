...
public class CancelPayoutRequest {
     ...
     * Provide the ID of the payout.
     */
    public CancelPayoutRequest withPayoutId(String payoutId) {
        Utils.checkNotNull(payoutId, "payoutId");
        this.payoutId = payoutId;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public CancelPayoutRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public CancelPayoutRequest withTestmode(Optional<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public CancelPayoutRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public CancelPayoutRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPayoutRequest other = (CancelPayoutRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPayoutRequest.class,
                "payoutId", payoutId,
                "testmode", testmode,
    ...
    public final static class Builder {
        ...
        public CancelPayoutRequest build() {
            ...
            return new CancelPayoutRequest(
                payoutId, testmode, idempotencyKey);
        }
