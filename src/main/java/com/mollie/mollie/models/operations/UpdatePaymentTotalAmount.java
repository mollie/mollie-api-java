...
public class UpdatePaymentTotalAmount {
    ...
    @JsonCreator
    public UpdatePaymentTotalAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public UpdatePaymentTotalAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public UpdatePaymentTotalAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentTotalAmount other = (UpdatePaymentTotalAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentTotalAmount.class,
                "currency", currency,
                "value", value);
    }
