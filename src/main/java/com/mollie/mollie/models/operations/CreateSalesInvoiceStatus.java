 ...
 */
public enum CreateSalesInvoiceStatus {
    DRAFT("draft"),
    ISSUED("issued"),
    PAID("paid");
    ...
    CreateSalesInvoiceStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateSalesInvoiceStatus> fromValue(String value) {
        for (CreateSalesInvoiceStatus o: CreateSalesInvoiceStatus.values()) {
