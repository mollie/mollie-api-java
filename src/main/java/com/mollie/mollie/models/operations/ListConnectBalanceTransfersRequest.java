...
public class ListConnectBalanceTransfersRequest {
    ...
    @JsonCreator
    public ListConnectBalanceTransfersRequest(
     ...
     * result set.
     */
    public ListConnectBalanceTransfersRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * result set.
     */
    public ListConnectBalanceTransfersRequest withFrom(JsonNullable<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListConnectBalanceTransfersRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListConnectBalanceTransfersRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * newest to oldest.
     */
    public ListConnectBalanceTransfersRequest withSort(Sorting sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public ListConnectBalanceTransfersRequest withSort(Optional<? extends Sorting> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListConnectBalanceTransfersRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListConnectBalanceTransfersRequest withTestmode(Optional<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListConnectBalanceTransfersRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListConnectBalanceTransfersRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListConnectBalanceTransfersRequest other = (ListConnectBalanceTransfersRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListConnectBalanceTransfersRequest.class,
                "from", from,
                "limit", limit,
                "sort", sort,
                "testmode", testmode,
    ...
    public final static class Builder {
        ...
        public ListConnectBalanceTransfersRequest build() {

            return new ListConnectBalanceTransfersRequest(
                from, limit, sort,
                testmode, idempotencyKey);
        }
