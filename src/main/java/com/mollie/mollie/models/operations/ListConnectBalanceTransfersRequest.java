...
public class ListConnectBalanceTransfersRequest {
     ...
     * newest to oldest.
     */
    public ListConnectBalanceTransfersRequest withSort(ListSort sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public ListConnectBalanceTransfersRequest withSort(JsonNullable<? extends ListSort> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListConnectBalanceTransfersRequest withTestmode(JsonNullable<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
