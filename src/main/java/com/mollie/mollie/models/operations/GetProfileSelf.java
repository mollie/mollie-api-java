...
public class GetProfileSelf {
     ...
     * The actual URL string.
     */
    public GetProfileSelf withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetProfileSelf withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetProfileSelf withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetProfileSelf withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetProfileSelf other = (GetProfileSelf) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetProfileSelf.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetProfileSelf build() {
            return new GetProfileSelf(
                href,
                type);
        }
    }
