...
public class ListAllSubscriptionsSettlementAmount {
    ...
    @JsonCreator
    public ListAllSubscriptionsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListAllSubscriptionsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListAllSubscriptionsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAllSubscriptionsSettlementAmount other = (ListAllSubscriptionsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAllSubscriptionsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListAllSubscriptionsSettlementAmount build() {

            return new ListAllSubscriptionsSettlementAmount(
                currency, value);
        }
