...
public enum CancelPaymentFailureReason {
    ...
    CancelPaymentFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<CancelPaymentFailureReason> fromValue(String value) {
        for (CancelPaymentFailureReason o: CancelPaymentFailureReason.values()) {
