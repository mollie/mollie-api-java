...
public class ListSettlementPaymentsRequestBuilder {
    ...
    public ListSettlementPaymentsResponse call() {
    ...
    * <pre><code>
    * for (ListSettlementPaymentsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListSettlementPaymentsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListSettlementPaymentsResponse> callAsStream() {
