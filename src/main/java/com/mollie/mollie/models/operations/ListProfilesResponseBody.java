...
public class ListProfilesResponseBody {
    ...
    private ListProfilesEmbedded embedded;
    ...
    public ListProfilesResponseBody(
            ...
            @JsonProperty("_embedded") ListProfilesEmbedded embedded,
    ...
    @JsonIgnore
    public ListProfilesEmbedded embedded() {
        return embedded;
    }
