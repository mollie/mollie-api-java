...
public class GetClientClientsAPIOrganization {
     ...
     * Possible values: `dutch` `british` `shifted`
     */
    public GetClientClientsAPIOrganization withVatRegulation(String vatRegulation) {
        Utils.checkNotNull(vatRegulation, "vatRegulation");
     ...
     * Possible values: `dutch` `british` `shifted`
     */
    public GetClientClientsAPIOrganization withVatRegulation(JsonNullable<String> vatRegulation) {
        Utils.checkNotNull(vatRegulation, "vatRegulation");
        this.vatRegulation = vatRegulation;
        return this;
    }
