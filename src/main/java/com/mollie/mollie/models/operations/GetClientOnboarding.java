...
public class GetClientOnboarding {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends GetClientClientsAPIResponseLinks> links;

    @JsonCreator
    public GetClientOnboarding(
            ...
            @JsonProperty("_links") Optional<? extends GetClientClientsAPIResponseLinks> links) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetClientClientsAPIResponseLinks> links() {
        return (Optional<GetClientClientsAPIResponseLinks>) links;
    }
     ...
     * resource type.
     */
    public GetClientOnboarding withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
     ...
     * resource type.
     */
    public GetClientOnboarding withResource(Optional<String> resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The name of the organization.
     */
    public GetClientOnboarding withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the organization.
     */
    public GetClientOnboarding withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * * `completed` — The onboarding is completed
     */
    public GetClientOnboarding withStatus(GetClientStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * * `completed` — The onboarding is completed
     */
    public GetClientOnboarding withStatus(Optional<? extends GetClientStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Whether the organization can receive payments.
     */
    public GetClientOnboarding withCanReceivePayments(boolean canReceivePayments) {
        Utils.checkNotNull(canReceivePayments, "canReceivePayments");
     ...
     * Whether the organization can receive payments.
     */
    public GetClientOnboarding withCanReceivePayments(Optional<Boolean> canReceivePayments) {
        Utils.checkNotNull(canReceivePayments, "canReceivePayments");
        this.canReceivePayments = canReceivePayments;
        return this;
    }
     ...
     * Whether the organization can receive settlements to their external bank account.
     */
    public GetClientOnboarding withCanReceiveSettlements(boolean canReceiveSettlements) {
        Utils.checkNotNull(canReceiveSettlements, "canReceiveSettlements");
     ...
     * Whether the organization can receive settlements to their external bank account.
     */
    public GetClientOnboarding withCanReceiveSettlements(Optional<Boolean> canReceiveSettlements) {
        Utils.checkNotNull(canReceiveSettlements, "canReceiveSettlements");
        this.canReceiveSettlements = canReceiveSettlements;
        return this;
    }
     ...
     * The sign up date time of the organization in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetClientOnboarding withSignedUpAt(String signedUpAt) {
        Utils.checkNotNull(signedUpAt, "signedUpAt");
     ...
     * The sign up date time of the organization in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetClientOnboarding withSignedUpAt(Optional<String> signedUpAt) {
        Utils.checkNotNull(signedUpAt, "signedUpAt");
        this.signedUpAt = signedUpAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetClientOnboarding withLinks(GetClientClientsAPIResponseLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetClientOnboarding withLinks(Optional<? extends GetClientClientsAPIResponseLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetClientOnboarding.class,
                "resource", resource,
                "name", name,
                "status", status,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetClientClientsAPIResponseLinks> links = Optional.empty();  
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetClientClientsAPIResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends GetClientClientsAPIResponseLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        
        public GetClientOnboarding build() {
            if (resource == null) {
                resource = _SINGLETON_VALUE_Resource.value();
            }            return new GetClientOnboarding(
                resource,
                name,
                status,
                canReceivePayments,
