...
public enum ListAllSubscriptionsSequenceType {
    ...
    ListAllSubscriptionsSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAllSubscriptionsSequenceType> fromValue(String value) {
        for (ListAllSubscriptionsSequenceType o: ListAllSubscriptionsSequenceType.values()) {
