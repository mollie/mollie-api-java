...
public class GetChargebackRequest {
     ...
     * Provide the ID of the item you want to perform this operation on.
     */
    public GetChargebackRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * * `payment`: Include the payment this chargeback was issued for.
     */
    public GetChargebackRequest withInclude(String include) {
        Utils.checkNotNull(include, "include");
     ...
     * * `payment`: Include the payment this chargeback was issued for.
     */
    public GetChargebackRequest withInclude(JsonNullable<String> include) {
        Utils.checkNotNull(include, "include");
        this.include = include;
        return this;
    }
