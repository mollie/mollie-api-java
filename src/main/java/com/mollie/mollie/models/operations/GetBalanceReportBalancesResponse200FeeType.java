 ...
 */
public enum GetBalanceReportBalancesResponse200FeeType {
    ...
    GetBalanceReportBalancesResponse200FeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200FeeType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200FeeType o: GetBalanceReportBalancesResponse200FeeType.values()) {
