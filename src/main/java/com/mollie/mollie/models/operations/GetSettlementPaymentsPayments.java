...
public class GetSettlementPaymentsPayments {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
    private Optional<? extends GetSettlementPaymentsAmount> amount;
    ...
    private JsonNullable<? extends GetSettlementPaymentsAmountRefunded> amountRefunded;
    ...
    private JsonNullable<? extends GetSettlementPaymentsAmountRemaining> amountRemaining;
    ...
    private JsonNullable<? extends GetSettlementPaymentsAmountCaptured> amountCaptured;
    ...
    private JsonNullable<? extends GetSettlementPaymentsAmountChargedBack> amountChargedBack;
    ...
    private JsonNullable<? extends GetSettlementPaymentsSettlementAmount> settlementAmount;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("lines")
    private JsonNullable<? extends List<GetSettlementPaymentsLines>> lines;
    ...
    private Optional<? extends GetSettlementPaymentsBillingAddress> billingAddress;
    ...
    private Optional<? extends GetSettlementPaymentsShippingAddress> shippingAddress;
    ...
    private JsonNullable<? extends GetSettlementPaymentsMetadata> metadata;
    ...
    private JsonNullable<? extends GetSettlementPaymentsApplicationFee> applicationFee;
    ...
    private JsonNullable<? extends List<GetSettlementPaymentsRouting>> routing;
    ...
    private JsonNullable<? extends GetSettlementPaymentsStatusReason> statusReason;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends GetSettlementPaymentsSettlementsLinks> links;

    @JsonCreator
    public GetSettlementPaymentsPayments(
            @JsonProperty("resource") Optional<String> resource,
            @JsonProperty("id") Optional<String> id,
            @JsonProperty("mode") Optional<String> mode,
            @JsonProperty("description") JsonNullable<String> description,
            @JsonProperty("amount") Optional<? extends GetSettlementPaymentsAmount> amount,
            @JsonProperty("amountRefunded") JsonNullable<? extends GetSettlementPaymentsAmountRefunded> amountRefunded,
            @JsonProperty("amountRemaining") JsonNullable<? extends GetSettlementPaymentsAmountRemaining> amountRemaining,
            @JsonProperty("amountCaptured") JsonNullable<? extends GetSettlementPaymentsAmountCaptured> amountCaptured,
            @JsonProperty("amountChargedBack") JsonNullable<? extends GetSettlementPaymentsAmountChargedBack> amountChargedBack,
            @JsonProperty("settlementAmount") JsonNullable<? extends GetSettlementPaymentsSettlementAmount> settlementAmount,
            ...
            @JsonProperty("lines") JsonNullable<? extends List<GetSettlementPaymentsLines>> lines,
            @JsonProperty("billingAddress") Optional<? extends GetSettlementPaymentsBillingAddress> billingAddress,
            @JsonProperty("shippingAddress") Optional<? extends GetSettlementPaymentsShippingAddress> shippingAddress,
            ...
            @JsonProperty("metadata") JsonNullable<? extends GetSettlementPaymentsMetadata> metadata,
            ...
            @JsonProperty("applicationFee") JsonNullable<? extends GetSettlementPaymentsApplicationFee> applicationFee,
            @JsonProperty("routing") JsonNullable<? extends List<GetSettlementPaymentsRouting>> routing,
            ...
            @JsonProperty("statusReason") JsonNullable<? extends GetSettlementPaymentsStatusReason> statusReason,
            ...
            @JsonProperty("_links") Optional<? extends GetSettlementPaymentsSettlementsLinks> links) {
    ...
    @JsonIgnore
    public Optional<GetSettlementPaymentsAmount> amount() {
        return (Optional<GetSettlementPaymentsAmount>) amount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsAmountRefunded> amountRefunded() {
        return (JsonNullable<GetSettlementPaymentsAmountRefunded>) amountRefunded;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsAmountRemaining> amountRemaining() {
        return (JsonNullable<GetSettlementPaymentsAmountRemaining>) amountRemaining;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsAmountCaptured> amountCaptured() {
        return (JsonNullable<GetSettlementPaymentsAmountCaptured>) amountCaptured;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsAmountChargedBack> amountChargedBack() {
        return (JsonNullable<GetSettlementPaymentsAmountChargedBack>) amountChargedBack;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsSettlementAmount> settlementAmount() {
        return (JsonNullable<GetSettlementPaymentsSettlementAmount>) settlementAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetSettlementPaymentsLines>> lines() {
        return (JsonNullable<List<GetSettlementPaymentsLines>>) lines;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetSettlementPaymentsBillingAddress> billingAddress() {
        return (Optional<GetSettlementPaymentsBillingAddress>) billingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetSettlementPaymentsShippingAddress> shippingAddress() {
        return (Optional<GetSettlementPaymentsShippingAddress>) shippingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsMetadata> metadata() {
        return (JsonNullable<GetSettlementPaymentsMetadata>) metadata;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsApplicationFee> applicationFee() {
        return (JsonNullable<GetSettlementPaymentsApplicationFee>) applicationFee;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetSettlementPaymentsRouting>> routing() {
        return (JsonNullable<List<GetSettlementPaymentsRouting>>) routing;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetSettlementPaymentsStatusReason> statusReason() {
        return (JsonNullable<GetSettlementPaymentsStatusReason>) statusReason;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetSettlementPaymentsSettlementsLinks> links() {
        return (Optional<GetSettlementPaymentsSettlementsLinks>) links;
    }
     ...
     * Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint.
     */
    public GetSettlementPaymentsPayments withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
     ...
     * Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint.
     */
    public GetSettlementPaymentsPayments withResource(Optional<String> resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this payment. Mollie assigns this identifier at payment creation time. Mollie will always refer to the payment by this ID. Example: `tr_5B8cwPMGnU6qLbRvo7qEZo`.
     */
    public GetSettlementPaymentsPayments withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The identifier uniquely referring to this payment. Mollie assigns this identifier at payment creation time. Mollie will always refer to the payment by this ID. Example: `tr_5B8cwPMGnU6qLbRvo7qEZo`.
     */
    public GetSettlementPaymentsPayments withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * <p>Possible values: `live` `test`
     */
    public GetSettlementPaymentsPayments withMode(String mode) {
        Utils.checkNotNull(mode, "mode");
     ...
     * <p>Possible values: `live` `test`
     */
    public GetSettlementPaymentsPayments withMode(Optional<String> mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * <p>The maximum length of the description field differs per payment method, with the absolute maximum being 255 characters. The API will not reject strings longer than the maximum length but it will truncate them to fit.
     */
    public GetSettlementPaymentsPayments withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * <p>The maximum length of the description field differs per payment method, with the absolute maximum being 255 characters. The API will not reject strings longer than the maximum length but it will truncate them to fit.
     */
    public GetSettlementPaymentsPayments withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * <p>If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
     */
    public GetSettlementPaymentsPayments withAmount(GetSettlementPaymentsAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * <p>If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
     */
    public GetSettlementPaymentsPayments withAmount(Optional<? extends GetSettlementPaymentsAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer.
     */
    public GetSettlementPaymentsPayments withAmountRefunded(GetSettlementPaymentsAmountRefunded amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
     ...
     * The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer.
     */
    public GetSettlementPaymentsPayments withAmountRefunded(JsonNullable<? extends GetSettlementPaymentsAmountRefunded> amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
        this.amountRefunded = amountRefunded;
        return this;
    }
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public GetSettlementPaymentsPayments withAmountRemaining(GetSettlementPaymentsAmountRemaining amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public GetSettlementPaymentsPayments withAmountRemaining(JsonNullable<? extends GetSettlementPaymentsAmountRemaining> amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
        this.amountRemaining = amountRemaining;
        return this;
    }
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public GetSettlementPaymentsPayments withAmountCaptured(GetSettlementPaymentsAmountCaptured amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public GetSettlementPaymentsPayments withAmountCaptured(JsonNullable<? extends GetSettlementPaymentsAmountCaptured> amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
        this.amountCaptured = amountCaptured;
        return this;
    }
     ...
     * The total amount that was charged back for this payment. Only available when the total charged back amount is not zero.
     */
    public GetSettlementPaymentsPayments withAmountChargedBack(GetSettlementPaymentsAmountChargedBack amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
     ...
     * The total amount that was charged back for this payment. Only available when the total charged back amount is not zero.
     */
    public GetSettlementPaymentsPayments withAmountChargedBack(JsonNullable<? extends GetSettlementPaymentsAmountChargedBack> amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
        this.amountChargedBack = amountChargedBack;
        return this;
    }
     ...
     * <p>Please note that this amount might be recalculated and changed when the status of the payment changes. We suggest using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public GetSettlementPaymentsPayments withSettlementAmount(GetSettlementPaymentsSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * <p>Please note that this amount might be recalculated and changed when the status of the payment changes. We suggest using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public GetSettlementPaymentsPayments withSettlementAmount(JsonNullable<? extends GetSettlementPaymentsSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * <p>The parameter is normally required, but can be omitted for recurring payments (`sequenceType: recurring`) and for Apple Pay payments with an `applePayPaymentToken`.
     */
    public GetSettlementPaymentsPayments withRedirectUrl(String redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
     ...
     * <p>The parameter is normally required, but can be omitted for recurring payments (`sequenceType: recurring`) and for Apple Pay payments with an `applePayPaymentToken`.
     */
    public GetSettlementPaymentsPayments withRedirectUrl(JsonNullable<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * <p>Mollie will always give you status updates via webhooks, including for the canceled status. This parameter is therefore entirely optional, but can be useful when implementing a dedicated customer-facing flow to handle payment cancellations.
     */
    public GetSettlementPaymentsPayments withCancelUrl(String cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
     ...
     * <p>Mollie will always give you status updates via webhooks, including for the canceled status. This parameter is therefore entirely optional, but can be useful when implementing a dedicated customer-facing flow to handle payment cancellations.
     */
    public GetSettlementPaymentsPayments withCancelUrl(JsonNullable<String> cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
        this.cancelUrl = cancelUrl;
        return this;
    }
     ...
     * <p>The webhookUrl must be reachable from Mollie's point of view, so you cannot use `localhost`. If you want to use webhook during development on `localhost`, you must use a tool like ngrok to have the webhooks delivered to your local machine.
     */
    public GetSettlementPaymentsPayments withWebhookUrl(String webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
     ...
     * <p>The webhookUrl must be reachable from Mollie's point of view, so you cannot use `localhost`. If you want to use webhook during development on `localhost`, you must use a tool like ngrok to have the webhooks delivered to your local machine.
     */
    public GetSettlementPaymentsPayments withWebhookUrl(JsonNullable<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetSettlementPaymentsPayments withLines(List<GetSettlementPaymentsLines> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetSettlementPaymentsPayments withLines(JsonNullable<? extends List<GetSettlementPaymentsLines>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetSettlementPaymentsPayments withBillingAddress(GetSettlementPaymentsBillingAddress billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetSettlementPaymentsPayments withBillingAddress(Optional<? extends GetSettlementPaymentsBillingAddress> billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
        this.billingAddress = billingAddress;
        return this;
    }
     ...
     * <p>Should include `email` or a valid postal address consisting of `streetAndNumber`, `postalCode`, `city` and `country`.
     */
    public GetSettlementPaymentsPayments withShippingAddress(GetSettlementPaymentsShippingAddress shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
     ...
     * <p>Should include `email` or a valid postal address consisting of `streetAndNumber`, `postalCode`, `city` and `country`.
     */
    public GetSettlementPaymentsPayments withShippingAddress(Optional<? extends GetSettlementPaymentsShippingAddress> shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
        this.shippingAddress = shippingAddress;
        return this;
    }
     ...
     * <p>For bank transfer payments specifically, the locale will determine the target bank account the customer has to transfer the money to. We have dedicated bank accounts for Belgium, Germany, and The Netherlands. Having the customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public GetSettlementPaymentsPayments withLocale(String locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * <p>For bank transfer payments specifically, the locale will determine the target bank account the customer has to transfer the money to. We have dedicated bank accounts for Belgium, Germany, and The Netherlands. Having the customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public GetSettlementPaymentsPayments withLocale(JsonNullable<String> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * This optional field contains your customer's ISO 3166-1 alpha-2 country code, detected by us during checkout. This field is omitted if the country code was not detected.
     */
    public GetSettlementPaymentsPayments withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
     ...
     * This optional field contains your customer's ISO 3166-1 alpha-2 country code, detected by us during checkout. This field is omitted if the country code was not detected.
     */
    public GetSettlementPaymentsPayments withCountryCode(JsonNullable<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * <p>Possible values: `alma` `applepay` `bacs` `bancomatpay` `bancontact` `banktransfer` `belfius` `billie` `blik` `creditcard` `directdebit` `eps` `giftcard` `ideal` `in3` `kbc` `klarna` `mbway` `multibanco` `mybank` `payconiq` `paypal` `paysafecard` `pointofsale` `przelewy24` `riverty` `satispay` `swish` `trustly` `twint` `voucher`
     */
    public GetSettlementPaymentsPayments withMethod(String method) {
        Utils.checkNotNull(method, "method");
     ...
     * <p>Possible values: `alma` `applepay` `bacs` `bancomatpay` `bancontact` `banktransfer` `belfius` `billie` `blik` `creditcard` `directdebit` `eps` `giftcard` `ideal` `in3` `kbc` `klarna` `mbway` `multibanco` `mybank` `payconiq` `paypal` `paysafecard` `pointofsale` `przelewy24` `riverty` `satispay` `swish` `trustly` `twint` `voucher`
     */
    public GetSettlementPaymentsPayments withMethod(JsonNullable<String> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public GetSettlementPaymentsPayments withRestrictPaymentMethodsToCountry(String restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public GetSettlementPaymentsPayments withRestrictPaymentMethodsToCountry(JsonNullable<String> restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
        this.restrictPaymentMethodsToCountry = restrictPaymentMethodsToCountry;
        return this;
    }
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetSettlementPaymentsPayments withMetadata(GetSettlementPaymentsMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetSettlementPaymentsPayments withMetadata(JsonNullable<? extends GetSettlementPaymentsMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * <p>Possible values: `automatic` `manual` (default: `automatic`)
     */
    public GetSettlementPaymentsPayments withCaptureMode(String captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
     ...
     * <p>Possible values: `automatic` `manual` (default: `automatic`)
     */
    public GetSettlementPaymentsPayments withCaptureMode(JsonNullable<String> captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
        this.captureMode = captureMode;
        return this;
    }
     ...
     * <p>Possible values: `... hours` `... days`
     */
    public GetSettlementPaymentsPayments withCaptureDelay(String captureDelay) {
        Utils.checkNotNull(captureDelay, "captureDelay");
     ...
     * <p>Possible values: `... hours` `... days`
     */
    public GetSettlementPaymentsPayments withCaptureDelay(JsonNullable<String> captureDelay) {
        Utils.checkNotNull(captureDelay, "captureDelay");
        this.captureDelay = captureDelay;
        return this;
    }
     ...
     * Indicates the date before which the payment needs to be captured, in ISO 8601 format. From this date onwards we can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public GetSettlementPaymentsPayments withCaptureBefore(String captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
     ...
     * Indicates the date before which the payment needs to be captured, in ISO 8601 format. From this date onwards we can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public GetSettlementPaymentsPayments withCaptureBefore(JsonNullable<String> captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
        this.captureBefore = captureBefore;
        return this;
    }
     ...
     * <p>If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
     */
    public GetSettlementPaymentsPayments withApplicationFee(GetSettlementPaymentsApplicationFee applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
     ...
     * <p>If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
     */
    public GetSettlementPaymentsPayments withApplicationFee(JsonNullable<? extends GetSettlementPaymentsApplicationFee> applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
        this.applicationFee = applicationFee;
        return this;
    }
     ...
     * <p>If instead you use OAuth to create payments on a connected merchant's account, refer to the `applicationFee` parameter.
     */
    public GetSettlementPaymentsPayments withRouting(List<GetSettlementPaymentsRouting> routing) {
        Utils.checkNotNull(routing, "routing");
     ...
     * <p>If instead you use OAuth to create payments on a connected merchant's account, refer to the `applicationFee` parameter.
     */
    public GetSettlementPaymentsPayments withRouting(JsonNullable<? extends List<GetSettlementPaymentsRouting>> routing) {
        Utils.checkNotNull(routing, "routing");
        this.routing = routing;
        return this;
    }
     ...
     * <p>Possible values: `oneoff` `first` `recurring` (default: `oneoff`)
     */
    public GetSettlementPaymentsPayments withSequenceType(String sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
     ...
     * <p>Possible values: `oneoff` `first` `recurring` (default: `oneoff`)
     */
    public GetSettlementPaymentsPayments withSequenceType(JsonNullable<String> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * If the payment was automatically created via a subscription, the ID of the [subscription](get-subscription) will be added to the response.
     */
    public GetSettlementPaymentsPayments withSubscriptionId(String subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
     ...
     * If the payment was automatically created via a subscription, the ID of the [subscription](get-subscription) will be added to the response.
     */
    public GetSettlementPaymentsPayments withSubscriptionId(JsonNullable<String> subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
        this.subscriptionId = subscriptionId;
        return this;
    }
     ...
     * <p>When creating recurring payments, the ID of a specific [mandate](get-mandate) can be supplied to indicate which of the customer's accounts should be credited.
     */
    public GetSettlementPaymentsPayments withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
     ...
     * <p>When creating recurring payments, the ID of a specific [mandate](get-mandate) can be supplied to indicate which of the customer's accounts should be credited.
     */
    public GetSettlementPaymentsPayments withMandateId(JsonNullable<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public GetSettlementPaymentsPayments withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public GetSettlementPaymentsPayments withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * <p>For more information, see [Authentication](authentication).
     */
    public GetSettlementPaymentsPayments withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
     ...
     * <p>For more information, see [Authentication](authentication).
     */
    public GetSettlementPaymentsPayments withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public GetSettlementPaymentsPayments withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public GetSettlementPaymentsPayments withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public GetSettlementPaymentsPayments withOrderId(String orderId) {
        Utils.checkNotNull(orderId, "orderId");
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public GetSettlementPaymentsPayments withOrderId(JsonNullable<String> orderId) {
        Utils.checkNotNull(orderId, "orderId");
        this.orderId = orderId;
        return this;
    }
     ...
     * <p>Possible values: `open` `pending` `authorized` `paid` `canceled` `expired` `failed`
     */
    public GetSettlementPaymentsPayments withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * <p>Possible values: `open` `pending` `authorized` `paid` `canceled` `expired` `failed`
     */
    public GetSettlementPaymentsPayments withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * <p>You can find more information about the possible values of this object on [this page](status-reasons).**
     */
    public GetSettlementPaymentsPayments withStatusReason(GetSettlementPaymentsStatusReason statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
     ...
     * <p>You can find more information about the possible values of this object on [this page](status-reasons).**
     */
    public GetSettlementPaymentsPayments withStatusReason(JsonNullable<? extends GetSettlementPaymentsStatusReason> statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
        this.statusReason = statusReason;
        return this;
    }
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public GetSettlementPaymentsPayments withIsCancelable(boolean isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public GetSettlementPaymentsPayments withIsCancelable(JsonNullable<Boolean> isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
        this.isCancelable = isCancelable;
        return this;
    }
     ...
     * An object containing payment details collected during the payment process. For example, details may include the customer's card or bank details and a payment reference. For the full list of details, please refer to the [method-specific parameters](extra-payment-parameters) guide.
     */
    public GetSettlementPaymentsPayments withDetails(Map<String, Object> details) {
        Utils.checkNotNull(details, "details");
     ...
     * An object containing payment details collected during the payment process. For example, details may include the customer's card or bank details and a payment reference. For the full list of details, please refer to the [method-specific parameters](extra-payment-parameters) guide.
     */
    public GetSettlementPaymentsPayments withDetails(JsonNullable<? extends Map<String, Object>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetSettlementPaymentsPayments withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetSettlementPaymentsPayments withCreatedAt(Optional<String> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date and time the payment became authorized, in ISO 8601 format. This parameter is omitted if the payment is not authorized (yet).
     */
    public GetSettlementPaymentsPayments withAuthorizedAt(String authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
     ...
     * The date and time the payment became authorized, in ISO 8601 format. This parameter is omitted if the payment is not authorized (yet).
     */
    public GetSettlementPaymentsPayments withAuthorizedAt(JsonNullable<String> authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
        this.authorizedAt = authorizedAt;
        return this;
    }
     ...
     * The date and time the payment became paid, in ISO 8601 format. This parameter is omitted if the payment is not completed (yet).
     */
    public GetSettlementPaymentsPayments withPaidAt(String paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
     ...
     * The date and time the payment became paid, in ISO 8601 format. This parameter is omitted if the payment is not completed (yet).
     */
    public GetSettlementPaymentsPayments withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * The date and time the payment was canceled, in ISO 8601 format. This parameter is omitted if the payment is not canceled (yet).
     */
    public GetSettlementPaymentsPayments withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * The date and time the payment was canceled, in ISO 8601 format. This parameter is omitted if the payment is not canceled (yet).
     */
    public GetSettlementPaymentsPayments withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * The date and time the payment will expire, in ISO 8601 format. This parameter is omitted if the payment can no longer expire.
     */
    public GetSettlementPaymentsPayments withExpiresAt(String expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * The date and time the payment will expire, in ISO 8601 format. This parameter is omitted if the payment can no longer expire.
     */
    public GetSettlementPaymentsPayments withExpiresAt(JsonNullable<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The date and time the payment was expired, in ISO 8601 format. This parameter is omitted if the payment did not expire (yet).
     */
    public GetSettlementPaymentsPayments withExpiredAt(String expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
     ...
     * The date and time the payment was expired, in ISO 8601 format. This parameter is omitted if the payment did not expire (yet).
     */
    public GetSettlementPaymentsPayments withExpiredAt(JsonNullable<String> expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
        this.expiredAt = expiredAt;
        return this;
    }
     ...
     * The date and time the payment failed, in ISO 8601 format. This parameter is omitted if the payment did not fail (yet).
     */
    public GetSettlementPaymentsPayments withFailedAt(String failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
     ...
     * The date and time the payment failed, in ISO 8601 format. This parameter is omitted if the payment did not fail (yet).
     */
    public GetSettlementPaymentsPayments withFailedAt(JsonNullable<String> failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
        this.failedAt = failedAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetSettlementPaymentsPayments withLinks(GetSettlementPaymentsSettlementsLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetSettlementPaymentsPayments withLinks(Optional<? extends GetSettlementPaymentsSettlementsLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementPaymentsPayments other = (GetSettlementPaymentsPayments) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementPaymentsPayments.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetSettlementPaymentsAmount> amount = Optional.empty();
 
        private JsonNullable<? extends GetSettlementPaymentsAmountRefunded> amountRefunded = JsonNullable.undefined();
 
        private JsonNullable<? extends GetSettlementPaymentsAmountRemaining> amountRemaining = JsonNullable.undefined();
 
        private JsonNullable<? extends GetSettlementPaymentsAmountCaptured> amountCaptured = JsonNullable.undefined();
 
        private JsonNullable<? extends GetSettlementPaymentsAmountChargedBack> amountChargedBack = JsonNullable.undefined();
 
        private JsonNullable<? extends GetSettlementPaymentsSettlementAmount> settlementAmount = JsonNullable.undefined();
        ...
        private JsonNullable<? extends List<GetSettlementPaymentsLines>> lines = JsonNullable.undefined();
 
        private Optional<? extends GetSettlementPaymentsBillingAddress> billingAddress = Optional.empty();
 
        private Optional<? extends GetSettlementPaymentsShippingAddress> shippingAddress = Optional.empty();
        ...
        private JsonNullable<? extends GetSettlementPaymentsMetadata> metadata = JsonNullable.undefined();
        ...
        private JsonNullable<? extends GetSettlementPaymentsApplicationFee> applicationFee = JsonNullable.undefined();
 
        private JsonNullable<? extends List<GetSettlementPaymentsRouting>> routing = JsonNullable.undefined();
        ...
        private JsonNullable<? extends GetSettlementPaymentsStatusReason> statusReason = JsonNullable.undefined();
        ...
        private Optional<? extends GetSettlementPaymentsSettlementsLinks> links = Optional.empty();
         ...
         * <p>If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
         */
        public Builder amount(GetSettlementPaymentsAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * <p>If a tip was added for a Point-of-Sale payment, the amount will be updated to reflect the initial amount plus the tip amount.
         */
        public Builder amount(Optional<? extends GetSettlementPaymentsAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
         ...
         * The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer.
         */
        public Builder amountRefunded(GetSettlementPaymentsAmountRefunded amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = JsonNullable.of(amountRefunded);
            return this;
        }
         ...
         * The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer.
         */
        public Builder amountRefunded(JsonNullable<? extends GetSettlementPaymentsAmountRefunded> amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = amountRefunded;
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(GetSettlementPaymentsAmountRemaining amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = JsonNullable.of(amountRemaining);
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(JsonNullable<? extends GetSettlementPaymentsAmountRemaining> amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = amountRemaining;
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(GetSettlementPaymentsAmountCaptured amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = JsonNullable.of(amountCaptured);
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(JsonNullable<? extends GetSettlementPaymentsAmountCaptured> amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = amountCaptured;
            return this;
        }
         ...
         * The total amount that was charged back for this payment. Only available when the total charged back amount is not zero.
         */
        public Builder amountChargedBack(GetSettlementPaymentsAmountChargedBack amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = JsonNullable.of(amountChargedBack);
            return this;
        }
         ...
         * The total amount that was charged back for this payment. Only available when the total charged back amount is not zero.
         */
        public Builder amountChargedBack(JsonNullable<? extends GetSettlementPaymentsAmountChargedBack> amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = amountChargedBack;
            return this;
        }
         ...
         * <p>Please note that this amount might be recalculated and changed when the status of the payment changes. We suggest using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(GetSettlementPaymentsSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = JsonNullable.of(settlementAmount);
            return this;
        }
         ...
         * <p>Please note that this amount might be recalculated and changed when the status of the payment changes. We suggest using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(JsonNullable<? extends GetSettlementPaymentsSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(List<GetSettlementPaymentsLines> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = JsonNullable.of(lines);
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(JsonNullable<? extends List<GetSettlementPaymentsLines>> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = lines;
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(GetSettlementPaymentsBillingAddress billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = Optional.ofNullable(billingAddress);
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(Optional<? extends GetSettlementPaymentsBillingAddress> billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = billingAddress;
            return this;
        }
         ...
         * <p>Should include `email` or a valid postal address consisting of `streetAndNumber`, `postalCode`, `city` and `country`.
         */
        public Builder shippingAddress(GetSettlementPaymentsShippingAddress shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = Optional.ofNullable(shippingAddress);
            return this;
        }
         ...
         * <p>Should include `email` or a valid postal address consisting of `streetAndNumber`, `postalCode`, `city` and `country`.
         */
        public Builder shippingAddress(Optional<? extends GetSettlementPaymentsShippingAddress> shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = shippingAddress;
            return this;
        }
         ...
         * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(GetSettlementPaymentsMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = JsonNullable.of(metadata);
            return this;
        }
         ...
         * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(JsonNullable<? extends GetSettlementPaymentsMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * <p>If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
         */
        public Builder applicationFee(GetSettlementPaymentsApplicationFee applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = JsonNullable.of(applicationFee);
            return this;
        }
         ...
         * <p>If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
         */
        public Builder applicationFee(JsonNullable<? extends GetSettlementPaymentsApplicationFee> applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = applicationFee;
            return this;
        }
         ...
         * <p>If instead you use OAuth to create payments on a connected merchant's account, refer to the `applicationFee` parameter.
         */
        public Builder routing(List<GetSettlementPaymentsRouting> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = JsonNullable.of(routing);
            return this;
        }
         ...
         * <p>If instead you use OAuth to create payments on a connected merchant's account, refer to the `applicationFee` parameter.
         */
        public Builder routing(JsonNullable<? extends List<GetSettlementPaymentsRouting>> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = routing;
            return this;
        }
         ...
         * <p>You can find more information about the possible values of this object on [this page](status-reasons).**
         */
        public Builder statusReason(GetSettlementPaymentsStatusReason statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = JsonNullable.of(statusReason);
            return this;
        }
         ...
         * <p>You can find more information about the possible values of this object on [this page](status-reasons).**
         */
        public Builder statusReason(JsonNullable<? extends GetSettlementPaymentsStatusReason> statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = statusReason;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetSettlementPaymentsSettlementsLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends GetSettlementPaymentsSettlementsLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        
        public GetSettlementPaymentsPayments build() {
            if (resource == null) {
                resource = _SINGLETON_VALUE_Resource.value();
            }
            return new GetSettlementPaymentsPayments(
                resource,
                id,
                mode,
                description,
