...
public class GetProfileResponseBody {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("review")
    private JsonNullable<? extends Review> review;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Review> review() {
        return (JsonNullable<Review>) review;
    }
     ...
     * The products or services offered by the profile's website or application.
     */
    public GetProfileResponseBody withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
