...
public class CancelPaymentResponseBody {
     ...
     */
    @JsonProperty("mode")
    private CancelPaymentMode mode;
     ...
     */
    @JsonProperty("amount")
    private CancelPaymentAmount amount;
    ...
    private Optional<? extends CancelPaymentAmountRefunded> amountRefunded;
    ...
    private Optional<? extends CancelPaymentAmountRemaining> amountRemaining;
    ...
    private Optional<? extends CancelPaymentAmountCaptured> amountCaptured;
    ...
    private Optional<? extends CancelPaymentAmountChargedBack> amountChargedBack;
    ...
    private Optional<? extends CancelPaymentSettlementAmount> settlementAmount;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("lines")
    private JsonNullable<? extends List<CancelPaymentLines>> lines;
    ...
    private Optional<? extends CancelPaymentBillingAddress> billingAddress;
    ...
    private Optional<? extends CancelPaymentShippingAddress> shippingAddress;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("locale")
    private JsonNullable<? extends CancelPaymentLocale> locale;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("method")
    private JsonNullable<? extends CancelPaymentMethod> method;
    ...
    private JsonNullable<? extends CancelPaymentMetadata> metadata;
    ...
    private JsonNullable<? extends CancelPaymentApplicationFee> applicationFee;
    ...
    private JsonNullable<? extends List<CancelPaymentRouting>> routing;
    ...
    private Optional<? extends CancelPaymentSequenceType> sequenceType;
     ...
     */
    @JsonProperty("status")
    private CancelPaymentStatus status;
    ...
    private JsonNullable<? extends CancelPaymentStatusReason> statusReason;
    ...
    private JsonNullable<? extends CancelPaymentDetails> details;
     ...
     */
    @JsonProperty("_links")
    private CancelPaymentLinks links;

    @JsonCreator
    public CancelPaymentResponseBody(
            @JsonProperty("resource") String resource,
            @JsonProperty("id") String id,
            @JsonProperty("mode") CancelPaymentMode mode,
            @JsonProperty("description") String description,
            @JsonProperty("amount") CancelPaymentAmount amount,
            @JsonProperty("amountRefunded") Optional<? extends CancelPaymentAmountRefunded> amountRefunded,
            @JsonProperty("amountRemaining") Optional<? extends CancelPaymentAmountRemaining> amountRemaining,
            @JsonProperty("amountCaptured") Optional<? extends CancelPaymentAmountCaptured> amountCaptured,
            @JsonProperty("amountChargedBack") Optional<? extends CancelPaymentAmountChargedBack> amountChargedBack,
            @JsonProperty("settlementAmount") Optional<? extends CancelPaymentSettlementAmount> settlementAmount,
            ...
            @JsonProperty("lines") JsonNullable<? extends List<CancelPaymentLines>> lines,
            @JsonProperty("billingAddress") Optional<? extends CancelPaymentBillingAddress> billingAddress,
            @JsonProperty("shippingAddress") Optional<? extends CancelPaymentShippingAddress> shippingAddress,
            @JsonProperty("locale") JsonNullable<? extends CancelPaymentLocale> locale,
            @JsonProperty("countryCode") JsonNullable<String> countryCode,
            @JsonProperty("method") JsonNullable<? extends CancelPaymentMethod> method,
            ...
            @JsonProperty("sequenceType") Optional<? extends CancelPaymentSequenceType> sequenceType,
            ...
            @JsonProperty("status") CancelPaymentStatus status,
            @JsonProperty("statusReason") JsonNullable<? extends CancelPaymentStatusReason> statusReason,
            @JsonProperty("isCancelable") JsonNullable<Boolean> isCancelable,
            @JsonProperty("details") JsonNullable<? extends CancelPaymentDetails> details,
            ...
            @JsonProperty("_links") CancelPaymentLinks links) {
    ...
    public CancelPaymentResponseBody(
            String resource,
            String id,
            CancelPaymentMode mode,
            String description,
            CancelPaymentAmount amount,
            String profileId,
            CancelPaymentStatus status,
            String createdAt,
            CancelPaymentLinks links) {
     ...
     */
    @JsonIgnore
    public CancelPaymentAmount amount() {
        return amount;
    }
    ...
    @JsonIgnore
    public Optional<CancelPaymentAmountRefunded> amountRefunded() {
        return (Optional<CancelPaymentAmountRefunded>) amountRefunded;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentAmountRemaining> amountRemaining() {
        return (Optional<CancelPaymentAmountRemaining>) amountRemaining;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentAmountCaptured> amountCaptured() {
        return (Optional<CancelPaymentAmountCaptured>) amountCaptured;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentAmountChargedBack> amountChargedBack() {
        return (Optional<CancelPaymentAmountChargedBack>) amountChargedBack;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentSettlementAmount> settlementAmount() {
        return (Optional<CancelPaymentSettlementAmount>) settlementAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<CancelPaymentLines>> lines() {
        return (JsonNullable<List<CancelPaymentLines>>) lines;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentBillingAddress> billingAddress() {
        return (Optional<CancelPaymentBillingAddress>) billingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentShippingAddress> shippingAddress() {
        return (Optional<CancelPaymentShippingAddress>) shippingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentLocale> locale() {
        return (JsonNullable<CancelPaymentLocale>) locale;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentMethod> method() {
        return (JsonNullable<CancelPaymentMethod>) method;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentMetadata> metadata() {
        return (JsonNullable<CancelPaymentMetadata>) metadata;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentCaptureMode> captureMode() {
        return (JsonNullable<CancelPaymentCaptureMode>) captureMode;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentApplicationFee> applicationFee() {
        return (JsonNullable<CancelPaymentApplicationFee>) applicationFee;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<CancelPaymentRouting>> routing() {
        return (JsonNullable<List<CancelPaymentRouting>>) routing;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentSequenceType> sequenceType() {
        return (Optional<CancelPaymentSequenceType>) sequenceType;
    }
     ...
     */
    @JsonIgnore
    public CancelPaymentStatus status() {
        return status;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentStatusReason> statusReason() {
        return (JsonNullable<CancelPaymentStatusReason>) statusReason;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CancelPaymentDetails> details() {
        return (JsonNullable<CancelPaymentDetails>) details;
    }
     ...
     */
    @JsonIgnore
    public CancelPaymentLinks links() {
        return links;
    }
     ...
     * Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint.
     */
    public CancelPaymentResponseBody withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * will always refer to the payment by this ID. Example: `tr_5B8cwPMGnU6qLbRvo7qEZo`.
     */
    public CancelPaymentResponseBody withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public CancelPaymentResponseBody withMode(CancelPaymentMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * characters. The API will not reject strings longer than the maximum length but it will truncate them to fit.
     */
    public CancelPaymentResponseBody withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * tip amount.
     */
    public CancelPaymentResponseBody withAmount(CancelPaymentAmount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * costs for a return shipment to the customer.
     */
    public CancelPaymentResponseBody withAmountRefunded(CancelPaymentAmountRefunded amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
     ...
     * costs for a return shipment to the customer.
     */
    public CancelPaymentResponseBody withAmountRefunded(Optional<? extends CancelPaymentAmountRefunded> amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
        this.amountRefunded = amountRefunded;
        return this;
    }
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public CancelPaymentResponseBody withAmountRemaining(CancelPaymentAmountRemaining amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public CancelPaymentResponseBody withAmountRemaining(Optional<? extends CancelPaymentAmountRemaining> amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
        this.amountRemaining = amountRemaining;
        return this;
    }
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public CancelPaymentResponseBody withAmountCaptured(CancelPaymentAmountCaptured amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public CancelPaymentResponseBody withAmountCaptured(Optional<? extends CancelPaymentAmountCaptured> amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
        this.amountCaptured = amountCaptured;
        return this;
    }
     ...
     * zero.
     */
    public CancelPaymentResponseBody withAmountChargedBack(CancelPaymentAmountChargedBack amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
     ...
     * zero.
     */
    public CancelPaymentResponseBody withAmountChargedBack(Optional<? extends CancelPaymentAmountChargedBack> amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
        this.amountChargedBack = amountChargedBack;
        return this;
    }
     ...
     * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public CancelPaymentResponseBody withSettlementAmount(CancelPaymentSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public CancelPaymentResponseBody withSettlementAmount(Optional<? extends CancelPaymentSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public CancelPaymentResponseBody withRedirectUrl(String redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public CancelPaymentResponseBody withRedirectUrl(JsonNullable<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * payment cancellations.
     */
    public CancelPaymentResponseBody withCancelUrl(String cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
     ...
     * payment cancellations.
     */
    public CancelPaymentResponseBody withCancelUrl(JsonNullable<String> cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
        this.cancelUrl = cancelUrl;
        return this;
    }
     ...
     * local machine.
     */
    public CancelPaymentResponseBody withWebhookUrl(String webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
     ...
     * local machine.
     */
    public CancelPaymentResponseBody withWebhookUrl(JsonNullable<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public CancelPaymentResponseBody withLines(List<CancelPaymentLines> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public CancelPaymentResponseBody withLines(JsonNullable<? extends List<CancelPaymentLines>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public CancelPaymentResponseBody withBillingAddress(CancelPaymentBillingAddress billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public CancelPaymentResponseBody withBillingAddress(Optional<? extends CancelPaymentBillingAddress> billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
        this.billingAddress = billingAddress;
        return this;
    }
     ...
     * `country`.
     */
    public CancelPaymentResponseBody withShippingAddress(CancelPaymentShippingAddress shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
     ...
     * `country`.
     */
    public CancelPaymentResponseBody withShippingAddress(Optional<? extends CancelPaymentShippingAddress> shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
        this.shippingAddress = shippingAddress;
        return this;
    }
     ...
     * customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public CancelPaymentResponseBody withLocale(CancelPaymentLocale locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public CancelPaymentResponseBody withLocale(JsonNullable<? extends CancelPaymentLocale> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * field is omitted if the country code was not detected.
     */
    public CancelPaymentResponseBody withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
     ...
     * field is omitted if the country code was not detected.
     */
    public CancelPaymentResponseBody withCountryCode(JsonNullable<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * this field reflects that choice.
     */
    public CancelPaymentResponseBody withMethod(CancelPaymentMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * this field reflects that choice.
     */
    public CancelPaymentResponseBody withMethod(JsonNullable<? extends CancelPaymentMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public CancelPaymentResponseBody withRestrictPaymentMethodsToCountry(String restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public CancelPaymentResponseBody withRestrictPaymentMethodsToCountry(JsonNullable<String> restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
        this.restrictPaymentMethodsToCountry = restrictPaymentMethodsToCountry;
        return this;
    }
     ...
     * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public CancelPaymentResponseBody withMetadata(CancelPaymentMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public CancelPaymentResponseBody withMetadata(JsonNullable<? extends CancelPaymentMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public CancelPaymentResponseBody withCaptureMode(CancelPaymentCaptureMode captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public CancelPaymentResponseBody withCaptureMode(JsonNullable<? extends CancelPaymentCaptureMode> captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
        this.captureMode = captureMode;
        return this;
    }
     ...
     * can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public CancelPaymentResponseBody withCaptureBefore(String captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
     ...
     * can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public CancelPaymentResponseBody withCaptureBefore(JsonNullable<String> captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
        this.captureBefore = captureBefore;
        return this;
    }
     ...
     * `routing` parameter.
     */
    public CancelPaymentResponseBody withApplicationFee(CancelPaymentApplicationFee applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
     ...
     * `routing` parameter.
     */
    public CancelPaymentResponseBody withApplicationFee(JsonNullable<? extends CancelPaymentApplicationFee> applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
        this.applicationFee = applicationFee;
        return this;
    }
     ...
     * parameter.
     */
    public CancelPaymentResponseBody withRouting(List<CancelPaymentRouting> routing) {
        Utils.checkNotNull(routing, "routing");
     ...
     * parameter.
     */
    public CancelPaymentResponseBody withRouting(JsonNullable<? extends List<CancelPaymentRouting>> routing) {
        Utils.checkNotNull(routing, "routing");
        this.routing = routing;
        return this;
    }
     ...
     * are set up correctly for recurring payments.
     */
    public CancelPaymentResponseBody withSequenceType(CancelPaymentSequenceType sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
     ...
     * are set up correctly for recurring payments.
     */
    public CancelPaymentResponseBody withSequenceType(Optional<? extends CancelPaymentSequenceType> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * be added to the response.
     */
    public CancelPaymentResponseBody withSubscriptionId(String subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
     ...
     * be added to the response.
     */
    public CancelPaymentResponseBody withSubscriptionId(JsonNullable<String> subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
        this.subscriptionId = subscriptionId;
        return this;
    }
     ...
     * the customer's accounts should be credited.
     */
    public CancelPaymentResponseBody withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
     ...
     * the customer's accounts should be credited.
     */
    public CancelPaymentResponseBody withMandateId(JsonNullable<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public CancelPaymentResponseBody withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public CancelPaymentResponseBody withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * <p>For more information, see [Authentication](authentication).
     */
    public CancelPaymentResponseBody withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public CancelPaymentResponseBody withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public CancelPaymentResponseBody withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public CancelPaymentResponseBody withOrderId(String orderId) {
        Utils.checkNotNull(orderId, "orderId");
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public CancelPaymentResponseBody withOrderId(JsonNullable<String> orderId) {
        Utils.checkNotNull(orderId, "orderId");
        this.orderId = orderId;
        return this;
    }
     ...
     * statuses occur at what point.
     */
    public CancelPaymentResponseBody withStatus(CancelPaymentStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * [this page](status-reasons).**
     */
    public CancelPaymentResponseBody withStatusReason(CancelPaymentStatusReason statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
     ...
     * [this page](status-reasons).**
     */
    public CancelPaymentResponseBody withStatusReason(JsonNullable<? extends CancelPaymentStatusReason> statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
        this.statusReason = statusReason;
        return this;
    }
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public CancelPaymentResponseBody withIsCancelable(boolean isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public CancelPaymentResponseBody withIsCancelable(JsonNullable<Boolean> isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
        this.isCancelable = isCancelable;
        return this;
    }
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public CancelPaymentResponseBody withDetails(CancelPaymentDetails details) {
        Utils.checkNotNull(details, "details");
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public CancelPaymentResponseBody withDetails(JsonNullable<? extends CancelPaymentDetails> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public CancelPaymentResponseBody withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * not authorized (yet).
     */
    public CancelPaymentResponseBody withAuthorizedAt(String authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
     ...
     * not authorized (yet).
     */
    public CancelPaymentResponseBody withAuthorizedAt(JsonNullable<String> authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
        this.authorizedAt = authorizedAt;
        return this;
    }
     ...
     * completed (yet).
     */
    public CancelPaymentResponseBody withPaidAt(String paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
     ...
     * completed (yet).
     */
    public CancelPaymentResponseBody withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * canceled (yet).
     */
    public CancelPaymentResponseBody withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * canceled (yet).
     */
    public CancelPaymentResponseBody withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * longer expire.
     */
    public CancelPaymentResponseBody withExpiresAt(String expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * longer expire.
     */
    public CancelPaymentResponseBody withExpiresAt(JsonNullable<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * expire (yet).
     */
    public CancelPaymentResponseBody withExpiredAt(String expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
     ...
     * expire (yet).
     */
    public CancelPaymentResponseBody withExpiredAt(JsonNullable<String> expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
        this.expiredAt = expiredAt;
        return this;
    }
     ...
     * (yet).
     */
    public CancelPaymentResponseBody withFailedAt(String failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
     ...
     * (yet).
     */
    public CancelPaymentResponseBody withFailedAt(JsonNullable<String> failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
        this.failedAt = failedAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public CancelPaymentResponseBody withLinks(CancelPaymentLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentResponseBody other = (CancelPaymentResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentResponseBody.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CancelPaymentAmountRefunded> amountRefunded = Optional.empty();

        private Optional<? extends CancelPaymentAmountRemaining> amountRemaining = Optional.empty();

        private Optional<? extends CancelPaymentAmountCaptured> amountCaptured = Optional.empty();

        private Optional<? extends CancelPaymentAmountChargedBack> amountChargedBack = Optional.empty();

        private Optional<? extends CancelPaymentSettlementAmount> settlementAmount = Optional.empty();
        ...
        private JsonNullable<? extends List<CancelPaymentLines>> lines = JsonNullable.undefined();

        private Optional<? extends CancelPaymentBillingAddress> billingAddress = Optional.empty();

        private Optional<? extends CancelPaymentShippingAddress> shippingAddress = Optional.empty();

        private JsonNullable<? extends CancelPaymentLocale> locale = JsonNullable.undefined();

        private JsonNullable<String> countryCode = JsonNullable.undefined();

        private JsonNullable<? extends CancelPaymentMethod> method = JsonNullable.undefined();
        ...
        private JsonNullable<? extends CancelPaymentApplicationFee> applicationFee = JsonNullable.undefined();

        private JsonNullable<? extends List<CancelPaymentRouting>> routing = JsonNullable.undefined();

        private Optional<? extends CancelPaymentSequenceType> sequenceType = Optional.empty();
        ...
        private JsonNullable<? extends CancelPaymentStatusReason> statusReason = JsonNullable.undefined();

        private JsonNullable<Boolean> isCancelable = JsonNullable.undefined();

        private JsonNullable<? extends CancelPaymentDetails> details = JsonNullable.undefined();
         ...
         * Whether this entity was created in live mode or in test mode.
         */
        public Builder mode(CancelPaymentMode mode) {
            Utils.checkNotNull(mode, "mode");
            this.mode = mode;
            return this;
        }
         ...
         * tip amount.
         */
        public Builder amount(CancelPaymentAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
         ...
         * costs for a return shipment to the customer.
         */
        public Builder amountRefunded(CancelPaymentAmountRefunded amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = Optional.ofNullable(amountRefunded);
            return this;
        }
         ...
         * costs for a return shipment to the customer.
         */
        public Builder amountRefunded(Optional<? extends CancelPaymentAmountRefunded> amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = amountRefunded;
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(CancelPaymentAmountRemaining amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = Optional.ofNullable(amountRemaining);
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(Optional<? extends CancelPaymentAmountRemaining> amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = amountRemaining;
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(CancelPaymentAmountCaptured amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = Optional.ofNullable(amountCaptured);
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(Optional<? extends CancelPaymentAmountCaptured> amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = amountCaptured;
            return this;
        }
         ...
         * zero.
         */
        public Builder amountChargedBack(CancelPaymentAmountChargedBack amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = Optional.ofNullable(amountChargedBack);
            return this;
        }
         ...
         * zero.
         */
        public Builder amountChargedBack(Optional<? extends CancelPaymentAmountChargedBack> amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = amountChargedBack;
            return this;
        }
         ...
         * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(CancelPaymentSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = Optional.ofNullable(settlementAmount);
            return this;
        }
         ...
         * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(Optional<? extends CancelPaymentSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(List<CancelPaymentLines> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = JsonNullable.of(lines);
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(JsonNullable<? extends List<CancelPaymentLines>> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = lines;
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(CancelPaymentBillingAddress billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = Optional.ofNullable(billingAddress);
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(Optional<? extends CancelPaymentBillingAddress> billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = billingAddress;
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(CancelPaymentShippingAddress shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = Optional.ofNullable(shippingAddress);
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(Optional<? extends CancelPaymentShippingAddress> shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = shippingAddress;
            return this;
        }
         ...
         * customer use a local bank account greatly increases the conversion and speed of payment.
         */
        public Builder locale(CancelPaymentLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = JsonNullable.of(locale);
            return this;
        }
         ...
         * customer use a local bank account greatly increases the conversion and speed of payment.
         */
        public Builder locale(JsonNullable<? extends CancelPaymentLocale> locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }
         ...
         * this field reflects that choice.
         */
        public Builder method(CancelPaymentMethod method) {
            Utils.checkNotNull(method, "method");
            this.method = JsonNullable.of(method);
            return this;
        }
         ...
         * this field reflects that choice.
         */
        public Builder method(JsonNullable<? extends CancelPaymentMethod> method) {
            Utils.checkNotNull(method, "method");
            this.method = method;
            return this;
        }
         ...
         * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(CancelPaymentMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = JsonNullable.of(metadata);
            return this;
        }
         ...
         * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(JsonNullable<? extends CancelPaymentMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * <p>This field needs to be set to `manual` for method `riverty`.
         */
        public Builder captureMode(CancelPaymentCaptureMode captureMode) {
            Utils.checkNotNull(captureMode, "captureMode");
            this.captureMode = JsonNullable.of(captureMode);
            return this;
        }
         ...
         * <p>This field needs to be set to `manual` for method `riverty`.
         */
        public Builder captureMode(JsonNullable<? extends CancelPaymentCaptureMode> captureMode) {
            Utils.checkNotNull(captureMode, "captureMode");
            this.captureMode = captureMode;
            return this;
        }
         ...
         * `routing` parameter.
         */
        public Builder applicationFee(CancelPaymentApplicationFee applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = JsonNullable.of(applicationFee);
            return this;
        }
         ...
         * `routing` parameter.
         */
        public Builder applicationFee(JsonNullable<? extends CancelPaymentApplicationFee> applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = applicationFee;
            return this;
        }
         ...
         * parameter.
         */
        public Builder routing(List<CancelPaymentRouting> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = JsonNullable.of(routing);
            return this;
        }
         ...
         * parameter.
         */
        public Builder routing(JsonNullable<? extends List<CancelPaymentRouting>> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = routing;
            return this;
        }
         ...
         * are set up correctly for recurring payments.
         */
        public Builder sequenceType(CancelPaymentSequenceType sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = Optional.ofNullable(sequenceType);
            return this;
        }
         ...
         * are set up correctly for recurring payments.
         */
        public Builder sequenceType(Optional<? extends CancelPaymentSequenceType> sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = sequenceType;
            return this;
        }
         ...
         * statuses occur at what point.
         */
        public Builder status(CancelPaymentStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * [this page](status-reasons).**
         */
        public Builder statusReason(CancelPaymentStatusReason statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = JsonNullable.of(statusReason);
            return this;
        }
         ...
         * [this page](status-reasons).**
         */
        public Builder statusReason(JsonNullable<? extends CancelPaymentStatusReason> statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = statusReason;
            return this;
        }
         ...
         * [method-specific parameters](extra-payment-parameters) guide.
         */
        public Builder details(CancelPaymentDetails details) {
            Utils.checkNotNull(details, "details");
            this.details = JsonNullable.of(details);
            return this;
        }
         ...
         * [method-specific parameters](extra-payment-parameters) guide.
         */
        public Builder details(JsonNullable<? extends CancelPaymentDetails> details) {
            Utils.checkNotNull(details, "details");
            this.details = details;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(CancelPaymentLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        public CancelPaymentResponseBody build() {
            ...
            return new CancelPaymentResponseBody(
                resource, id, mode,
                description, amount, amountRefunded,
                amountRemaining, amountCaptured, amountChargedBack,
                settlementAmount, redirectUrl, cancelUrl,
