...
public class DeletePaymentLinkRequestBody {
    ...
    @JsonCreator
    public DeletePaymentLinkRequestBody(
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public DeletePaymentLinkRequestBody withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public DeletePaymentLinkRequestBody withTestmode(JsonNullable<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
