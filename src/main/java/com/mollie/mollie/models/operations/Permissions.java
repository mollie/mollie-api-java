...
public class Permissions {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListPermissionsPermissionsLinks> links;
    ...
    public Permissions(
            ...
            @JsonProperty("_links") Optional<? extends ListPermissionsPermissionsLinks> links) {
    ...
    @JsonIgnore
    public Optional<ListPermissionsPermissionsLinks> links() {
     ...
     * endpoint.
     */
    public Permissions withResource(Optional<String> resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this permission. Example: `payments.read`.
     */
    public Permissions withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * A short description of what kind of access the permission enables.
     */
    public Permissions withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Whether this permission is granted to the app by the organization.
     */
    public Permissions withGranted(boolean granted) {
        Utils.checkNotNull(granted, "granted");
     ...
     * Whether this permission is granted to the app by the organization.
     */
    public Permissions withGranted(Optional<Boolean> granted) {
        Utils.checkNotNull(granted, "granted");
        this.granted = granted;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public Permissions withLinks(ListPermissionsPermissionsLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public Permissions withLinks(Optional<? extends ListPermissionsPermissionsLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListPermissionsPermissionsLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends ListPermissionsPermissionsLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
