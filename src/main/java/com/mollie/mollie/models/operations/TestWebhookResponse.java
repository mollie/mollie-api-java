...
public class TestWebhookResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public TestWebhookResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public TestWebhookResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public TestWebhookResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Accepted.
     */
    public TestWebhookResponse withAny(Object any) {
        Utils.checkNotNull(any, "any");
     ...
     * Accepted.
     */
    public TestWebhookResponse withAny(Optional<? extends Object> any) {
        Utils.checkNotNull(any, "any");
        this.any = any;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TestWebhookResponse other = (TestWebhookResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TestWebhookResponse.class,
