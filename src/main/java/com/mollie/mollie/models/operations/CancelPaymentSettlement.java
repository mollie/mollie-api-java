...
public class CancelPaymentSettlement {
    ...
    @JsonCreator
    public CancelPaymentSettlement(
     ...
     * The actual URL string.
     */
    public CancelPaymentSettlement withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public CancelPaymentSettlement withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentSettlement withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentSettlement withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentSettlement other = (CancelPaymentSettlement) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentSettlement.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public CancelPaymentSettlement build() {
            return new CancelPaymentSettlement(
                href,
                type);
        }
    }
