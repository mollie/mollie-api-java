...
public class CancelPaymentOrder {
     ...
     * The actual URL string.
     */
    public CancelPaymentOrder withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public CancelPaymentOrder withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentOrder withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentOrder withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentOrder other = (CancelPaymentOrder) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentOrder.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public CancelPaymentOrder build() {
            return new CancelPaymentOrder(
                href,
                type);
        }
    }
