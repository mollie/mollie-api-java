...
public class GetPaymentLinkShippingAddress {
    ...
    @JsonCreator
    public GetPaymentLinkShippingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public GetPaymentLinkShippingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public GetPaymentLinkShippingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public GetPaymentLinkShippingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public GetPaymentLinkShippingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public GetPaymentLinkShippingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public GetPaymentLinkShippingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public GetPaymentLinkShippingAddress withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public GetPaymentLinkShippingAddress withPhone(Optional<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public GetPaymentLinkShippingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public GetPaymentLinkShippingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public GetPaymentLinkShippingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkShippingAddress other = (GetPaymentLinkShippingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkShippingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public GetPaymentLinkShippingAddress build() {

            return new GetPaymentLinkShippingAddress(
                title, givenName, familyName,
                organizationName, streetAndNumber, streetAdditional,
                postalCode, email, phone,
                city, region, country);
