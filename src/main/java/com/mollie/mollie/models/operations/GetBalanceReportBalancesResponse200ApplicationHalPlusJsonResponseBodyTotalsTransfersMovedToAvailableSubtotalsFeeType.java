 ...
 */
public enum GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsTransfersMovedToAvailableSubtotalsFeeType {
    ...
    GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsTransfersMovedToAvailableSubtotalsFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsTransfersMovedToAvailableSubtotalsFeeType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsTransfersMovedToAvailableSubtotalsFeeType o: GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsTransfersMovedToAvailableSubtotalsFeeType.values()) {
