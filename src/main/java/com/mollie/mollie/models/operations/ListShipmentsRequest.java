...
public class ListShipmentsRequest {
    ...
    public ListShipmentsRequest(
            String orderId) {
        this(orderId, Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined());
    }
     ...
     * Provide the ID of the related order.
     */
    public ListShipmentsRequest withOrderId(String orderId) {
        Utils.checkNotNull(orderId, "orderId");
        this.orderId = orderId;
        return this;
    }
     ...
     * result set.
     */
    public ListShipmentsRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * result set.
     */
    public ListShipmentsRequest withFrom(Optional<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListShipmentsRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListShipmentsRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListShipmentsRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListShipmentsRequest withTestmode(JsonNullable<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
