...
public class GetPaymentLinkUnitPrice {
    ...
    @JsonCreator
    public GetPaymentLinkUnitPrice(
     ...
     * A three-character ISO 4217 currency code.
     */
    public GetPaymentLinkUnitPrice withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public GetPaymentLinkUnitPrice withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkUnitPrice other = (GetPaymentLinkUnitPrice) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkUnitPrice.class,
                "currency", currency,
                "value", value);
    }
