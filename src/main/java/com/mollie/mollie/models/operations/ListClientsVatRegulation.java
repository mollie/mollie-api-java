...
public enum ListClientsVatRegulation {
    ...
    ListClientsVatRegulation(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListClientsVatRegulation> fromValue(String value) {
        for (ListClientsVatRegulation o: ListClientsVatRegulation.values()) {
