...
public enum GetWebhookWebhookEventTypes {
    ...
    GetWebhookWebhookEventTypes(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetWebhookWebhookEventTypes> fromValue(String value) {
        for (GetWebhookWebhookEventTypes o: GetWebhookWebhookEventTypes.values()) {
