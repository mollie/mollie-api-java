...
public class ListMandatesNext {
     ...
     * The actual URL string.
     */
    public ListMandatesNext withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListMandatesNext withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListMandatesNext withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListMandatesNext withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMandatesNext other = (ListMandatesNext) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMandatesNext.class,
                "href", href,
                "type", type);
    }
