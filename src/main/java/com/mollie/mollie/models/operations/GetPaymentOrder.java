...
public class GetPaymentOrder {
     ...
     * The actual URL string.
     */
    public GetPaymentOrder withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetPaymentOrder withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentOrder withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentOrder withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentOrder other = (GetPaymentOrder) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentOrder.class,
                "href", href,
                "type", type);
    }
