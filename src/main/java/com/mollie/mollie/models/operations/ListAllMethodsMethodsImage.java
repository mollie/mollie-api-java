...
public class ListAllMethodsMethodsImage {
    ...
    @JsonCreator
    public ListAllMethodsMethodsImage(
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListAllMethodsMethodsImage withSize1x(String size1x) {
        Utils.checkNotNull(size1x, "size1x");
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListAllMethodsMethodsImage withSize1x(Optional<String> size1x) {
        Utils.checkNotNull(size1x, "size1x");
        this.size1x = size1x;
        return this;
    }
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListAllMethodsMethodsImage withSize2x(String size2x) {
        Utils.checkNotNull(size2x, "size2x");
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListAllMethodsMethodsImage withSize2x(Optional<String> size2x) {
        Utils.checkNotNull(size2x, "size2x");
        this.size2x = size2x;
        return this;
    }
     ...
     * scale to any desired size without compromising visual quality.
     */
    public ListAllMethodsMethodsImage withSvg(String svg) {
        Utils.checkNotNull(svg, "svg");
     ...
     * scale to any desired size without compromising visual quality.
     */
    public ListAllMethodsMethodsImage withSvg(Optional<String> svg) {
        Utils.checkNotNull(svg, "svg");
        this.svg = svg;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAllMethodsMethodsImage other = (ListAllMethodsMethodsImage) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAllMethodsMethodsImage.class,
                "size1x", size1x,
                "size2x", size2x,
                "svg", svg);
    }
