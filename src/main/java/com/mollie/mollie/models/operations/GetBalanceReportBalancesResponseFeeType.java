 ...
 */
public enum GetBalanceReportBalancesResponseFeeType {
    ...
    GetBalanceReportBalancesResponseFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponseFeeType> fromValue(String value) {
        for (GetBalanceReportBalancesResponseFeeType o: GetBalanceReportBalancesResponseFeeType.values()) {
