...
public class Routing {
    ...
    @JsonProperty("amount")
    private Optional<? extends CreatePaymentPaymentsRequestRequestBodyAmount> amount;
    ...
    @JsonCreator
    public Routing(
            @JsonProperty("amount") Optional<? extends CreatePaymentPaymentsRequestRequestBodyAmount> amount,
    ...
    @JsonIgnore
    public Optional<CreatePaymentPaymentsRequestRequestBodyAmount> amount() {
        return (Optional<CreatePaymentPaymentsRequestRequestBodyAmount>) amount;
    }
     ...
     * The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
     */
    public Routing withAmount(CreatePaymentPaymentsRequestRequestBodyAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
     */
    public Routing withAmount(Optional<? extends CreatePaymentPaymentsRequestRequestBodyAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreatePaymentPaymentsRequestRequestBodyAmount> amount = Optional.empty();
         ...
         * The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
         */
        public Builder amount(CreatePaymentPaymentsRequestRequestBodyAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
         */
        public Builder amount(Optional<? extends CreatePaymentPaymentsRequestRequestBodyAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
