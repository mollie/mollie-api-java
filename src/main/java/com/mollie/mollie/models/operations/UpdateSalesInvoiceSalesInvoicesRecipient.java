...
public class UpdateSalesInvoiceSalesInvoicesRecipient {
    /**
     * The type of recipient, either `consumer` or `business`. This will determine what further fields are
     * required on the `recipient` object.
     */
    @JsonProperty("type")
    private UpdateSalesInvoiceSalesInvoicesResponseType type;
     ...
     */
    @JsonProperty("locale")
    private UpdateSalesInvoiceSalesInvoicesLocale locale;

    @JsonCreator
    public UpdateSalesInvoiceSalesInvoicesRecipient(
            @JsonProperty("type") UpdateSalesInvoiceSalesInvoicesResponseType type,
            ...
            @JsonProperty("locale") UpdateSalesInvoiceSalesInvoicesLocale locale) {
    ...
    public UpdateSalesInvoiceSalesInvoicesRecipient(
            UpdateSalesInvoiceSalesInvoicesResponseType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            UpdateSalesInvoiceSalesInvoicesLocale locale) {
     ...
     */
    @JsonIgnore
    public UpdateSalesInvoiceSalesInvoicesResponseType type() {
        return type;
    }
     ...
     */
    @JsonIgnore
    public UpdateSalesInvoiceSalesInvoicesLocale locale() {
        return locale;
    }
     ...
     * required on the `recipient` object.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withType(UpdateSalesInvoiceSalesInvoicesResponseType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withGivenName(JsonNullable<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * only numbers.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withFamilyName(JsonNullable<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The trading name of the `business` type recipient.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The trading name of the `business` type recipient.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withOrganizationName(JsonNullable<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withOrganizationNumber(String organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withOrganizationNumber(JsonNullable<String> organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
        this.organizationNumber = organizationNumber;
        return this;
    }
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * has to be provided.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * The email address of the recipient.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withEmail(String email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * The phone number of the recipient.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * The phone number of the recipient.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * A street and street number.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withStreetAdditional(JsonNullable<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * A postal code.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The recipient's city.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The recipient's region.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The recipient's region.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * The locale for the recipient, to be used for translations in PDF generation and payment pages.
     */
    public UpdateSalesInvoiceSalesInvoicesRecipient withLocale(UpdateSalesInvoiceSalesInvoicesLocale locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSalesInvoiceSalesInvoicesRecipient other = (UpdateSalesInvoiceSalesInvoicesRecipient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSalesInvoiceSalesInvoicesRecipient.class,
                "type", type,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(UpdateSalesInvoiceSalesInvoicesResponseType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The locale for the recipient, to be used for translations in PDF generation and payment pages.
         */
        public Builder locale(UpdateSalesInvoiceSalesInvoicesLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }

        public UpdateSalesInvoiceSalesInvoicesRecipient build() {

            return new UpdateSalesInvoiceSalesInvoicesRecipient(
                type, title, givenName,
                familyName, organizationName, organizationNumber,
                vatNumber, email, phone,
                streetAndNumber, streetAdditional, postalCode,
