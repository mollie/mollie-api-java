...
/**
 * PaymentLink - The URL your customer should visit to make the payment. This is where you should redirect the customer to.
 */
...
public class PaymentLink {
     ...
     * The actual URL string.
     */
    public PaymentLink withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public PaymentLink withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public PaymentLink withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public PaymentLink withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
