...
public enum GetPaymentLinkPaymentsSequenceType {
    ...
    GetPaymentLinkPaymentsSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentLinkPaymentsSequenceType> fromValue(String value) {
        for (GetPaymentLinkPaymentsSequenceType o: GetPaymentLinkPaymentsSequenceType.values()) {
