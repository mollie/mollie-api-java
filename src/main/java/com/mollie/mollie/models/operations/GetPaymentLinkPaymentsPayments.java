...
public class GetPaymentLinkPaymentsPayments {
     ...
     */
    @JsonProperty("mode")
    private GetPaymentLinkPaymentsMode mode;
    ...
    private Optional<? extends GetPaymentLinkPaymentsAmountRefunded> amountRefunded;
    ...
    private Optional<? extends GetPaymentLinkPaymentsAmountRemaining> amountRemaining;
    ...
    private Optional<? extends GetPaymentLinkPaymentsAmountCaptured> amountCaptured;
    ...
    private Optional<? extends GetPaymentLinkPaymentsAmountChargedBack> amountChargedBack;
    ...
    private Optional<? extends GetPaymentLinkPaymentsSettlementAmount> settlementAmount;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("lines")
    private JsonNullable<? extends List<GetPaymentLinkPaymentsLines>> lines;
    ...
    private Optional<? extends GetPaymentLinkPaymentsBillingAddress> billingAddress;
    ...
    private Optional<? extends GetPaymentLinkPaymentsShippingAddress> shippingAddress;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("locale")
    private JsonNullable<? extends GetPaymentLinkPaymentsLocale> locale;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("method")
    private JsonNullable<? extends GetPaymentLinkPaymentsMethod> method;
    ...
    private JsonNullable<? extends GetPaymentLinkPaymentsMetadata> metadata;
    ...
    private JsonNullable<? extends GetPaymentLinkPaymentsApplicationFee> applicationFee;
    ...
    private JsonNullable<? extends List<GetPaymentLinkPaymentsRouting>> routing;
    ...
    private Optional<? extends GetPaymentLinkPaymentsSequenceType> sequenceType;
     ...
     */
    @JsonProperty("status")
    private GetPaymentLinkPaymentsStatus status;
    ...
    private JsonNullable<? extends GetPaymentLinkPaymentsStatusReason> statusReason;
    ...
    private JsonNullable<? extends GetPaymentLinkPaymentsDetails> details;
    ...
    @JsonCreator
    public GetPaymentLinkPaymentsPayments(
            @JsonProperty("resource") String resource,
            @JsonProperty("id") String id,
            @JsonProperty("mode") GetPaymentLinkPaymentsMode mode,
            @JsonProperty("description") String description,
            @JsonProperty("amount") GetPaymentLinkPaymentsAmount amount,
            @JsonProperty("amountRefunded") Optional<? extends GetPaymentLinkPaymentsAmountRefunded> amountRefunded,
            @JsonProperty("amountRemaining") Optional<? extends GetPaymentLinkPaymentsAmountRemaining> amountRemaining,
            @JsonProperty("amountCaptured") Optional<? extends GetPaymentLinkPaymentsAmountCaptured> amountCaptured,
            @JsonProperty("amountChargedBack") Optional<? extends GetPaymentLinkPaymentsAmountChargedBack> amountChargedBack,
            @JsonProperty("settlementAmount") Optional<? extends GetPaymentLinkPaymentsSettlementAmount> settlementAmount,
            ...
            @JsonProperty("lines") JsonNullable<? extends List<GetPaymentLinkPaymentsLines>> lines,
            @JsonProperty("billingAddress") Optional<? extends GetPaymentLinkPaymentsBillingAddress> billingAddress,
            @JsonProperty("shippingAddress") Optional<? extends GetPaymentLinkPaymentsShippingAddress> shippingAddress,
            @JsonProperty("locale") JsonNullable<? extends GetPaymentLinkPaymentsLocale> locale,
            @JsonProperty("countryCode") JsonNullable<String> countryCode,
            @JsonProperty("method") JsonNullable<? extends GetPaymentLinkPaymentsMethod> method,
            ...
            @JsonProperty("sequenceType") Optional<? extends GetPaymentLinkPaymentsSequenceType> sequenceType,
            ...
            @JsonProperty("status") GetPaymentLinkPaymentsStatus status,
            @JsonProperty("statusReason") JsonNullable<? extends GetPaymentLinkPaymentsStatusReason> statusReason,
            @JsonProperty("isCancelable") JsonNullable<Boolean> isCancelable,
            @JsonProperty("details") JsonNullable<? extends GetPaymentLinkPaymentsDetails> details,
            ...
            @JsonProperty("_links") GetPaymentLinkPaymentsPaymentLinksLinks links) {
    ...
    public GetPaymentLinkPaymentsPayments(
            String resource,
            String id,
            GetPaymentLinkPaymentsMode mode,
            String description,
            GetPaymentLinkPaymentsAmount amount,
            String profileId,
            GetPaymentLinkPaymentsStatus status,
            String createdAt,
     ...
     */
    @JsonIgnore
    public GetPaymentLinkPaymentsMode mode() {
        return mode;
    }
     ...
     */
    @JsonIgnore
    public GetPaymentLinkPaymentsAmount amount() {
        return amount;
    }
    ...
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsAmountRefunded> amountRefunded() {
        return (Optional<GetPaymentLinkPaymentsAmountRefunded>) amountRefunded;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsAmountRemaining> amountRemaining() {
        return (Optional<GetPaymentLinkPaymentsAmountRemaining>) amountRemaining;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsAmountCaptured> amountCaptured() {
        return (Optional<GetPaymentLinkPaymentsAmountCaptured>) amountCaptured;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsAmountChargedBack> amountChargedBack() {
        return (Optional<GetPaymentLinkPaymentsAmountChargedBack>) amountChargedBack;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsSettlementAmount> settlementAmount() {
        return (Optional<GetPaymentLinkPaymentsSettlementAmount>) settlementAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetPaymentLinkPaymentsLines>> lines() {
        return (JsonNullable<List<GetPaymentLinkPaymentsLines>>) lines;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsBillingAddress> billingAddress() {
        return (Optional<GetPaymentLinkPaymentsBillingAddress>) billingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsShippingAddress> shippingAddress() {
        return (Optional<GetPaymentLinkPaymentsShippingAddress>) shippingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsLocale> locale() {
        return (JsonNullable<GetPaymentLinkPaymentsLocale>) locale;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsMethod> method() {
        return (JsonNullable<GetPaymentLinkPaymentsMethod>) method;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsMetadata> metadata() {
        return (JsonNullable<GetPaymentLinkPaymentsMetadata>) metadata;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsCaptureMode> captureMode() {
        return (JsonNullable<GetPaymentLinkPaymentsCaptureMode>) captureMode;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsApplicationFee> applicationFee() {
        return (JsonNullable<GetPaymentLinkPaymentsApplicationFee>) applicationFee;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetPaymentLinkPaymentsRouting>> routing() {
        return (JsonNullable<List<GetPaymentLinkPaymentsRouting>>) routing;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentsSequenceType> sequenceType() {
        return (Optional<GetPaymentLinkPaymentsSequenceType>) sequenceType;
    }
     ...
     */
    @JsonIgnore
    public GetPaymentLinkPaymentsStatus status() {
        return status;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsStatusReason> statusReason() {
        return (JsonNullable<GetPaymentLinkPaymentsStatusReason>) statusReason;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<GetPaymentLinkPaymentsDetails> details() {
        return (JsonNullable<GetPaymentLinkPaymentsDetails>) details;
    }
     ...
     */
    @JsonIgnore
    public GetPaymentLinkPaymentsPaymentLinksLinks links() {
        return links;
    }
     ...
     * Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint.
     */
    public GetPaymentLinkPaymentsPayments withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * will always refer to the payment by this ID. Example: `tr_5B8cwPMGnU6qLbRvo7qEZo`.
     */
    public GetPaymentLinkPaymentsPayments withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public GetPaymentLinkPaymentsPayments withMode(GetPaymentLinkPaymentsMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * characters. The API will not reject strings longer than the maximum length but it will truncate them to fit.
     */
    public GetPaymentLinkPaymentsPayments withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * tip amount.
     */
    public GetPaymentLinkPaymentsPayments withAmount(GetPaymentLinkPaymentsAmount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * costs for a return shipment to the customer.
     */
    public GetPaymentLinkPaymentsPayments withAmountRefunded(GetPaymentLinkPaymentsAmountRefunded amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
     ...
     * costs for a return shipment to the customer.
     */
    public GetPaymentLinkPaymentsPayments withAmountRefunded(Optional<? extends GetPaymentLinkPaymentsAmountRefunded> amountRefunded) {
        Utils.checkNotNull(amountRefunded, "amountRefunded");
        this.amountRefunded = amountRefunded;
        return this;
    }
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public GetPaymentLinkPaymentsPayments withAmountRemaining(GetPaymentLinkPaymentsAmountRemaining amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
     ...
     * The remaining amount that can be refunded. Only available when refunds are available for this payment.
     */
    public GetPaymentLinkPaymentsPayments withAmountRemaining(Optional<? extends GetPaymentLinkPaymentsAmountRemaining> amountRemaining) {
        Utils.checkNotNull(amountRemaining, "amountRemaining");
        this.amountRemaining = amountRemaining;
        return this;
    }
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public GetPaymentLinkPaymentsPayments withAmountCaptured(GetPaymentLinkPaymentsAmountCaptured amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
     ...
     * The total amount that is already captured for this payment. Only available when this payment supports captures.
     */
    public GetPaymentLinkPaymentsPayments withAmountCaptured(Optional<? extends GetPaymentLinkPaymentsAmountCaptured> amountCaptured) {
        Utils.checkNotNull(amountCaptured, "amountCaptured");
        this.amountCaptured = amountCaptured;
        return this;
    }
     ...
     * zero.
     */
    public GetPaymentLinkPaymentsPayments withAmountChargedBack(GetPaymentLinkPaymentsAmountChargedBack amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
     ...
     * zero.
     */
    public GetPaymentLinkPaymentsPayments withAmountChargedBack(Optional<? extends GetPaymentLinkPaymentsAmountChargedBack> amountChargedBack) {
        Utils.checkNotNull(amountChargedBack, "amountChargedBack");
        this.amountChargedBack = amountChargedBack;
        return this;
    }
     ...
     * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public GetPaymentLinkPaymentsPayments withSettlementAmount(GetPaymentLinkPaymentsSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
     */
    public GetPaymentLinkPaymentsPayments withSettlementAmount(Optional<? extends GetPaymentLinkPaymentsSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public GetPaymentLinkPaymentsPayments withRedirectUrl(String redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public GetPaymentLinkPaymentsPayments withRedirectUrl(JsonNullable<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * payment cancellations.
     */
    public GetPaymentLinkPaymentsPayments withCancelUrl(String cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
     ...
     * payment cancellations.
     */
    public GetPaymentLinkPaymentsPayments withCancelUrl(JsonNullable<String> cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
        this.cancelUrl = cancelUrl;
        return this;
    }
     ...
     * local machine.
     */
    public GetPaymentLinkPaymentsPayments withWebhookUrl(String webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
     ...
     * local machine.
     */
    public GetPaymentLinkPaymentsPayments withWebhookUrl(JsonNullable<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetPaymentLinkPaymentsPayments withLines(List<GetPaymentLinkPaymentsLines> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public GetPaymentLinkPaymentsPayments withLines(JsonNullable<? extends List<GetPaymentLinkPaymentsLines>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetPaymentLinkPaymentsPayments withBillingAddress(GetPaymentLinkPaymentsBillingAddress billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
     ...
     * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
     */
    public GetPaymentLinkPaymentsPayments withBillingAddress(Optional<? extends GetPaymentLinkPaymentsBillingAddress> billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
        this.billingAddress = billingAddress;
        return this;
    }
     ...
     * `country`.
     */
    public GetPaymentLinkPaymentsPayments withShippingAddress(GetPaymentLinkPaymentsShippingAddress shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
     ...
     * `country`.
     */
    public GetPaymentLinkPaymentsPayments withShippingAddress(Optional<? extends GetPaymentLinkPaymentsShippingAddress> shippingAddress) {
        Utils.checkNotNull(shippingAddress, "shippingAddress");
        this.shippingAddress = shippingAddress;
        return this;
    }
     ...
     * customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public GetPaymentLinkPaymentsPayments withLocale(GetPaymentLinkPaymentsLocale locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * customer use a local bank account greatly increases the conversion and speed of payment.
     */
    public GetPaymentLinkPaymentsPayments withLocale(JsonNullable<? extends GetPaymentLinkPaymentsLocale> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * field is omitted if the country code was not detected.
     */
    public GetPaymentLinkPaymentsPayments withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
     ...
     * field is omitted if the country code was not detected.
     */
    public GetPaymentLinkPaymentsPayments withCountryCode(JsonNullable<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * this field reflects that choice.
     */
    public GetPaymentLinkPaymentsPayments withMethod(GetPaymentLinkPaymentsMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * this field reflects that choice.
     */
    public GetPaymentLinkPaymentsPayments withMethod(JsonNullable<? extends GetPaymentLinkPaymentsMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public GetPaymentLinkPaymentsPayments withRestrictPaymentMethodsToCountry(String restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public GetPaymentLinkPaymentsPayments withRestrictPaymentMethodsToCountry(JsonNullable<String> restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
        this.restrictPaymentMethodsToCountry = restrictPaymentMethodsToCountry;
        return this;
    }
     ...
     * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetPaymentLinkPaymentsPayments withMetadata(GetPaymentLinkPaymentsMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public GetPaymentLinkPaymentsPayments withMetadata(JsonNullable<? extends GetPaymentLinkPaymentsMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public GetPaymentLinkPaymentsPayments withCaptureMode(GetPaymentLinkPaymentsCaptureMode captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public GetPaymentLinkPaymentsPayments withCaptureMode(JsonNullable<? extends GetPaymentLinkPaymentsCaptureMode> captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
        this.captureMode = captureMode;
        return this;
    }
     ...
     * can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public GetPaymentLinkPaymentsPayments withCaptureBefore(String captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
     ...
     * can no longer guarantee a successful capture. The parameter is omitted if the payment is not authorized (yet).
     */
    public GetPaymentLinkPaymentsPayments withCaptureBefore(JsonNullable<String> captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
        this.captureBefore = captureBefore;
        return this;
    }
     ...
     * `routing` parameter.
     */
    public GetPaymentLinkPaymentsPayments withApplicationFee(GetPaymentLinkPaymentsApplicationFee applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
     ...
     * `routing` parameter.
     */
    public GetPaymentLinkPaymentsPayments withApplicationFee(JsonNullable<? extends GetPaymentLinkPaymentsApplicationFee> applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
        this.applicationFee = applicationFee;
        return this;
    }
     ...
     * parameter.
     */
    public GetPaymentLinkPaymentsPayments withRouting(List<GetPaymentLinkPaymentsRouting> routing) {
        Utils.checkNotNull(routing, "routing");
     ...
     * parameter.
     */
    public GetPaymentLinkPaymentsPayments withRouting(JsonNullable<? extends List<GetPaymentLinkPaymentsRouting>> routing) {
        Utils.checkNotNull(routing, "routing");
        this.routing = routing;
        return this;
    }
     ...
     * are set up correctly for recurring payments.
     */
    public GetPaymentLinkPaymentsPayments withSequenceType(GetPaymentLinkPaymentsSequenceType sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
     ...
     * are set up correctly for recurring payments.
     */
    public GetPaymentLinkPaymentsPayments withSequenceType(Optional<? extends GetPaymentLinkPaymentsSequenceType> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * be added to the response.
     */
    public GetPaymentLinkPaymentsPayments withSubscriptionId(String subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
     ...
     * be added to the response.
     */
    public GetPaymentLinkPaymentsPayments withSubscriptionId(JsonNullable<String> subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
        this.subscriptionId = subscriptionId;
        return this;
    }
     ...
     * the customer's accounts should be credited.
     */
    public GetPaymentLinkPaymentsPayments withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
     ...
     * the customer's accounts should be credited.
     */
    public GetPaymentLinkPaymentsPayments withMandateId(JsonNullable<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public GetPaymentLinkPaymentsPayments withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * <p>If `sequenceType` is set to `recurring`, this field is required.
     */
    public GetPaymentLinkPaymentsPayments withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * <p>For more information, see [Authentication](authentication).
     */
    public GetPaymentLinkPaymentsPayments withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public GetPaymentLinkPaymentsPayments withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public GetPaymentLinkPaymentsPayments withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public GetPaymentLinkPaymentsPayments withOrderId(String orderId) {
        Utils.checkNotNull(orderId, "orderId");
     ...
     * If the payment was created for an [order](get-order), the ID of that order will be part of the response.
     */
    public GetPaymentLinkPaymentsPayments withOrderId(JsonNullable<String> orderId) {
        Utils.checkNotNull(orderId, "orderId");
        this.orderId = orderId;
        return this;
    }
     ...
     * statuses occur at what point.
     */
    public GetPaymentLinkPaymentsPayments withStatus(GetPaymentLinkPaymentsStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * [this page](status-reasons).**
     */
    public GetPaymentLinkPaymentsPayments withStatusReason(GetPaymentLinkPaymentsStatusReason statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
     ...
     * [this page](status-reasons).**
     */
    public GetPaymentLinkPaymentsPayments withStatusReason(JsonNullable<? extends GetPaymentLinkPaymentsStatusReason> statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
        this.statusReason = statusReason;
        return this;
    }
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public GetPaymentLinkPaymentsPayments withIsCancelable(boolean isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public GetPaymentLinkPaymentsPayments withIsCancelable(JsonNullable<Boolean> isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
        this.isCancelable = isCancelable;
        return this;
    }
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public GetPaymentLinkPaymentsPayments withDetails(GetPaymentLinkPaymentsDetails details) {
        Utils.checkNotNull(details, "details");
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public GetPaymentLinkPaymentsPayments withDetails(JsonNullable<? extends GetPaymentLinkPaymentsDetails> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetPaymentLinkPaymentsPayments withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * not authorized (yet).
     */
    public GetPaymentLinkPaymentsPayments withAuthorizedAt(String authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
     ...
     * not authorized (yet).
     */
    public GetPaymentLinkPaymentsPayments withAuthorizedAt(JsonNullable<String> authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
        this.authorizedAt = authorizedAt;
        return this;
    }
     ...
     * completed (yet).
     */
    public GetPaymentLinkPaymentsPayments withPaidAt(String paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
     ...
     * completed (yet).
     */
    public GetPaymentLinkPaymentsPayments withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * canceled (yet).
     */
    public GetPaymentLinkPaymentsPayments withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * canceled (yet).
     */
    public GetPaymentLinkPaymentsPayments withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * longer expire.
     */
    public GetPaymentLinkPaymentsPayments withExpiresAt(String expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * longer expire.
     */
    public GetPaymentLinkPaymentsPayments withExpiresAt(JsonNullable<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * expire (yet).
     */
    public GetPaymentLinkPaymentsPayments withExpiredAt(String expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
     ...
     * expire (yet).
     */
    public GetPaymentLinkPaymentsPayments withExpiredAt(JsonNullable<String> expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
        this.expiredAt = expiredAt;
        return this;
    }
     ...
     * (yet).
     */
    public GetPaymentLinkPaymentsPayments withFailedAt(String failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
     ...
     * (yet).
     */
    public GetPaymentLinkPaymentsPayments withFailedAt(JsonNullable<String> failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
        this.failedAt = failedAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetPaymentLinkPaymentsPayments withLinks(GetPaymentLinkPaymentsPaymentLinksLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkPaymentsPayments other = (GetPaymentLinkPaymentsPayments) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkPaymentsPayments.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends GetPaymentLinkPaymentsLocale> locale = JsonNullable.undefined();

        private JsonNullable<String> countryCode = JsonNullable.undefined();

        private JsonNullable<? extends GetPaymentLinkPaymentsMethod> method = JsonNullable.undefined();
        ...
        private Optional<? extends GetPaymentLinkPaymentsSequenceType> sequenceType = Optional.empty();
        ...
        private JsonNullable<? extends GetPaymentLinkPaymentsDetails> details = JsonNullable.undefined();
         ...
         * Whether this entity was created in live mode or in test mode.
         */
        public Builder mode(GetPaymentLinkPaymentsMode mode) {
            Utils.checkNotNull(mode, "mode");
            this.mode = mode;
            return this;
        }
         ...
         * tip amount.
         */
        public Builder amount(GetPaymentLinkPaymentsAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
         ...
         * costs for a return shipment to the customer.
         */
        public Builder amountRefunded(GetPaymentLinkPaymentsAmountRefunded amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = Optional.ofNullable(amountRefunded);
            return this;
        }
         ...
         * costs for a return shipment to the customer.
         */
        public Builder amountRefunded(Optional<? extends GetPaymentLinkPaymentsAmountRefunded> amountRefunded) {
            Utils.checkNotNull(amountRefunded, "amountRefunded");
            this.amountRefunded = amountRefunded;
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(GetPaymentLinkPaymentsAmountRemaining amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = Optional.ofNullable(amountRemaining);
            return this;
        }
         ...
         * The remaining amount that can be refunded. Only available when refunds are available for this payment.
         */
        public Builder amountRemaining(Optional<? extends GetPaymentLinkPaymentsAmountRemaining> amountRemaining) {
            Utils.checkNotNull(amountRemaining, "amountRemaining");
            this.amountRemaining = amountRemaining;
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(GetPaymentLinkPaymentsAmountCaptured amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = Optional.ofNullable(amountCaptured);
            return this;
        }
         ...
         * The total amount that is already captured for this payment. Only available when this payment supports captures.
         */
        public Builder amountCaptured(Optional<? extends GetPaymentLinkPaymentsAmountCaptured> amountCaptured) {
            Utils.checkNotNull(amountCaptured, "amountCaptured");
            this.amountCaptured = amountCaptured;
            return this;
        }
         ...
         * zero.
         */
        public Builder amountChargedBack(GetPaymentLinkPaymentsAmountChargedBack amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = Optional.ofNullable(amountChargedBack);
            return this;
        }
         ...
         * zero.
         */
        public Builder amountChargedBack(Optional<? extends GetPaymentLinkPaymentsAmountChargedBack> amountChargedBack) {
            Utils.checkNotNull(amountChargedBack, "amountChargedBack");
            this.amountChargedBack = amountChargedBack;
            return this;
        }
         ...
         * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(GetPaymentLinkPaymentsSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = Optional.ofNullable(settlementAmount);
            return this;
        }
         ...
         * using the List balance transactions endpoint instead to get more accurate settlement amounts for your payments.
         */
        public Builder settlementAmount(Optional<? extends GetPaymentLinkPaymentsSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(List<GetPaymentLinkPaymentsLines> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = JsonNullable.of(lines);
            return this;
        }
         ...
         * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
         */
        public Builder lines(JsonNullable<? extends List<GetPaymentLinkPaymentsLines>> lines) {
            Utils.checkNotNull(lines, "lines");
            this.lines = lines;
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(GetPaymentLinkPaymentsBillingAddress billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = Optional.ofNullable(billingAddress);
            return this;
        }
         ...
         * <p>Required for payment method `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(Optional<? extends GetPaymentLinkPaymentsBillingAddress> billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = billingAddress;
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(GetPaymentLinkPaymentsShippingAddress shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = Optional.ofNullable(shippingAddress);
            return this;
        }
         ...
         * `country`.
         */
        public Builder shippingAddress(Optional<? extends GetPaymentLinkPaymentsShippingAddress> shippingAddress) {
            Utils.checkNotNull(shippingAddress, "shippingAddress");
            this.shippingAddress = shippingAddress;
            return this;
        }
         ...
         * customer use a local bank account greatly increases the conversion and speed of payment.
         */
        public Builder locale(GetPaymentLinkPaymentsLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = JsonNullable.of(locale);
            return this;
        }
         ...
         * customer use a local bank account greatly increases the conversion and speed of payment.
         */
        public Builder locale(JsonNullable<? extends GetPaymentLinkPaymentsLocale> locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }
         ...
         * this field reflects that choice.
         */
        public Builder method(GetPaymentLinkPaymentsMethod method) {
            Utils.checkNotNull(method, "method");
            this.method = JsonNullable.of(method);
            return this;
        }
         ...
         * this field reflects that choice.
         */
        public Builder method(JsonNullable<? extends GetPaymentLinkPaymentsMethod> method) {
            Utils.checkNotNull(method, "method");
            this.method = method;
            return this;
        }
         ...
         * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(GetPaymentLinkPaymentsMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = JsonNullable.of(metadata);
            return this;
        }
         ...
         * you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
         */
        public Builder metadata(JsonNullable<? extends GetPaymentLinkPaymentsMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * <p>This field needs to be set to `manual` for method `riverty`.
         */
        public Builder captureMode(GetPaymentLinkPaymentsCaptureMode captureMode) {
            Utils.checkNotNull(captureMode, "captureMode");
            this.captureMode = JsonNullable.of(captureMode);
            return this;
        }
         ...
         * <p>This field needs to be set to `manual` for method `riverty`.
         */
        public Builder captureMode(JsonNullable<? extends GetPaymentLinkPaymentsCaptureMode> captureMode) {
            Utils.checkNotNull(captureMode, "captureMode");
            this.captureMode = captureMode;
            return this;
        }
         ...
         * `routing` parameter.
         */
        public Builder applicationFee(GetPaymentLinkPaymentsApplicationFee applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = JsonNullable.of(applicationFee);
            return this;
        }
         ...
         * `routing` parameter.
         */
        public Builder applicationFee(JsonNullable<? extends GetPaymentLinkPaymentsApplicationFee> applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = applicationFee;
            return this;
        }
         ...
         * parameter.
         */
        public Builder routing(List<GetPaymentLinkPaymentsRouting> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = JsonNullable.of(routing);
            return this;
        }
         ...
         * parameter.
         */
        public Builder routing(JsonNullable<? extends List<GetPaymentLinkPaymentsRouting>> routing) {
            Utils.checkNotNull(routing, "routing");
            this.routing = routing;
            return this;
        }
         ...
         * are set up correctly for recurring payments.
         */
        public Builder sequenceType(GetPaymentLinkPaymentsSequenceType sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = Optional.ofNullable(sequenceType);
            return this;
        }
         ...
         * are set up correctly for recurring payments.
         */
        public Builder sequenceType(Optional<? extends GetPaymentLinkPaymentsSequenceType> sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = sequenceType;
            return this;
        }
         ...
         * statuses occur at what point.
         */
        public Builder status(GetPaymentLinkPaymentsStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * [this page](status-reasons).**
         */
        public Builder statusReason(GetPaymentLinkPaymentsStatusReason statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = JsonNullable.of(statusReason);
            return this;
        }
         ...
         * [this page](status-reasons).**
         */
        public Builder statusReason(JsonNullable<? extends GetPaymentLinkPaymentsStatusReason> statusReason) {
            Utils.checkNotNull(statusReason, "statusReason");
            this.statusReason = statusReason;
            return this;
        }
         ...
         * [method-specific parameters](extra-payment-parameters) guide.
         */
        public Builder details(GetPaymentLinkPaymentsDetails details) {
            Utils.checkNotNull(details, "details");
            this.details = JsonNullable.of(details);
            return this;
        }
         ...
         * [method-specific parameters](extra-payment-parameters) guide.
         */
        public Builder details(JsonNullable<? extends GetPaymentLinkPaymentsDetails> details) {
            Utils.checkNotNull(details, "details");
            this.details = details;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetPaymentLinkPaymentsPaymentLinksLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
