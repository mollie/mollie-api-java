...
public class GetSettlementPaymentsLines {
    ...
    private GetSettlementPaymentsUnitPrice unitPrice;
    ...
    private Optional<? extends GetSettlementPaymentsVatAmount> vatAmount;
    ...
    private Optional<? extends List<GetSettlementPaymentsCategories>> categories;
     ...
     */
    @JsonIgnore
    public GetSettlementPaymentsUnitPrice unitPrice() {
        return unitPrice;
    }
     ...
     */
    @JsonIgnore
    public GetSettlementPaymentsTotalAmount totalAmount() {
        return totalAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetSettlementPaymentsVatAmount> vatAmount() {
        return (Optional<GetSettlementPaymentsVatAmount>) vatAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<GetSettlementPaymentsCategories>> categories() {
        return (Optional<List<GetSettlementPaymentsCategories>>) categories;
    }
     ...
     * <p>Possible values: `physical` `digital` `shipping_fee` `discount` `store_credit` `gift_card` `surcharge` `tip` (default: `physical`)
     */
    public GetSettlementPaymentsLines withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>Possible values: `physical` `digital` `shipping_fee` `discount` `store_credit` `gift_card` `surcharge` `tip` (default: `physical`)
     */
    public GetSettlementPaymentsLines withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public GetSettlementPaymentsLines withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public GetSettlementPaymentsLines withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public GetSettlementPaymentsLines withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public GetSettlementPaymentsLines withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * <p>The unit price can be zero in case of free items.
     */
    public GetSettlementPaymentsLines withUnitPrice(GetSettlementPaymentsUnitPrice unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type.
     */
    public GetSettlementPaymentsLines withDiscountAmount(GetSettlementPaymentsDiscountAmount discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
     ...
     * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
     */
    public GetSettlementPaymentsLines withTotalAmount(GetSettlementPaymentsTotalAmount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * The VAT rate applied to the line, for example `21.00` for 21%. The vatRate should be passed as a string and not as a float, to ensure the correct number of decimals are passed.
     */
    public GetSettlementPaymentsLines withVatRate(String vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
     ...
     * The VAT rate applied to the line, for example `21.00` for 21%. The vatRate should be passed as a string and not as a float, to ensure the correct number of decimals are passed.
     */
    public GetSettlementPaymentsLines withVatRate(Optional<String> vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
        this.vatRate = vatRate;
        return this;
    }
     ...
     * <p>For example, for a `totalAmount` of SEK 100.00 with a 25.00% VAT rate, we expect a VAT amount of `SEK 100.00 × (25 / 125) = SEK 20.00`.
     */
    public GetSettlementPaymentsLines withVatAmount(GetSettlementPaymentsVatAmount vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
     ...
     * <p>For example, for a `totalAmount` of SEK 100.00 with a 25.00% VAT rate, we expect a VAT amount of `SEK 100.00 × (25 / 125) = SEK 20.00`.
     */
    public GetSettlementPaymentsLines withVatAmount(Optional<? extends GetSettlementPaymentsVatAmount> vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
        this.vatAmount = vatAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public GetSettlementPaymentsLines withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public GetSettlementPaymentsLines withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information.
     */
    public GetSettlementPaymentsLines withCategories(List<GetSettlementPaymentsCategories> categories) {
        Utils.checkNotNull(categories, "categories");
     ...
     * An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information.
     */
    public GetSettlementPaymentsLines withCategories(Optional<? extends List<GetSettlementPaymentsCategories>> categories) {
        Utils.checkNotNull(categories, "categories");
        this.categories = categories;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public GetSettlementPaymentsLines withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public GetSettlementPaymentsLines withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public GetSettlementPaymentsLines withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public GetSettlementPaymentsLines withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementPaymentsLines other = (GetSettlementPaymentsLines) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementPaymentsLines.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetSettlementPaymentsVatAmount> vatAmount = Optional.empty();
 
        private Optional<String> sku = Optional.empty();
 
        private Optional<? extends List<GetSettlementPaymentsCategories>> categories = Optional.empty();
         ...
         * <p>The unit price can be zero in case of free items.
         */
        public Builder unitPrice(GetSettlementPaymentsUnitPrice unitPrice) {
            Utils.checkNotNull(unitPrice, "unitPrice");
            this.unitPrice = unitPrice;
            return this;
        }
         ...
         * Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type.
         */
        public Builder discountAmount(GetSettlementPaymentsDiscountAmount discountAmount) {
            Utils.checkNotNull(discountAmount, "discountAmount");
            this.discountAmount = Optional.ofNullable(discountAmount);
            return this;
        }
         ...
         * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
         */
        public Builder totalAmount(GetSettlementPaymentsTotalAmount totalAmount) {
            Utils.checkNotNull(totalAmount, "totalAmount");
            this.totalAmount = totalAmount;
            return this;
        }
         ...
         * <p>For example, for a `totalAmount` of SEK 100.00 with a 25.00% VAT rate, we expect a VAT amount of `SEK 100.00 × (25 / 125) = SEK 20.00`.
         */
        public Builder vatAmount(GetSettlementPaymentsVatAmount vatAmount) {
            Utils.checkNotNull(vatAmount, "vatAmount");
            this.vatAmount = Optional.ofNullable(vatAmount);
            return this;
        }
         ...
         * <p>For example, for a `totalAmount` of SEK 100.00 with a 25.00% VAT rate, we expect a VAT amount of `SEK 100.00 × (25 / 125) = SEK 20.00`.
         */
        public Builder vatAmount(Optional<? extends GetSettlementPaymentsVatAmount> vatAmount) {
            Utils.checkNotNull(vatAmount, "vatAmount");
            this.vatAmount = vatAmount;
            return this;
        }
         ...
         * An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information.
         */
        public Builder categories(List<GetSettlementPaymentsCategories> categories) {
            Utils.checkNotNull(categories, "categories");
            this.categories = Optional.ofNullable(categories);
            return this;
        }
         ...
         * An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information.
         */
        public Builder categories(Optional<? extends List<GetSettlementPaymentsCategories>> categories) {
            Utils.checkNotNull(categories, "categories");
            this.categories = categories;
            return this;
        }
