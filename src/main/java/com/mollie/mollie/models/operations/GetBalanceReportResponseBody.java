...
public class GetBalanceReportResponseBody {
    ...
    /**
     * The start date of the report, in `YYYY-MM-DD` format. The from date is 'inclusive', and in Central European Time. This means a report with for example `from=2024-01-01` will include movements of 2024-01-01 0:00:00 CET and onwards.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("from")
     ...
     * The ID of the balance this report is generated for.
     */
    public GetBalanceReportResponseBody withBalanceId(String balanceId) {
        Utils.checkNotNull(balanceId, "balanceId");
     ...
     * The ID of the balance this report is generated for.
     */
    public GetBalanceReportResponseBody withBalanceId(Optional<String> balanceId) {
        Utils.checkNotNull(balanceId, "balanceId");
        this.balanceId = balanceId;
        return this;
    }
     ...
     * The time zone used for the from and until parameters. Currently only time zone `Europe/Amsterdam` is supported.
     */
    public GetBalanceReportResponseBody withTimeZone(String timeZone) {
        Utils.checkNotNull(timeZone, "timeZone");
     ...
     * The time zone used for the from and until parameters. Currently only time zone `Europe/Amsterdam` is supported.
     */
    public GetBalanceReportResponseBody withTimeZone(Optional<String> timeZone) {
        Utils.checkNotNull(timeZone, "timeZone");
        this.timeZone = timeZone;
        return this;
    }
     ...
     * * A `subtotals` array containing more sub-group objects if applicable
     */
    public GetBalanceReportResponseBody withTotals(Totals totals) {
        Utils.checkNotNull(totals, "totals");
     ...
     * * A `subtotals` array containing more sub-group objects if applicable
     */
    public GetBalanceReportResponseBody withTotals(Optional<? extends Totals> totals) {
        Utils.checkNotNull(totals, "totals");
        this.totals = totals;
        return this;
    }
