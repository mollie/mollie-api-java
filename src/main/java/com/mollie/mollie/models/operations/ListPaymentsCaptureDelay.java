...
public enum ListPaymentsCaptureDelay {
    ...
    ListPaymentsCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListPaymentsCaptureDelay> fromValue(String value) {
        for (ListPaymentsCaptureDelay o: ListPaymentsCaptureDelay.values()) {
