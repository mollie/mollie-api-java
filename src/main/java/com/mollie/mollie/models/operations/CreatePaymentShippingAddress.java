...
public class CreatePaymentShippingAddress {
    ...
    @JsonCreator
    public CreatePaymentShippingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentShippingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentShippingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentShippingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentShippingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentShippingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentShippingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public CreatePaymentShippingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public CreatePaymentShippingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentShippingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentShippingAddress other = (CreatePaymentShippingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentShippingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public CreatePaymentShippingAddress build() {

            return new CreatePaymentShippingAddress(
                title, givenName, familyName,
                organizationName, streetAndNumber, streetAdditional,
                postalCode, email, phone,
                city, region, country);
