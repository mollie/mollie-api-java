...
public class ListWebhooksRequestBuilder {
     ...
     * <pre><code>
     * Publisher&lt;ListWebhooksResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListWebhooksResponse&gt;() {
     ...
     */
    public Publisher<ListWebhooksResponse> callAsPublisher() {
        ListWebhooksRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListWebhooksResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
