...
public class UpdatePaymentChangePaymentState {
    ...
    @JsonCreator
    public UpdatePaymentChangePaymentState(
     ...
     * The actual URL string.
     */
    public UpdatePaymentChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public UpdatePaymentChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentChangePaymentState other = (UpdatePaymentChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public UpdatePaymentChangePaymentState build() {
            return new UpdatePaymentChangePaymentState(
                href,
                type);
        }
    }
