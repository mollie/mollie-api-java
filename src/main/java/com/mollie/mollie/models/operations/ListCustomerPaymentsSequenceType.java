...
public enum ListCustomerPaymentsSequenceType {
    ...
    ListCustomerPaymentsSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListCustomerPaymentsSequenceType> fromValue(String value) {
        for (ListCustomerPaymentsSequenceType o: ListCustomerPaymentsSequenceType.values()) {
