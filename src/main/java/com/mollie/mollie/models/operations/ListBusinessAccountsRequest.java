...
public class ListBusinessAccountsRequest {
     ...
     * the result set.
     */
    public ListBusinessAccountsRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * the result set.
     */
    public ListBusinessAccountsRequest withFrom(Optional<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListBusinessAccountsRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public ListBusinessAccountsRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * newest to oldest.
     */
    public ListBusinessAccountsRequest withSort(Sorting sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * newest to oldest.
     */
    public ListBusinessAccountsRequest withSort(Optional<? extends Sorting> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListBusinessAccountsRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public ListBusinessAccountsRequest withTestmode(Optional<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListBusinessAccountsRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public ListBusinessAccountsRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
