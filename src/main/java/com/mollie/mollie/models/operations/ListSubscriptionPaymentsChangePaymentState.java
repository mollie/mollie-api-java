...
public class ListSubscriptionPaymentsChangePaymentState {
    ...
    @JsonCreator
    public ListSubscriptionPaymentsChangePaymentState(
     ...
     * The actual URL string.
     */
    public ListSubscriptionPaymentsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListSubscriptionPaymentsChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListSubscriptionPaymentsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListSubscriptionPaymentsChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSubscriptionPaymentsChangePaymentState other = (ListSubscriptionPaymentsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSubscriptionPaymentsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListSubscriptionPaymentsChangePaymentState build() {
            return new ListSubscriptionPaymentsChangePaymentState(
                href,
                type);
        }
    }
