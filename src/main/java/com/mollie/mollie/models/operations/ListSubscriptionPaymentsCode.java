...
public enum ListSubscriptionPaymentsCode {
    ...
    ListSubscriptionPaymentsCode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionPaymentsCode> fromValue(String value) {
        for (ListSubscriptionPaymentsCode o: ListSubscriptionPaymentsCode.values()) {
