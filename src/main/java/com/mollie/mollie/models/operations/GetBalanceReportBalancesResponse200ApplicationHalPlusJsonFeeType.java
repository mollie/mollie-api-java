 ...
 */
public enum GetBalanceReportBalancesResponse200ApplicationHalPlusJsonFeeType {
    ...
    GetBalanceReportBalancesResponse200ApplicationHalPlusJsonFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonFeeType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200ApplicationHalPlusJsonFeeType o: GetBalanceReportBalancesResponse200ApplicationHalPlusJsonFeeType.values()) {
