...
public class CancelPaymentChangePaymentState {
    ...
    @JsonCreator
    public CancelPaymentChangePaymentState(
     ...
     * The actual URL string.
     */
    public CancelPaymentChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public CancelPaymentChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public CancelPaymentChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentChangePaymentState other = (CancelPaymentChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentChangePaymentState.class,
                "href", href,
                "type", type);
    }
