...
public class Clients {
    ...
    private Optional<? extends ListClientsClientsAPIEmbedded> embedded;
    ...
    public Clients(
            ...
            @JsonProperty("_embedded") Optional<? extends ListClientsClientsAPIEmbedded> embedded) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListClientsClientsAPIEmbedded> embedded() {
        return (Optional<ListClientsClientsAPIEmbedded>) embedded;
    }
     ...
     * The identifier uniquely referring to this client. Example: `org_12345678`.
     */
    public Clients withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public Clients withLinks(ListClientsClientsAPILinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public Clients withLinks(Optional<? extends ListClientsClientsAPILinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }

    public Clients withEmbedded(ListClientsClientsAPIEmbedded embedded) {
        Utils.checkNotNull(embedded, "embedded");
        this.embedded = Optional.ofNullable(embedded);
        return this;
    }

    public Clients withEmbedded(Optional<? extends ListClientsClientsAPIEmbedded> embedded) {
        Utils.checkNotNull(embedded, "embedded");
        this.embedded = embedded;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ListClientsClientsAPIEmbedded> embedded = Optional.empty();  
        ...
        public Builder embedded(ListClientsClientsAPIEmbedded embedded) {
            Utils.checkNotNull(embedded, "embedded");
            this.embedded = Optional.ofNullable(embedded);
            return this;
        }

        public Builder embedded(Optional<? extends ListClientsClientsAPIEmbedded> embedded) {
            Utils.checkNotNull(embedded, "embedded");
            this.embedded = embedded;
            return this;
        }
