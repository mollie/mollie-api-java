...
public class ListPaymentsTotalAmount {
    ...
    @JsonCreator
    public ListPaymentsTotalAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListPaymentsTotalAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListPaymentsTotalAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ListPaymentsTotalAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentsTotalAmount build() {

            return new ListPaymentsTotalAmount(
                currency, value);
        }
