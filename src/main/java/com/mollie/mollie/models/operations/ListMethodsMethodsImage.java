...
public class ListMethodsMethodsImage {
    ...
    @JsonCreator
    public ListMethodsMethodsImage(
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListMethodsMethodsImage withSize1x(String size1x) {
        Utils.checkNotNull(size1x, "size1x");
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListMethodsMethodsImage withSize1x(Optional<String> size1x) {
        Utils.checkNotNull(size1x, "size1x");
        this.size1x = size1x;
        return this;
    }
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListMethodsMethodsImage withSize2x(String size2x) {
        Utils.checkNotNull(size2x, "size2x");
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListMethodsMethodsImage withSize2x(Optional<String> size2x) {
        Utils.checkNotNull(size2x, "size2x");
        this.size2x = size2x;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ListMethodsMethodsImage.class,
                "size1x", size1x,
                "size2x", size2x,
                "svg", svg);
    }
    ...
    public final static class Builder {
        ...
        public ListMethodsMethodsImage build() {

            return new ListMethodsMethodsImage(
                size1x, size2x, svg);
        }
