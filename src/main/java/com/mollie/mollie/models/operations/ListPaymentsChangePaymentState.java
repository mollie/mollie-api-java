...
public class ListPaymentsChangePaymentState {
    ...
    @JsonCreator
    public ListPaymentsChangePaymentState(
     ...
     * The actual URL string.
     */
    public ListPaymentsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListPaymentsChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListPaymentsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListPaymentsChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentsChangePaymentState other = (ListPaymentsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentsChangePaymentState build() {
            return new ListPaymentsChangePaymentState(
                href,
                type);
        }
    }
