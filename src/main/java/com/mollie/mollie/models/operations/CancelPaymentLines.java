...
public class CancelPaymentLines {
    /**
    ...
    private Optional<? extends CancelPaymentDiscountAmount> discountAmount;
    ...
    private Optional<? extends CancelPaymentVatAmount> vatAmount;
    ...
    private Optional<? extends List<CancelPaymentCategories>> categories;
    ...
    private Optional<? extends CancelPaymentRecurring> recurring;
    ...
    public CancelPaymentLines(
            ...
            @JsonProperty("unitPrice") CancelPaymentUnitPrice unitPrice,
            @JsonProperty("discountAmount") Optional<? extends CancelPaymentDiscountAmount> discountAmount,
            @JsonProperty("totalAmount") CancelPaymentTotalAmount totalAmount,
            @JsonProperty("vatRate") Optional<String> vatRate,
            @JsonProperty("vatAmount") Optional<? extends CancelPaymentVatAmount> vatAmount,
            @JsonProperty("sku") Optional<String> sku,
            @JsonProperty("categories") Optional<? extends List<CancelPaymentCategories>> categories,
            @JsonProperty("imageUrl") Optional<String> imageUrl,
            @JsonProperty("productUrl") Optional<String> productUrl,
            @JsonProperty("recurring") Optional<? extends CancelPaymentRecurring> recurring) {
    ...
    public CancelPaymentLines(
            String description,
            long quantity,
            CancelPaymentUnitPrice unitPrice,
            CancelPaymentTotalAmount totalAmount) {
     ...
     */
    @JsonIgnore
    public CancelPaymentUnitPrice unitPrice() {
        return unitPrice;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentDiscountAmount> discountAmount() {
        return (Optional<CancelPaymentDiscountAmount>) discountAmount;
    }
     ...
     */
    @JsonIgnore
    public CancelPaymentTotalAmount totalAmount() {
        return totalAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentVatAmount> vatAmount() {
        return (Optional<CancelPaymentVatAmount>) vatAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<CancelPaymentCategories>> categories() {
        return (Optional<List<CancelPaymentCategories>>) categories;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CancelPaymentRecurring> recurring() {
        return (Optional<CancelPaymentRecurring>) recurring;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public CancelPaymentLines withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public CancelPaymentLines withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public CancelPaymentLines withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public CancelPaymentLines withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * <p>The unit price can be zero in case of free items.
     */
    public CancelPaymentLines withUnitPrice(CancelPaymentUnitPrice unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
     */
    public CancelPaymentLines withTotalAmount(CancelPaymentTotalAmount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public CancelPaymentLines withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public CancelPaymentLines withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public CancelPaymentLines withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public CancelPaymentLines withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public CancelPaymentLines withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public CancelPaymentLines withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelPaymentLines other = (CancelPaymentLines) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelPaymentLines.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CancelPaymentType> type = Optional.empty();
        ...
        private Optional<? extends CancelPaymentDiscountAmount> discountAmount = Optional.empty();

        private CancelPaymentTotalAmount totalAmount;

        private Optional<String> vatRate = Optional.empty();

        private Optional<? extends CancelPaymentVatAmount> vatAmount = Optional.empty();

        private Optional<String> sku = Optional.empty();

        private Optional<? extends List<CancelPaymentCategories>> categories = Optional.empty();

        private Optional<String> imageUrl = Optional.empty();

        private Optional<String> productUrl = Optional.empty();

        private Optional<? extends CancelPaymentRecurring> recurring = Optional.empty();
         ...
         * <p>The unit price can be zero in case of free items.
         */
        public Builder unitPrice(CancelPaymentUnitPrice unitPrice) {
            Utils.checkNotNull(unitPrice, "unitPrice");
            this.unitPrice = unitPrice;
            return this;
        }
         ...
         * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
         */
        public Builder totalAmount(CancelPaymentTotalAmount totalAmount) {
            Utils.checkNotNull(totalAmount, "totalAmount");
            this.totalAmount = totalAmount;
            return this;
        }
