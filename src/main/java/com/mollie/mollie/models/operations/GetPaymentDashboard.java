...
public class GetPaymentDashboard {
     ...
     * The actual URL string.
     */
    public GetPaymentDashboard withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetPaymentDashboard withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentDashboard withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentDashboard withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentDashboard other = (GetPaymentDashboard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentDashboard.class,
                "href", href,
                "type", type);
    }
