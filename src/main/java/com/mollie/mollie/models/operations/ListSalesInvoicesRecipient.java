...
public class ListSalesInvoicesRecipient {
     ...
     */
    @JsonProperty("type")
    private ListSalesInvoicesType type;
     ...
     */
    @JsonProperty("locale")
    private ListSalesInvoicesLocale locale;

    @JsonCreator
    public ListSalesInvoicesRecipient(
            @JsonProperty("type") ListSalesInvoicesType type,
            ...
            @JsonProperty("locale") ListSalesInvoicesLocale locale) {
    ...
    public ListSalesInvoicesRecipient(
            ListSalesInvoicesType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            ListSalesInvoicesLocale locale) {
     ...
     */
    @JsonIgnore
    public ListSalesInvoicesType type() {
        return type;
    }
     ...
     */
    @JsonIgnore
    public ListSalesInvoicesLocale locale() {
        return locale;
    }
     ...
     * required on the `recipient` object.
     */
    public ListSalesInvoicesRecipient withType(ListSalesInvoicesType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public ListSalesInvoicesRecipient withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public ListSalesInvoicesRecipient withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * only numbers.
     */
    public ListSalesInvoicesRecipient withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * only numbers.
     */
    public ListSalesInvoicesRecipient withGivenName(JsonNullable<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * only numbers.
     */
    public ListSalesInvoicesRecipient withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * only numbers.
     */
    public ListSalesInvoicesRecipient withFamilyName(JsonNullable<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The trading name of the `business` type recipient.
     */
    public ListSalesInvoicesRecipient withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The trading name of the `business` type recipient.
     */
    public ListSalesInvoicesRecipient withOrganizationName(JsonNullable<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * has to be provided.
     */
    public ListSalesInvoicesRecipient withOrganizationNumber(String organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
     ...
     * has to be provided.
     */
    public ListSalesInvoicesRecipient withOrganizationNumber(JsonNullable<String> organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
        this.organizationNumber = organizationNumber;
        return this;
    }
     ...
     * has to be provided.
     */
    public ListSalesInvoicesRecipient withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * has to be provided.
     */
    public ListSalesInvoicesRecipient withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * The email address of the recipient.
     */
    public ListSalesInvoicesRecipient withEmail(String email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * The phone number of the recipient.
     */
    public ListSalesInvoicesRecipient withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * The phone number of the recipient.
     */
    public ListSalesInvoicesRecipient withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * A street and street number.
     */
    public ListSalesInvoicesRecipient withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public ListSalesInvoicesRecipient withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public ListSalesInvoicesRecipient withStreetAdditional(JsonNullable<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * A postal code.
     */
    public ListSalesInvoicesRecipient withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The recipient's city.
     */
    public ListSalesInvoicesRecipient withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The recipient's region.
     */
    public ListSalesInvoicesRecipient withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The recipient's region.
     */
    public ListSalesInvoicesRecipient withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public ListSalesInvoicesRecipient withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * The locale for the recipient, to be used for translations in PDF generation and payment pages.
     */
    public ListSalesInvoicesRecipient withLocale(ListSalesInvoicesLocale locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSalesInvoicesRecipient other = (ListSalesInvoicesRecipient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSalesInvoicesRecipient.class,
                "type", type,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(ListSalesInvoicesType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The locale for the recipient, to be used for translations in PDF generation and payment pages.
         */
        public Builder locale(ListSalesInvoicesLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }

        public ListSalesInvoicesRecipient build() {

            return new ListSalesInvoicesRecipient(
                type, title, givenName,
                familyName, organizationName, organizationNumber,
                vatNumber, email, phone,
                streetAndNumber, streetAdditional, postalCode,
