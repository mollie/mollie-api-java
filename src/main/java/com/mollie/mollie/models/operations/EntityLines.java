...
public class EntityLines {
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public EntityLines withType(EntityType type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public EntityLines withType(Optional<? extends EntityType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends EntityType>> _SINGLETON_VALUE_Type =
                new LazySingletonValue<>(
                        "type",
                        "\"physical\"",
                        new TypeReference<Optional<? extends EntityType>>() {});
    }
}
