 ...
 */
public enum CreateCustomerPaymentMethod {
    ALMA("alma"),
    APPLEPAY("applepay"),
    BACS("bacs"),
    ...
    CreateCustomerPaymentMethod(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentMethod> fromValue(String value) {
        for (CreateCustomerPaymentMethod o: CreateCustomerPaymentMethod.values()) {
