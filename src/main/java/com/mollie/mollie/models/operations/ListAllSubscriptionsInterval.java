...
public enum ListAllSubscriptionsInterval {
    ...
    ListAllSubscriptionsInterval(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAllSubscriptionsInterval> fromValue(String value) {
        for (ListAllSubscriptionsInterval o: ListAllSubscriptionsInterval.values()) {
