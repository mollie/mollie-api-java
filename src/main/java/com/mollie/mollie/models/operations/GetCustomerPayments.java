...
public class GetCustomerPayments {
     ...
     * The actual URL string.
     */
    public GetCustomerPayments withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetCustomerPayments withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerPayments withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerPayments withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomerPayments other = (GetCustomerPayments) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomerPayments.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetCustomerPayments build() {
            return new GetCustomerPayments(
                href,
                type);
        }
    }
