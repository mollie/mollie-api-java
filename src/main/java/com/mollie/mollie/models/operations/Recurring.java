...
public class Recurring {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
    private Optional<? extends CreatePaymentAmount> amount;
    ...
    public Recurring(
            ...
            @JsonProperty("amount") Optional<? extends CreatePaymentAmount> amount,
    ...
    @JsonIgnore
    public Optional<CreatePaymentAmount> amount() {
        return (Optional<CreatePaymentAmount>) amount;
    }
     ...
     * Total amount and currency of the recurring item.
     */
    public Recurring withAmount(CreatePaymentAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * Total amount and currency of the recurring item.
     */
    public Recurring withAmount(Optional<? extends CreatePaymentAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreatePaymentAmount> amount = Optional.empty();
         ...
         * Total amount and currency of the recurring item.
         */
        public Builder amount(Optional<? extends CreatePaymentAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
