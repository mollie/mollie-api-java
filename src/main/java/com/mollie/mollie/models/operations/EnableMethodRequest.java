...
public class EnableMethodRequest {
     ...
     * Provide the ID of the related payment method.
     */
    public EnableMethodRequest withMethodId(Method methodId) {
        Utils.checkNotNull(methodId, "methodId");
     ...
     * Provide the ID of the related payment method.
     */
    public EnableMethodRequest withMethodId(Optional<? extends Method> methodId) {
        Utils.checkNotNull(methodId, "methodId");
        this.methodId = methodId;
        return this;
    }
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public EnableMethodRequest withIdempotencyKey(String idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
     ...
     * A unique key to ensure idempotent requests. This key should be a UUID v4 string.
     */
    public EnableMethodRequest withIdempotencyKey(Optional<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
