...
public class ApplicationFee {
     ...
     * Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public ApplicationFee withAmount(CreatePaymentPaymentsRequestAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public ApplicationFee withAmount(Optional<? extends CreatePaymentPaymentsRequestAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
