...
public class PaymentLinks {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
    private JsonNullable<? extends ListPaymentLinksAmount> amount;
    ...
    private JsonNullable<? extends List<ListPaymentLinksAllowedMethods>> allowedMethods;

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("sequenceType")
    private Optional<? extends ListPaymentLinksSequenceType> sequenceType;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListPaymentLinksPaymentLinksLinks> links;
    ...
    public PaymentLinks(
            ...
            @JsonProperty("amount") JsonNullable<? extends ListPaymentLinksAmount> amount,
            ...
            @JsonProperty("allowedMethods") JsonNullable<? extends List<ListPaymentLinksAllowedMethods>> allowedMethods,
            @JsonProperty("sequenceType") Optional<? extends ListPaymentLinksSequenceType> sequenceType,
            ...
            @JsonProperty("_links") Optional<? extends ListPaymentLinksPaymentLinksLinks> links) {
    ...
    @JsonIgnore
    public JsonNullable<ListPaymentLinksAmount> amount() {
        return (JsonNullable<ListPaymentLinksAmount>) amount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<ListPaymentLinksAllowedMethods>> allowedMethods() {
        return (JsonNullable<List<ListPaymentLinksAllowedMethods>>) allowedMethods;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListPaymentLinksSequenceType> sequenceType() {
        return (Optional<ListPaymentLinksSequenceType>) sequenceType;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListPaymentLinksPaymentLinksLinks> links() {
        return (Optional<ListPaymentLinksPaymentLinksLinks>) links;
    }
     ...
     * The identifier uniquely referring to this payment link. Example: `pl_4Y0eZitmBnQ6IDoMqZQKh`.
     */
    public PaymentLinks withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * <p>Possible values: `live` `test`
     */
    public PaymentLinks withMode(String mode) {
        Utils.checkNotNull(mode, "mode");
     ...
     * <p>Possible values: `live` `test`
     */
    public PaymentLinks withMode(Optional<String> mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * A short description of the payment link. The description is visible in the Dashboard and will be shown on the customer's bank or card statement when possible.
     */
    public PaymentLinks withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The amount of the payment link. If no amount is provided initially, the customer will be prompted to enter an amount.
     */
    public PaymentLinks withAmount(JsonNullable<? extends ListPaymentLinksAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * Whether the payment link is archived. Customers will not be able to complete payments on archived payment links.
     */
    public PaymentLinks withArchived(Optional<Boolean> archived) {
        Utils.checkNotNull(archived, "archived");
        this.archived = archived;
        return this;
    }
     ...
     * The URL your customer will be redirected to after completing the payment process. If no redirect URL is provided, the customer will be shown a generic message after completing the payment.
     */
    public PaymentLinks withRedirectUrl(JsonNullable<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * <p>The webhookUrl must be reachable from Mollie's point of view, so you cannot use `localhost`. If you want to use webhook during development on `localhost`, you must use a tool like ngrok to have the webhooks delivered to your local machine.
     */
    public PaymentLinks withWebhookUrl(JsonNullable<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Most API credentials are linked to a single profile. In these cases the `profileId` can be omitted in the creation request. For organization-level credentials such as OAuth access tokens however, the `profileId` parameter is required.
     */
    public PaymentLinks withProfileId(JsonNullable<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public PaymentLinks withCreatedAt(Optional<String> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date and time the payment link became paid, in ISO 8601 format.
     */
    public PaymentLinks withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * The date and time the payment link is set to expire, in ISO 8601 format. If no expiry date was provided up front, the payment link will not expire automatically.
     */
    public PaymentLinks withExpiresAt(JsonNullable<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * An array of payment methods that are allowed to be used for this payment link. When this parameter is not provided or is an empty array, all enabled payment methods will be available.
     */
    public PaymentLinks withAllowedMethods(List<ListPaymentLinksAllowedMethods> allowedMethods) {
        Utils.checkNotNull(allowedMethods, "allowedMethods");
     ...
     * An array of payment methods that are allowed to be used for this payment link. When this parameter is not provided or is an empty array, all enabled payment methods will be available.
     */
    public PaymentLinks withAllowedMethods(JsonNullable<? extends List<ListPaymentLinksAllowedMethods>> allowedMethods) {
        Utils.checkNotNull(allowedMethods, "allowedMethods");
        this.allowedMethods = allowedMethods;
        return this;
    }
    ...
    public PaymentLinks withSequenceType(Optional<? extends ListPaymentLinksSequenceType> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
    ...
    public PaymentLinks withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public PaymentLinks withLinks(Optional<? extends ListPaymentLinksPaymentLinksLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListPaymentLinksAmount> amount = JsonNullable.undefined();
        ...
        private JsonNullable<? extends List<ListPaymentLinksAllowedMethods>> allowedMethods = JsonNullable.undefined();
        ...
        private Optional<? extends ListPaymentLinksPaymentLinksLinks> links = Optional.empty();
         ...
         * The amount of the payment link. If no amount is provided initially, the customer will be prompted to enter an amount.
         */
        public Builder amount(JsonNullable<? extends ListPaymentLinksAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
         ...
         * An array of payment methods that are allowed to be used for this payment link. When this parameter is not provided or is an empty array, all enabled payment methods will be available.
         */
        public Builder allowedMethods(List<ListPaymentLinksAllowedMethods> allowedMethods) {
            Utils.checkNotNull(allowedMethods, "allowedMethods");
            this.allowedMethods = JsonNullable.of(allowedMethods);
            return this;
        }
         ...
         * An array of payment methods that are allowed to be used for this payment link. When this parameter is not provided or is an empty array, all enabled payment methods will be available.
         */
        public Builder allowedMethods(JsonNullable<? extends List<ListPaymentLinksAllowedMethods>> allowedMethods) {
            Utils.checkNotNull(allowedMethods, "allowedMethods");
            this.allowedMethods = allowedMethods;
            return this;
        }
        ...
        public Builder sequenceType(Optional<? extends ListPaymentLinksSequenceType> sequenceType) {
            Utils.checkNotNull(sequenceType, "sequenceType");
            this.sequenceType = sequenceType;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends ListPaymentLinksPaymentLinksLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        private static final LazySingletonValue<Optional<? extends ListPaymentLinksSequenceType>> _SINGLETON_VALUE_SequenceType =
                new LazySingletonValue<>(
                        "sequenceType",
                        "\"oneoff\"",
                        new TypeReference<Optional<? extends ListPaymentLinksSequenceType>>() {});
    }
}
