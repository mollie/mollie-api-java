...
public class ListConnectBalanceTransfersRequestBuilder {
    ...
    * <pre><code>
    * for (ListConnectBalanceTransfersResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListConnectBalanceTransfersResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListConnectBalanceTransfersResponse> callAsStream() {
