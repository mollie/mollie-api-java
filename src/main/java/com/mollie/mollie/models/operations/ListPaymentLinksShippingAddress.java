...
public class ListPaymentLinksShippingAddress {
    ...
    @JsonCreator
    public ListPaymentLinksShippingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public ListPaymentLinksShippingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public ListPaymentLinksShippingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public ListPaymentLinksShippingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public ListPaymentLinksShippingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public ListPaymentLinksShippingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public ListPaymentLinksShippingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public ListPaymentLinksShippingAddress withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public ListPaymentLinksShippingAddress withPhone(Optional<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public ListPaymentLinksShippingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public ListPaymentLinksShippingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public ListPaymentLinksShippingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentLinksShippingAddress other = (ListPaymentLinksShippingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentLinksShippingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public ListPaymentLinksShippingAddress build() {

            return new ListPaymentLinksShippingAddress(
                title, givenName, familyName,
                organizationName, streetAndNumber, streetAdditional,
                postalCode, email, phone,
                city, region, country);
