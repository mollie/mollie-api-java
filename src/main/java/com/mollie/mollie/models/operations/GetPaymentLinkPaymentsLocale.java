...
public enum GetPaymentLinkPaymentsLocale {
    ...
    GetPaymentLinkPaymentsLocale(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentLinkPaymentsLocale> fromValue(String value) {
        for (GetPaymentLinkPaymentsLocale o: GetPaymentLinkPaymentsLocale.values()) {
