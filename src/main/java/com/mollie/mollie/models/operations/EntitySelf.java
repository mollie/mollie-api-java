...
public class EntitySelf {
     ...
     * The actual URL string.
     */
    public EntitySelf withHref(String href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public EntitySelf withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(EntitySelf.class,
                "href", href,
                "type", type);
    }
