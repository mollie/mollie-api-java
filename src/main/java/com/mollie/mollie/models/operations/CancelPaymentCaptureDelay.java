...
public enum CancelPaymentCaptureDelay {
    ...
    CancelPaymentCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<CancelPaymentCaptureDelay> fromValue(String value) {
        for (CancelPaymentCaptureDelay o: CancelPaymentCaptureDelay.values()) {
