...
public class GetNextSettlementCosts {
     ...
     */
    @JsonProperty("rate")
    private GetNextSettlementRate rate;
    ...
    public GetNextSettlementCosts(
            ...
            @JsonProperty("rate") GetNextSettlementRate rate,
     ...
     */
    @JsonIgnore
    public GetNextSettlementRate rate() {
        return rate;
    }
     ...
     * correction or transaction type that is not tied to a specific payment method.
     */
    public GetNextSettlementCosts withMethod(SettlementMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * correction or transaction type that is not tied to a specific payment method.
     */
    public GetNextSettlementCosts withMethod(Optional<? extends SettlementMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public GetNextSettlementCosts withAmountNet(Amount amountNet) {
        Utils.checkNotNull(amountNet, "amountNet");
        this.amountNet = amountNet;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public GetNextSettlementCosts withAmountVat(AmountNullable amountVat) {
        Utils.checkNotNull(amountVat, "amountVat");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public GetNextSettlementCosts withAmountVat(Optional<? extends AmountNullable> amountVat) {
        Utils.checkNotNull(amountVat, "amountVat");
        this.amountVat = amountVat;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public GetNextSettlementCosts withAmountGross(Amount amountGross) {
        Utils.checkNotNull(amountGross, "amountGross");
        this.amountGross = amountGross;
        return this;
    }
