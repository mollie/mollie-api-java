...
public class ListSettlementPaymentsChangePaymentState {
    ...
    @JsonCreator
    public ListSettlementPaymentsChangePaymentState(
     ...
     * The actual URL string.
     */
    public ListSettlementPaymentsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListSettlementPaymentsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementPaymentsChangePaymentState other = (ListSettlementPaymentsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementPaymentsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListSettlementPaymentsChangePaymentState build() {

            return new ListSettlementPaymentsChangePaymentState(
                href, type);
        }
