...
public class ListInvoicesRequestBuilder {
    ...
    public CompletableFuture<ListInvoicesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListInvoicesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListInvoicesResponse&gt;() {
     ...
     */
    public Publisher<ListInvoicesResponse> callAsPublisher() {
        ListInvoicesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListInvoicesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
