...
public class ListSettlementPaymentsQrCode {
    ...
    @JsonCreator
    public ListSettlementPaymentsQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public ListSettlementPaymentsQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public ListSettlementPaymentsQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public ListSettlementPaymentsQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public ListSettlementPaymentsQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public ListSettlementPaymentsQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public ListSettlementPaymentsQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementPaymentsQrCode other = (ListSettlementPaymentsQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementPaymentsQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public ListSettlementPaymentsQrCode build() {

            return new ListSettlementPaymentsQrCode(
                height, width, src);
        }
