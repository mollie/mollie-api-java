...
/**
 * Next - The next set of items, if available.
 */
...
public class Next {
     ...
     * The actual URL string.
     */
    public Next withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Next withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Next.class,
                "href", href,
                "type", type);
    }
