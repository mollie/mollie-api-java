...
public class ListCustomersRequestBuilder {
     ...
     * <pre><code>
     * Publisher&lt;ListCustomersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListCustomersResponse&gt;() {
     ...
     */
    public Publisher<ListCustomersResponse> callAsPublisher() {
        ListCustomersRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListCustomersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
