...
public class CreateSalesInvoiceRecipient {
     ...
     */
    @JsonProperty("type")
    private CreateSalesInvoiceSalesInvoicesResponseType type;
     ...
     */
    @JsonProperty("locale")
    private CreateSalesInvoiceSalesInvoicesLocale locale;

    @JsonCreator
    public CreateSalesInvoiceRecipient(
            @JsonProperty("type") CreateSalesInvoiceSalesInvoicesResponseType type,
            ...
            @JsonProperty("locale") CreateSalesInvoiceSalesInvoicesLocale locale) {
    ...
    public CreateSalesInvoiceRecipient(
            CreateSalesInvoiceSalesInvoicesResponseType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            CreateSalesInvoiceSalesInvoicesLocale locale) {
     ...
     */
    @JsonIgnore
    public CreateSalesInvoiceSalesInvoicesResponseType type() {
        return type;
    }
     ...
     */
    @JsonIgnore
    public CreateSalesInvoiceSalesInvoicesLocale locale() {
        return locale;
    }
     ...
     * required on the `recipient` object.
     */
    public CreateSalesInvoiceRecipient withType(CreateSalesInvoiceSalesInvoicesResponseType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The locale for the recipient, to be used for translations in PDF generation and payment pages.
     */
    public CreateSalesInvoiceRecipient withLocale(CreateSalesInvoiceSalesInvoicesLocale locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(CreateSalesInvoiceSalesInvoicesResponseType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The locale for the recipient, to be used for translations in PDF generation and payment pages.
         */
        public Builder locale(CreateSalesInvoiceSalesInvoicesLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }
