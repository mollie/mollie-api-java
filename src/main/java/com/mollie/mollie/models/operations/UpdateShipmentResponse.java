...
public class UpdateShipmentResponse implements Response {
    ...
    /**
     * The updated shipment object. For a complete reference of the shipment object, refer to the [Get shipment endpoint](get-shipment) documentation.
     */
     ...
     * HTTP response status code for this operation
     */
    public UpdateShipmentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateShipmentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateShipmentResponse other = (UpdateShipmentResponse) o;
        return 
