...
/**
 * Previous - The previous set of items, if available.
 */
...
public class Previous {
     ...
     * The actual URL string.
     */
    public Previous withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public Previous withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Previous withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Previous withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Previous.class,
                "href", href,
                "type", type);
    }
