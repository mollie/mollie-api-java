 ...
 * 
 * <p>The type of transaction, for example `payment` or `refund`. Values include the below examples, although this list
 * is not definitive.
 * 
...
public enum ListBalanceTransactionsType {
    ...
    ListBalanceTransactionsType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListBalanceTransactionsType> fromValue(String value) {
        for (ListBalanceTransactionsType o: ListBalanceTransactionsType.values()) {
