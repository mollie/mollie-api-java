...
/**
 * Customer - The API resource URL of the [customer](get-customer) that this mandate belongs to.
 */
...
public class Customer {
     ...
     * The actual URL string.
     */
    public Customer withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public Customer withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Customer withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
