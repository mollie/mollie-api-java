...
public class ListInvoicesResponseBody {
    ...
    private ListInvoicesEmbedded embedded;
    ...
    public ListInvoicesResponseBody(
            ...
            @JsonProperty("_embedded") ListInvoicesEmbedded embedded,
    ...
    @JsonIgnore
    public ListInvoicesEmbedded embedded() {
        return embedded;
    }
