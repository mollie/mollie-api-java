...
public enum ListAllSubscriptionsCaptureDelay {
    ...
    ListAllSubscriptionsCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAllSubscriptionsCaptureDelay> fromValue(String value) {
        for (ListAllSubscriptionsCaptureDelay o: ListAllSubscriptionsCaptureDelay.values()) {
