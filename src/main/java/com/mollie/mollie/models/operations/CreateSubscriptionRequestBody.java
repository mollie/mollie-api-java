...
public class CreateSubscriptionRequestBody {
     ...
     * Possible values: `pending` `active` `canceled` `suspended` `completed`
     */
    public CreateSubscriptionRequestBody withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * Possible values: `pending` `active` `canceled` `suspended` `completed`
     */
    public CreateSubscriptionRequestBody withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Possible values: `creditcard` `directdebit` `paypal`
     */
    public CreateSubscriptionRequestBody withMethod(String method) {
        Utils.checkNotNull(method, "method");
     ...
     * Possible values: `creditcard` `directdebit` `paypal`
     */
    public CreateSubscriptionRequestBody withMethod(JsonNullable<String> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
