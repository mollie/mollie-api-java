...
/**
 * ChangePaymentState - For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
 * 
...
public class ChangePaymentState {
     ...
     * The actual URL string.
     */
    public ChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChangePaymentState other = (ChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ChangePaymentState build() {
            return new ChangePaymentState(
                href,
                type);
        }
    }
