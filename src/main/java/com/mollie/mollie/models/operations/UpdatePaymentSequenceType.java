...
public enum UpdatePaymentSequenceType {
    ...
    UpdatePaymentSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdatePaymentSequenceType> fromValue(String value) {
        for (UpdatePaymentSequenceType o: UpdatePaymentSequenceType.values()) {
