...
public class ListCustomerPaymentsQrCode {
    ...
    @JsonCreator
    public ListCustomerPaymentsQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public ListCustomerPaymentsQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public ListCustomerPaymentsQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public ListCustomerPaymentsQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public ListCustomerPaymentsQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public ListCustomerPaymentsQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public ListCustomerPaymentsQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCustomerPaymentsQrCode other = (ListCustomerPaymentsQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCustomerPaymentsQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public ListCustomerPaymentsQrCode build() {

            return new ListCustomerPaymentsQrCode(
                height, width, src);
        }
