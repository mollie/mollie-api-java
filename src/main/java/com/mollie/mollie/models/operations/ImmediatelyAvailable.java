...
public class ImmediatelyAvailable {
    ...
    private JsonNullable<? extends List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals>> subtotals;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals>> subtotals() {
        return (JsonNullable<List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals>>) subtotals;
    }
    ...
    public ImmediatelyAvailable withSubtotals(List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals> subtotals) {
        Utils.checkNotNull(subtotals, "subtotals");
        this.subtotals = JsonNullable.of(subtotals);
        return this;
    }

    public ImmediatelyAvailable withSubtotals(JsonNullable<? extends List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals>> subtotals) {
        Utils.checkNotNull(subtotals, "subtotals");
        this.subtotals = subtotals;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ImmediatelyAvailable other = (ImmediatelyAvailable) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ImmediatelyAvailable.class,
                "amount", amount,
                "subtotals", subtotals);
    }
    ...
    public final static class Builder {
        ...
        public Builder subtotals(List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals> subtotals) {
            Utils.checkNotNull(subtotals, "subtotals");
            this.subtotals = JsonNullable.of(subtotals);
            return this;
        }

        public Builder subtotals(JsonNullable<? extends List<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodySubtotals>> subtotals) {
            Utils.checkNotNull(subtotals, "subtotals");
            this.subtotals = subtotals;
            return this;
        }
        
        public ImmediatelyAvailable build() {
            return new ImmediatelyAvailable(
                amount,
                subtotals);
        }
    }
