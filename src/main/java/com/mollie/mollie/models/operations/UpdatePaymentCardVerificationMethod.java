...
public enum UpdatePaymentCardVerificationMethod {
    ...
    UpdatePaymentCardVerificationMethod(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdatePaymentCardVerificationMethod> fromValue(String value) {
        for (UpdatePaymentCardVerificationMethod o: UpdatePaymentCardVerificationMethod.values()) {
