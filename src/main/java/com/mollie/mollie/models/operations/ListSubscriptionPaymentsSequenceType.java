...
public enum ListSubscriptionPaymentsSequenceType {
    ...
    ListSubscriptionPaymentsSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionPaymentsSequenceType> fromValue(String value) {
        for (ListSubscriptionPaymentsSequenceType o: ListSubscriptionPaymentsSequenceType.values()) {
