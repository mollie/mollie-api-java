...
public class ListSettlementChargebacksRequestBuilder {
     ...
     * <pre><code>
     * Publisher&lt;ListSettlementChargebacksResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSettlementChargebacksResponse&gt;() {
     ...
     */
    public Publisher<ListSettlementChargebacksResponse> callAsPublisher() {
        ListSettlementChargebacksRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListSettlementChargebacksResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
