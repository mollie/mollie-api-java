...
public class ListClientsOnboarding {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListClientsClientsAPIResponseLinks> links;
    ...
    public ListClientsOnboarding(
            ...
            @JsonProperty("_links") Optional<? extends ListClientsClientsAPIResponseLinks> links) {
    ...
    @JsonIgnore
    public Optional<ListClientsClientsAPIResponseLinks> links() {
        return (Optional<ListClientsClientsAPIResponseLinks>) links;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListClientsOnboarding withLinks(ListClientsClientsAPIResponseLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListClientsOnboarding withLinks(Optional<? extends ListClientsClientsAPIResponseLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ListClientsClientsAPIResponseLinks> links = Optional.empty();  
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListClientsClientsAPIResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends ListClientsClientsAPIResponseLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
