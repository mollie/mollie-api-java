...
public enum CancelPaymentSequenceType {
    ...
    CancelPaymentSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<CancelPaymentSequenceType> fromValue(String value) {
        for (CancelPaymentSequenceType o: CancelPaymentSequenceType.values()) {
