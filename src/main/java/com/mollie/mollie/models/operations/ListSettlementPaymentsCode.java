...
public enum ListSettlementPaymentsCode {
    ...
    ListSettlementPaymentsCode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSettlementPaymentsCode> fromValue(String value) {
        for (ListSettlementPaymentsCode o: ListSettlementPaymentsCode.values()) {
