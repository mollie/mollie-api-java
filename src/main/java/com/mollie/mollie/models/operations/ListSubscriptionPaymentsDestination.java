...
public class ListSubscriptionPaymentsDestination {
     ...
     * <p>Possible values: `organization`
     */
    public ListSubscriptionPaymentsDestination withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * Required for destination type `organization`. The ID of the connected organization the funds should be routed to.
     */
    public ListSubscriptionPaymentsDestination withOrganizationId(Optional<String> organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = organizationId;
        return this;
    }
