...
public class CreatePaymentRecurring {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
    private Optional<? extends CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount> amount;
    ...
    @JsonIgnore
    public Optional<CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount> amount() {
        return (Optional<CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount>) amount;
    }
     ...
     * A description of the recurring item. If not present, the main description of the item will be used.
     */
    public CreatePaymentRecurring withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of the recurring item. If not present, the main description of the item will be used.
     */
    public CreatePaymentRecurring withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Total amount and currency of the recurring item.
     */
    public CreatePaymentRecurring withAmount(CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * Total amount and currency of the recurring item.
     */
    public CreatePaymentRecurring withAmount(Optional<? extends CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * Total number of charges for the subscription to complete. Leave empty for ongoing subscription.
     */
    public CreatePaymentRecurring withTimes(long times) {
        Utils.checkNotNull(times, "times");
     ...
     * Total number of charges for the subscription to complete. Leave empty for ongoing subscription.
     */
    public CreatePaymentRecurring withTimes(Optional<Long> times) {
        Utils.checkNotNull(times, "times");
        this.times = times;
        return this;
    }
     ...
     * The start date of the subscription if it does not start right away (format `YYYY-MM-DD`)
     */
    public CreatePaymentRecurring withStartDate(String startDate) {
        Utils.checkNotNull(startDate, "startDate");
     ...
     * The start date of the subscription if it does not start right away (format `YYYY-MM-DD`)
     */
    public CreatePaymentRecurring withStartDate(JsonNullable<String> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentRecurring other = (CreatePaymentRecurring) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentRecurring.class,
    ...
    public final static class Builder {
         ...
         * Total amount and currency of the recurring item.
         */
        public Builder amount(CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * Total amount and currency of the recurring item.
         */
        public Builder amount(Optional<? extends CreatePaymentPaymentsResponse201ApplicationHalPlusJsonResponseBodyAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
