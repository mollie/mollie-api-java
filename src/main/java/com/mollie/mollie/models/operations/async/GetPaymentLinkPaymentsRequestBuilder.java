...
public class GetPaymentLinkPaymentsRequestBuilder {
    ...
    public CompletableFuture<GetPaymentLinkPaymentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetPaymentLinkPaymentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetPaymentLinkPaymentsResponse&gt;() {
     ...
     */
    public Publisher<GetPaymentLinkPaymentsResponse> callAsPublisher() {
        GetPaymentLinkPaymentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<GetPaymentLinkPaymentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
