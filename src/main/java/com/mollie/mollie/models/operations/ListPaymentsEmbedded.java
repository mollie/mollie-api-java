...
public class ListPaymentsEmbedded {
     ...
     * An array of payment objects.
     */
    public ListPaymentsEmbedded withPayments(List<ListPaymentResponse> payments) {
        Utils.checkNotNull(payments, "payments");
     ...
     * An array of payment objects.
     */
    public ListPaymentsEmbedded withPayments(Optional<? extends List<ListPaymentResponse>> payments) {
        Utils.checkNotNull(payments, "payments");
        this.payments = payments;
        return this;
    }
