 ...
 */
public enum GetBalanceReportBalancesTransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportBalancesTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesTransactionType> fromValue(String value) {
        for (GetBalanceReportBalancesTransactionType o: GetBalanceReportBalancesTransactionType.values()) {
