...
public class DeleteCustomerResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteCustomerResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * An empty response.
     */
    public DeleteCustomerResponse withAny(Object any) {
        Utils.checkNotNull(any, "any");
     ...
     * An empty response.
     */
    public DeleteCustomerResponse withAny(Optional<? extends Object> any) {
        Utils.checkNotNull(any, "any");
        this.any = any;
        return this;
    }
