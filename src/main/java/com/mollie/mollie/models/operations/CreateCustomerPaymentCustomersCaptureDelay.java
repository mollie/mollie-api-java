 ...
 */
public enum CreateCustomerPaymentCustomersCaptureDelay {
    ...
    CreateCustomerPaymentCustomersCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentCustomersCaptureDelay> fromValue(String value) {
        for (CreateCustomerPaymentCustomersCaptureDelay o: CreateCustomerPaymentCustomersCaptureDelay.values()) {
