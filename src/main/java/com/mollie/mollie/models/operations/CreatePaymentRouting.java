...
public class CreatePaymentRouting {
     ...
     */
    @JsonProperty("mode")
    private CreatePaymentPaymentsMode mode;

    /**
     * The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
     */
    @JsonProperty("amount")
    private CreatePaymentPaymentsResponse201ApplicationHalPlusJsonAmount amount;

    /**
     * The destination of this portion of the payment.
     */
    @JsonProperty("destination")
    private CreatePaymentDestination destination;
    ...
    public CreatePaymentRouting(
            ...
            @JsonProperty("mode") CreatePaymentPaymentsMode mode,
    ...
    public CreatePaymentRouting(
            String resource,
            String id,
            CreatePaymentPaymentsMode mode,
     ...
     */
    @JsonIgnore
    public CreatePaymentPaymentsMode mode() {
        return mode;
    }
     ...
     */
    @JsonIgnore
    public CreatePaymentPaymentsResponse201ApplicationHalPlusJsonAmount amount() {
        return amount;
    }
     ...
     */
    @JsonIgnore
    public CreatePaymentDestination destination() {
        return destination;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public CreatePaymentRouting withMode(CreatePaymentPaymentsMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * The date and time when the route was created. The date is given in ISO 8601 format.
     */
    public CreatePaymentRouting withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Whether this entity was created in live mode or in test mode.
         */
        public Builder mode(CreatePaymentPaymentsMode mode) {
            Utils.checkNotNull(mode, "mode");
            this.mode = mode;
            return this;
        }
