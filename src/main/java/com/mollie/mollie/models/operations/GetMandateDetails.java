...
public class GetMandateDetails {
    ...
    private JsonNullable<? extends GetMandateCardLabel> cardLabel;
    ...
    public GetMandateDetails(
            ...
            @JsonProperty("cardLabel") JsonNullable<? extends GetMandateCardLabel> cardLabel,
    ...
    @JsonIgnore
    public JsonNullable<GetMandateCardLabel> cardLabel() {
        return (JsonNullable<GetMandateCardLabel>) cardLabel;
    }
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public GetMandateDetails withConsumerName(String consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public GetMandateDetails withConsumerName(JsonNullable<String> consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
        this.consumerName = consumerName;
        return this;
    }
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public GetMandateDetails withConsumerAccount(String consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public GetMandateDetails withConsumerAccount(JsonNullable<String> consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
        this.consumerAccount = consumerAccount;
        return this;
    }
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public GetMandateDetails withConsumerBic(String consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public GetMandateDetails withConsumerBic(JsonNullable<String> consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
        this.consumerBic = consumerBic;
        return this;
    }
     ...
     * The card holder's name. Available for card mandates.
     */
    public GetMandateDetails withCardHolder(String cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
     ...
     * The card holder's name. Available for card mandates.
     */
    public GetMandateDetails withCardHolder(JsonNullable<String> cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
        this.cardHolder = cardHolder;
        return this;
    }
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public GetMandateDetails withCardNumber(String cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public GetMandateDetails withCardNumber(JsonNullable<String> cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
        this.cardNumber = cardNumber;
        return this;
    }
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public GetMandateDetails withCardExpiryDate(String cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public GetMandateDetails withCardExpiryDate(JsonNullable<String> cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
        this.cardExpiryDate = cardExpiryDate;
        return this;
    }
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public GetMandateDetails withCardLabel(GetMandateCardLabel cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public GetMandateDetails withCardLabel(JsonNullable<? extends GetMandateCardLabel> cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
        this.cardLabel = cardLabel;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMandateDetails other = (GetMandateDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMandateDetails.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends GetMandateCardLabel> cardLabel = JsonNullable.undefined();
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(GetMandateCardLabel cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = JsonNullable.of(cardLabel);
            return this;
        }
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(JsonNullable<? extends GetMandateCardLabel> cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = cardLabel;
            return this;
        }
        ...
        public GetMandateDetails build() {

            return new GetMandateDetails(
                consumerName, consumerAccount, consumerBic,
                cardHolder, cardNumber, cardExpiryDate,
                cardLabel, cardFingerprint);
        }
