...
public class GetPaymentSettlement {
     ...
     * The actual URL string.
     */
    public GetPaymentSettlement withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetPaymentSettlement withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentSettlement withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetPaymentSettlement withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentSettlement other = (GetPaymentSettlement) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentSettlement.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentSettlement build() {
            return new GetPaymentSettlement(
                href,
                type);
        }
    }
