...
public class GetRefundRoutingReversals {
    ...
    @JsonProperty("amount")
    private Optional<? extends GetRefundRefundsAPIAmount> amount;
    ...
    public GetRefundRoutingReversals(
            @JsonProperty("amount") Optional<? extends GetRefundRefundsAPIAmount> amount,
    ...
    @JsonIgnore
    public Optional<GetRefundRefundsAPIAmount> amount() {
        return (Optional<GetRefundRefundsAPIAmount>) amount;
    }
     ...
     * The amount that will be pulled back.
     */
    public GetRefundRoutingReversals withAmount(GetRefundRefundsAPIAmount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The amount that will be pulled back.
     */
    public GetRefundRoutingReversals withAmount(Optional<? extends GetRefundRefundsAPIAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetRefundRefundsAPIAmount> amount = Optional.empty();
         ...
         * The amount that will be pulled back.
         */
        public Builder amount(GetRefundRefundsAPIAmount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * The amount that will be pulled back.
         */
        public Builder amount(Optional<? extends GetRefundRefundsAPIAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
