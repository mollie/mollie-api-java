...
public class ListBalanceTransactionsRequestBuilder {
    ...
    public ListBalanceTransactionsResponse call() {
    ...
    * <pre><code>
    * for (ListBalanceTransactionsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListBalanceTransactionsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListBalanceTransactionsResponse> callAsStream() {
