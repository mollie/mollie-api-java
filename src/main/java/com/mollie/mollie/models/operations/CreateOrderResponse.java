...
public class CreateOrderResponse implements Response {
    ...
    /**
     * The newly created order object. For a complete reference of the order object, refer to the [Get order endpoint](get-order) documentation.
     */
     ...
     * The newly created order object. For a complete reference of the order object, refer to the [Get order endpoint](get-order) documentation.
     */
    public CreateOrderResponse withAny(Object any) {
        Utils.checkNotNull(any, "any");
     ...
     * The newly created order object. For a complete reference of the order object, refer to the [Get order endpoint](get-order) documentation.
     */
    public CreateOrderResponse withAny(Optional<? extends Object> any) {
        Utils.checkNotNull(any, "any");
        this.any = any;
        return this;
    }
