...
public class GetCustomerMandates {
     ...
     * The actual URL string.
     */
    public GetCustomerMandates withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetCustomerMandates withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerMandates withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCustomerMandates withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomerMandates other = (GetCustomerMandates) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomerMandates.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetCustomerMandates build() {

            return new GetCustomerMandates(
                href, type);
        }
