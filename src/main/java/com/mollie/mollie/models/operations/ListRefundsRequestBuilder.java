...
public class ListRefundsRequestBuilder {
    ...
    * <pre><code>
    * for (ListRefundsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListRefundsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListRefundsResponse> callAsStream() {
