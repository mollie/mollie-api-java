...
public class ListPaymentsLinks {
    ...
    private JsonNullable<? extends ListPaymentsPrevious> previous;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("next")
    private JsonNullable<? extends ListPaymentsNext> next;
    ...
    public ListPaymentsLinks(
            ...
            @JsonProperty("previous") JsonNullable<? extends ListPaymentsPrevious> previous,
            @JsonProperty("next") JsonNullable<? extends ListPaymentsNext> next,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<ListPaymentsPrevious> previous() {
        return (JsonNullable<ListPaymentsPrevious>) previous;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<ListPaymentsNext> next() {
        return (JsonNullable<ListPaymentsNext>) next;
    }
     ...
     * The previous set of items, if available.
     */
    public ListPaymentsLinks withPrevious(JsonNullable<? extends ListPaymentsPrevious> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
     ...
     * The next set of items, if available.
     */
    public ListPaymentsLinks withNext(JsonNullable<? extends ListPaymentsNext> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListPaymentsPrevious> previous = JsonNullable.undefined();
 
        private JsonNullable<? extends ListPaymentsNext> next = JsonNullable.undefined();
         ...
         * The previous set of items, if available.
         */
        public Builder previous(JsonNullable<? extends ListPaymentsPrevious> previous) {
            Utils.checkNotNull(previous, "previous");
            this.previous = previous;
            return this;
        }
         ...
         * The next set of items, if available.
         */
        public Builder next(JsonNullable<? extends ListPaymentsNext> next) {
            Utils.checkNotNull(next, "next");
            this.next = next;
            return this;
        }
