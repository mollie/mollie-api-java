...
public enum ListSettlementPaymentsLocale {
    ...
    ListSettlementPaymentsLocale(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSettlementPaymentsLocale> fromValue(String value) {
        for (ListSettlementPaymentsLocale o: ListSettlementPaymentsLocale.values()) {
