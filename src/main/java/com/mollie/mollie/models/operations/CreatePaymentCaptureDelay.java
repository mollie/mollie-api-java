 ...
 */
public enum CreatePaymentCaptureDelay {
    ...
    CreatePaymentCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreatePaymentCaptureDelay> fromValue(String value) {
        for (CreatePaymentCaptureDelay o: CreatePaymentCaptureDelay.values()) {
