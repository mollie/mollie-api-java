 ...
 */
public enum GetBalanceReportBalancesResponse200TransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportBalancesResponse200TransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200TransactionType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200TransactionType o: GetBalanceReportBalancesResponse200TransactionType.values()) {
