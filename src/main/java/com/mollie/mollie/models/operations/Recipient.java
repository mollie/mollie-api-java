...
public class Recipient {
     ...
     */
    @JsonProperty("type")
    private CreateSalesInvoiceType type;
     ...
     */
    @JsonProperty("locale")
    private CreateSalesInvoiceLocale locale;

    @JsonCreator
    public Recipient(
            @JsonProperty("type") CreateSalesInvoiceType type,
            ...
            @JsonProperty("locale") CreateSalesInvoiceLocale locale) {
    ...
    public Recipient(
            CreateSalesInvoiceType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            CreateSalesInvoiceLocale locale) {
     ...
     */
    @JsonIgnore
    public CreateSalesInvoiceType type() {
        return type;
    }
     ...
     */
    @JsonIgnore
    public CreateSalesInvoiceLocale locale() {
        return locale;
    }
     ...
     * required on the `recipient` object.
     */
    public Recipient withType(CreateSalesInvoiceType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public Recipient withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public Recipient withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * only numbers.
     */
    public Recipient withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * only numbers.
     */
    public Recipient withGivenName(JsonNullable<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * only numbers.
     */
    public Recipient withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * only numbers.
     */
    public Recipient withFamilyName(JsonNullable<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The trading name of the `business` type recipient.
     */
    public Recipient withOrganizationName(JsonNullable<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * has to be provided.
     */
    public Recipient withOrganizationNumber(JsonNullable<String> organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
        this.organizationNumber = organizationNumber;
        return this;
    }
     ...
     * has to be provided.
     */
    public Recipient withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * has to be provided.
     */
    public Recipient withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * The phone number of the recipient.
     */
    public Recipient withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * A street and street number.
     */
    public Recipient withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public Recipient withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public Recipient withStreetAdditional(JsonNullable<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * A postal code.
     */
    public Recipient withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The recipient's region.
     */
    public Recipient withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The recipient's region.
     */
    public Recipient withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public Recipient withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * The locale for the recipient, to be used for translations in PDF generation and payment pages.
     */
    public Recipient withLocale(CreateSalesInvoiceLocale locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(CreateSalesInvoiceType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * The locale for the recipient, to be used for translations in PDF generation and payment pages.
         */
        public Builder locale(CreateSalesInvoiceLocale locale) {
            Utils.checkNotNull(locale, "locale");
            this.locale = locale;
            return this;
        }
