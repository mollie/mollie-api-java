...
public class CreateMandateDetails {
    ...
    private JsonNullable<? extends CreateMandateCardLabel> cardLabel;
    ...
    public CreateMandateDetails(
            ...
            @JsonProperty("cardLabel") JsonNullable<? extends CreateMandateCardLabel> cardLabel,
    ...
    @JsonIgnore
    public JsonNullable<CreateMandateCardLabel> cardLabel() {
        return (JsonNullable<CreateMandateCardLabel>) cardLabel;
    }
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public CreateMandateDetails withConsumerName(String consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public CreateMandateDetails withConsumerName(JsonNullable<String> consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
        this.consumerName = consumerName;
        return this;
    }
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public CreateMandateDetails withConsumerAccount(String consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public CreateMandateDetails withConsumerAccount(JsonNullable<String> consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
        this.consumerAccount = consumerAccount;
        return this;
    }
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public CreateMandateDetails withConsumerBic(String consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public CreateMandateDetails withConsumerBic(JsonNullable<String> consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
        this.consumerBic = consumerBic;
        return this;
    }
     ...
     * The card holder's name. Available for card mandates.
     */
    public CreateMandateDetails withCardHolder(String cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
     ...
     * The card holder's name. Available for card mandates.
     */
    public CreateMandateDetails withCardHolder(JsonNullable<String> cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
        this.cardHolder = cardHolder;
        return this;
    }
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public CreateMandateDetails withCardNumber(String cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public CreateMandateDetails withCardNumber(JsonNullable<String> cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
        this.cardNumber = cardNumber;
        return this;
    }
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public CreateMandateDetails withCardExpiryDate(String cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public CreateMandateDetails withCardExpiryDate(JsonNullable<String> cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
        this.cardExpiryDate = cardExpiryDate;
        return this;
    }
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public CreateMandateDetails withCardLabel(CreateMandateCardLabel cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
     ...
     * The card's label. Available for card mandates, if the card label could be detected.
     */
    public CreateMandateDetails withCardLabel(JsonNullable<? extends CreateMandateCardLabel> cardLabel) {
        Utils.checkNotNull(cardLabel, "cardLabel");
        this.cardLabel = cardLabel;
        return this;
    }
     ...
     * returning customers.
     */
    public CreateMandateDetails withCardFingerprint(String cardFingerprint) {
        Utils.checkNotNull(cardFingerprint, "cardFingerprint");
     ...
     * returning customers.
     */
    public CreateMandateDetails withCardFingerprint(JsonNullable<String> cardFingerprint) {
        Utils.checkNotNull(cardFingerprint, "cardFingerprint");
        this.cardFingerprint = cardFingerprint;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateMandateDetails other = (CreateMandateDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateMandateDetails.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends CreateMandateCardLabel> cardLabel = JsonNullable.undefined();
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(CreateMandateCardLabel cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = JsonNullable.of(cardLabel);
            return this;
        }
         ...
         * The card's label. Available for card mandates, if the card label could be detected.
         */
        public Builder cardLabel(JsonNullable<? extends CreateMandateCardLabel> cardLabel) {
            Utils.checkNotNull(cardLabel, "cardLabel");
            this.cardLabel = cardLabel;
            return this;
        }
        ...
        public CreateMandateDetails build() {

            return new CreateMandateDetails(
                consumerName, consumerAccount, consumerBic,
                cardHolder, cardNumber, cardExpiryDate,
                cardLabel, cardFingerprint);
        }
