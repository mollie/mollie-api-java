...
public enum ListSettlementPaymentsCaptureDelay {
    ...
    ListSettlementPaymentsCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSettlementPaymentsCaptureDelay> fromValue(String value) {
        for (ListSettlementPaymentsCaptureDelay o: ListSettlementPaymentsCaptureDelay.values()) {
