...
public class ListCustomerPaymentsChangePaymentState {
    ...
    @JsonCreator
    public ListCustomerPaymentsChangePaymentState(
     ...
     * The actual URL string.
     */
    public ListCustomerPaymentsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListCustomerPaymentsChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCustomerPaymentsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCustomerPaymentsChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCustomerPaymentsChangePaymentState other = (ListCustomerPaymentsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCustomerPaymentsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListCustomerPaymentsChangePaymentState build() {
            return new ListCustomerPaymentsChangePaymentState(
                href,
                type);
        }
    }
