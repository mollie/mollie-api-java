...
public class CreateOrderRefundResponseBody {
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public CreateOrderRefundResponseBody withMetadata(CreateOrderRefundRefundsMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
     */
    public CreateOrderRefundResponseBody withMetadata(JsonNullable<? extends CreateOrderRefundRefundsMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
