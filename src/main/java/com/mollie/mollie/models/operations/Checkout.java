...
/**
 * Checkout - The URL your customer should visit to make the payment. This is where you should redirect the customer to.
 */
...
public class Checkout {
     ...
     * The actual URL string.
     */
    public Checkout withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public Checkout withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Checkout withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Checkout.class,
                "href", href,
                "type", type);
    }
