...
public class GetPaymentLinkPaymentsQrCode {
    ...
    @JsonCreator
    public GetPaymentLinkPaymentsQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public GetPaymentLinkPaymentsQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public GetPaymentLinkPaymentsQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public GetPaymentLinkPaymentsQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public GetPaymentLinkPaymentsQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public GetPaymentLinkPaymentsQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public GetPaymentLinkPaymentsQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkPaymentsQrCode other = (GetPaymentLinkPaymentsQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkPaymentsQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentLinkPaymentsQrCode build() {

            return new GetPaymentLinkPaymentsQrCode(
                height, width, src);
        }
