 ...
 * 
 * <p>Billie is a business-to-business (B2B) payment method. It requires extra information to identify the organization
...
public class CreateCustomerPaymentCompany {
    ...
    @JsonCreator
    public CreateCustomerPaymentCompany(
     ...
     * The organization's registration number.
     */
    public CreateCustomerPaymentCompany withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
     ...
     * The organization's registration number.
     */
    public CreateCustomerPaymentCompany withRegistrationNumber(Optional<String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }
     ...
     * The organization's VAT number.
     */
    public CreateCustomerPaymentCompany withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * The organization's VAT number.
     */
    public CreateCustomerPaymentCompany withVatNumber(Optional<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * The organization's entity type.
     */
    public CreateCustomerPaymentCompany withEntityType(String entityType) {
        Utils.checkNotNull(entityType, "entityType");
     ...
     * The organization's entity type.
     */
    public CreateCustomerPaymentCompany withEntityType(Optional<String> entityType) {
        Utils.checkNotNull(entityType, "entityType");
        this.entityType = entityType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerPaymentCompany other = (CreateCustomerPaymentCompany) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerPaymentCompany.class,
    ...
    public final static class Builder {
        ...
        public CreateCustomerPaymentCompany build() {

            return new CreateCustomerPaymentCompany(
                registrationNumber, vatNumber, entityType);
        }
