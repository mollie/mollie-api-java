...
public class ListSubscriptionPaymentsRequestBuilder {
    ...
    public CompletableFuture<ListSubscriptionPaymentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListSubscriptionPaymentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSubscriptionPaymentsResponse&gt;() {
     ...
     */
    public Publisher<ListSubscriptionPaymentsResponse> callAsPublisher() {
        ListSubscriptionPaymentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListSubscriptionPaymentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
