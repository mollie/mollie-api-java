...
public enum ListPaymentsSequenceType {
    ...
    ListPaymentsSequenceType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListPaymentsSequenceType> fromValue(String value) {
        for (ListPaymentsSequenceType o: ListPaymentsSequenceType.values()) {
