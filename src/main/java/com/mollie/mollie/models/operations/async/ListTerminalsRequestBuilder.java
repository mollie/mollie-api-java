...
public class ListTerminalsRequestBuilder {
    ...
    public CompletableFuture<ListTerminalsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTerminalsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTerminalsResponse&gt;() {
     ...
     */
    public Publisher<ListTerminalsResponse> callAsPublisher() {
        ListTerminalsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListTerminalsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
