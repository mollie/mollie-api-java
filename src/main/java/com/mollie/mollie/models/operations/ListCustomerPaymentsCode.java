...
public enum ListCustomerPaymentsCode {
    ...
    ListCustomerPaymentsCode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListCustomerPaymentsCode> fromValue(String value) {
        for (ListCustomerPaymentsCode o: ListCustomerPaymentsCode.values()) {
