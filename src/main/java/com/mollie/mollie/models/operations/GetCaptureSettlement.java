...
public class GetCaptureSettlement {
     ...
     * The actual URL string.
     */
    public GetCaptureSettlement withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetCaptureSettlement withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCaptureSettlement withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetCaptureSettlement withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCaptureSettlement other = (GetCaptureSettlement) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCaptureSettlement.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetCaptureSettlement build() {
            return new GetCaptureSettlement(
                href,
                type);
        }
    }
