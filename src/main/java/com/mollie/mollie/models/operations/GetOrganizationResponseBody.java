...
public class GetOrganizationResponseBody {
    ...
    private Optional<? extends GetOrganizationAddress> address;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends GetOrganizationLinks> links;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetOrganizationAddress> address() {
        return (Optional<GetOrganizationAddress>) address;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetOrganizationLinks> links() {
     ...
     * The identifier uniquely referring to this organization. Example: `org_12345678`.
     */
    public GetOrganizationResponseBody withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The identifier uniquely referring to this organization. Example: `org_12345678`.
     */
    public GetOrganizationResponseBody withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The name of the organization.
     */
    public GetOrganizationResponseBody withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the organization.
     */
    public GetOrganizationResponseBody withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The email address associated with the organization.
     */
    public GetOrganizationResponseBody withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * The email address associated with the organization.
     */
    public GetOrganizationResponseBody withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * The address of the organization.
     */
    public GetOrganizationResponseBody withAddress(GetOrganizationAddress address) {
        Utils.checkNotNull(address, "address");
     ...
     * The address of the organization.
     */
    public GetOrganizationResponseBody withAddress(Optional<? extends GetOrganizationAddress> address) {
        Utils.checkNotNull(address, "address");
        this.address = address;
        return this;
    }
     ...
     * The registration number of the organization at their local chamber of commerce.
     */
    public GetOrganizationResponseBody withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
     ...
     * The registration number of the organization at their local chamber of commerce.
     */
    public GetOrganizationResponseBody withRegistrationNumber(Optional<String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }
     ...
     * <p>The field is not present for merchants residing in other countries.
     */
    public GetOrganizationResponseBody withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * <p>The field is not present for merchants residing in other countries.
     */
    public GetOrganizationResponseBody withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetOrganizationResponseBody withLinks(GetOrganizationLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetOrganizationResponseBody withLinks(Optional<? extends GetOrganizationLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOrganizationResponseBody other = (GetOrganizationResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOrganizationResponseBody.class,
                "resource", resource,
                "id", id,
                "name", name,
                "email", email,
    ...
    public final static class Builder {
         ...
         * The address of the organization.
         */
        public Builder address(Optional<? extends GetOrganizationAddress> address) {
            Utils.checkNotNull(address, "address");
            this.address = address;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetOrganizationLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends GetOrganizationLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
