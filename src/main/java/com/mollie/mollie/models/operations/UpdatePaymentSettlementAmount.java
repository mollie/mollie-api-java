...
public class UpdatePaymentSettlementAmount {
    ...
    @JsonCreator
    public UpdatePaymentSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public UpdatePaymentSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public UpdatePaymentSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentSettlementAmount other = (UpdatePaymentSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public UpdatePaymentSettlementAmount build() {

            return new UpdatePaymentSettlementAmount(
                currency, value);
        }
