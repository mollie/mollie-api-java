...
public class GetOnboardingStatusResponseBody {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends GetOnboardingStatusLinks> links;
    ...
    public GetOnboardingStatusResponseBody(
            ...
            @JsonProperty("_links") Optional<? extends GetOnboardingStatusLinks> links) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetOnboardingStatusLinks> links() {
     ...
     * The name of the organization.
     */
    public GetOnboardingStatusResponseBody withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the organization.
     */
    public GetOnboardingStatusResponseBody withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Whether the organization can receive payments.
     */
    public GetOnboardingStatusResponseBody withCanReceivePayments(boolean canReceivePayments) {
        Utils.checkNotNull(canReceivePayments, "canReceivePayments");
     ...
     * Whether the organization can receive payments.
     */
    public GetOnboardingStatusResponseBody withCanReceivePayments(Optional<Boolean> canReceivePayments) {
        Utils.checkNotNull(canReceivePayments, "canReceivePayments");
        this.canReceivePayments = canReceivePayments;
        return this;
    }
     ...
     * Whether the organization can receive settlements to their external bank account.
     */
    public GetOnboardingStatusResponseBody withCanReceiveSettlements(boolean canReceiveSettlements) {
        Utils.checkNotNull(canReceiveSettlements, "canReceiveSettlements");
     ...
     * Whether the organization can receive settlements to their external bank account.
     */
    public GetOnboardingStatusResponseBody withCanReceiveSettlements(Optional<Boolean> canReceiveSettlements) {
        Utils.checkNotNull(canReceiveSettlements, "canReceiveSettlements");
        this.canReceiveSettlements = canReceiveSettlements;
        return this;
    }
     ...
     * The sign up date time of the organization in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetOnboardingStatusResponseBody withSignedUpAt(String signedUpAt) {
        Utils.checkNotNull(signedUpAt, "signedUpAt");
     ...
     * The sign up date time of the organization in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public GetOnboardingStatusResponseBody withSignedUpAt(Optional<String> signedUpAt) {
        Utils.checkNotNull(signedUpAt, "signedUpAt");
        this.signedUpAt = signedUpAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetOnboardingStatusResponseBody withLinks(GetOnboardingStatusLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public GetOnboardingStatusResponseBody withLinks(Optional<? extends GetOnboardingStatusLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOnboardingStatusResponseBody other = (GetOnboardingStatusResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOnboardingStatusResponseBody.class,
                "resource", resource,
                "name", name,
                "status", status,
    ...
    public final static class Builder {
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetOnboardingStatusLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends GetOnboardingStatusLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
