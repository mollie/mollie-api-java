...
/**
 * CreatePaymentBillingAddress - The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
 * 
...
public class CreatePaymentBillingAddress {
    ...
    @JsonCreator
    public CreatePaymentBillingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentBillingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentBillingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentBillingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentBillingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentBillingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentBillingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public CreatePaymentBillingAddress withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public CreatePaymentBillingAddress withPhone(Optional<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public CreatePaymentBillingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public CreatePaymentBillingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * Required for payment method `in3`.
     */
    public CreatePaymentBillingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentBillingAddress other = (CreatePaymentBillingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentBillingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public CreatePaymentBillingAddress build() {
            return new CreatePaymentBillingAddress(
                title,
                givenName,
                familyName,
                organizationName,
