...
/**
 * EnableMethodMethodsAPIImage - URLs of images representing the issuer.
 */

public class EnableMethodMethodsAPIImage {
    ...
    @JsonCreator
    public EnableMethodMethodsAPIImage(
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public EnableMethodMethodsAPIImage withSize1x(String size1x) {
        Utils.checkNotNull(size1x, "size1x");
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public EnableMethodMethodsAPIImage withSize1x(Optional<String> size1x) {
        Utils.checkNotNull(size1x, "size1x");
        this.size1x = size1x;
        return this;
    }
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public EnableMethodMethodsAPIImage withSize2x(String size2x) {
        Utils.checkNotNull(size2x, "size2x");
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public EnableMethodMethodsAPIImage withSize2x(Optional<String> size2x) {
        Utils.checkNotNull(size2x, "size2x");
        this.size2x = size2x;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EnableMethodMethodsAPIImage other = (EnableMethodMethodsAPIImage) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EnableMethodMethodsAPIImage.class,
                "size1x", size1x,
                "size2x", size2x,
                "svg", svg);
    }
    ...
    public final static class Builder {
        ...
        public EnableMethodMethodsAPIImage build() {
            return new EnableMethodMethodsAPIImage(
                size1x,
                size2x,
                svg);
        }
