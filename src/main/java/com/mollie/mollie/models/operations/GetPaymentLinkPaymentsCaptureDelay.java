...
public enum GetPaymentLinkPaymentsCaptureDelay {
    ...
    GetPaymentLinkPaymentsCaptureDelay(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentLinkPaymentsCaptureDelay> fromValue(String value) {
        for (GetPaymentLinkPaymentsCaptureDelay o: GetPaymentLinkPaymentsCaptureDelay.values()) {
