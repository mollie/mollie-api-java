...
public class GetSettlementPaymentsSettlementAmount {
    ...
    @JsonCreator
    public GetSettlementPaymentsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public GetSettlementPaymentsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public GetSettlementPaymentsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementPaymentsSettlementAmount other = (GetSettlementPaymentsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementPaymentsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public GetSettlementPaymentsSettlementAmount build() {

            return new GetSettlementPaymentsSettlementAmount(
                currency, value);
        }
