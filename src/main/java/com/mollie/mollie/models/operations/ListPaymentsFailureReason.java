...
public enum ListPaymentsFailureReason {
    ...
    ListPaymentsFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListPaymentsFailureReason> fromValue(String value) {
        for (ListPaymentsFailureReason o: ListPaymentsFailureReason.values()) {
