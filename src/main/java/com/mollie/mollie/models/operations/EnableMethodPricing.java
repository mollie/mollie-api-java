...
public class EnableMethodPricing {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("fixed")
    private Optional<? extends EnableMethodFixed> fixed;
    ...
    @JsonCreator
    public EnableMethodPricing(
            @JsonProperty("description") Optional<String> description,
            @JsonProperty("fixed") Optional<? extends EnableMethodFixed> fixed,
            @JsonProperty("variable") Optional<String> variable,
            @JsonProperty("feeRegion") Optional<String> feeRegion) {
    ...
    @JsonIgnore
    public Optional<EnableMethodFixed> fixed() {
        return (Optional<EnableMethodFixed>) fixed;
    }
     ...
     * A description of what the pricing applies to. For example, a specific country (`The Netherlands`) or a category of cards (`American Express`). If a `locale` is provided, the description may be translated.
     */
    public EnableMethodPricing withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of what the pricing applies to. For example, a specific country (`The Netherlands`) or a category of cards (`American Express`). If a `locale` is provided, the description may be translated.
     */
    public EnableMethodPricing withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The fixed price charged per payment.
     */
    public EnableMethodPricing withFixed(EnableMethodFixed fixed) {
        Utils.checkNotNull(fixed, "fixed");
     ...
     * The fixed price charged per payment.
     */
    public EnableMethodPricing withFixed(Optional<? extends EnableMethodFixed> fixed) {
        Utils.checkNotNull(fixed, "fixed");
        this.fixed = fixed;
        return this;
    }
     ...
     * The variable price charged per payment, as a percentage string.
     */
    public EnableMethodPricing withVariable(String variable) {
        Utils.checkNotNull(variable, "variable");
     ...
     * The variable price charged per payment, as a percentage string.
     */
    public EnableMethodPricing withVariable(Optional<String> variable) {
        Utils.checkNotNull(variable, "variable");
        this.variable = variable;
        return this;
    }
     ...
     * Only present for credit card pricing. It will correspond with the `feeRegion` of credit card payments as returned in the [Payments API](get-payment).
     */
    public EnableMethodPricing withFeeRegion(String feeRegion) {
        Utils.checkNotNull(feeRegion, "feeRegion");
        this.feeRegion = Optional.ofNullable(feeRegion);
        return this;
    }
     ...
     * Only present for credit card pricing. It will correspond with the `feeRegion` of credit card payments as returned in the [Payments API](get-payment).
     */
    public EnableMethodPricing withFeeRegion(Optional<String> feeRegion) {
        Utils.checkNotNull(feeRegion, "feeRegion");
        this.feeRegion = feeRegion;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EnableMethodPricing other = (EnableMethodPricing) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EnableMethodPricing.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends EnableMethodFixed> fixed = Optional.empty();
         ...
         * The fixed price charged per payment.
         */
        public Builder fixed(EnableMethodFixed fixed) {
            Utils.checkNotNull(fixed, "fixed");
            this.fixed = Optional.ofNullable(fixed);
            return this;
        }
         ...
         * The fixed price charged per payment.
         */
        public Builder fixed(Optional<? extends EnableMethodFixed> fixed) {
            Utils.checkNotNull(fixed, "fixed");
            this.fixed = fixed;
            return this;
        }
        ...
        public EnableMethodPricing build() {
            return new EnableMethodPricing(
                description,
                fixed,
                variable,
                feeRegion);
