...
public class CreatePaymentApplicationFee {
    ...
    @JsonProperty("amount")
    private Optional<? extends CreatePaymentPaymentsResponse201Amount> amount;
    ...
    @JsonCreator
    public CreatePaymentApplicationFee(
            @JsonProperty("amount") Optional<? extends CreatePaymentPaymentsResponse201Amount> amount,
    ...
    @JsonIgnore
    public Optional<CreatePaymentPaymentsResponse201Amount> amount() {
        return (Optional<CreatePaymentPaymentsResponse201Amount>) amount;
    }
     ...
     * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public CreatePaymentApplicationFee withAmount(CreatePaymentPaymentsResponse201Amount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public CreatePaymentApplicationFee withAmount(Optional<? extends CreatePaymentPaymentsResponse201Amount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The description of the application fee. This will appear on settlement reports towards both you and the connected merchant.
     */
    public CreatePaymentApplicationFee withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * The description of the application fee. This will appear on settlement reports towards both you and the connected merchant.
     */
    public CreatePaymentApplicationFee withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentApplicationFee other = (CreatePaymentApplicationFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentApplicationFee.class,
                "amount", amount,
    ...
    public final static class Builder {
         ...
         * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
         */
        public Builder amount(CreatePaymentPaymentsResponse201Amount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
         */
        public Builder amount(Optional<? extends CreatePaymentPaymentsResponse201Amount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
