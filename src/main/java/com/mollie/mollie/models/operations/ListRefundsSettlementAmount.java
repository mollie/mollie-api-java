...
public class ListRefundsSettlementAmount {
    ...
    @JsonCreator
    public ListRefundsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListRefundsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListRefundsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListRefundsSettlementAmount other = (ListRefundsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListRefundsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListRefundsSettlementAmount build() {

            return new ListRefundsSettlementAmount(
                currency, value);
        }
