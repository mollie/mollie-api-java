...
public class ListCustomerPaymentsRequestBuilder {
    ...
    public CompletableFuture<ListCustomerPaymentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListCustomerPaymentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListCustomerPaymentsResponse&gt;() {
     ...
     */
    public Publisher<ListCustomerPaymentsResponse> callAsPublisher() {
        ListCustomerPaymentsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListCustomerPaymentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
