 ...
 */
public enum GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyFeeType {
    ...
    GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyFeeType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyFeeType o: GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyFeeType.values()) {
