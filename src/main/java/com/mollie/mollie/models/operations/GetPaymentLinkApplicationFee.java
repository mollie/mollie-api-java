...
public class GetPaymentLinkApplicationFee {
    ...
    @JsonProperty("amount")
    private Optional<? extends GetPaymentLinkPaymentLinksAmount> amount;
    ...
    @JsonCreator
    public GetPaymentLinkApplicationFee(
            @JsonProperty("amount") Optional<? extends GetPaymentLinkPaymentLinksAmount> amount,
    ...
    @JsonIgnore
    public Optional<GetPaymentLinkPaymentLinksAmount> amount() {
        return (Optional<GetPaymentLinkPaymentLinksAmount>) amount;
    }
     ...
     * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public GetPaymentLinkApplicationFee withAmount(Optional<? extends GetPaymentLinkPaymentLinksAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The description of the application fee. This will appear on settlement reports towards both you and the connected merchant.
     */
    public GetPaymentLinkApplicationFee withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkApplicationFee other = (GetPaymentLinkApplicationFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkApplicationFee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetPaymentLinkPaymentLinksAmount> amount = Optional.empty();
         ...
         * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
         */
        public Builder amount(Optional<? extends GetPaymentLinkPaymentLinksAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
        ...
        public GetPaymentLinkApplicationFee build() {
            return new GetPaymentLinkApplicationFee(
                amount,
                description);
        }
    }
