...
public class ListAllRefundsSettlementAmount {
    ...
    @JsonCreator
    public ListAllRefundsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListAllRefundsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListAllRefundsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAllRefundsSettlementAmount other = (ListAllRefundsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAllRefundsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListAllRefundsSettlementAmount build() {

            return new ListAllRefundsSettlementAmount(
                currency, value);
        }
