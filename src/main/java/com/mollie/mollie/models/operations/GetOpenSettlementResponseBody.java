 ...
 * 
 * <p>A settlement object describing your current balance. For a complete reference of the settlement object, refer to the [Get settlement](get-settlement) endpoint documentation.
 */
public class GetOpenSettlementResponseBody {
     ...
     * <p>Possible values: `open` `pending` `paidout` `failed`
     */
    public GetOpenSettlementResponseBody withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * <p>Possible values: `open` `pending` `paidout` `failed`
     */
    public GetOpenSettlementResponseBody withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
