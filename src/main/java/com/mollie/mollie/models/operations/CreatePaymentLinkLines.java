...
public class CreatePaymentLinkLines {
    /**
    ...
    private CreatePaymentLinkUnitPrice unitPrice;
    ...
    private Optional<? extends CreatePaymentLinkDiscountAmount> discountAmount;
    ...
    private CreatePaymentLinkTotalAmount totalAmount;
    ...
    private Optional<? extends CreatePaymentLinkVatAmount> vatAmount;
    ...
    private Optional<? extends List<CreatePaymentLinkCategories>> categories;
    ...
    @JsonCreator
    public CreatePaymentLinkLines(
            @JsonProperty("type") Optional<? extends CreatePaymentLinkType> type,
            @JsonProperty("description") String description,
            @JsonProperty("quantity") long quantity,
            @JsonProperty("quantityUnit") Optional<String> quantityUnit,
            @JsonProperty("unitPrice") CreatePaymentLinkUnitPrice unitPrice,
            @JsonProperty("discountAmount") Optional<? extends CreatePaymentLinkDiscountAmount> discountAmount,
            @JsonProperty("totalAmount") CreatePaymentLinkTotalAmount totalAmount,
            @JsonProperty("vatRate") Optional<String> vatRate,
            @JsonProperty("vatAmount") Optional<? extends CreatePaymentLinkVatAmount> vatAmount,
            @JsonProperty("sku") Optional<String> sku,
            @JsonProperty("categories") Optional<? extends List<CreatePaymentLinkCategories>> categories,
    ...
    public CreatePaymentLinkLines(
            String description,
            long quantity,
            CreatePaymentLinkUnitPrice unitPrice,
            CreatePaymentLinkTotalAmount totalAmount) {
    ...
    @JsonIgnore
    public Optional<CreatePaymentLinkType> type() {
        return (Optional<CreatePaymentLinkType>) type;
    }
     ...
     */
    @JsonIgnore
    public CreatePaymentLinkUnitPrice unitPrice() {
        return unitPrice;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CreatePaymentLinkDiscountAmount> discountAmount() {
        return (Optional<CreatePaymentLinkDiscountAmount>) discountAmount;
    }
     ...
     */
    @JsonIgnore
    public CreatePaymentLinkTotalAmount totalAmount() {
        return totalAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CreatePaymentLinkVatAmount> vatAmount() {
        return (Optional<CreatePaymentLinkVatAmount>) vatAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<List<CreatePaymentLinkCategories>> categories() {
        return (Optional<List<CreatePaymentLinkCategories>>) categories;
    }
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public CreatePaymentLinkLines withType(CreatePaymentLinkType type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public CreatePaymentLinkLines withType(Optional<? extends CreatePaymentLinkType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public CreatePaymentLinkLines withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public CreatePaymentLinkLines withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public CreatePaymentLinkLines withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public CreatePaymentLinkLines withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * <p>The unit price can be zero in case of free items.
     */
    public CreatePaymentLinkLines withUnitPrice(CreatePaymentLinkUnitPrice unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * type.
     */
    public CreatePaymentLinkLines withDiscountAmount(CreatePaymentLinkDiscountAmount discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
     ...
     * type.
     */
    public CreatePaymentLinkLines withDiscountAmount(Optional<? extends CreatePaymentLinkDiscountAmount> discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
     */
    public CreatePaymentLinkLines withTotalAmount(CreatePaymentLinkTotalAmount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public CreatePaymentLinkLines withVatRate(String vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public CreatePaymentLinkLines withVatRate(Optional<String> vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
        this.vatRate = vatRate;
        return this;
    }
     ...
     * `SEK 100.00 × (25 / 125) = SEK 20.00`.
     */
    public CreatePaymentLinkLines withVatAmount(CreatePaymentLinkVatAmount vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
     ...
     * `SEK 100.00 × (25 / 125) = SEK 20.00`.
     */
    public CreatePaymentLinkLines withVatAmount(Optional<? extends CreatePaymentLinkVatAmount> vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
        this.vatAmount = vatAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public CreatePaymentLinkLines withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public CreatePaymentLinkLines withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public CreatePaymentLinkLines withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public CreatePaymentLinkLines withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public CreatePaymentLinkLines withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public CreatePaymentLinkLines withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentLinkLines other = (CreatePaymentLinkLines) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentLinkLines.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreatePaymentLinkDiscountAmount> discountAmount = Optional.empty();

        private CreatePaymentLinkTotalAmount totalAmount;

        private Optional<String> vatRate = Optional.empty();

        private Optional<? extends CreatePaymentLinkVatAmount> vatAmount = Optional.empty();

        private Optional<String> sku = Optional.empty();

        private Optional<? extends List<CreatePaymentLinkCategories>> categories = Optional.empty();
         ...
         * <p>The `tip` payment line type is not available when creating a payment.
         */
        public Builder type(CreatePaymentLinkType type) {
            Utils.checkNotNull(type, "type");
            this.type = Optional.ofNullable(type);
            return this;
        }
         ...
         * <p>The `tip` payment line type is not available when creating a payment.
         */
        public Builder type(Optional<? extends CreatePaymentLinkType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * <p>The unit price can be zero in case of free items.
         */
        public Builder unitPrice(CreatePaymentLinkUnitPrice unitPrice) {
            Utils.checkNotNull(unitPrice, "unitPrice");
            this.unitPrice = unitPrice;
            return this;
        }
         ...
         * type.
         */
        public Builder discountAmount(CreatePaymentLinkDiscountAmount discountAmount) {
            Utils.checkNotNull(discountAmount, "discountAmount");
            this.discountAmount = Optional.ofNullable(discountAmount);
            return this;
        }
         ...
         * type.
         */
        public Builder discountAmount(Optional<? extends CreatePaymentLinkDiscountAmount> discountAmount) {
            Utils.checkNotNull(discountAmount, "discountAmount");
            this.discountAmount = discountAmount;
            return this;
        }
         ...
         * <p>The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
         */
        public Builder totalAmount(CreatePaymentLinkTotalAmount totalAmount) {
            Utils.checkNotNull(totalAmount, "totalAmount");
            this.totalAmount = totalAmount;
            return this;
        }
         ...
         * `SEK 100.00 × (25 / 125) = SEK 20.00`.
         */
        public Builder vatAmount(CreatePaymentLinkVatAmount vatAmount) {
            Utils.checkNotNull(vatAmount, "vatAmount");
            this.vatAmount = Optional.ofNullable(vatAmount);
            return this;
        }
         ...
         * `SEK 100.00 × (25 / 125) = SEK 20.00`.
         */
        public Builder vatAmount(Optional<? extends CreatePaymentLinkVatAmount> vatAmount) {
            Utils.checkNotNull(vatAmount, "vatAmount");
            this.vatAmount = vatAmount;
            return this;
        }
