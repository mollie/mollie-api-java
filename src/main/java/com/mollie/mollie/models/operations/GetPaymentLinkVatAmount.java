...
public class GetPaymentLinkVatAmount {
    ...
    @JsonCreator
    public GetPaymentLinkVatAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public GetPaymentLinkVatAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public GetPaymentLinkVatAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentLinkVatAmount other = (GetPaymentLinkVatAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentLinkVatAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public GetPaymentLinkVatAmount build() {
            return new GetPaymentLinkVatAmount(
                currency,
                value);
        }
    }
