...
public class ListSubscriptionPaymentsRecurring {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
    private Optional<? extends ListSubscriptionPaymentsSubscriptionsResponse200Amount> amount;
    ...
    @JsonIgnore
    public Optional<ListSubscriptionPaymentsSubscriptionsResponse200Amount> amount() {
        return (Optional<ListSubscriptionPaymentsSubscriptionsResponse200Amount>) amount;
    }
     ...
     * A description of the recurring item. If not present, the main description of the item will be used.
     */
    public ListSubscriptionPaymentsRecurring withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of the recurring item. If not present, the main description of the item will be used.
     */
    public ListSubscriptionPaymentsRecurring withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Total amount and currency of the recurring item.
     */
    public ListSubscriptionPaymentsRecurring withAmount(ListSubscriptionPaymentsSubscriptionsResponse200Amount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * Total amount and currency of the recurring item.
     */
    public ListSubscriptionPaymentsRecurring withAmount(Optional<? extends ListSubscriptionPaymentsSubscriptionsResponse200Amount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * Total number of charges for the subscription to complete. Leave empty for ongoing subscription.
     */
    public ListSubscriptionPaymentsRecurring withTimes(long times) {
        Utils.checkNotNull(times, "times");
     ...
     * Total number of charges for the subscription to complete. Leave empty for ongoing subscription.
     */
    public ListSubscriptionPaymentsRecurring withTimes(Optional<Long> times) {
        Utils.checkNotNull(times, "times");
        this.times = times;
        return this;
    }
     ...
     * The start date of the subscription if it does not start right away (format `YYYY-MM-DD`)
     */
    public ListSubscriptionPaymentsRecurring withStartDate(String startDate) {
        Utils.checkNotNull(startDate, "startDate");
     ...
     * The start date of the subscription if it does not start right away (format `YYYY-MM-DD`)
     */
    public ListSubscriptionPaymentsRecurring withStartDate(JsonNullable<String> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSubscriptionPaymentsRecurring other = (ListSubscriptionPaymentsRecurring) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSubscriptionPaymentsRecurring.class,
    ...
    public final static class Builder {
         ...
         * Total amount and currency of the recurring item.
         */
        public Builder amount(ListSubscriptionPaymentsSubscriptionsResponse200Amount amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = Optional.ofNullable(amount);
            return this;
        }
         ...
         * Total amount and currency of the recurring item.
         */
        public Builder amount(Optional<? extends ListSubscriptionPaymentsSubscriptionsResponse200Amount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
        ...
        public ListSubscriptionPaymentsRecurring build() {
            return new ListSubscriptionPaymentsRecurring(
                description,
                interval,
                amount,
                times,
