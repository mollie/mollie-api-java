...
public enum GetPaymentFailureReason {
    ...
    GetPaymentFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentFailureReason> fromValue(String value) {
        for (GetPaymentFailureReason o: GetPaymentFailureReason.values()) {
