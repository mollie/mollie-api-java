...
public enum GetPaymentLinkPaymentsCode {
    ...
    GetPaymentLinkPaymentsCode(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentLinkPaymentsCode> fromValue(String value) {
        for (GetPaymentLinkPaymentsCode o: GetPaymentLinkPaymentsCode.values()) {
