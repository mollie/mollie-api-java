...
public class ListOrderRefundsSettlementAmount {
    ...
    @JsonCreator
    public ListOrderRefundsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListOrderRefundsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListOrderRefundsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListOrderRefundsSettlementAmount other = (ListOrderRefundsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListOrderRefundsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListOrderRefundsSettlementAmount build() {
            return new ListOrderRefundsSettlementAmount(
                currency,
                value);
        }
    }
