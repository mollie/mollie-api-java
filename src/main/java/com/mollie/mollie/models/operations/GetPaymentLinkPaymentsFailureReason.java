...
public enum GetPaymentLinkPaymentsFailureReason {
    ...
    GetPaymentLinkPaymentsFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetPaymentLinkPaymentsFailureReason> fromValue(String value) {
        for (GetPaymentLinkPaymentsFailureReason o: GetPaymentLinkPaymentsFailureReason.values()) {
