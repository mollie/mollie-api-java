...
public class ListSettlementRefundsResponseBody {
    ...
    private ListSettlementRefundsEmbedded embedded;
    ...
    public ListSettlementRefundsResponseBody(
            ...
            @JsonProperty("_embedded") ListSettlementRefundsEmbedded embedded,
    ...
    @JsonIgnore
    public ListSettlementRefundsEmbedded embedded() {
        return embedded;
    }
     ...
     * `type` field.
     */
    public ListSettlementRefundsResponseBody withLinks(ListLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
