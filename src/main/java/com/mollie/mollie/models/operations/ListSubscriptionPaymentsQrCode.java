...
public class ListSubscriptionPaymentsQrCode {
    ...
    @JsonCreator
    public ListSubscriptionPaymentsQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public ListSubscriptionPaymentsQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public ListSubscriptionPaymentsQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public ListSubscriptionPaymentsQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public ListSubscriptionPaymentsQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public ListSubscriptionPaymentsQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public ListSubscriptionPaymentsQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSubscriptionPaymentsQrCode other = (ListSubscriptionPaymentsQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSubscriptionPaymentsQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public ListSubscriptionPaymentsQrCode build() {

            return new ListSubscriptionPaymentsQrCode(
                height, width, src);
        }
