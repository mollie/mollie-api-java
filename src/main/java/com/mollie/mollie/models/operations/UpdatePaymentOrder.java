...
public class UpdatePaymentOrder {
     ...
     * The actual URL string.
     */
    public UpdatePaymentOrder withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public UpdatePaymentOrder withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentOrder withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UpdatePaymentOrder withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePaymentOrder other = (UpdatePaymentOrder) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePaymentOrder.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public UpdatePaymentOrder build() {
            return new UpdatePaymentOrder(
                href,
                type);
        }
    }
