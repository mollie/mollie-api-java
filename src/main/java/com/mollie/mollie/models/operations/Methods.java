...
/**
 * Methods - The API resource URL of the methods that are enabled for this profile.
 */
...
public class Methods {
     ...
     * The actual URL string.
     */
    public Methods withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Methods withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
