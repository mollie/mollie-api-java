 ...
 */
public enum GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsOpenAvailableTransactionType {
    PAYMENT("payment"),
    ...
    GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsOpenAvailableTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsOpenAvailableTransactionType> fromValue(String value) {
        for (GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsOpenAvailableTransactionType o: GetBalanceReportBalancesResponse200ApplicationHalPlusJsonResponseBodyTotalsOpenAvailableTransactionType.values()) {
