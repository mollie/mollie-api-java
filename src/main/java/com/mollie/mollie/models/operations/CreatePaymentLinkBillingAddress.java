 ...
 */
public class CreatePaymentLinkBillingAddress {
    /**
    ...
    @JsonCreator
    public CreatePaymentLinkBillingAddress(
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentLinkBillingAddress withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the person, for example *Mr.* or *Mrs.*.
     */
    public CreatePaymentLinkBillingAddress withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentLinkBillingAddress withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The name of the organization, in case the addressee is an organization.
     */
    public CreatePaymentLinkBillingAddress withOrganizationName(Optional<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentLinkBillingAddress withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public CreatePaymentLinkBillingAddress withStreetAdditional(Optional<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public CreatePaymentLinkBillingAddress withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * If provided, it must be in the [E.164](https://en.wikipedia.org/wiki/E.164) format. For example: +31208202070.
     */
    public CreatePaymentLinkBillingAddress withPhone(Optional<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public CreatePaymentLinkBillingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The top-level administrative subdivision of the country. For example: Noord-Holland.
     */
    public CreatePaymentLinkBillingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna` and `riverty`.
     */
    public CreatePaymentLinkBillingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentLinkBillingAddress other = (CreatePaymentLinkBillingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePaymentLinkBillingAddress.class,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
        ...
        public CreatePaymentLinkBillingAddress build() {

            return new CreatePaymentLinkBillingAddress(
                title, givenName, familyName,
                organizationName, streetAndNumber, streetAdditional,
                postalCode, email, phone,
                city, region, country);
