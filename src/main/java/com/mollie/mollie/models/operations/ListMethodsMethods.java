...
public class ListMethodsMethods {
    /**
     ...
     * endpoint.
     */
    public ListMethodsMethods withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * method selection screen will be skipped.
     */
    public ListMethodsMethods withId(ListMethodsId id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * <p>If a `locale` parameter is provided, the name is translated to the given locale if possible.
     */
    public ListMethodsMethods withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The minimum payment amount required to use this payment method.
     */
    public ListMethodsMethods withMinimumAmount(ListMethodsMinimumAmount minimumAmount) {
        Utils.checkNotNull(minimumAmount, "minimumAmount");
        this.minimumAmount = minimumAmount;
        return this;
    }
     ...
     * is returned instead.
     */
    public ListMethodsMethods withMaximumAmount(ListMethodsMaximumAmount maximumAmount) {
        Utils.checkNotNull(maximumAmount, "maximumAmount");
     ...
     * is returned instead.
     */
    public ListMethodsMethods withMaximumAmount(Optional<? extends ListMethodsMaximumAmount> maximumAmount) {
        Utils.checkNotNull(maximumAmount, "maximumAmount");
        this.maximumAmount = maximumAmount;
        return this;
    }
     ...
     * URLs of images representing the payment method.
     */
    public ListMethodsMethods withImage(ListMethodsImage image) {
        Utils.checkNotNull(image, "image");
        this.image = image;
        return this;
    }
     ...
     * The payment method's activation status for this profile.
     */
    public ListMethodsMethods withStatus(ListMethodsStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * for iDEAL, KBC/CBC, gift cards, and vouchers.
     */
    public ListMethodsMethods withIssuers(List<ListMethodsIssuers> issuers) {
        Utils.checkNotNull(issuers, "issuers");
     ...
     * for iDEAL, KBC/CBC, gift cards, and vouchers.
     */
    public ListMethodsMethods withIssuers(Optional<? extends List<ListMethodsIssuers>> issuers) {
        Utils.checkNotNull(issuers, "issuers");
        this.issuers = issuers;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListMethodsMethods withLinks(ListMethodsMethodsLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMethodsMethods other = (ListMethodsMethods) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMethodsMethods.class,
                "resource", resource,
                "id", id,
    ...
    public final static class Builder {
        ...
        public ListMethodsMethods build() {

            return new ListMethodsMethods(
                resource, id, description,
                minimumAmount, maximumAmount, image,
                status, issuers, links);
        }
