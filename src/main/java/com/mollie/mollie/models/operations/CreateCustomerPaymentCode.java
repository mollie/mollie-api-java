...
public enum CreateCustomerPaymentCode {
    ...
    CreateCustomerPaymentCode(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateCustomerPaymentCode> fromValue(String value) {
        for (CreateCustomerPaymentCode o: CreateCustomerPaymentCode.values()) {
