...
public class ListSalesInvoicesPaymentDetails {
     ...
     */
    @JsonProperty("source")
    private ListSalesInvoicesSource source;
    ...
    @JsonCreator
    public ListSalesInvoicesPaymentDetails(
            @JsonProperty("source") ListSalesInvoicesSource source,
    ...
    public ListSalesInvoicesPaymentDetails(
            ListSalesInvoicesSource source) {
     ...
     */
    @JsonIgnore
    public ListSalesInvoicesSource source() {
        return source;
    }
     ...
     * The way through which the invoice is to be set to paid.
     */
    public ListSalesInvoicesPaymentDetails withSource(ListSalesInvoicesSource source) {
        Utils.checkNotNull(source, "source");
        this.source = source;
        return this;
    }
     ...
     * `payment`.
     */
    public ListSalesInvoicesPaymentDetails withSourceReference(String sourceReference) {
        Utils.checkNotNull(sourceReference, "sourceReference");
     ...
     * `payment`.
     */
    public ListSalesInvoicesPaymentDetails withSourceReference(JsonNullable<String> sourceReference) {
        Utils.checkNotNull(sourceReference, "sourceReference");
        this.sourceReference = sourceReference;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSalesInvoicesPaymentDetails other = (ListSalesInvoicesPaymentDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSalesInvoicesPaymentDetails.class,
                "source", source,
    ...
    public final static class Builder {
         ...
         * The way through which the invoice is to be set to paid.
         */
        public Builder source(ListSalesInvoicesSource source) {
            Utils.checkNotNull(source, "source");
            this.source = source;
            return this;
        }
        ...
        public ListSalesInvoicesPaymentDetails build() {

            return new ListSalesInvoicesPaymentDetails(
                source, sourceReference);
        }
