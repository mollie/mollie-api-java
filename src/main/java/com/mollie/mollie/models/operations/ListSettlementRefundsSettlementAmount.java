...
public class ListSettlementRefundsSettlementAmount {
    ...
    @JsonCreator
    public ListSettlementRefundsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListSettlementRefundsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListSettlementRefundsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementRefundsSettlementAmount other = (ListSettlementRefundsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementRefundsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListSettlementRefundsSettlementAmount build() {

            return new ListSettlementRefundsSettlementAmount(
                currency, value);
        }
