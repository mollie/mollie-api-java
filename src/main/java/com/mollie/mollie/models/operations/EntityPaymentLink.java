...
public class EntityPaymentLink {
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public EntityPaymentLink withMode(EntityMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * amount.
     */
    public EntityPaymentLink withAmount(Optional<? extends EntityAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * the customer will be shown a generic message after completing the payment.
     */
    public EntityPaymentLink withRedirectUrl(Optional<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * local machine.
     */
    public EntityPaymentLink withWebhookUrl(Optional<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * required.
     */
    public EntityPaymentLink withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The date and time the payment link became paid, in ISO 8601 format.
     */
    public EntityPaymentLink withPaidAt(Optional<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * the payment link will not expire automatically.
     */
    public EntityPaymentLink withExpiresAt(Optional<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * 'in3', 'riverty', 'klarna', 'billie'.
     */
    public EntityPaymentLink withAllowedMethods(Optional<? extends List<String>> allowedMethods) {
        Utils.checkNotNull(allowedMethods, "allowedMethods");
        this.allowedMethods = allowedMethods;
        return this;
    }
     ...
     * [Payment Link Payments Endpoint](get-payment-link-payments).
     */
    public EntityPaymentLink withSequenceType(EntitySequenceType sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
     ...
     * [Payment Link Payments Endpoint](get-payment-link-payments).
     */
    public EntityPaymentLink withSequenceType(JsonNullable<? extends EntitySequenceType> sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * the payment is made.
     */
    public EntityPaymentLink withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * the payment is made.
     */
    public EntityPaymentLink withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
