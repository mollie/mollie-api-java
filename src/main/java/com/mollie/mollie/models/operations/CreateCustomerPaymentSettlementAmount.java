...
public class CreateCustomerPaymentSettlementAmount {
    ...
    @JsonCreator
    public CreateCustomerPaymentSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public CreateCustomerPaymentSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public CreateCustomerPaymentSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerPaymentSettlementAmount other = (CreateCustomerPaymentSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerPaymentSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public CreateCustomerPaymentSettlementAmount build() {
            return new CreateCustomerPaymentSettlementAmount(
                currency,
                value);
        }
    }
