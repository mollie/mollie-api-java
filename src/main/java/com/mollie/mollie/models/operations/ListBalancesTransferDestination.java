...
public class ListBalancesTransferDestination {
    ...
    @JsonProperty("type")
    private Optional<? extends ListBalancesType> type;
    ...
    @JsonCreator
    public ListBalancesTransferDestination(
            @JsonProperty("type") Optional<? extends ListBalancesType> type,
    ...
    @JsonIgnore
    public Optional<ListBalancesType> type() {
        return (Optional<ListBalancesType>) type;
    }
     ...
     * <p>* `bank-account` — Transfer the balance amount to an external bank account
     */
    public ListBalancesTransferDestination withType(ListBalancesType type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>* `bank-account` — Transfer the balance amount to an external bank account
     */
    public ListBalancesTransferDestination withType(Optional<? extends ListBalancesType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The configured bank account number of the beneficiary the balance amount is to be transferred to.
     */
    public ListBalancesTransferDestination withBankAccount(String bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
     ...
     * The configured bank account number of the beneficiary the balance amount is to be transferred to.
     */
    public ListBalancesTransferDestination withBankAccount(Optional<String> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * The full name of the beneficiary the balance amount is to be transferred to.
     */
    public ListBalancesTransferDestination withBeneficiaryName(String beneficiaryName) {
        Utils.checkNotNull(beneficiaryName, "beneficiaryName");
     ...
     * The full name of the beneficiary the balance amount is to be transferred to.
     */
    public ListBalancesTransferDestination withBeneficiaryName(Optional<String> beneficiaryName) {
        Utils.checkNotNull(beneficiaryName, "beneficiaryName");
        this.beneficiaryName = beneficiaryName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListBalancesTransferDestination other = (ListBalancesTransferDestination) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListBalancesTransferDestination.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends ListBalancesType> type = Optional.empty();
         ...
         * <p>* `bank-account` — Transfer the balance amount to an external bank account
         */
        public Builder type(ListBalancesType type) {
            Utils.checkNotNull(type, "type");
            this.type = Optional.ofNullable(type);
            return this;
        }
         ...
         * <p>* `bank-account` — Transfer the balance amount to an external bank account
         */
        public Builder type(Optional<? extends ListBalancesType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
        ...
        public ListBalancesTransferDestination build() {

            return new ListBalancesTransferDestination(
                type, bankAccount, beneficiaryName);
        }
