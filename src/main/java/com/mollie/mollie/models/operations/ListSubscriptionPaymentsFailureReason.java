...
public enum ListSubscriptionPaymentsFailureReason {
    ...
    ListSubscriptionPaymentsFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionPaymentsFailureReason> fromValue(String value) {
        for (ListSubscriptionPaymentsFailureReason o: ListSubscriptionPaymentsFailureReason.values()) {
