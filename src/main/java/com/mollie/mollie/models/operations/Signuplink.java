...
public class Signuplink {
     ...
     * The actual URL string.
     */
    public Signuplink withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public Signuplink withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Signuplink withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Signuplink withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Signuplink.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public Signuplink build() {
            return new Signuplink(
                href,
                type);
        }
    }
