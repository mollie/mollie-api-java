...
public class ListAllSubscriptionsSubscriptionsAmount {
    ...
    @JsonCreator
    public ListAllSubscriptionsSubscriptionsAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListAllSubscriptionsSubscriptionsAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListAllSubscriptionsSubscriptionsAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAllSubscriptionsSubscriptionsAmount other = (ListAllSubscriptionsSubscriptionsAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAllSubscriptionsSubscriptionsAmount.class,
                "currency", currency,
                "value", value);
    }
