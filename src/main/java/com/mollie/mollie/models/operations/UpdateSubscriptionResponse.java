...
public class UpdateSubscriptionResponse implements Response {
    ...
    /**
     * The updated subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
     ...
     * The updated subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
    public UpdateSubscriptionResponse withAny(Object any) {
        Utils.checkNotNull(any, "any");
     ...
     * The updated subscription object. For a complete reference of the subscription object, refer to the [Get subscription endpoint](get-subscription) documentation.
     */
    public UpdateSubscriptionResponse withAny(Optional<? extends Object> any) {
        Utils.checkNotNull(any, "any");
        this.any = any;
        return this;
    }
