...
public class ListCapabilitiesDashboard {
    ...
    @JsonCreator
    public ListCapabilitiesDashboard(
     ...
     * The actual URL string.
     */
    public ListCapabilitiesDashboard withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListCapabilitiesDashboard withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCapabilitiesDashboard withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListCapabilitiesDashboard withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCapabilitiesDashboard other = (ListCapabilitiesDashboard) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCapabilitiesDashboard.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListCapabilitiesDashboard build() {
            return new ListCapabilitiesDashboard(
                href,
                type);
        }
    }
