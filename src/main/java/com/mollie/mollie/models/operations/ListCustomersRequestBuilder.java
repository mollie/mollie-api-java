...
public class ListCustomersRequestBuilder {
    ...
    * <pre><code>
    * for (ListCustomersResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListCustomersResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListCustomersResponse> callAsStream() {
