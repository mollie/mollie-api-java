 ...
 * 
 * <p>The updated subscription object.
 */
public class UpdateSubscriptionResponseBody {
     ...
     */
    @JsonProperty("mode")
    private UpdateSubscriptionMode mode;
     ...
     */
    @JsonProperty("status")
    private UpdateSubscriptionStatus status;
     ...
     */
    @JsonProperty("amount")
    private UpdateSubscriptionSubscriptionsAmount amount;
    ...
    private UpdateSubscriptionSubscriptionsInterval interval;
    ...
    @JsonInclude(Include.ALWAYS)
    @JsonProperty("method")
    private Optional<? extends UpdateSubscriptionMethod> method;
    ...
    private Optional<? extends UpdateSubscriptionSubscriptionsMetadata> metadata;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends UpdateSubscriptionLinks> links;

    @JsonCreator
    public UpdateSubscriptionResponseBody(
            @JsonProperty("resource") Optional<String> resource,
            @JsonProperty("id") String id,
            @JsonProperty("mode") UpdateSubscriptionMode mode,
            @JsonProperty("status") UpdateSubscriptionStatus status,
            @JsonProperty("amount") UpdateSubscriptionSubscriptionsAmount amount,
            @JsonProperty("times") Optional<Long> times,
            @JsonProperty("timesRemaining") long timesRemaining,
            @JsonProperty("interval") UpdateSubscriptionSubscriptionsInterval interval,
            @JsonProperty("startDate") String startDate,
            @JsonProperty("nextPaymentDate") JsonNullable<String> nextPaymentDate,
            @JsonProperty("description") String description,
            @JsonProperty("method") Optional<? extends UpdateSubscriptionMethod> method,
            @JsonProperty("applicationFee") Optional<? extends UpdateSubscriptionApplicationFee> applicationFee,
            @JsonProperty("metadata") Optional<? extends UpdateSubscriptionSubscriptionsMetadata> metadata,
            ...
            @JsonProperty("_links") Optional<? extends UpdateSubscriptionLinks> links) {
    ...
    public UpdateSubscriptionResponseBody(
            String id,
            UpdateSubscriptionMode mode,
            UpdateSubscriptionStatus status,
            UpdateSubscriptionSubscriptionsAmount amount,
            long timesRemaining,
            UpdateSubscriptionSubscriptionsInterval interval,
            String startDate,
            String description,
            String webhookUrl,
            String customerId,
     ...
     */
    @JsonIgnore
    public UpdateSubscriptionMode mode() {
        return mode;
    }
     ...
     */
    @JsonIgnore
    public UpdateSubscriptionStatus status() {
        return status;
    }
     ...
     */
    @JsonIgnore
    public UpdateSubscriptionSubscriptionsAmount amount() {
        return amount;
    }
     ...
     */
    @JsonIgnore
    public UpdateSubscriptionSubscriptionsInterval interval() {
        return interval;
    }
    ...
    @JsonIgnore
    public Optional<UpdateSubscriptionMethod> method() {
        return (Optional<UpdateSubscriptionMethod>) method;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<UpdateSubscriptionApplicationFee> applicationFee() {
        return (Optional<UpdateSubscriptionApplicationFee>) applicationFee;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<UpdateSubscriptionSubscriptionsMetadata> metadata() {
        return (Optional<UpdateSubscriptionSubscriptionsMetadata>) metadata;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<UpdateSubscriptionLinks> links() {
        return (Optional<UpdateSubscriptionLinks>) links;
    }
     ...
     * The identifier uniquely referring to this subscription. Example: `sub_rVKGtNd6s3`.
     */
    public UpdateSubscriptionResponseBody withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * <p>Test mode subscriptions will get canceled automatically after 10 payments.
     */
    public UpdateSubscriptionResponseBody withTimes(long times) {
        Utils.checkNotNull(times, "times");
     ...
     * <p>Test mode subscriptions will get canceled automatically after 10 payments.
     */
    public UpdateSubscriptionResponseBody withTimes(Optional<Long> times) {
        Utils.checkNotNull(times, "times");
        this.times = times;
        return this;
    }
     ...
     * Number of payments left for the subscription.
     */
    public UpdateSubscriptionResponseBody withTimesRemaining(long timesRemaining) {
        Utils.checkNotNull(timesRemaining, "timesRemaining");
        this.timesRemaining = timesRemaining;
        return this;
    }
     ...
     * The start date of the subscription in `YYYY-MM-DD` format.
     */
    public UpdateSubscriptionResponseBody withStartDate(String startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * <p>**Please note:** the description needs to be unique for the Customer in case it has multiple active subscriptions.
     */
    public UpdateSubscriptionResponseBody withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The payment method used for this subscription. If omitted, any of the customer's valid mandates may be used.
     */
    public UpdateSubscriptionResponseBody withMethod(Optional<? extends UpdateSubscriptionMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * <p>Any metadata added to the subscription will be automatically forwarded to the payments generated for it.
     */
    public UpdateSubscriptionResponseBody withMetadata(UpdateSubscriptionSubscriptionsMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * <p>Any metadata added to the subscription will be automatically forwarded to the payments generated for it.
     */
    public UpdateSubscriptionResponseBody withMetadata(Optional<? extends UpdateSubscriptionSubscriptionsMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The customer this subscription belongs to.
     */
    public UpdateSubscriptionResponseBody withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The mandate used for this subscription, if any.
     */
    public UpdateSubscriptionResponseBody withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
     ...
     * The mandate used for this subscription, if any.
     */
    public UpdateSubscriptionResponseBody withMandateId(JsonNullable<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public UpdateSubscriptionResponseBody withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public UpdateSubscriptionResponseBody withLinks(UpdateSubscriptionLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public UpdateSubscriptionResponseBody withLinks(Optional<? extends UpdateSubscriptionLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSubscriptionResponseBody other = (UpdateSubscriptionResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSubscriptionResponseBody.class,
                "resource", resource,
                "id", id,
                "mode", mode,
                "status", status,
    ...
    public final static class Builder {
        ...
        private Optional<? extends UpdateSubscriptionMethod> method = Optional.empty();

        private Optional<? extends UpdateSubscriptionApplicationFee> applicationFee = Optional.empty();

        private Optional<? extends UpdateSubscriptionSubscriptionsMetadata> metadata = Optional.empty();
        ...
        private Optional<? extends UpdateSubscriptionLinks> links = Optional.empty();
         ...
         * The payment method used for this subscription. If omitted, any of the customer's valid mandates may be used.
         */
        public Builder method(Optional<? extends UpdateSubscriptionMethod> method) {
            Utils.checkNotNull(method, "method");
            this.method = method;
            return this;
        }
         ...
         * <p>Any metadata added to the subscription will be automatically forwarded to the payments generated for it.
         */
        public Builder metadata(UpdateSubscriptionSubscriptionsMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = Optional.ofNullable(metadata);
            return this;
        }
         ...
         * <p>Any metadata added to the subscription will be automatically forwarded to the payments generated for it.
         */
        public Builder metadata(Optional<? extends UpdateSubscriptionSubscriptionsMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(UpdateSubscriptionLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends UpdateSubscriptionLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
