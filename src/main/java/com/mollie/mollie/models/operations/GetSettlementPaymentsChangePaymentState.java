...
public class GetSettlementPaymentsChangePaymentState {
    ...
    @JsonCreator
    public GetSettlementPaymentsChangePaymentState(
     ...
     * The actual URL string.
     */
    public GetSettlementPaymentsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public GetSettlementPaymentsChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetSettlementPaymentsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public GetSettlementPaymentsChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSettlementPaymentsChangePaymentState other = (GetSettlementPaymentsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSettlementPaymentsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public GetSettlementPaymentsChangePaymentState build() {
            return new GetSettlementPaymentsChangePaymentState(
                href,
                type);
        }
    }
