...
public class CreateCustomerPaymentStatusReason {
     ...
     * A description of the status reason, localized according to the payment `locale`.
     */
    public CreateCustomerPaymentStatusReason withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerPaymentStatusReason other = (CreateCustomerPaymentStatusReason) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerPaymentStatusReason.class,
                "code", code,
                "message", message);
    }
    ...
    public final static class Builder {
        ...
        public CreateCustomerPaymentStatusReason build() {

            return new CreateCustomerPaymentStatusReason(
                code, message);
        }
