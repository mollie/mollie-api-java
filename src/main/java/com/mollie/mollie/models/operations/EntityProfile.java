...
public class EntityProfile {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("mode")
    private Optional<? extends GetWebhookEventEntityMode> mode;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    private Optional<? extends EntityStatus> status;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("review")
    private Optional<? extends EntityReview> review;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends GetWebhookEventEntityLinks> links;

    @JsonCreator
    public EntityProfile(
            @JsonProperty("resource") Optional<String> resource,
            @JsonProperty("id") Optional<String> id,
            @JsonProperty("mode") Optional<? extends GetWebhookEventEntityMode> mode,
            ...
            @JsonProperty("status") Optional<? extends EntityStatus> status,
            @JsonProperty("review") Optional<? extends EntityReview> review,
            @JsonProperty("createdAt") Optional<String> createdAt,
            @JsonProperty("_links") Optional<? extends GetWebhookEventEntityLinks> links) {
    ...
    @JsonIgnore
    public Optional<GetWebhookEventEntityMode> mode() {
        return (Optional<GetWebhookEventEntityMode>) mode;
    }
    ...
    public Optional<EntityStatus> status() {
        return (Optional<EntityStatus>) status;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<EntityReview> review() {
        return (Optional<EntityReview>) review;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<GetWebhookEventEntityLinks> links() {
        return (Optional<GetWebhookEventEntityLinks>) links;
    }
     ...
     * Indicates the response contains a profile object. Will always contain the string `profile` for this endpoint.
     */
    public EntityProfile withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
     ...
     * Indicates the response contains a profile object. Will always contain the string `profile` for this endpoint.
     */
    public EntityProfile withResource(Optional<String> resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this profile. Example: `pfl_v9hTwCvYqw`.
     */
    public EntityProfile withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The identifier uniquely referring to this profile. Example: `pfl_v9hTwCvYqw`.
     */
    public EntityProfile withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public EntityProfile withMode(GetWebhookEventEntityMode mode) {
        Utils.checkNotNull(mode, "mode");
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public EntityProfile withMode(Optional<? extends GetWebhookEventEntityMode> mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * * `blocked`: The profile is blocked and can no longer be used or changed.
     */
    public EntityProfile withStatus(EntityStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * * `blocked`: The profile is blocked and can no longer be used or changed.
     */
    public EntityProfile withStatus(Optional<? extends EntityStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * `null` in test mode.
     */
    public EntityProfile withReview(EntityReview review) {
        Utils.checkNotNull(review, "review");
     ...
     * `null` in test mode.
     */
    public EntityProfile withReview(Optional<? extends EntityReview> review) {
        Utils.checkNotNull(review, "review");
        this.review = review;
        return this;
    }
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public EntityProfile withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public EntityProfile withCreatedAt(Optional<String> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public EntityProfile withLinks(GetWebhookEventEntityLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public EntityProfile withLinks(Optional<? extends GetWebhookEventEntityLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetWebhookEventEntityMode> mode = Optional.empty();
        ...
        private Optional<? extends EntityStatus> status = Optional.empty();

        private Optional<? extends EntityReview> review = Optional.empty();

        private Optional<String> createdAt = Optional.empty();

        private Optional<? extends GetWebhookEventEntityLinks> links = Optional.empty();
         ...
         * Whether this entity was created in live mode or in test mode.
         */
        public Builder mode(GetWebhookEventEntityMode mode) {
            Utils.checkNotNull(mode, "mode");
            this.mode = Optional.ofNullable(mode);
            return this;
        }
         ...
         * Whether this entity was created in live mode or in test mode.
         */
        public Builder mode(Optional<? extends GetWebhookEventEntityMode> mode) {
            Utils.checkNotNull(mode, "mode");
            this.mode = mode;
            return this;
        }
         ...
         * * `blocked`: The profile is blocked and can no longer be used or changed.
         */
        public Builder status(Optional<? extends EntityStatus> status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * `null` in test mode.
         */
        public Builder review(EntityReview review) {
            Utils.checkNotNull(review, "review");
            this.review = Optional.ofNullable(review);
            return this;
        }
         ...
         * `null` in test mode.
         */
        public Builder review(Optional<? extends EntityReview> review) {
            Utils.checkNotNull(review, "review");
            this.review = review;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(GetWebhookEventEntityLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends GetWebhookEventEntityLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
