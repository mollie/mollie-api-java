...
public class ListPaymentsSettlementAmount {
    ...
    @JsonCreator
    public ListPaymentsSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListPaymentsSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListPaymentsSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentsSettlementAmount other = (ListPaymentsSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentsSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentsSettlementAmount build() {
            return new ListPaymentsSettlementAmount(
                currency,
                value);
        }
    }
