...
public class ListPaymentLinksApplicationFee {
    ...
    @JsonProperty("amount")
    private Optional<? extends ListPaymentLinksPaymentLinksAmount> amount;
    ...
    public ListPaymentLinksApplicationFee(
            @JsonProperty("amount") Optional<? extends ListPaymentLinksPaymentLinksAmount> amount,
    ...
    @JsonIgnore
    public Optional<ListPaymentLinksPaymentLinksAmount> amount() {
        return (Optional<ListPaymentLinksPaymentLinksAmount>) amount;
    }
     ...
     * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
     */
    public ListPaymentLinksApplicationFee withAmount(Optional<? extends ListPaymentLinksPaymentLinksAmount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The description of the application fee. This will appear on settlement reports towards both you and the connected merchant.
     */
    public ListPaymentLinksApplicationFee withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ListPaymentLinksPaymentLinksAmount> amount = Optional.empty();
         ...
         * <p>Be careful to leave enough space for Mollie's own fees to be deducted as well. For example, you cannot charge a €0.99 fee on a €1.00 payment.
         */
        public Builder amount(Optional<? extends ListPaymentLinksPaymentLinksAmount> amount) {
            Utils.checkNotNull(amount, "amount");
            this.amount = amount;
            return this;
        }
