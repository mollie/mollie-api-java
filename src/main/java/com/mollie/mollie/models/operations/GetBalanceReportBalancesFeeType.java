 ...
 */
public enum GetBalanceReportBalancesFeeType {
    ...
    GetBalanceReportBalancesFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetBalanceReportBalancesFeeType> fromValue(String value) {
        for (GetBalanceReportBalancesFeeType o: GetBalanceReportBalancesFeeType.values()) {
