...
public class GetSettlementPaymentsRequest {
     ...
     * Provide an ID to start the result set from the item with the given ID and onwards. This allows you to paginate the result set.
     */
    public GetSettlementPaymentsRequest withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * Provide an ID to start the result set from the item with the given ID and onwards. This allows you to paginate the result set.
     */
    public GetSettlementPaymentsRequest withFrom(Optional<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public GetSettlementPaymentsRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The maximum number of items to return. Defaults to 50 items.
     */
    public GetSettlementPaymentsRequest withLimit(JsonNullable<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * <p>Possible values: `asc` `desc` (default: `desc`)
     */
    public GetSettlementPaymentsRequest withSort(String sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * <p>Possible values: `asc` `desc` (default: `desc`)
     */
    public GetSettlementPaymentsRequest withSort(JsonNullable<String> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * <p>Most API credentials are linked to a single profile. In these cases the `profileId` can be omitted. For organization-level credentials such as OAuth access tokens however, the `profileId` parameter is required.
     */
    public GetSettlementPaymentsRequest withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
     ...
     * <p>Most API credentials are linked to a single profile. In these cases the `profileId` can be omitted. For organization-level credentials such as OAuth access tokens however, the `profileId` parameter is required.
     */
    public GetSettlementPaymentsRequest withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public GetSettlementPaymentsRequest withTestmode(boolean testmode) {
        Utils.checkNotNull(testmode, "testmode");
     ...
     * <p>Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa.
     */
    public GetSettlementPaymentsRequest withTestmode(JsonNullable<Boolean> testmode) {
        Utils.checkNotNull(testmode, "testmode");
        this.testmode = testmode;
        return this;
    }
