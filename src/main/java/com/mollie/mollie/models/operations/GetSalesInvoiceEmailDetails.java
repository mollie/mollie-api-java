...
public class GetSalesInvoiceEmailDetails {
    ...
    @JsonCreator
    public GetSalesInvoiceEmailDetails(
     ...
     * The subject of the email to be sent.
     */
    public GetSalesInvoiceEmailDetails withSubject(String subject) {
        Utils.checkNotNull(subject, "subject");
        this.subject = subject;
        return this;
    }
     ...
     * The body of the email to be sent. To add newline characters, you can use `\n`.
     */
    public GetSalesInvoiceEmailDetails withBody(String body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSalesInvoiceEmailDetails other = (GetSalesInvoiceEmailDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSalesInvoiceEmailDetails.class,
                "subject", subject,
                "body", body);
    }
