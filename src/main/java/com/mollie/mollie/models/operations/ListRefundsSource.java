...
public class ListRefundsSource {
     ...
     * Required for source type `organization`. The ID of the connected organization the funds should be pulled back from.
     */
    public ListRefundsSource withOrganizationId(String organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
     ...
     * Required for source type `organization`. The ID of the connected organization the funds should be pulled back from.
     */
    public ListRefundsSource withOrganizationId(Optional<String> organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = organizationId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListRefundsSource other = (ListRefundsSource) o;
        return 
