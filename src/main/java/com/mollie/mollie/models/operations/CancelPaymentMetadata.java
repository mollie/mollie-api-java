...
public class CancelPaymentMetadata {
    ...
    public static CancelPaymentMetadata of(Map<String, Object> value) {
        Utils.checkNotNull(value, "value");
        return new CancelPaymentMetadata(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Map<String, Object>>(){}));
    }
