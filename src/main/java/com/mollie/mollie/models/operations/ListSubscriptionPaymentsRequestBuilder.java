...
public class ListSubscriptionPaymentsRequestBuilder {
    ...
    public ListSubscriptionPaymentsResponse call() {
    ...
    * <pre><code>
    * for (ListSubscriptionPaymentsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListSubscriptionPaymentsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListSubscriptionPaymentsResponse> callAsStream() {
