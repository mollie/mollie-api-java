...
public enum ListSubscriptionsMethod {
    ...
    ListSubscriptionsMethod(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListSubscriptionsMethod> fromValue(String value) {
        for (ListSubscriptionsMethod o: ListSubscriptionsMethod.values()) {
