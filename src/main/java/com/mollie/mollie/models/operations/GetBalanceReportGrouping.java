...
/**
 * GetBalanceReportGrouping - You can retrieve reports in two different formats. With the `status-balances` format, transactions are grouped by
...
public enum GetBalanceReportGrouping {
    ...
    private GetBalanceReportGrouping(String value) {
        this.value = value;
    }
