...
public class ListRefundsRequestBuilder {
    ...
    public CompletableFuture<ListRefundsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListRefundsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListRefundsResponse&gt;() {
     ...
     */
    public Publisher<ListRefundsResponse> callAsPublisher() {
        ListRefundsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListRefundsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
