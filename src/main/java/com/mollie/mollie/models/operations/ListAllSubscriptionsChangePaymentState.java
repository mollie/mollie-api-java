...
public class ListAllSubscriptionsChangePaymentState {
    ...
    @JsonCreator
    public ListAllSubscriptionsChangePaymentState(
     ...
     * The actual URL string.
     */
    public ListAllSubscriptionsChangePaymentState withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public ListAllSubscriptionsChangePaymentState withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListAllSubscriptionsChangePaymentState withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public ListAllSubscriptionsChangePaymentState withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAllSubscriptionsChangePaymentState other = (ListAllSubscriptionsChangePaymentState) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAllSubscriptionsChangePaymentState.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public ListAllSubscriptionsChangePaymentState build() {
            return new ListAllSubscriptionsChangePaymentState(
                href,
                type);
        }
    }
