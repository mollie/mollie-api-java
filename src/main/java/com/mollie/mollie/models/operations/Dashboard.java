...
/**
 * Dashboard - Direct link to the organization's Mollie dashboard.
 */
...
public class Dashboard {
     ...
     * The actual URL string.
     */
    public Dashboard withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public Dashboard withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Dashboard withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Dashboard withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Dashboard.class,
                "href", href,
                "type", type);
    }
