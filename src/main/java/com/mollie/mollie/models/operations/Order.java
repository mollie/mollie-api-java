...
/**
 * Order - The API resource URL of the [order](get-order) that this shipment belongs to.
 */
...
public class Order {
     ...
     * The actual URL string.
     */
    public Order withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public Order withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
