 ...
 */
@JsonDeserialize(using = UpdateSubscriptionSubscriptionsMetadata._Deserializer.class)
public class UpdateSubscriptionSubscriptionsMetadata {

    @JsonValue
    private TypedObject value;
    
    private UpdateSubscriptionSubscriptionsMetadata(TypedObject value) {
        this.value = value;
    }

    public static UpdateSubscriptionSubscriptionsMetadata of(String value) {
    ...
    public static UpdateSubscriptionSubscriptionsMetadata of(List<String> value) {
        Utils.checkNotNull(value, "value");
        return new UpdateSubscriptionSubscriptionsMetadata(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<String>>(){}));
    }
    ...
    public static final class _Deserializer extends OneOfDeserializer<UpdateSubscriptionSubscriptionsMetadata> {
    ...
    public String toString() {
        return Utils.toString(UpdateSubscriptionSubscriptionsMetadata.class,
                "value", value);
    }
