 ...
 */
public class CreateSalesInvoiceEmailDetails {
    /**
    ...
    @JsonCreator
    public CreateSalesInvoiceEmailDetails(
     ...
     * The subject of the email to be sent.
     */
    public CreateSalesInvoiceEmailDetails withSubject(String subject) {
        Utils.checkNotNull(subject, "subject");
        this.subject = subject;
        return this;
    }
     ...
     * The body of the email to be sent. To add newline characters, you can use `\n`.
     */
    public CreateSalesInvoiceEmailDetails withBody(String body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CreateSalesInvoiceEmailDetails.class,
                "subject", subject,
                "body", body);
    }
    ...
    public final static class Builder {
        ...
        public CreateSalesInvoiceEmailDetails build() {

            return new CreateSalesInvoiceEmailDetails(
                subject, body);
        }
