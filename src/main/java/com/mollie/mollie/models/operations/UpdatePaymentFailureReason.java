...
public enum UpdatePaymentFailureReason {
    ...
    UpdatePaymentFailureReason(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdatePaymentFailureReason> fromValue(String value) {
        for (UpdatePaymentFailureReason o: UpdatePaymentFailureReason.values()) {
