...
public class ListClientsAddress {
     ...
     * A street and street number.
     */
    public ListClientsAddress withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
     ...
     * A street and street number.
     */
    public ListClientsAddress withStreetAndNumber(Optional<String> streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * A postal code. This field may be required if the provided country has a postal code system.
     */
    public ListClientsAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * A postal code. This field may be required if the provided country has a postal code system.
     */
    public ListClientsAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public ListClientsAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public ListClientsAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public ListClientsAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public ListClientsAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListClientsAddress other = (ListClientsAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListClientsAddress.class,
    ...
    public final static class Builder {
        ...
        public ListClientsAddress build() {

            return new ListClientsAddress(
                streetAndNumber, postalCode, city,
                country);
        }
