...
public enum ListCustomerPaymentsLocale {
    ...
    ListCustomerPaymentsLocale(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListCustomerPaymentsLocale> fromValue(String value) {
        for (ListCustomerPaymentsLocale o: ListCustomerPaymentsLocale.values()) {
