 ...
 *
 */
@JsonDeserialize(using = CapabilityStatus._Deserializer.class)
@JsonSerialize(using = CapabilityStatus._Serializer.class)
public class CapabilityStatus {

    public static final CapabilityStatus UNREQUESTED = new CapabilityStatus("unrequested");
    ...
    private static final Map<String, CapabilityStatus> createValuesMap() {
        ...
        map.put("unrequested", UNREQUESTED);
    ...
    private static final Map<String, CapabilityStatusEnum> createEnumsMap() {
        ...
        map.put("unrequested", CapabilityStatusEnum.UNREQUESTED);
    ...
    public static final class _Serializer extends StdSerializer<CapabilityStatus> {

        protected _Serializer() {
            super(CapabilityStatus.class);
        }

        @Override
        public void serialize(CapabilityStatus value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<CapabilityStatus> {
        ...
        @Override
        public CapabilityStatus deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return CapabilityStatus.of(v);
        }
    }
