...
public class ListPaymentResponseApplicationFee {
    ...
    @JsonCreator
    public ListPaymentResponseApplicationFee(
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseApplicationFee withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseApplicationFee withAmount(Optional<? extends Amount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * connected merchant.
     */
    public ListPaymentResponseApplicationFee withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * connected merchant.
     */
    public ListPaymentResponseApplicationFee withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentResponseApplicationFee other = (ListPaymentResponseApplicationFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentResponseApplicationFee.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public ListPaymentResponseApplicationFee build() {

            return new ListPaymentResponseApplicationFee(
                amount, description);
        }
