...
public class SubTotals2 {
    ...
    public SubTotals2 withSubTotals(List<SubTotals> subTotals) {
        Utils.checkNotNull(subTotals, "subTotals");
        this.subTotals = JsonNullable.of(subTotals);
        return this;
    }

    public SubTotals2 withSubTotals(JsonNullable<? extends List<SubTotals>> subTotals) {
        Utils.checkNotNull(subTotals, "subTotals");
        this.subTotals = subTotals;
        return this;
    }
     ...
     * Number of transactions of this type
     */
    public SubTotals2 withCount(long count) {
        Utils.checkNotNull(count, "count");
     ...
     * Number of transactions of this type
     */
    public SubTotals2 withCount(Optional<Long> count) {
        Utils.checkNotNull(count, "count");
        this.count = count;
        return this;
    }
     ...
     * The payment method, if applicable
     */
    public SubTotals2 withMethod(PaymentMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * The payment method, if applicable
     */
    public SubTotals2 withMethod(JsonNullable<? extends PaymentMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }

    public SubTotals2 withCardIssuer(BalanceCardIssuer cardIssuer) {
        Utils.checkNotNull(cardIssuer, "cardIssuer");
    ...
    public SubTotals2 withCardIssuer(Optional<? extends BalanceCardIssuer> cardIssuer) {
        Utils.checkNotNull(cardIssuer, "cardIssuer");
        this.cardIssuer = cardIssuer;
        return this;
    }

    public SubTotals2 withCardAudience(BalanceCardAudience cardAudience) {
        Utils.checkNotNull(cardAudience, "cardAudience");
    ...
    public SubTotals2 withCardAudience(Optional<? extends BalanceCardAudience> cardAudience) {
        Utils.checkNotNull(cardAudience, "cardAudience");
        this.cardAudience = cardAudience;
        return this;
    }

    public SubTotals2 withCardRegion(BalanceCardRegion cardRegion) {
        Utils.checkNotNull(cardRegion, "cardRegion");
    ...
    public SubTotals2 withCardRegion(Optional<? extends BalanceCardRegion> cardRegion) {
        Utils.checkNotNull(cardRegion, "cardRegion");
        this.cardRegion = cardRegion;
        return this;
    }

    public SubTotals2 withFeeType(BalanceFeeType feeType) {
        Utils.checkNotNull(feeType, "feeType");
    ...
    public SubTotals2 withFeeType(Optional<? extends BalanceFeeType> feeType) {
        Utils.checkNotNull(feeType, "feeType");
        this.feeType = feeType;
        return this;
    }

    public SubTotals2 withPrepaymentPartType(BalancePrepaymentPartType prepaymentPartType) {
        Utils.checkNotNull(prepaymentPartType, "prepaymentPartType");
    ...
    public SubTotals2 withPrepaymentPartType(Optional<? extends BalancePrepaymentPartType> prepaymentPartType) {
        Utils.checkNotNull(prepaymentPartType, "prepaymentPartType");
        this.prepaymentPartType = prepaymentPartType;
        return this;
    }

    public SubTotals2 withTransactionType(BalanceTransactionType transactionType) {
        Utils.checkNotNull(transactionType, "transactionType");
    ...
    public SubTotals2 withTransactionType(Optional<? extends BalanceTransactionType> transactionType) {
        Utils.checkNotNull(transactionType, "transactionType");
        this.transactionType = transactionType;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(SubTotals2.class,
                "subTotals", subTotals,
                "count", count,
                "method", method,
    ...
    public final static class Builder {
        ...
        public SubTotals2 build() {

            return new SubTotals2(
                subTotals, count, method,
                cardIssuer, cardAudience, cardRegion,
                feeType, prepaymentPartType, transactionType);
        }
