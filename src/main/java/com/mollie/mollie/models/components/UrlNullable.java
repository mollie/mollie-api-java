...
public class UrlNullable {
     ...
     * The actual URL string.
     */
    public UrlNullable withHref(String href) {
        Utils.checkNotNull(href, "href");
     ...
     * The actual URL string.
     */
    public UrlNullable withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UrlNullable withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The content type of the page or endpoint the URL points to.
     */
    public UrlNullable withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UrlNullable other = (UrlNullable) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UrlNullable.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public UrlNullable build() {

            return new UrlNullable(
                href, type);
        }
