...
public class ReversedPlatformPaymentChargeback {
    ...
    @JsonCreator
    public ReversedPlatformPaymentChargeback(
    ...
    public ReversedPlatformPaymentChargeback withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public ReversedPlatformPaymentChargeback withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public ReversedPlatformPaymentChargeback withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public ReversedPlatformPaymentChargeback withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public ReversedPlatformPaymentChargeback withChargebackId(String chargebackId) {
        Utils.checkNotNull(chargebackId, "chargebackId");
    ...
    public ReversedPlatformPaymentChargeback withChargebackId(Optional<String> chargebackId) {
        Utils.checkNotNull(chargebackId, "chargebackId");
        this.chargebackId = chargebackId;
        return this;
    }

    public ReversedPlatformPaymentChargeback withChargebackDescription(String chargebackDescription) {
        Utils.checkNotNull(chargebackDescription, "chargebackDescription");
    ...
    public ReversedPlatformPaymentChargeback withChargebackDescription(Optional<String> chargebackDescription) {
        Utils.checkNotNull(chargebackDescription, "chargebackDescription");
        this.chargebackDescription = chargebackDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReversedPlatformPaymentChargeback other = (ReversedPlatformPaymentChargeback) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReversedPlatformPaymentChargeback.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public ReversedPlatformPaymentChargeback build() {

            return new ReversedPlatformPaymentChargeback(
                paymentId, paymentDescription, chargebackId,
                chargebackDescription);
        }
