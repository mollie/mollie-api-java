...
public class MandateResponseDetails {
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public MandateResponseDetails withConsumerName(String consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
     ...
     * The customer's name. Available for SEPA Direct Debit and PayPal mandates.
     */
    public MandateResponseDetails withConsumerName(JsonNullable<String> consumerName) {
        Utils.checkNotNull(consumerName, "consumerName");
        this.consumerName = consumerName;
        return this;
    }
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public MandateResponseDetails withConsumerAccount(String consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
     ...
     * The customer's IBAN or email address. Available for SEPA Direct Debit and PayPal mandates.
     */
    public MandateResponseDetails withConsumerAccount(JsonNullable<String> consumerAccount) {
        Utils.checkNotNull(consumerAccount, "consumerAccount");
        this.consumerAccount = consumerAccount;
        return this;
    }
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public MandateResponseDetails withConsumerBic(String consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
     ...
     * The BIC of the customer's bank. Available for SEPA Direct Debit mandates.
     */
    public MandateResponseDetails withConsumerBic(JsonNullable<String> consumerBic) {
        Utils.checkNotNull(consumerBic, "consumerBic");
        this.consumerBic = consumerBic;
        return this;
    }
     ...
     * The card holder's name. Available for card mandates.
     */
    public MandateResponseDetails withCardHolder(String cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
     ...
     * The card holder's name. Available for card mandates.
     */
    public MandateResponseDetails withCardHolder(JsonNullable<String> cardHolder) {
        Utils.checkNotNull(cardHolder, "cardHolder");
        this.cardHolder = cardHolder;
        return this;
    }
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public MandateResponseDetails withCardNumber(String cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
     ...
     * The last four digits of the card number. Available for card mandates.
     */
    public MandateResponseDetails withCardNumber(JsonNullable<String> cardNumber) {
        Utils.checkNotNull(cardNumber, "cardNumber");
        this.cardNumber = cardNumber;
        return this;
    }
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public MandateResponseDetails withCardExpiryDate(String cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
     ...
     * The card's expiry date in `YYYY-MM-DD` format. Available for card mandates.
     */
    public MandateResponseDetails withCardExpiryDate(JsonNullable<String> cardExpiryDate) {
        Utils.checkNotNull(cardExpiryDate, "cardExpiryDate");
        this.cardExpiryDate = cardExpiryDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MandateResponseDetails other = (MandateResponseDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MandateResponseDetails.class,
    ...
    public final static class Builder {
        ...
        public MandateResponseDetails build() {

            return new MandateResponseDetails(
                consumerName, consumerAccount, consumerBic,
                cardHolder, cardNumber, cardExpiryDate,
                cardLabel, cardFingerprint);
        }
