...
public class PaymentResponseQrCode {
     ...
     * The height of the QR code image in pixels.
     */
    public PaymentResponseQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public PaymentResponseQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public PaymentResponseQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public PaymentResponseQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public PaymentResponseQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public PaymentResponseQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentResponseQrCode other = (PaymentResponseQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentResponseQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public PaymentResponseQrCode build() {

            return new PaymentResponseQrCode(
                height, width, src);
        }
