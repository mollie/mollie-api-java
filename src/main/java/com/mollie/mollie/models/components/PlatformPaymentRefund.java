...
public class PlatformPaymentRefund {
    ...
    public PlatformPaymentRefund withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public PlatformPaymentRefund withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }
    ...
    public PlatformPaymentRefund withRefundDescription(String refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
    ...
    public PlatformPaymentRefund withRefundDescription(Optional<String> refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
        this.refundDescription = refundDescription;
        return this;
    }
