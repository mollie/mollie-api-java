...
public class Payments {
    ...
    public Payments withPending(SubGroup pending) {
        Utils.checkNotNull(pending, "pending");
    ...
    public Payments withPending(Optional<? extends SubGroup> pending) {
        Utils.checkNotNull(pending, "pending");
        this.pending = pending;
        return this;
    }

    public Payments withMovedToAvailable(SubGroup movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
    ...
    public Payments withMovedToAvailable(Optional<? extends SubGroup> movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
        this.movedToAvailable = movedToAvailable;
        return this;
    }

    public Payments withImmediatelyAvailable(SubGroup immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
    ...
    public Payments withImmediatelyAvailable(Optional<? extends SubGroup> immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
        this.immediatelyAvailable = immediatelyAvailable;
        return this;
    }
