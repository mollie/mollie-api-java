...
public class ListSettlementPaymentResponse {
    ...
    private Optional<? extends ListSettlementPaymentResponseBillingAddress> billingAddress;
     ...
     */
    @JsonProperty("status")
    private SettlementPaymentStatus status;
    ...
    @JsonCreator
    public ListSettlementPaymentResponse(
            ...
            @JsonProperty("status") SettlementPaymentStatus status,
            ...
            @JsonProperty("_links") ListSettlementPaymentResponseLinks links,
    ...
    public ListSettlementPaymentResponse(
            ...
            String createdAt,
            ListSettlementPaymentResponseLinks links) {
        this(resource, id, mode,
            ...
            JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(),
            JsonNullable.undefined(), links, Optional.empty());
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListSettlementPaymentResponseBillingAddress> billingAddress() {
        return (Optional<ListSettlementPaymentResponseBillingAddress>) billingAddress;
    }
     ...
     */
    @JsonIgnore
    public SettlementPaymentStatus status() {
        return status;
    }
     ...
     */
    @JsonIgnore
    public ListSettlementPaymentResponseLinks links() {
        return links;
    }
     ...
     * endpoint.
     */
    public ListSettlementPaymentResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * will always refer to the payment by this ID. Example: `tr_5B8cwPMGnU6qLbRvo7qEZo`.
     */
    public ListSettlementPaymentResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode. Settlements are always in live mode.
     */
    public ListSettlementPaymentResponse withMode(SettlementMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * to fit.
     */
    public ListSettlementPaymentResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListSettlementPaymentResponse withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public ListSettlementPaymentResponse withRedirectUrl(String redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
     ...
     * Apple Pay payments with an `applePayPaymentToken`.
     */
    public ListSettlementPaymentResponse withRedirectUrl(JsonNullable<String> redirectUrl) {
        Utils.checkNotNull(redirectUrl, "redirectUrl");
        this.redirectUrl = redirectUrl;
        return this;
    }
     ...
     * payment cancellations.
     */
    public ListSettlementPaymentResponse withCancelUrl(String cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
     ...
     * payment cancellations.
     */
    public ListSettlementPaymentResponse withCancelUrl(JsonNullable<String> cancelUrl) {
        Utils.checkNotNull(cancelUrl, "cancelUrl");
        this.cancelUrl = cancelUrl;
        return this;
    }
     ...
     * local machine.
     */
    public ListSettlementPaymentResponse withWebhookUrl(String webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
     ...
     * local machine.
     */
    public ListSettlementPaymentResponse withWebhookUrl(JsonNullable<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public ListSettlementPaymentResponse withLines(List<Lines> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>Required for payment methods `billie`, `in3`, `klarna`, `riverty` and `voucher`.
     */
    public ListSettlementPaymentResponse withLines(JsonNullable<? extends List<Lines>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * <p>Required for payment method `alma`, `in3`, `klarna`, `billie` and `riverty`.
     */
    public ListSettlementPaymentResponse withBillingAddress(ListSettlementPaymentResponseBillingAddress billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
     ...
     * <p>Required for payment method `alma`, `in3`, `klarna`, `billie` and `riverty`.
     */
    public ListSettlementPaymentResponse withBillingAddress(Optional<? extends ListSettlementPaymentResponseBillingAddress> billingAddress) {
        Utils.checkNotNull(billingAddress, "billingAddress");
        this.billingAddress = billingAddress;
        return this;
    }
     ...
     * field is omitted if the country code was not detected.
     */
    public ListSettlementPaymentResponse withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
     ...
     * field is omitted if the country code was not detected.
     */
    public ListSettlementPaymentResponse withCountryCode(JsonNullable<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public ListSettlementPaymentResponse withRestrictPaymentMethodsToCountry(String restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
     ...
     * <p>The field expects a country code in ISO 3166-1 alpha-2 format, for example `NL`.
     */
    public ListSettlementPaymentResponse withRestrictPaymentMethodsToCountry(JsonNullable<String> restrictPaymentMethodsToCountry) {
        Utils.checkNotNull(restrictPaymentMethodsToCountry, "restrictPaymentMethodsToCountry");
        this.restrictPaymentMethodsToCountry = restrictPaymentMethodsToCountry;
        return this;
    }
     ...
     * approximately 1kB.
     */
    public ListSettlementPaymentResponse withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * approximately 1kB.
     */
    public ListSettlementPaymentResponse withMetadata(JsonNullable<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public ListSettlementPaymentResponse withCaptureMode(CaptureModeResponse captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
     ...
     * <p>This field needs to be set to `manual` for method `riverty`.
     */
    public ListSettlementPaymentResponse withCaptureMode(JsonNullable<? extends CaptureModeResponse> captureMode) {
        Utils.checkNotNull(captureMode, "captureMode");
        this.captureMode = captureMode;
        return this;
    }
     ...
     * <p>Possible values: `... hours` `... days`
     */
    public ListSettlementPaymentResponse withCaptureDelay(String captureDelay) {
        Utils.checkNotNull(captureDelay, "captureDelay");
     ...
     * <p>Possible values: `... hours` `... days`
     */
    public ListSettlementPaymentResponse withCaptureDelay(JsonNullable<String> captureDelay) {
        Utils.checkNotNull(captureDelay, "captureDelay");
        this.captureDelay = captureDelay;
        return this;
    }
     ...
     * authorized (yet).
     */
    public ListSettlementPaymentResponse withCaptureBefore(String captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
     ...
     * authorized (yet).
     */
    public ListSettlementPaymentResponse withCaptureBefore(JsonNullable<String> captureBefore) {
        Utils.checkNotNull(captureBefore, "captureBefore");
        this.captureBefore = captureBefore;
        return this;
    }
     ...
     * `routing` parameter.
     */
    public ListSettlementPaymentResponse withApplicationFee(ApplicationFee applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
     ...
     * `routing` parameter.
     */
    public ListSettlementPaymentResponse withApplicationFee(JsonNullable<? extends ApplicationFee> applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
        this.applicationFee = applicationFee;
        return this;
    }
     ...
     * parameter.
     */
    public ListSettlementPaymentResponse withRouting(List<EntityPaymentRouteResponse> routing) {
        Utils.checkNotNull(routing, "routing");
     ...
     * parameter.
     */
    public ListSettlementPaymentResponse withRouting(JsonNullable<? extends List<EntityPaymentRouteResponse>> routing) {
        Utils.checkNotNull(routing, "routing");
        this.routing = routing;
        return this;
    }

    public ListSettlementPaymentResponse withSequenceType(SequenceTypeResponse sequenceType) {
        Utils.checkNotNull(sequenceType, "sequenceType");
        this.sequenceType = sequenceType;
        return this;
    }
     ...
     * be added to the response.
     */
    public ListSettlementPaymentResponse withSubscriptionId(String subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
     ...
     * be added to the response.
     */
    public ListSettlementPaymentResponse withSubscriptionId(JsonNullable<String> subscriptionId) {
        Utils.checkNotNull(subscriptionId, "subscriptionId");
        this.subscriptionId = subscriptionId;
        return this;
    }
    ...
    public ListSettlementPaymentResponse withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
    ...
    public ListSettlementPaymentResponse withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * required.
     */
    public ListSettlementPaymentResponse withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public ListSettlementPaymentResponse withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * The identifier referring to the [settlement](get-settlement) this payment was settled with.
     */
    public ListSettlementPaymentResponse withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * response.
     */
    public ListSettlementPaymentResponse withOrderId(String orderId) {
        Utils.checkNotNull(orderId, "orderId");
     ...
     * response.
     */
    public ListSettlementPaymentResponse withOrderId(JsonNullable<String> orderId) {
        Utils.checkNotNull(orderId, "orderId");
        this.orderId = orderId;
        return this;
    }
     ...
     * The payment's status. Settlement payments always have a status of `paid`.
     */
    public ListSettlementPaymentResponse withStatus(SettlementPaymentStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * [this page](status-reasons).**
     */
    public ListSettlementPaymentResponse withStatusReason(StatusReason statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
     ...
     * [this page](status-reasons).**
     */
    public ListSettlementPaymentResponse withStatusReason(JsonNullable<? extends StatusReason> statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
        this.statusReason = statusReason;
        return this;
    }
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public ListSettlementPaymentResponse withIsCancelable(boolean isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
     ...
     * Whether the payment can be canceled. This parameter is omitted if the payment reaches a final state.
     */
    public ListSettlementPaymentResponse withIsCancelable(JsonNullable<Boolean> isCancelable) {
        Utils.checkNotNull(isCancelable, "isCancelable");
        this.isCancelable = isCancelable;
        return this;
    }
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public ListSettlementPaymentResponse withDetails(PaymentDetails details) {
        Utils.checkNotNull(details, "details");
     ...
     * [method-specific parameters](extra-payment-parameters) guide.
     */
    public ListSettlementPaymentResponse withDetails(JsonNullable<? extends PaymentDetails> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * format.
     */
    public ListSettlementPaymentResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * not authorized (yet).
     */
    public ListSettlementPaymentResponse withAuthorizedAt(String authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
     ...
     * not authorized (yet).
     */
    public ListSettlementPaymentResponse withAuthorizedAt(JsonNullable<String> authorizedAt) {
        Utils.checkNotNull(authorizedAt, "authorizedAt");
        this.authorizedAt = authorizedAt;
        return this;
    }
     ...
     * completed (yet).
     */
    public ListSettlementPaymentResponse withPaidAt(String paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
     ...
     * completed (yet).
     */
    public ListSettlementPaymentResponse withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * canceled (yet).
     */
    public ListSettlementPaymentResponse withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * canceled (yet).
     */
    public ListSettlementPaymentResponse withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * longer expire.
     */
    public ListSettlementPaymentResponse withExpiresAt(String expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * longer expire.
     */
    public ListSettlementPaymentResponse withExpiresAt(JsonNullable<String> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * expire (yet).
     */
    public ListSettlementPaymentResponse withExpiredAt(String expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
     ...
     * expire (yet).
     */
    public ListSettlementPaymentResponse withExpiredAt(JsonNullable<String> expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
        this.expiredAt = expiredAt;
        return this;
    }
     ...
     * (yet).
     */
    public ListSettlementPaymentResponse withFailedAt(String failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
     ...
     * (yet).
     */
    public ListSettlementPaymentResponse withFailedAt(JsonNullable<String> failedAt) {
        Utils.checkNotNull(failedAt, "failedAt");
        this.failedAt = failedAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListSettlementPaymentResponse withLinks(ListSettlementPaymentResponseLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementPaymentResponse other = (ListSettlementPaymentResponse) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            failedAt, links, settlementAmount);
    }
    
    @Override
    public String toString() {
        return Utils.toString(ListSettlementPaymentResponse.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
         ...
         * <p>Required for payment method `alma`, `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(ListSettlementPaymentResponseBillingAddress billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = Optional.ofNullable(billingAddress);
            return this;
        }
         ...
         * <p>Required for payment method `alma`, `in3`, `klarna`, `billie` and `riverty`.
         */
        public Builder billingAddress(Optional<? extends ListSettlementPaymentResponseBillingAddress> billingAddress) {
            Utils.checkNotNull(billingAddress, "billingAddress");
            this.billingAddress = billingAddress;
            return this;
        }
         ...
         * The payment's status. Settlement payments always have a status of `paid`.
         */
        public Builder status(SettlementPaymentStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListSettlementPaymentResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        public ListSettlementPaymentResponse build() {

            return new ListSettlementPaymentResponse(
                resource, id, mode,
                description, amount, amountRefunded,
                amountRemaining, amountCaptured, amountChargedBack,
                redirectUrl, cancelUrl, webhookUrl,
