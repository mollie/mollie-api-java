...
public class UnauthorizedDirectDebit {
    ...
    @JsonCreator
    public UnauthorizedDirectDebit(
    ...
    public UnauthorizedDirectDebit withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public UnauthorizedDirectDebit withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public UnauthorizedDirectDebit withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public UnauthorizedDirectDebit withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UnauthorizedDirectDebit other = (UnauthorizedDirectDebit) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UnauthorizedDirectDebit.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public UnauthorizedDirectDebit build() {

            return new UnauthorizedDirectDebit(
                paymentId, paymentDescription);
        }
