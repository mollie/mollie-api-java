...
public class FeePrepayments {
    ...
    public FeePrepayments withPending(SubGroup pending) {
        Utils.checkNotNull(pending, "pending");
    ...
    public FeePrepayments withPending(Optional<? extends SubGroup> pending) {
        Utils.checkNotNull(pending, "pending");
        this.pending = pending;
        return this;
    }

    public FeePrepayments withMovedToAvailable(SubGroup movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
    ...
    public FeePrepayments withMovedToAvailable(Optional<? extends SubGroup> movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
        this.movedToAvailable = movedToAvailable;
        return this;
    }

    public FeePrepayments withImmediatelyAvailable(SubGroup immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
    ...
    public FeePrepayments withImmediatelyAvailable(Optional<? extends SubGroup> immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
        this.immediatelyAvailable = immediatelyAvailable;
        return this;
    }
