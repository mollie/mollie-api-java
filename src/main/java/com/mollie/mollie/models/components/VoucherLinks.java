...
public class VoucherLinks {
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public VoucherLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public VoucherLinks withSelf(Optional<? extends Url> self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public VoucherLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public VoucherLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VoucherLinks other = (VoucherLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VoucherLinks.class,
                "self", self,
    ...
    public final static class Builder {
        ...
        public VoucherLinks build() {

            return new VoucherLinks(
                self, documentation);
        }
