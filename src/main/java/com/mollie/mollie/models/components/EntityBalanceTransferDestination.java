...
public class EntityBalanceTransferDestination {
    ...
    @JsonCreator
    public EntityBalanceTransferDestination(
     ...
     * <p>* `bank-account` — Transfer the balance amount to an external bank account
     */
    public EntityBalanceTransferDestination withType(BalanceTransferDestinationType type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>* `bank-account` — Transfer the balance amount to an external bank account
     */
    public EntityBalanceTransferDestination withType(Optional<? extends BalanceTransferDestinationType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The configured bank account number of the beneficiary the balance amount is to be transferred to.
     */
    public EntityBalanceTransferDestination withBankAccount(String bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
     ...
     * The configured bank account number of the beneficiary the balance amount is to be transferred to.
     */
    public EntityBalanceTransferDestination withBankAccount(Optional<String> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * The full name of the beneficiary the balance amount is to be transferred to.
     */
    public EntityBalanceTransferDestination withBeneficiaryName(String beneficiaryName) {
        Utils.checkNotNull(beneficiaryName, "beneficiaryName");
     ...
     * The full name of the beneficiary the balance amount is to be transferred to.
     */
    public EntityBalanceTransferDestination withBeneficiaryName(Optional<String> beneficiaryName) {
        Utils.checkNotNull(beneficiaryName, "beneficiaryName");
        this.beneficiaryName = beneficiaryName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityBalanceTransferDestination other = (EntityBalanceTransferDestination) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityBalanceTransferDestination.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        public EntityBalanceTransferDestination build() {

            return new EntityBalanceTransferDestination(
                type, bankAccount, beneficiaryName);
        }
