...
public enum ComponentsSubTotalsTransactionType {
    ...
    ComponentsSubTotalsTransactionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ComponentsSubTotalsTransactionType> fromValue(String value) {
        for (ComponentsSubTotalsTransactionType o: ComponentsSubTotalsTransactionType.values()) {
