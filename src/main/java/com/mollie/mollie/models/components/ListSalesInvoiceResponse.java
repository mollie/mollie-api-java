...
public class ListSalesInvoiceResponse {
    ...
    private JsonNullable<? extends ListSalesInvoiceResponseMetadata> metadata;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListSalesInvoiceResponseLinks> links;

    @JsonCreator
    public ListSalesInvoiceResponse(
            ...
            @JsonProperty("metadata") JsonNullable<? extends ListSalesInvoiceResponseMetadata> metadata,
            ...
            @JsonProperty("totalVatAmount") Optional<? extends ListSalesInvoiceResponseTotalVatAmount> totalVatAmount,
            @JsonProperty("discountedSubtotalAmount") Optional<? extends ListSalesInvoiceResponseDiscountedSubtotalAmount> discountedSubtotalAmount,
            ...
            @JsonProperty("_links") Optional<? extends ListSalesInvoiceResponseLinks> links) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<ListSalesInvoiceResponseMetadata> metadata() {
        return (JsonNullable<ListSalesInvoiceResponseMetadata>) metadata;
    }
    ...
    public Optional<ListSalesInvoiceResponseDiscountedSubtotalAmount> discountedSubtotalAmount() {
        return (Optional<ListSalesInvoiceResponseDiscountedSubtotalAmount>) discountedSubtotalAmount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListSalesInvoiceResponseLinks> links() {
        return (Optional<ListSalesInvoiceResponseLinks>) links;
    }
     ...
     * endpoint.
     */
    public ListSalesInvoiceResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this invoice. Example: `invoice_4Y0eZitmBnQ6IDoMqZQKh`.
     */
    public ListSalesInvoiceResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public ListSalesInvoiceResponse withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * When issued, an invoice number will be set for the sales invoice.
     */
    public ListSalesInvoiceResponse withInvoiceNumber(String invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
     ...
     * When issued, an invoice number will be set for the sales invoice.
     */
    public ListSalesInvoiceResponse withInvoiceNumber(JsonNullable<String> invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
        this.invoiceNumber = invoiceNumber;
        return this;
    }
     ...
     * required.
     */
    public ListSalesInvoiceResponse withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
     ...
     * required.
     */
    public ListSalesInvoiceResponse withProfileId(JsonNullable<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * - `emailDetails` optional for `issued` and `paid` to send the invoice by email
     */
    public ListSalesInvoiceResponse withStatus(SalesInvoiceStatusResponse status) {
        Utils.checkNotNull(status, "status");
     ...
     * - `emailDetails` optional for `issued` and `paid` to send the invoice by email
     */
    public ListSalesInvoiceResponse withStatus(Optional<? extends SalesInvoiceStatusResponse> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The VAT scheme to create the invoice for. You must be enrolled with One Stop Shop enabled to use it.
     */
    public ListSalesInvoiceResponse withVatScheme(SalesInvoiceVatSchemeResponse vatScheme) {
        Utils.checkNotNull(vatScheme, "vatScheme");
     ...
     * The VAT scheme to create the invoice for. You must be enrolled with One Stop Shop enabled to use it.
     */
    public ListSalesInvoiceResponse withVatScheme(Optional<? extends SalesInvoiceVatSchemeResponse> vatScheme) {
        Utils.checkNotNull(vatScheme, "vatScheme");
        this.vatScheme = vatScheme;
        return this;
    }
     ...
     * apply.
     */
    public ListSalesInvoiceResponse withVatMode(SalesInvoiceVatModeResponse vatMode) {
        Utils.checkNotNull(vatMode, "vatMode");
     ...
     * apply.
     */
    public ListSalesInvoiceResponse withVatMode(Optional<? extends SalesInvoiceVatModeResponse> vatMode) {
        Utils.checkNotNull(vatMode, "vatMode");
        this.vatMode = vatMode;
        return this;
    }
     ...
     * A free-form memo you can set on the invoice, and will be shown on the invoice PDF.
     */
    public ListSalesInvoiceResponse withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * A free-form memo you can set on the invoice, and will be shown on the invoice PDF.
     */
    public ListSalesInvoiceResponse withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }
     ...
     * approximately 1kB.
     */
    public ListSalesInvoiceResponse withMetadata(ListSalesInvoiceResponseMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * approximately 1kB.
     */
    public ListSalesInvoiceResponse withMetadata(JsonNullable<? extends ListSalesInvoiceResponseMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The payment term to be set on the invoice.
     */
    public ListSalesInvoiceResponse withPaymentTerm(SalesInvoicePaymentTermResponse paymentTerm) {
        Utils.checkNotNull(paymentTerm, "paymentTerm");
     ...
     * The payment term to be set on the invoice.
     */
    public ListSalesInvoiceResponse withPaymentTerm(JsonNullable<? extends SalesInvoicePaymentTermResponse> paymentTerm) {
        Utils.checkNotNull(paymentTerm, "paymentTerm");
        this.paymentTerm = paymentTerm;
        return this;
    }
    ...
    public ListSalesInvoiceResponse withEmailDetails(SalesInvoiceEmailDetails emailDetails) {
        Utils.checkNotNull(emailDetails, "emailDetails");
        this.emailDetails = JsonNullable.of(emailDetails);
        return this;
    }

    public ListSalesInvoiceResponse withEmailDetails(JsonNullable<? extends SalesInvoiceEmailDetails> emailDetails) {
        Utils.checkNotNull(emailDetails, "emailDetails");
        this.emailDetails = emailDetails;
        return this;
    }
     ...
     * provided, `mandateId` becomes required as well. Only allowed for invoices with status `paid`.
     */
    public ListSalesInvoiceResponse withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * provided, `mandateId` becomes required as well. Only allowed for invoices with status `paid`.
     */
    public ListSalesInvoiceResponse withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * `customerId` becomes required as well. Only allowed for invoices with status `paid`.
     */
    public ListSalesInvoiceResponse withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
     ...
     * `customerId` becomes required as well. Only allowed for invoices with status `paid`.
     */
    public ListSalesInvoiceResponse withMandateId(Optional<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * is not required to send a first invoice to a recipient.
     */
    public ListSalesInvoiceResponse withRecipientIdentifier(String recipientIdentifier) {
        Utils.checkNotNull(recipientIdentifier, "recipientIdentifier");
     ...
     * is not required to send a first invoice to a recipient.
     */
    public ListSalesInvoiceResponse withRecipientIdentifier(Optional<String> recipientIdentifier) {
        Utils.checkNotNull(recipientIdentifier, "recipientIdentifier");
        this.recipientIdentifier = recipientIdentifier;
        return this;
    }

    public ListSalesInvoiceResponse withRecipient(SalesInvoiceRecipientResponse recipient) {
        Utils.checkNotNull(recipient, "recipient");
        this.recipient = JsonNullable.of(recipient);
        return this;
    }

    public ListSalesInvoiceResponse withRecipient(JsonNullable<? extends SalesInvoiceRecipientResponse> recipient) {
        Utils.checkNotNull(recipient, "recipient");
        this.recipient = recipient;
        return this;
    }
     ...
     * <p>All lines must have the same currency as the invoice.
     */
    public ListSalesInvoiceResponse withLines(List<SalesInvoiceLineItemResponse> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * <p>All lines must have the same currency as the invoice.
     */
    public ListSalesInvoiceResponse withLines(JsonNullable<? extends List<SalesInvoiceLineItemResponse>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }

    public ListSalesInvoiceResponse withDiscount(SalesInvoiceDiscountResponse discount) {
        Utils.checkNotNull(discount, "discount");
        this.discount = JsonNullable.of(discount);
        return this;
    }

    public ListSalesInvoiceResponse withDiscount(JsonNullable<? extends SalesInvoiceDiscountResponse> discount) {
        Utils.checkNotNull(discount, "discount");
        this.discount = discount;
        return this;
    }
     ...
     * format.
     */
    public ListSalesInvoiceResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * format.
     */
    public ListSalesInvoiceResponse withCreatedAt(Optional<String> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * format.
     */
    public ListSalesInvoiceResponse withIssuedAt(String issuedAt) {
        Utils.checkNotNull(issuedAt, "issuedAt");
     ...
     * format.
     */
    public ListSalesInvoiceResponse withIssuedAt(JsonNullable<String> issuedAt) {
        Utils.checkNotNull(issuedAt, "issuedAt");
        this.issuedAt = issuedAt;
        return this;
    }
     ...
     * format.
     */
    public ListSalesInvoiceResponse withPaidAt(String paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
     ...
     * format.
     */
    public ListSalesInvoiceResponse withPaidAt(JsonNullable<String> paidAt) {
        Utils.checkNotNull(paidAt, "paidAt");
        this.paidAt = paidAt;
        return this;
    }
     ...
     * format.
     */
    public ListSalesInvoiceResponse withDueAt(String dueAt) {
        Utils.checkNotNull(dueAt, "dueAt");
     ...
     * format.
     */
    public ListSalesInvoiceResponse withDueAt(JsonNullable<String> dueAt) {
        Utils.checkNotNull(dueAt, "dueAt");
        this.dueAt = dueAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListSalesInvoiceResponse withLinks(ListSalesInvoiceResponseLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListSalesInvoiceResponse withLinks(Optional<? extends ListSalesInvoiceResponseLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSalesInvoiceResponse other = (ListSalesInvoiceResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSalesInvoiceResponse.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListSalesInvoiceResponseMetadata> metadata = JsonNullable.undefined();
        ...
        private Optional<? extends ListSalesInvoiceResponseSubtotalAmount> subtotalAmount = Optional.empty();

        private Optional<? extends ListSalesInvoiceResponseTotalAmount> totalAmount = Optional.empty();

        private Optional<? extends ListSalesInvoiceResponseTotalVatAmount> totalVatAmount = Optional.empty();

        private Optional<? extends ListSalesInvoiceResponseDiscountedSubtotalAmount> discountedSubtotalAmount = Optional.empty();
        ...
        private Optional<? extends ListSalesInvoiceResponseLinks> links = Optional.empty();
         ...
         * approximately 1kB.
         */
        public Builder metadata(ListSalesInvoiceResponseMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = JsonNullable.of(metadata);
            return this;
        }
         ...
         * approximately 1kB.
         */
        public Builder metadata(JsonNullable<? extends ListSalesInvoiceResponseMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListSalesInvoiceResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends ListSalesInvoiceResponseLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }

        public ListSalesInvoiceResponse build() {

            return new ListSalesInvoiceResponse(
                resource, id, mode,
                invoiceNumber, profileId, status,
                vatScheme, vatMode, memo,
                metadata, paymentTerm, paymentDetails,
