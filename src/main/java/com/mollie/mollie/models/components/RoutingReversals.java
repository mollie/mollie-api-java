...
public class RoutingReversals {
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public RoutingReversals withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public RoutingReversals withAmount(Optional<? extends Amount> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * Where the funds will be pulled back from.
     */
    public RoutingReversals withSource(RefundRequestSource source) {
        Utils.checkNotNull(source, "source");
     ...
     * Where the funds will be pulled back from.
     */
    public RoutingReversals withSource(Optional<? extends RefundRequestSource> source) {
        Utils.checkNotNull(source, "source");
        this.source = source;
        return this;
    }
