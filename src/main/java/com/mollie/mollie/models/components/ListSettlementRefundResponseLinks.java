...
public class ListSettlementRefundResponseLinks {
    ...
    @JsonCreator
    public ListSettlementRefundResponseLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementRefundResponseLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementRefundResponseLinks withPayment(Url payment) {
        Utils.checkNotNull(payment, "payment");
        this.payment = payment;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementRefundResponseLinks withSettlement(UrlNullable settlement) {
        Utils.checkNotNull(settlement, "settlement");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementRefundResponseLinks withSettlement(JsonNullable<? extends UrlNullable> settlement) {
        Utils.checkNotNull(settlement, "settlement");
        this.settlement = settlement;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementRefundResponseLinks other = (ListSettlementRefundResponseLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementRefundResponseLinks.class,
                "self", self,
                "payment", payment,
    ...
    public final static class Builder {
        ...
        public ListSettlementRefundResponseLinks build() {

            return new ListSettlementRefundResponseLinks(
                self, payment, settlement);
        }
