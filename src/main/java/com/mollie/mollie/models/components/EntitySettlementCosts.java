...
public class EntitySettlementCosts {
    /**
     ...
     */
    @JsonProperty("rate")
    private EntitySettlementRate rate;
    ...
    @JsonCreator
    public EntitySettlementCosts(
            @JsonProperty("description") String description,
            @JsonProperty("method") Optional<? extends PaymentMethod> method,
            @JsonProperty("count") long count,
            @JsonProperty("rate") EntitySettlementRate rate,
     ...
     */
    @JsonIgnore
    public EntitySettlementRate rate() {
        return rate;
    }
     ...
     * A description of the cost subtotal
     */
    public EntitySettlementCosts withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The payment method, if applicable
     */
    public EntitySettlementCosts withMethod(PaymentMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * The payment method, if applicable
     */
    public EntitySettlementCosts withMethod(Optional<? extends PaymentMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * The number of fees
     */
    public EntitySettlementCosts withCount(long count) {
        Utils.checkNotNull(count, "count");
        this.count = count;
        return this;
    }
     ...
     * The service rates, further divided into `fixed` and `percentage` costs.
     */
    public EntitySettlementCosts withRate(EntitySettlementRate rate) {
        Utils.checkNotNull(rate, "rate");
        this.rate = rate;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementCosts withAmountNet(Amount amountNet) {
        Utils.checkNotNull(amountNet, "amountNet");
        this.amountNet = amountNet;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementCosts withAmountVat(AmountNullable amountVat) {
        Utils.checkNotNull(amountVat, "amountVat");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementCosts withAmountVat(Optional<? extends AmountNullable> amountVat) {
        Utils.checkNotNull(amountVat, "amountVat");
        this.amountVat = amountVat;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementCosts withAmountGross(Amount amountGross) {
        Utils.checkNotNull(amountGross, "amountGross");
        this.amountGross = amountGross;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntitySettlementCosts other = (EntitySettlementCosts) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntitySettlementCosts.class,
    ...
    public final static class Builder {
         ...
         * The service rates, further divided into `fixed` and `percentage` costs.
         */
        public Builder rate(EntitySettlementRate rate) {
            Utils.checkNotNull(rate, "rate");
            this.rate = rate;
            return this;
        }
        ...
        public EntitySettlementCosts build() {

            return new EntitySettlementCosts(
                description, method, count,
                rate, amountNet, amountVat,
                amountGross);
        }
