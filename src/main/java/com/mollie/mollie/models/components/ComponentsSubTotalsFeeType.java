...
public enum ComponentsSubTotalsFeeType {
    ...
    ComponentsSubTotalsFeeType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ComponentsSubTotalsFeeType> fromValue(String value) {
        for (ComponentsSubTotalsFeeType o: ComponentsSubTotalsFeeType.values()) {
