...
public class RefundCompensation {
    ...
    public RefundCompensation withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public RefundCompensation withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public RefundCompensation withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public RefundCompensation withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public RefundCompensation withRefundId(String refundId) {
        Utils.checkNotNull(refundId, "refundId");
    ...
    public RefundCompensation withRefundId(Optional<String> refundId) {
        Utils.checkNotNull(refundId, "refundId");
        this.refundId = refundId;
        return this;
    }

    public RefundCompensation withRefundDescription(String refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
    ...
    public RefundCompensation withRefundDescription(Optional<String> refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
        this.refundDescription = refundDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefundCompensation other = (RefundCompensation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RefundCompensation.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public RefundCompensation build() {

            return new RefundCompensation(
                paymentId, paymentDescription, refundId,
                refundDescription);
        }
