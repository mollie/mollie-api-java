...
public class ListSettlementCaptureResponse {
    ...
    public ListSettlementCaptureResponse(
            ...
            String id,
            SettlementMode mode,
            SettlementCaptureStatus status,
            String paymentId,
            String createdAt,
     ...
     */
    @JsonIgnore
    public SettlementCaptureStatus status() {
        return status;
    }
     ...
     * endpoint.
     */
    public ListSettlementCaptureResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this capture. Example: `cpt_mNepDkEtco6ah3QNPUGYH`.
     */
    public ListSettlementCaptureResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode. Settlements are always in live mode.
     */
    public ListSettlementCaptureResponse withMode(SettlementMode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * The description of the capture.
     */
    public ListSettlementCaptureResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * The description of the capture.
     */
    public ListSettlementCaptureResponse withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListSettlementCaptureResponse withAmount(AmountNullable amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The capture's status. Settlement captures always have a status of `succeeded`.
     */
    public ListSettlementCaptureResponse withStatus(SettlementCaptureStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * approximately 1kB.
     */
    public ListSettlementCaptureResponse withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * approximately 1kB.
     */
    public ListSettlementCaptureResponse withMetadata(JsonNullable<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The full payment object can be retrieved via the payment URL in the `_links` object.
     */
    public ListSettlementCaptureResponse withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }
     ...
     * `shp_gNapNy9qQTUFZYnCrCF7J`.
     */
    public ListSettlementCaptureResponse withShipmentId(String shipmentId) {
        Utils.checkNotNull(shipmentId, "shipmentId");
     ...
     * `shp_gNapNy9qQTUFZYnCrCF7J`.
     */
    public ListSettlementCaptureResponse withShipmentId(JsonNullable<String> shipmentId) {
        Utils.checkNotNull(shipmentId, "shipmentId");
        this.shipmentId = shipmentId;
        return this;
    }
     ...
     * is omitted if the capture is not settled (yet).
     */
    public ListSettlementCaptureResponse withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * is omitted if the capture is not settled (yet).
     */
    public ListSettlementCaptureResponse withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * format.
     */
    public ListSettlementCaptureResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListSettlementCaptureResponse withLinks(ListSettlementCaptureResponseLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementCaptureResponse other = (ListSettlementCaptureResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementCaptureResponse.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
         ...
         * The capture's status. Settlement captures always have a status of `succeeded`.
         */
        public Builder status(SettlementCaptureStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListSettlementCaptureResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
