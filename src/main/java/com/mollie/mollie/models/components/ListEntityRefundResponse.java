...
public class ListEntityRefundResponse {
    ...
    private JsonNullable<? extends ListEntityRefundResponseSettlementAmount> settlementAmount;
    ...
    @JsonProperty("status")
    private ListEntityRefundResponseStatus status;
    ...
    private JsonNullable<? extends List<ListEntityRefundResponseRoutingReversals>> routingReversals;

    /**
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    @JsonProperty("_links")
    private ListEntityRefundResponseLinks links;

    @JsonCreator
    public ListEntityRefundResponse(
            @JsonProperty("resource") String resource,
            @JsonProperty("id") String id,
            @JsonProperty("mode") Mode mode,
            @JsonProperty("description") String description,
            @JsonProperty("amount") Amount amount,
            @JsonProperty("settlementAmount") JsonNullable<? extends ListEntityRefundResponseSettlementAmount> settlementAmount,
            @JsonProperty("metadata") Optional<? extends Metadata> metadata,
            @JsonProperty("paymentId") Optional<String> paymentId,
            @JsonProperty("settlementId") JsonNullable<String> settlementId,
            @JsonProperty("status") ListEntityRefundResponseStatus status,
            @JsonProperty("createdAt") String createdAt,
            @JsonProperty("externalReference") Optional<? extends ExternalReference> externalReference,
            @JsonProperty("routingReversals") JsonNullable<? extends List<ListEntityRefundResponseRoutingReversals>> routingReversals,
            @JsonProperty("_links") ListEntityRefundResponseLinks links) {
    ...
    public ListEntityRefundResponse(
            ...
            String description,
            Amount amount,
            ListEntityRefundResponseStatus status,
            String createdAt,
            ListEntityRefundResponseLinks links) {
    ...
    @JsonIgnore
    public JsonNullable<ListEntityRefundResponseSettlementAmount> settlementAmount() {
        return (JsonNullable<ListEntityRefundResponseSettlementAmount>) settlementAmount;
    }
    ...
    @JsonIgnore
    public ListEntityRefundResponseStatus status() {
        return status;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<ListEntityRefundResponseRoutingReversals>> routingReversals() {
        return (JsonNullable<List<ListEntityRefundResponseRoutingReversals>>) routingReversals;
    }
     ...
     */
    @JsonIgnore
    public ListEntityRefundResponseLinks links() {
        return links;
    }
     ...
     * endpoint.
     */
    public ListEntityRefundResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * will always refer to the refund by this ID. Example: `re_4qqhO89gsT`.
     */
    public ListEntityRefundResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public ListEntityRefundResponse withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * used.
     */
    public ListEntityRefundResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListEntityRefundResponse withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * [List balance transactions endpoint](list-balance-transactions) instead.
     */
    public ListEntityRefundResponse withSettlementAmount(ListEntityRefundResponseSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * [List balance transactions endpoint](list-balance-transactions) instead.
     */
    public ListEntityRefundResponse withSettlementAmount(JsonNullable<? extends ListEntityRefundResponseSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * approximately 1kB.
     */
    public ListEntityRefundResponse withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * approximately 1kB.
     */
    public ListEntityRefundResponse withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The full payment object can be retrieved via the payment URL in the `_links` object.
     */
    public ListEntityRefundResponse withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
     ...
     * The full payment object can be retrieved via the payment URL in the `_links` object.
     */
    public ListEntityRefundResponse withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }
     ...
     * the refund is not settled (yet).
     */
    public ListEntityRefundResponse withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * the refund is not settled (yet).
     */
    public ListEntityRefundResponse withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }

    public ListEntityRefundResponse withStatus(ListEntityRefundResponseStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * format.
     */
    public ListEntityRefundResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }

    public ListEntityRefundResponse withExternalReference(ExternalReference externalReference) {
        Utils.checkNotNull(externalReference, "externalReference");
    ...
    public ListEntityRefundResponse withExternalReference(Optional<? extends ExternalReference> externalReference) {
        Utils.checkNotNull(externalReference, "externalReference");
        this.externalReference = externalReference;
        return this;
    }
     ...
     * parameter instead.
     */
    public ListEntityRefundResponse withRoutingReversals(List<ListEntityRefundResponseRoutingReversals> routingReversals) {
        Utils.checkNotNull(routingReversals, "routingReversals");
     ...
     * parameter instead.
     */
    public ListEntityRefundResponse withRoutingReversals(JsonNullable<? extends List<ListEntityRefundResponseRoutingReversals>> routingReversals) {
        Utils.checkNotNull(routingReversals, "routingReversals");
        this.routingReversals = routingReversals;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListEntityRefundResponse withLinks(ListEntityRefundResponseLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEntityRefundResponse other = (ListEntityRefundResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListEntityRefundResponse.class,
                "resource", resource,
                "id", id,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListEntityRefundResponseSettlementAmount> settlementAmount = JsonNullable.undefined();
        ...
        private JsonNullable<? extends List<ListEntityRefundResponseRoutingReversals>> routingReversals = JsonNullable.undefined();
         ...
         * [List balance transactions endpoint](list-balance-transactions) instead.
         */
        public Builder settlementAmount(ListEntityRefundResponseSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = JsonNullable.of(settlementAmount);
            return this;
        }
         ...
         * [List balance transactions endpoint](list-balance-transactions) instead.
         */
        public Builder settlementAmount(JsonNullable<? extends ListEntityRefundResponseSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
        ...
        public Builder status(ListEntityRefundResponseStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * parameter instead.
         */
        public Builder routingReversals(List<ListEntityRefundResponseRoutingReversals> routingReversals) {
            Utils.checkNotNull(routingReversals, "routingReversals");
            this.routingReversals = JsonNullable.of(routingReversals);
            return this;
        }
         ...
         * parameter instead.
         */
        public Builder routingReversals(JsonNullable<? extends List<ListEntityRefundResponseRoutingReversals>> routingReversals) {
            Utils.checkNotNull(routingReversals, "routingReversals");
            this.routingReversals = routingReversals;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListEntityRefundResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }

        public ListEntityRefundResponse build() {

            return new ListEntityRefundResponse(
                resource, id, mode,
                description, amount, settlementAmount,
                metadata, paymentId, settlementId,
                status, createdAt, externalReference,
