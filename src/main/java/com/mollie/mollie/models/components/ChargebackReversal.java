...
public class ChargebackReversal {
    ...
    public ChargebackReversal withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public ChargebackReversal withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public ChargebackReversal withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public ChargebackReversal withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public ChargebackReversal withChargebackId(String chargebackId) {
        Utils.checkNotNull(chargebackId, "chargebackId");
    ...
    public ChargebackReversal withChargebackId(Optional<String> chargebackId) {
        Utils.checkNotNull(chargebackId, "chargebackId");
        this.chargebackId = chargebackId;
        return this;
    }

    public ChargebackReversal withChargebackDescription(String chargebackDescription) {
        Utils.checkNotNull(chargebackDescription, "chargebackDescription");
    ...
    public ChargebackReversal withChargebackDescription(Optional<String> chargebackDescription) {
        Utils.checkNotNull(chargebackDescription, "chargebackDescription");
        this.chargebackDescription = chargebackDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChargebackReversal other = (ChargebackReversal) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ChargebackReversal.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public ChargebackReversal build() {

            return new ChargebackReversal(
                paymentId, paymentDescription, chargebackId,
                chargebackDescription);
        }
