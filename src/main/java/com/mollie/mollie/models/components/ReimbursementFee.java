...
public class ReimbursementFee {
    ...
    public ReimbursementFee withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public ReimbursementFee withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public ReimbursementFee withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public ReimbursementFee withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReimbursementFee other = (ReimbursementFee) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReimbursementFee.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public ReimbursementFee build() {

            return new ReimbursementFee(
                paymentId, paymentDescription);
        }
