...
public class ListEntityMethodAllLinks {
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityMethodAllLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityMethodAllLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
