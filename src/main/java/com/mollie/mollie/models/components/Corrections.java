...
public class Corrections {
    ...
    public Corrections withPending(SubGroup pending) {
        Utils.checkNotNull(pending, "pending");
    ...
    public Corrections withPending(Optional<? extends SubGroup> pending) {
        Utils.checkNotNull(pending, "pending");
        this.pending = pending;
        return this;
    }

    public Corrections withMovedToAvailable(SubGroup movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
    ...
    public Corrections withMovedToAvailable(Optional<? extends SubGroup> movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
        this.movedToAvailable = movedToAvailable;
        return this;
    }

    public Corrections withImmediatelyAvailable(SubGroup immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
    ...
    public Corrections withImmediatelyAvailable(Optional<? extends SubGroup> immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
        this.immediatelyAvailable = immediatelyAvailable;
        return this;
    }
