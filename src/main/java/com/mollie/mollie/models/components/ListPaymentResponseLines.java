...
public class ListPaymentResponseLines {
    /**
    ...
    @JsonCreator
    public ListPaymentResponseLines(
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public ListPaymentResponseLines withType(PaymentLineTypeResponse type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public ListPaymentResponseLines withType(Optional<? extends PaymentLineTypeResponse> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public ListPaymentResponseLines withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public ListPaymentResponseLines withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public ListPaymentResponseLines withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public ListPaymentResponseLines withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withUnitPrice(Amount unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withDiscountAmount(Amount discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withDiscountAmount(Optional<? extends Amount> discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withTotalAmount(Amount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public ListPaymentResponseLines withVatRate(String vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public ListPaymentResponseLines withVatRate(Optional<String> vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
        this.vatRate = vatRate;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withVatAmount(Amount vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListPaymentResponseLines withVatAmount(Optional<? extends Amount> vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
        this.vatAmount = vatAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public ListPaymentResponseLines withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public ListPaymentResponseLines withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * information.
     */
    public ListPaymentResponseLines withCategories(List<LineCategoriesResponse> categories) {
        Utils.checkNotNull(categories, "categories");
     ...
     * information.
     */
    public ListPaymentResponseLines withCategories(Optional<? extends List<LineCategoriesResponse>> categories) {
        Utils.checkNotNull(categories, "categories");
        this.categories = categories;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public ListPaymentResponseLines withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public ListPaymentResponseLines withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public ListPaymentResponseLines withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public ListPaymentResponseLines withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }

    public ListPaymentResponseLines withRecurring(RecurringLineItem recurring) {
        Utils.checkNotNull(recurring, "recurring");
    ...
    public ListPaymentResponseLines withRecurring(Optional<? extends RecurringLineItem> recurring) {
        Utils.checkNotNull(recurring, "recurring");
        this.recurring = recurring;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentResponseLines other = (ListPaymentResponseLines) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentResponseLines.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        public ListPaymentResponseLines build() {

            return new ListPaymentResponseLines(
                type, description, quantity,
                quantityUnit, unitPrice, discountAmount,
                totalAmount, vatRate, vatAmount,
                sku, categories, imageUrl,
