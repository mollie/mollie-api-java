...
public enum SalesInvoiceStatus {
    ...
    SalesInvoiceStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<SalesInvoiceStatus> fromValue(String value) {
        for (SalesInvoiceStatus o: SalesInvoiceStatus.values()) {
