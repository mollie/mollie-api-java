...
public class EntityPayoutResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends EntityPayoutResponseLinks> links;

    @JsonCreator
    public EntityPayoutResponse(
            ...
            @JsonProperty("_links") Optional<? extends EntityPayoutResponseLinks> links) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<EntityPayoutResponseLinks> links() {
        return (Optional<EntityPayoutResponseLinks>) links;
    }
     ...
     * endpoint.
     */
    public EntityPayoutResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Mollie will always refer to the payout by this ID. Example: `payout_j8NvRAM2WNZtsykpLEX8J`.
     */
    public EntityPayoutResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The identifier of the balance that will be paid out. Example: `bal_gVMhHKqSSRYJyPsuoPNFH`.
     */
    public EntityPayoutResponse withBalanceId(String balanceId) {
        Utils.checkNotNull(balanceId, "balanceId");
        this.balanceId = balanceId;
        return this;
    }
     ...
     * The status of the payout.
     */
    public EntityPayoutResponse withStatus(PayoutStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The reason for the payout's current status.
     */
    public EntityPayoutResponse withStatusReason(PayoutStatusReason statusReason) {
        Utils.checkNotNull(statusReason, "statusReason");
        this.statusReason = statusReason;
        return this;
    }
     ...
     * format.
     */
    public EntityPayoutResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * This is the moment Mollie attempted to reserve the funds on the balance.
     */
    public EntityPayoutResponse withInitiatedAt(String initiatedAt) {
        Utils.checkNotNull(initiatedAt, "initiatedAt");
     ...
     * This is the moment Mollie attempted to reserve the funds on the balance.
     */
    public EntityPayoutResponse withInitiatedAt(JsonNullable<String> initiatedAt) {
        Utils.checkNotNull(initiatedAt, "initiatedAt");
        this.initiatedAt = initiatedAt;
        return this;
    }
     ...
     * yet.
     */
    public EntityPayoutResponse withCompletedAt(String completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * yet.
     */
    public EntityPayoutResponse withCompletedAt(JsonNullable<String> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * `null` if the payout was not canceled.
     */
    public EntityPayoutResponse withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * `null` if the payout was not canceled.
     */
    public EntityPayoutResponse withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public EntityPayoutResponse withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public EntityPayoutResponse withLinks(EntityPayoutResponseLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public EntityPayoutResponse withLinks(Optional<? extends EntityPayoutResponseLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityPayoutResponse other = (EntityPayoutResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityPayoutResponse.class,
                "resource", resource,
                "id", id,
                "balanceId", balanceId,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        private Optional<? extends EntityPayoutResponseLinks> links = Optional.empty();
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(EntityPayoutResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(Optional<? extends EntityPayoutResponseLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }

        public EntityPayoutResponse build() {

            return new EntityPayoutResponse(
                resource, id, balanceId,
                amount, description, status,
                statusReason, createdAt, initiatedAt,
                completedAt, canceledAt, mode,
