...
public class ReturnedPlatformPaymentRefund {
    ...
    @JsonCreator
    public ReturnedPlatformPaymentRefund(
    ...
    public ReturnedPlatformPaymentRefund withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public ReturnedPlatformPaymentRefund withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public ReturnedPlatformPaymentRefund withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public ReturnedPlatformPaymentRefund withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public ReturnedPlatformPaymentRefund withRefundId(String refundId) {
        Utils.checkNotNull(refundId, "refundId");
    ...
    public ReturnedPlatformPaymentRefund withRefundId(Optional<String> refundId) {
        Utils.checkNotNull(refundId, "refundId");
        this.refundId = refundId;
        return this;
    }

    public ReturnedPlatformPaymentRefund withRefundDescription(String refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
    ...
    public ReturnedPlatformPaymentRefund withRefundDescription(Optional<String> refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
        this.refundDescription = refundDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReturnedPlatformPaymentRefund other = (ReturnedPlatformPaymentRefund) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReturnedPlatformPaymentRefund.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public ReturnedPlatformPaymentRefund build() {

            return new ReturnedPlatformPaymentRefund(
                paymentId, paymentDescription, refundId,
                refundDescription);
        }
