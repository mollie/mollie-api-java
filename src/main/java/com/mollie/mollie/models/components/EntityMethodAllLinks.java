...
public class EntityMethodAllLinks {
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityMethodAllLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityMethodAllLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityMethodAllLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityMethodAllLinks other = (EntityMethodAllLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityMethodAllLinks.class,
                "self", self,
    ...
    public final static class Builder {
        ...
        public EntityMethodAllLinks build() {

            return new EntityMethodAllLinks(
                self, documentation);
        }
