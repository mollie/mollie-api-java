...
public class Chargebacks {
    ...
    public Chargebacks withPending(SubGroup pending) {
        Utils.checkNotNull(pending, "pending");
    ...
    public Chargebacks withPending(Optional<? extends SubGroup> pending) {
        Utils.checkNotNull(pending, "pending");
        this.pending = pending;
        return this;
    }

    public Chargebacks withMovedToAvailable(SubGroup movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
    ...
    public Chargebacks withMovedToAvailable(Optional<? extends SubGroup> movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
        this.movedToAvailable = movedToAvailable;
        return this;
    }

    public Chargebacks withImmediatelyAvailable(SubGroup immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
    ...
    public Chargebacks withImmediatelyAvailable(Optional<? extends SubGroup> immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
        this.immediatelyAvailable = immediatelyAvailable;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Chargebacks other = (Chargebacks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(Chargebacks.class,
                "pending", pending,
    ...
    public final static class Builder {
        ...
        public Chargebacks build() {

            return new Chargebacks(
                pending, movedToAvailable, immediatelyAvailable);
        }
