...
public class Mode {
    ...
    public static final Mode LIVE = new Mode("live");
    public static final Mode TEST = new Mode("test");
    ...
    private static final Map<String, ModeEnum> createEnumsMap() {
        ...
        map.put("live", ModeEnum.LIVE);
        map.put("test", ModeEnum.TEST);
        return map;
    }
