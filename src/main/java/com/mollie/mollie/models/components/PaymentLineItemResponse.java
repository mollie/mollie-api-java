...
public class PaymentLineItemResponse {
    ...
    @JsonProperty("type")
    private Optional<? extends PaymentLineItemResponseType> type;
    ...
    @JsonCreator
    public PaymentLineItemResponse(
            @JsonProperty("type") Optional<? extends PaymentLineItemResponseType> type,
    ...
    @JsonIgnore
    public Optional<PaymentLineItemResponseType> type() {
        return (Optional<PaymentLineItemResponseType>) type;
    }
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public PaymentLineItemResponse withType(PaymentLineItemResponseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * <p>The `tip` payment line type is not available when creating a payment.
     */
    public PaymentLineItemResponse withType(Optional<? extends PaymentLineItemResponseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * A description of the line item. For example *LEGO 4440 Forest Police Station*.
     */
    public PaymentLineItemResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The number of items.
     */
    public PaymentLineItemResponse withQuantity(long quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public PaymentLineItemResponse withQuantityUnit(String quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
     ...
     * The unit for the quantity. For example *pcs*, *kg*, or *cm*.
     */
    public PaymentLineItemResponse withQuantityUnit(Optional<String> quantityUnit) {
        Utils.checkNotNull(quantityUnit, "quantityUnit");
        this.quantityUnit = quantityUnit;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withUnitPrice(Amount unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withDiscountAmount(Amount discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withDiscountAmount(Optional<? extends Amount> discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withTotalAmount(Amount totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public PaymentLineItemResponse withVatRate(String vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
     ...
     * not as a float, to ensure the correct number of decimals are passed.
     */
    public PaymentLineItemResponse withVatRate(Optional<String> vatRate) {
        Utils.checkNotNull(vatRate, "vatRate");
        this.vatRate = vatRate;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withVatAmount(Amount vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public PaymentLineItemResponse withVatAmount(Optional<? extends Amount> vatAmount) {
        Utils.checkNotNull(vatAmount, "vatAmount");
        this.vatAmount = vatAmount;
        return this;
    }
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public PaymentLineItemResponse withSku(String sku) {
        Utils.checkNotNull(sku, "sku");
     ...
     * The SKU, EAN, ISBN or UPC of the product sold.
     */
    public PaymentLineItemResponse withSku(Optional<String> sku) {
        Utils.checkNotNull(sku, "sku");
        this.sku = sku;
        return this;
    }
     ...
     * A link pointing to an image of the product sold.
     */
    public PaymentLineItemResponse withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * A link pointing to an image of the product sold.
     */
    public PaymentLineItemResponse withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public PaymentLineItemResponse withProductUrl(String productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
     ...
     * A link pointing to the product page in your web shop of the product sold.
     */
    public PaymentLineItemResponse withProductUrl(Optional<String> productUrl) {
        Utils.checkNotNull(productUrl, "productUrl");
        this.productUrl = productUrl;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentLineItemResponse other = (PaymentLineItemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentLineItemResponse.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends PaymentLineItemResponseType> type = Optional.empty();
         ...
         * <p>The `tip` payment line type is not available when creating a payment.
         */
        public Builder type(PaymentLineItemResponseType type) {
            Utils.checkNotNull(type, "type");
            this.type = Optional.ofNullable(type);
            return this;
        }
         ...
         * <p>The `tip` payment line type is not available when creating a payment.
         */
        public Builder type(Optional<? extends PaymentLineItemResponseType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
        ...
        public PaymentLineItemResponse build() {

            return new PaymentLineItemResponse(
                type, description, quantity,
                quantityUnit, unitPrice, discountAmount,
                totalAmount, vatRate, vatAmount,
                sku, categories, imageUrl,
