...
public enum EntitySalesInvoiceStatus {
    ...
    EntitySalesInvoiceStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<EntitySalesInvoiceStatus> fromValue(String value) {
        for (EntitySalesInvoiceStatus o: EntitySalesInvoiceStatus.values()) {
