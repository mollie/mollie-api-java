...
public class EntityBalanceLinks {
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceLinks withSelf(Optional<? extends Url> self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityBalanceLinks other = (EntityBalanceLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityBalanceLinks.class,
                "self", self,
    ...
    public final static class Builder {
        ...
        public EntityBalanceLinks build() {

            return new EntityBalanceLinks(
                self, documentation);
        }
