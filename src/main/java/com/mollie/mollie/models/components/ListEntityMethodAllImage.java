...
public class ListEntityMethodAllImage {
    ...
    @JsonCreator
    public ListEntityMethodAllImage(
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListEntityMethodAllImage withSize1x(String size1x) {
        Utils.checkNotNull(size1x, "size1x");
        this.size1x = size1x;
        return this;
    }
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListEntityMethodAllImage withSize2x(String size2x) {
        Utils.checkNotNull(size2x, "size2x");
        this.size2x = size2x;
        return this;
    }
     ...
     * scale to any desired size without compromising visual quality.
     */
    public ListEntityMethodAllImage withSvg(String svg) {
        Utils.checkNotNull(svg, "svg");
        this.svg = svg;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEntityMethodAllImage other = (ListEntityMethodAllImage) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListEntityMethodAllImage.class,
                "size1x", size1x,
                "size2x", size2x,
                "svg", svg);
    }
    ...
    public final static class Builder {
        ...
        public ListEntityMethodAllImage build() {

            return new ListEntityMethodAllImage(
                size1x, size2x, svg);
        }
