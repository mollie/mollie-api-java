...
public class SalesInvoiceRecipient {
     ...
     */
    @JsonProperty("type")
    private SalesInvoiceRecipientType type;
    ...
    @JsonCreator
    public SalesInvoiceRecipient(
            @JsonProperty("type") SalesInvoiceRecipientType type,
            ...
            @JsonProperty("locale") SalesInvoiceRecipientLocale locale) {
    ...
    public SalesInvoiceRecipient(
            SalesInvoiceRecipientType type,
            String email,
            String streetAndNumber,
            String postalCode,
            String city,
            String country,
            SalesInvoiceRecipientLocale locale) {
     ...
     */
    @JsonIgnore
    public SalesInvoiceRecipientType type() {
        return type;
    }
     ...
     * required on the `recipient` object.
     */
    public SalesInvoiceRecipient withType(SalesInvoiceRecipientType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public SalesInvoiceRecipient withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the `consumer` type recipient, for example Mr. or Mrs..
     */
    public SalesInvoiceRecipient withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * only numbers.
     */
    public SalesInvoiceRecipient withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
     ...
     * only numbers.
     */
    public SalesInvoiceRecipient withGivenName(JsonNullable<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }
     ...
     * only numbers.
     */
    public SalesInvoiceRecipient withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
     ...
     * only numbers.
     */
    public SalesInvoiceRecipient withFamilyName(JsonNullable<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }
     ...
     * The trading name of the `business` type recipient.
     */
    public SalesInvoiceRecipient withOrganizationName(String organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
     ...
     * The trading name of the `business` type recipient.
     */
    public SalesInvoiceRecipient withOrganizationName(JsonNullable<String> organizationName) {
        Utils.checkNotNull(organizationName, "organizationName");
        this.organizationName = organizationName;
        return this;
    }
     ...
     * has to be provided.
     */
    public SalesInvoiceRecipient withOrganizationNumber(String organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
     ...
     * has to be provided.
     */
    public SalesInvoiceRecipient withOrganizationNumber(JsonNullable<String> organizationNumber) {
        Utils.checkNotNull(organizationNumber, "organizationNumber");
        this.organizationNumber = organizationNumber;
        return this;
    }
     ...
     * has to be provided.
     */
    public SalesInvoiceRecipient withVatNumber(String vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
     ...
     * has to be provided.
     */
    public SalesInvoiceRecipient withVatNumber(JsonNullable<String> vatNumber) {
        Utils.checkNotNull(vatNumber, "vatNumber");
        this.vatNumber = vatNumber;
        return this;
    }
     ...
     * 3492](https://www.rfc-editor.org/rfc/rfc3492).
     */
    public SalesInvoiceRecipient withEmail(String email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * The phone number of the recipient.
     */
    public SalesInvoiceRecipient withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * The phone number of the recipient.
     */
    public SalesInvoiceRecipient withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * A street and street number.
     */
    public SalesInvoiceRecipient withStreetAndNumber(String streetAndNumber) {
        Utils.checkNotNull(streetAndNumber, "streetAndNumber");
        this.streetAndNumber = streetAndNumber;
        return this;
    }
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public SalesInvoiceRecipient withStreetAdditional(String streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
     ...
     * Any additional addressing details, for example an apartment number.
     */
    public SalesInvoiceRecipient withStreetAdditional(JsonNullable<String> streetAdditional) {
        Utils.checkNotNull(streetAdditional, "streetAdditional");
        this.streetAdditional = streetAdditional;
        return this;
    }
     ...
     * A postal code.
     */
    public SalesInvoiceRecipient withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The recipient's city.
     */
    public SalesInvoiceRecipient withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * The recipient's region.
     */
    public SalesInvoiceRecipient withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * The recipient's region.
     */
    public SalesInvoiceRecipient withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * A country code in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.
     */
    public SalesInvoiceRecipient withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SalesInvoiceRecipient other = (SalesInvoiceRecipient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SalesInvoiceRecipient.class,
                "type", type,
                "title", title,
                "givenName", givenName,
    ...
    public final static class Builder {
         ...
         * required on the `recipient` object.
         */
        public Builder type(SalesInvoiceRecipientType type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
        ...
        public SalesInvoiceRecipient build() {

            return new SalesInvoiceRecipient(
                type, title, givenName,
                familyName, organizationName, organizationNumber,
                vatNumber, email, phone,
                streetAndNumber, streetAdditional, postalCode,
