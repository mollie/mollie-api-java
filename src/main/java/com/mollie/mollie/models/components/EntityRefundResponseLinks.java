...
public class EntityRefundResponseLinks {
    ...
    @JsonCreator
    public EntityRefundResponseLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityRefundResponseLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityRefundResponseLinks withPayment(Url payment) {
        Utils.checkNotNull(payment, "payment");
        this.payment = payment;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityRefundResponseLinks withSettlement(UrlNullable settlement) {
        Utils.checkNotNull(settlement, "settlement");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityRefundResponseLinks withSettlement(JsonNullable<? extends UrlNullable> settlement) {
        Utils.checkNotNull(settlement, "settlement");
        this.settlement = settlement;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityRefundResponseLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityRefundResponseLinks other = (EntityRefundResponseLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityRefundResponseLinks.class,
                "self", self,
                "payment", payment,
    ...
    public final static class Builder {
        ...
        public EntityRefundResponseLinks build() {

            return new EntityRefundResponseLinks(
                self, payment, settlement,
                documentation);
        }
