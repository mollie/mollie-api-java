...
public class Topups {
    ...
    public Topups withPending(SubGroup pending) {
        Utils.checkNotNull(pending, "pending");
    ...
    public Topups withPending(Optional<? extends SubGroup> pending) {
        Utils.checkNotNull(pending, "pending");
        this.pending = pending;
        return this;
    }

    public Topups withMovedToAvailable(SubGroup movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
    ...
    public Topups withMovedToAvailable(Optional<? extends SubGroup> movedToAvailable) {
        Utils.checkNotNull(movedToAvailable, "movedToAvailable");
        this.movedToAvailable = movedToAvailable;
        return this;
    }

    public Topups withImmediatelyAvailable(SubGroup immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
    ...
    public Topups withImmediatelyAvailable(Optional<? extends SubGroup> immediatelyAvailable) {
        Utils.checkNotNull(immediatelyAvailable, "immediatelyAvailable");
        this.immediatelyAvailable = immediatelyAvailable;
        return this;
    }
