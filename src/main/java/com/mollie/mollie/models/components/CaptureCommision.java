...
public class CaptureCommision {
    ...
    public CaptureCommision withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public CaptureCommision withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public CaptureCommision withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public CaptureCommision withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public CaptureCommision withCaptureId(String captureId) {
        Utils.checkNotNull(captureId, "captureId");
    ...
    public CaptureCommision withCaptureId(Optional<String> captureId) {
        Utils.checkNotNull(captureId, "captureId");
        this.captureId = captureId;
        return this;
    }

    public CaptureCommision withCaptureDescription(String captureDescription) {
        Utils.checkNotNull(captureDescription, "captureDescription");
    ...
    public CaptureCommision withCaptureDescription(Optional<String> captureDescription) {
        Utils.checkNotNull(captureDescription, "captureDescription");
        this.captureDescription = captureDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CaptureCommision other = (CaptureCommision) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CaptureCommision.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public CaptureCommision build() {

            return new CaptureCommision(
                paymentId, paymentDescription, captureId,
                captureDescription);
        }
