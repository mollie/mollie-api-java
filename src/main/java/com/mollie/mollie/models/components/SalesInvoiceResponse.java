...
public class SalesInvoiceResponse {
     ...
     * provided details. Required for `paid` status.
     */
    public SalesInvoiceResponse withPaymentDetails(List<SalesInvoicePaymentDetailsResponse> paymentDetails) {
        Utils.checkNotNull(paymentDetails, "paymentDetails");
     ...
     * provided details. Required for `paid` status.
     */
    public SalesInvoiceResponse withPaymentDetails(Optional<? extends List<SalesInvoicePaymentDetailsResponse>> paymentDetails) {
        Utils.checkNotNull(paymentDetails, "paymentDetails");
        this.paymentDetails = paymentDetails;
        return this;
    }
     ...
     * the recipient is also located in one of these countries.
     */
    public SalesInvoiceResponse withIsEInvoice(boolean isEInvoice) {
        Utils.checkNotNull(isEInvoice, "isEInvoice");
     ...
     * the recipient is also located in one of these countries.
     */
    public SalesInvoiceResponse withIsEInvoice(Optional<Boolean> isEInvoice) {
        Utils.checkNotNull(isEInvoice, "isEInvoice");
        this.isEInvoice = isEInvoice;
        return this;
    }
