...
public class ListEntityMethodImage {
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListEntityMethodImage withSize1x(String size1x) {
        Utils.checkNotNull(size1x, "size1x");
     ...
     * The URL pointing to an icon of 32 by 24 pixels.
     */
    public ListEntityMethodImage withSize1x(Optional<String> size1x) {
        Utils.checkNotNull(size1x, "size1x");
        this.size1x = size1x;
        return this;
    }
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListEntityMethodImage withSize2x(String size2x) {
        Utils.checkNotNull(size2x, "size2x");
     ...
     * The URL pointing to an icon of 64 by 48 pixels.
     */
    public ListEntityMethodImage withSize2x(Optional<String> size2x) {
        Utils.checkNotNull(size2x, "size2x");
        this.size2x = size2x;
        return this;
    }
     ...
     * scale to any desired size without compromising visual quality.
     */
    public ListEntityMethodImage withSvg(String svg) {
        Utils.checkNotNull(svg, "svg");
     ...
     * scale to any desired size without compromising visual quality.
     */
    public ListEntityMethodImage withSvg(Optional<String> svg) {
        Utils.checkNotNull(svg, "svg");
        this.svg = svg;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEntityMethodImage other = (ListEntityMethodImage) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListEntityMethodImage.class,
                "size1x", size1x,
                "size2x", size2x,
                "svg", svg);
    }
    ...
    public final static class Builder {
        ...
        public ListEntityMethodImage build() {

            return new ListEntityMethodImage(
                size1x, size2x, svg);
        }
