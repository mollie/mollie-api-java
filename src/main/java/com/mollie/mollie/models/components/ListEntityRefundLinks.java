...
public class ListEntityRefundLinks {
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityRefundLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityRefundLinks withPayment(Url payment) {
        Utils.checkNotNull(payment, "payment");
        this.payment = payment;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityRefundLinks withSettlement(UrlNullable settlement) {
        Utils.checkNotNull(settlement, "settlement");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListEntityRefundLinks withSettlement(JsonNullable<? extends UrlNullable> settlement) {
        Utils.checkNotNull(settlement, "settlement");
        this.settlement = settlement;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEntityRefundLinks other = (ListEntityRefundLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListEntityRefundLinks.class,
                "self", self,
                "payment", payment,
    ...
    public final static class Builder {
        ...
        public ListEntityRefundLinks build() {

            return new ListEntityRefundLinks(
                self, payment, settlement);
        }
