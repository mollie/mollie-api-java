...
public class PaymentResponseSettlementAmount {
    ...
    @JsonCreator
    public PaymentResponseSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public PaymentResponseSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public PaymentResponseSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentResponseSettlementAmount other = (PaymentResponseSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentResponseSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public PaymentResponseSettlementAmount build() {

            return new PaymentResponseSettlementAmount(
                currency, value);
        }
