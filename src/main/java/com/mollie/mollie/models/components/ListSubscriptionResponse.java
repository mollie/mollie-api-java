...
public class ListSubscriptionResponse {
    ...
    @JsonProperty("status")
    private ListSubscriptionResponseStatus status;
    ...
    private Optional<? extends ListSubscriptionResponseApplicationFee> applicationFee;
     ...
     */
    @JsonProperty("_links")
    private ListSubscriptionResponseLinks links;
    ...
    public ListSubscriptionResponse(
            ...
            @JsonProperty("status") ListSubscriptionResponseStatus status,
            ...
            @JsonProperty("applicationFee") Optional<? extends ListSubscriptionResponseApplicationFee> applicationFee,
            ...
            @JsonProperty("_links") ListSubscriptionResponseLinks links) {
    ...
    public ListSubscriptionResponse(
            ...
            String id,
            Mode mode,
            ListSubscriptionResponseStatus status,
            Amount amount,
            String interval,
            String startDate,
            String description,
            String customerId,
            String createdAt,
            ListSubscriptionResponseLinks links) {
    ...
    @JsonIgnore
    public ListSubscriptionResponseStatus status() {
        return status;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ListSubscriptionResponseApplicationFee> applicationFee() {
        return (Optional<ListSubscriptionResponseApplicationFee>) applicationFee;
    }
     ...
     */
    @JsonIgnore
    public ListSubscriptionResponseLinks links() {
        return links;
    }
     ...
     * endpoint.
     */
    public ListSubscriptionResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this subscription. Example: `sub_rVKGtNd6s3`.
     */
    public ListSubscriptionResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public ListSubscriptionResponse withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }

    public ListSubscriptionResponse withStatus(ListSubscriptionResponseStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListSubscriptionResponse withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * <p>Test mode subscriptions will get canceled automatically after 10 payments.
     */
    public ListSubscriptionResponse withTimes(long times) {
        Utils.checkNotNull(times, "times");
     ...
     * <p>Test mode subscriptions will get canceled automatically after 10 payments.
     */
    public ListSubscriptionResponse withTimes(Optional<Long> times) {
        Utils.checkNotNull(times, "times");
        this.times = times;
        return this;
    }
     ...
     * Number of payments left for the subscription.
     */
    public ListSubscriptionResponse withTimesRemaining(long timesRemaining) {
        Utils.checkNotNull(timesRemaining, "timesRemaining");
     ...
     * Number of payments left for the subscription.
     */
    public ListSubscriptionResponse withTimesRemaining(Optional<Long> timesRemaining) {
        Utils.checkNotNull(timesRemaining, "timesRemaining");
        this.timesRemaining = timesRemaining;
        return this;
    }
     ...
     * <p>months`.
     */
    public ListSubscriptionResponse withInterval(String interval) {
        Utils.checkNotNull(interval, "interval");
        this.interval = interval;
        return this;
    }
     ...
     * The start date of the subscription in `YYYY-MM-DD` format.
     */
    public ListSubscriptionResponse withStartDate(String startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * this parameter will not be returned.
     */
    public ListSubscriptionResponse withNextPaymentDate(String nextPaymentDate) {
        Utils.checkNotNull(nextPaymentDate, "nextPaymentDate");
     ...
     * this parameter will not be returned.
     */
    public ListSubscriptionResponse withNextPaymentDate(JsonNullable<String> nextPaymentDate) {
        Utils.checkNotNull(nextPaymentDate, "nextPaymentDate");
        this.nextPaymentDate = nextPaymentDate;
        return this;
    }
     ...
     * subscriptions.
     */
    public ListSubscriptionResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * be used.
     */
    public ListSubscriptionResponse withMethod(SubscriptionMethodResponse method) {
        Utils.checkNotNull(method, "method");
     ...
     * be used.
     */
    public ListSubscriptionResponse withMethod(Optional<? extends SubscriptionMethodResponse> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * information.
     */
    public ListSubscriptionResponse withApplicationFee(ListSubscriptionResponseApplicationFee applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
     ...
     * information.
     */
    public ListSubscriptionResponse withApplicationFee(Optional<? extends ListSubscriptionResponseApplicationFee> applicationFee) {
        Utils.checkNotNull(applicationFee, "applicationFee");
        this.applicationFee = applicationFee;
        return this;
    }
     ...
     * approximately 1kB.
     */
    public ListSubscriptionResponse withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * approximately 1kB.
     */
    public ListSubscriptionResponse withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * well. Be sure to verify the payment's subscription ID and its status.
     */
    public ListSubscriptionResponse withWebhookUrl(String webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
     ...
     * well. Be sure to verify the payment's subscription ID and its status.
     */
    public ListSubscriptionResponse withWebhookUrl(Optional<String> webhookUrl) {
        Utils.checkNotNull(webhookUrl, "webhookUrl");
        this.webhookUrl = webhookUrl;
        return this;
    }
     ...
     * The customer this subscription belongs to.
     */
    public ListSubscriptionResponse withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }

    public ListSubscriptionResponse withMandateId(String mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
    ...
    public ListSubscriptionResponse withMandateId(Optional<String> mandateId) {
        Utils.checkNotNull(mandateId, "mandateId");
        this.mandateId = mandateId;
        return this;
    }
     ...
     * format.
     */
    public ListSubscriptionResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * subscription is not canceled (yet).
     */
    public ListSubscriptionResponse withCanceledAt(String canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * subscription is not canceled (yet).
     */
    public ListSubscriptionResponse withCanceledAt(JsonNullable<String> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListSubscriptionResponse withLinks(ListSubscriptionResponseLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ListSubscriptionResponseApplicationFee> applicationFee = Optional.empty();
        ...
        public Builder status(ListSubscriptionResponseStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
         ...
         * information.
         */
        public Builder applicationFee(ListSubscriptionResponseApplicationFee applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = Optional.ofNullable(applicationFee);
            return this;
        }
         ...
         * information.
         */
        public Builder applicationFee(Optional<? extends ListSubscriptionResponseApplicationFee> applicationFee) {
            Utils.checkNotNull(applicationFee, "applicationFee");
            this.applicationFee = applicationFee;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListSubscriptionResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
