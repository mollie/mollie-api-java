...
public class EntityWebhook {
     ...
     */
    @JsonProperty("_links")
    private EntityWebhookLinks links;

    @JsonCreator
    public EntityWebhook(
     ...
     */
    @JsonIgnore
    public EntityWebhookLinks links() {
        return links;
    }
     ...
     * Will always contain the string `webhook` for this endpoint.
     */
    public EntityWebhook withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this subscription.
     */
    public EntityWebhook withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The subscription's events destination.
     */
    public EntityWebhook withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * The identifier uniquely referring to the profile that created the subscription.
     */
    public EntityWebhook withProfileId(String profileId) {
        Utils.checkNotNull(profileId, "profileId");
     ...
     * The identifier uniquely referring to the profile that created the subscription.
     */
    public EntityWebhook withProfileId(Optional<String> profileId) {
        Utils.checkNotNull(profileId, "profileId");
        this.profileId = profileId;
        return this;
    }
     ...
     * The subscription's date time of creation.
     */
    public EntityWebhook withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The subscription's name.
     */
    public EntityWebhook withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The events types that are subscribed.
     */
    public EntityWebhook withEventTypes(List<WebhookEventTypes> eventTypes) {
        Utils.checkNotNull(eventTypes, "eventTypes");
        this.eventTypes = eventTypes;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public EntityWebhook withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public EntityWebhook withLinks(EntityWebhookLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityWebhook other = (EntityWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityWebhook.class,
                "resource", resource,
                "id", id,
                "url", url,
                "profileId", profileId,
    ...
    public final static class Builder {
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(EntityWebhookLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
