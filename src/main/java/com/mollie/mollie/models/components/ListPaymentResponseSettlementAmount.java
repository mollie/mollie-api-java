...
public class ListPaymentResponseSettlementAmount {
    ...
    @JsonCreator
    public ListPaymentResponseSettlementAmount(
     ...
     * A three-character ISO 4217 currency code.
     */
    public ListPaymentResponseSettlementAmount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * A string containing an exact monetary amount in the given currency.
     */
    public ListPaymentResponseSettlementAmount withValue(String value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentResponseSettlementAmount other = (ListPaymentResponseSettlementAmount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentResponseSettlementAmount.class,
                "currency", currency,
                "value", value);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentResponseSettlementAmount build() {

            return new ListPaymentResponseSettlementAmount(
                currency, value);
        }
