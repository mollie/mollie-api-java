...
public class EntityBalanceReportLinks {
    ...
    @JsonCreator
    public EntityBalanceReportLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceReportLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceReportLinks withSelf(Optional<? extends Url> self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceReportLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityBalanceReportLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityBalanceReportLinks other = (EntityBalanceReportLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityBalanceReportLinks.class,
                "self", self,
    ...
    public final static class Builder {
        ...
        public EntityBalanceReportLinks build() {

            return new EntityBalanceReportLinks(
                self, documentation);
        }
