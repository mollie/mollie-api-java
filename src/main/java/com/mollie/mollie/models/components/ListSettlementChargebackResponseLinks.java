...
public class ListSettlementChargebackResponseLinks {
    ...
    @JsonCreator
    public ListSettlementChargebackResponseLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementChargebackResponseLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementChargebackResponseLinks withPayment(Url payment) {
        Utils.checkNotNull(payment, "payment");
        this.payment = payment;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementChargebackResponseLinks withSettlement(UrlNullable settlement) {
        Utils.checkNotNull(settlement, "settlement");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListSettlementChargebackResponseLinks withSettlement(JsonNullable<? extends UrlNullable> settlement) {
        Utils.checkNotNull(settlement, "settlement");
        this.settlement = settlement;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSettlementChargebackResponseLinks other = (ListSettlementChargebackResponseLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSettlementChargebackResponseLinks.class,
                "self", self,
                "payment", payment,
    ...
    public final static class Builder {
        ...
        public ListSettlementChargebackResponseLinks build() {

            return new ListSettlementChargebackResponseLinks(
                self, payment, settlement);
        }
