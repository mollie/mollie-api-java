...
public class EntityBalanceTransactionPayment {
    ...
    @JsonCreator
    public EntityBalanceTransactionPayment(
    ...
    public EntityBalanceTransactionPayment withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public EntityBalanceTransactionPayment withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public EntityBalanceTransactionPayment withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public EntityBalanceTransactionPayment withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityBalanceTransactionPayment other = (EntityBalanceTransactionPayment) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityBalanceTransactionPayment.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public EntityBalanceTransactionPayment build() {

            return new EntityBalanceTransactionPayment(
                paymentId, paymentDescription);
        }
