...
public enum EntitySalesInvoiceResponseStatus {
    ...
    EntitySalesInvoiceResponseStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<EntitySalesInvoiceResponseStatus> fromValue(String value) {
        for (EntitySalesInvoiceResponseStatus o: EntitySalesInvoiceResponseStatus.values()) {
