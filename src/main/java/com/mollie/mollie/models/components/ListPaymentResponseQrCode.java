...
public class ListPaymentResponseQrCode {
    ...
    @JsonCreator
    public ListPaymentResponseQrCode(
     ...
     * The height of the QR code image in pixels.
     */
    public ListPaymentResponseQrCode withHeight(long height) {
        Utils.checkNotNull(height, "height");
     ...
     * The height of the QR code image in pixels.
     */
    public ListPaymentResponseQrCode withHeight(Optional<Long> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * The width of the QR code image in pixels.
     */
    public ListPaymentResponseQrCode withWidth(long width) {
        Utils.checkNotNull(width, "width");
     ...
     * The width of the QR code image in pixels.
     */
    public ListPaymentResponseQrCode withWidth(Optional<Long> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
     ...
     * downloaded.
     */
    public ListPaymentResponseQrCode withSrc(String src) {
        Utils.checkNotNull(src, "src");
     ...
     * downloaded.
     */
    public ListPaymentResponseQrCode withSrc(Optional<String> src) {
        Utils.checkNotNull(src, "src");
        this.src = src;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentResponseQrCode other = (ListPaymentResponseQrCode) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentResponseQrCode.class,
                "height", height,
                "width", width,
                "src", src);
    }
    ...
    public final static class Builder {
        ...
        public ListPaymentResponseQrCode build() {

            return new ListPaymentResponseQrCode(
                height, width, src);
        }
