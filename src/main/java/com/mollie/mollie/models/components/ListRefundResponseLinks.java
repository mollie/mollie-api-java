...
public class ListRefundResponseLinks {
    ...
    @JsonCreator
    public ListRefundResponseLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListRefundResponseLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListRefundResponseLinks withPayment(Url payment) {
        Utils.checkNotNull(payment, "payment");
        this.payment = payment;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListRefundResponseLinks withSettlement(UrlNullable settlement) {
        Utils.checkNotNull(settlement, "settlement");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public ListRefundResponseLinks withSettlement(JsonNullable<? extends UrlNullable> settlement) {
        Utils.checkNotNull(settlement, "settlement");
        this.settlement = settlement;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListRefundResponseLinks other = (ListRefundResponseLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListRefundResponseLinks.class,
                "self", self,
                "payment", payment,
    ...
    public final static class Builder {
        ...
        public ListRefundResponseLinks build() {

            return new ListRefundResponseLinks(
                self, payment, settlement);
        }
