...
public class ReturnedRefundCompensation {
    ...
    @JsonCreator
    public ReturnedRefundCompensation(
    ...
    public ReturnedRefundCompensation withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
    ...
    public ReturnedRefundCompensation withPaymentId(Optional<String> paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }

    public ReturnedRefundCompensation withPaymentDescription(String paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
    ...
    public ReturnedRefundCompensation withPaymentDescription(Optional<String> paymentDescription) {
        Utils.checkNotNull(paymentDescription, "paymentDescription");
        this.paymentDescription = paymentDescription;
        return this;
    }

    public ReturnedRefundCompensation withRefundId(String refundId) {
        Utils.checkNotNull(refundId, "refundId");
    ...
    public ReturnedRefundCompensation withRefundId(Optional<String> refundId) {
        Utils.checkNotNull(refundId, "refundId");
        this.refundId = refundId;
        return this;
    }

    public ReturnedRefundCompensation withRefundDescription(String refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
    ...
    public ReturnedRefundCompensation withRefundDescription(Optional<String> refundDescription) {
        Utils.checkNotNull(refundDescription, "refundDescription");
        this.refundDescription = refundDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReturnedRefundCompensation other = (ReturnedRefundCompensation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReturnedRefundCompensation.class,
                "paymentId", paymentId,
    ...
    public final static class Builder {
        ...
        public ReturnedRefundCompensation build() {

            return new ReturnedRefundCompensation(
                paymentId, paymentDescription, refundId,
                refundDescription);
        }
