...
public class EntitySettlementRate {
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementRate withFixed(Amount fixed) {
        Utils.checkNotNull(fixed, "fixed");
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public EntitySettlementRate withFixed(Optional<? extends Amount> fixed) {
        Utils.checkNotNull(fixed, "fixed");
        this.fixed = fixed;
        return this;
    }

    public EntitySettlementRate withPercentage(String percentage) {
        Utils.checkNotNull(percentage, "percentage");
    ...
    public EntitySettlementRate withPercentage(Optional<String> percentage) {
        Utils.checkNotNull(percentage, "percentage");
        this.percentage = percentage;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntitySettlementRate other = (EntitySettlementRate) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntitySettlementRate.class,
                "fixed", fixed,
    ...
    public final static class Builder {
        ...
        public EntitySettlementRate build() {

            return new EntitySettlementRate(
                fixed, percentage);
        }
