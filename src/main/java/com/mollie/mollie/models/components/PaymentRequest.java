...
public class PaymentRequest {
    ...
    private Optional<? extends PaymentRequestBillingAddress> billingAddress;
     ...
     * specific
     * payment method and your customer will skip the selection screen and is sent directly to the chosen
     * payment
     ...
     * selection
     * screen but will only show the methods specified in the array. For example, you can use this
     * functionality
     * to only show payment methods from a specific country to your customer `['bancontact', 'belfius']`.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("method")
    private JsonNullable<? extends PaymentRequestMethod> method;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<PaymentRequestBillingAddress> billingAddress() {
        return (Optional<PaymentRequestBillingAddress>) billingAddress;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<PaymentRequestMethod> method() {
        return (JsonNullable<PaymentRequestMethod>) method;
    }
     ...
     * to only show payment methods from a specific country to your customer `['bancontact', 'belfius']`.
     */
    public PaymentRequest withMethod(PaymentRequestMethod method) {
        Utils.checkNotNull(method, "method");
     ...
     * to only show payment methods from a specific country to your customer `['bancontact', 'belfius']`.
     */
    public PaymentRequest withMethod(JsonNullable<? extends PaymentRequestMethod> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * to only show payment methods from a specific country to your customer `['bancontact', 'belfius']`.
         */
        public Builder method(PaymentRequestMethod method) {
            Utils.checkNotNull(method, "method");
            this.method = JsonNullable.of(method);
            return this;
        }
         ...
         * to only show payment methods from a specific country to your customer `['bancontact', 'belfius']`.
         */
        public Builder method(JsonNullable<? extends PaymentRequestMethod> method) {
            Utils.checkNotNull(method, "method");
            this.method = method;
            return this;
        }
