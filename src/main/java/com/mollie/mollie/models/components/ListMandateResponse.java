...
public class ListMandateResponse {
    ...
    private ListMandateResponseDetails details;
     ...
     */
    @JsonProperty("_links")
    private ListMandateResponseLinks links;

    @JsonCreator
    public ListMandateResponse(
            ...
            @JsonProperty("_links") ListMandateResponseLinks links) {
    ...
    public ListMandateResponse(
            ...
            ListMandateResponseDetails details,
            ListMandateResponseStatus status,
            String customerId,
            String createdAt,
    ...
    @JsonIgnore
    public ListMandateResponseDetails details() {
        return details;
    }
    ...
    @JsonIgnore
    public ListMandateResponseStatus status() {
        return status;
    }
     ...
     */
    @JsonIgnore
    public ListMandateResponseLinks links() {
        return links;
    }
     ...
     * endpoint.
     */
    public ListMandateResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this mandate. Example: `mdt_pWUnw6pkBN`.
     */
    public ListMandateResponse withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Whether this entity was created in live mode or in test mode.
     */
    public ListMandateResponse withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * <p>SEPA Direct Debit and PayPal mandates can be created directly.
     */
    public ListMandateResponse withMethod(MandateMethodResponse method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }

    public ListMandateResponse withDetails(ListMandateResponseDetails details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The date when the mandate was signed in `YYYY-MM-DD` format.
     */
    public ListMandateResponse withSignatureDate(String signatureDate) {
        Utils.checkNotNull(signatureDate, "signatureDate");
     ...
     * The date when the mandate was signed in `YYYY-MM-DD` format.
     */
    public ListMandateResponse withSignatureDate(Optional<String> signatureDate) {
        Utils.checkNotNull(signatureDate, "signatureDate");
        this.signatureDate = signatureDate;
        return this;
    }
     ...
     * decline Direct Debit payments if the mandate reference is not unique.
     */
    public ListMandateResponse withMandateReference(String mandateReference) {
        Utils.checkNotNull(mandateReference, "mandateReference");
     ...
     * decline Direct Debit payments if the mandate reference is not unique.
     */
    public ListMandateResponse withMandateReference(Optional<String> mandateReference) {
        Utils.checkNotNull(mandateReference, "mandateReference");
        this.mandateReference = mandateReference;
        return this;
    }
     ...
     * The identifier referring to the [customer](get-customer) this mandate was linked to.
     */
    public ListMandateResponse withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * format.
     */
    public ListMandateResponse withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListMandateResponse withLinks(ListMandateResponseLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMandateResponse other = (ListMandateResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMandateResponse.class,
                "resource", resource,
                "id", id,
                "mode", mode,
                "method", method,
    ...
    public final static class Builder {
        ...
        public Builder details(ListMandateResponseDetails details) {
            Utils.checkNotNull(details, "details");
            this.details = details;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListMandateResponseLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }

        public ListMandateResponse build() {
