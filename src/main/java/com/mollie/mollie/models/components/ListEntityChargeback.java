...
public class ListEntityChargeback {
    ...
    private JsonNullable<? extends ListEntityChargebackSettlementAmount> settlementAmount;
     ...
     */
    @JsonProperty("_links")
    private ListEntityChargebackLinks links;

    @JsonCreator
    public ListEntityChargeback(
            @JsonProperty("resource") String resource,
            @JsonProperty("id") String id,
            @JsonProperty("amount") Amount amount,
            @JsonProperty("settlementAmount") JsonNullable<? extends ListEntityChargebackSettlementAmount> settlementAmount,
            ...
            @JsonProperty("_links") ListEntityChargebackLinks links) {
    ...
    public ListEntityChargeback(
            ...
            String paymentId,
            String createdAt,
            ListEntityChargebackLinks links) {
    ...
    @JsonIgnore
    public JsonNullable<ListEntityChargebackSettlementAmount> settlementAmount() {
        return (JsonNullable<ListEntityChargebackSettlementAmount>) settlementAmount;
    }
     ...
     */
    @JsonIgnore
    public ListEntityChargebackLinks links() {
        return links;
    }
     ...
     * endpoint.
     */
    public ListEntityChargeback withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * The identifier uniquely referring to this chargeback. Example: `chb_n9z0tp`.
     */
    public ListEntityChargeback withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field.
     */
    public ListEntityChargeback withAmount(Amount amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * instead.
     */
    public ListEntityChargeback withSettlementAmount(ListEntityChargebackSettlementAmount settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
     ...
     * instead.
     */
    public ListEntityChargeback withSettlementAmount(JsonNullable<? extends ListEntityChargebackSettlementAmount> settlementAmount) {
        Utils.checkNotNull(settlementAmount, "settlementAmount");
        this.settlementAmount = settlementAmount;
        return this;
    }
     ...
     * payments.
     */
    public ListEntityChargeback withReason(Reason reason) {
        Utils.checkNotNull(reason, "reason");
     ...
     * payments.
     */
    public ListEntityChargeback withReason(JsonNullable<? extends Reason> reason) {
        Utils.checkNotNull(reason, "reason");
        this.reason = reason;
        return this;
    }
     ...
     * The full payment object can be retrieved via the payment URL in the `_links` object.
     */
    public ListEntityChargeback withPaymentId(String paymentId) {
        Utils.checkNotNull(paymentId, "paymentId");
        this.paymentId = paymentId;
        return this;
    }
     ...
     * is omitted if the refund is not settled (yet).
     */
    public ListEntityChargeback withSettlementId(String settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
     ...
     * is omitted if the refund is not settled (yet).
     */
    public ListEntityChargeback withSettlementId(JsonNullable<String> settlementId) {
        Utils.checkNotNull(settlementId, "settlementId");
        this.settlementId = settlementId;
        return this;
    }
     ...
     * format.
     */
    public ListEntityChargeback withCreatedAt(String createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public ListEntityChargeback withReversedAt(String reversedAt) {
        Utils.checkNotNull(reversedAt, "reversedAt");
     ...
     * [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    public ListEntityChargeback withReversedAt(JsonNullable<String> reversedAt) {
        Utils.checkNotNull(reversedAt, "reversedAt");
        this.reversedAt = reversedAt;
        return this;
    }
     ...
     * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
     */
    public ListEntityChargeback withLinks(ListEntityChargebackLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEntityChargeback other = (ListEntityChargeback) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListEntityChargeback.class,
                "resource", resource,
                "id", id,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends ListEntityChargebackSettlementAmount> settlementAmount = JsonNullable.undefined();
         ...
         * instead.
         */
        public Builder settlementAmount(ListEntityChargebackSettlementAmount settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = JsonNullable.of(settlementAmount);
            return this;
        }
         ...
         * instead.
         */
        public Builder settlementAmount(JsonNullable<? extends ListEntityChargebackSettlementAmount> settlementAmount) {
            Utils.checkNotNull(settlementAmount, "settlementAmount");
            this.settlementAmount = settlementAmount;
            return this;
        }
         ...
         * An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
         */
        public Builder links(ListEntityChargebackLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }

        public ListEntityChargeback build() {

            return new ListEntityChargeback(
                resource, id, amount,
                settlementAmount, reason, paymentId,
                settlementId, createdAt, reversedAt,
                links);
