...
public class EntityOrganizationLinks {
    ...
    @JsonCreator
    public EntityOrganizationLinks(
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withSelf(Url self) {
        Utils.checkNotNull(self, "self");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withSelf(Optional<? extends Url> self) {
        Utils.checkNotNull(self, "self");
        this.self = self;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withDashboard(Url dashboard) {
        Utils.checkNotNull(dashboard, "dashboard");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withDashboard(Optional<? extends Url> dashboard) {
        Utils.checkNotNull(dashboard, "dashboard");
        this.dashboard = dashboard;
        return this;
    }
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withDocumentation(Url documentation) {
        Utils.checkNotNull(documentation, "documentation");
     ...
     * In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
     */
    public EntityOrganizationLinks withDocumentation(Optional<? extends Url> documentation) {
        Utils.checkNotNull(documentation, "documentation");
        this.documentation = documentation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EntityOrganizationLinks other = (EntityOrganizationLinks) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EntityOrganizationLinks.class,
                "self", self,
                "dashboard", dashboard,
    ...
    public final static class Builder {
        ...
        public EntityOrganizationLinks build() {

            return new EntityOrganizationLinks(
                self, dashboard, documentation);
        }
