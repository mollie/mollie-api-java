...
import com.mollie.mollie.models.errors.ListInvoicesLinks;
...
public class ListInvoicesResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListInvoicesLinks links;
    ...
    public ListInvoicesResponseBody(
            ...
            @JsonProperty("_links") ListInvoicesLinks links,
    ...
    @JsonIgnore
    public ListInvoicesLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListInvoicesResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListInvoicesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListInvoicesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
