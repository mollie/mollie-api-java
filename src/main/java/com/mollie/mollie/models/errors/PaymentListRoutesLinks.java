...
public class PaymentListRoutesLinks {
    ...
    private PaymentListRoutesDocumentation documentation;

    @JsonCreator
    public PaymentListRoutesLinks(
            @JsonProperty("documentation") PaymentListRoutesDocumentation documentation) {
     ...
     */
    @JsonIgnore
    public PaymentListRoutesDocumentation documentation() {
