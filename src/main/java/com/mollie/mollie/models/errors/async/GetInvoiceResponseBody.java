...
import com.mollie.mollie.models.errors.GetInvoiceLinks;
...
public class GetInvoiceResponseBody extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetInvoiceResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetInvoiceResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
