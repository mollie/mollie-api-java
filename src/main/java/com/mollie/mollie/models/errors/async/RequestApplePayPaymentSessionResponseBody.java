...
import com.mollie.mollie.models.errors.RequestApplePayPaymentSessionLinks;
...
public class RequestApplePayPaymentSessionResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private RequestApplePayPaymentSessionLinks links;
    ...
    public RequestApplePayPaymentSessionResponseBody(
            ...
            @JsonProperty("_links") RequestApplePayPaymentSessionLinks links,
    ...
    public RequestApplePayPaymentSessionResponseBody(
            ...
            String title,
            String detail,
            RequestApplePayPaymentSessionLinks links) {
    ...
    @JsonIgnore
    public RequestApplePayPaymentSessionLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public RequestApplePayPaymentSessionResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RequestApplePayPaymentSessionResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RequestApplePayPaymentSessionResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
