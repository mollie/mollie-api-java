...
import com.mollie.mollie.models.errors.ListAllRefundsLinks;
...
public class ListAllRefundsResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListAllRefundsLinks links;
    ...
    public ListAllRefundsResponseBody(
            ...
            @JsonProperty("_links") ListAllRefundsLinks links,
    ...
    @JsonIgnore
    public ListAllRefundsLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListAllRefundsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListAllRefundsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListAllRefundsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
