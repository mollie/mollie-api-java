...
import com.mollie.mollie.models.errors.CreateClientLinkLinks;
...
public class CreateClientLinkResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private CreateClientLinkLinks links;
    ...
    public CreateClientLinkResponseBody(
            ...
            @JsonProperty("_links") CreateClientLinkLinks links,
    ...
    @JsonIgnore
    public CreateClientLinkLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public CreateClientLinkResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateClientLinkResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateClientLinkResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
