...
import com.mollie.mollie.models.errors.ListSettlementChargebacksLinks;
...
public class ListSettlementChargebacksResponseBody extends RuntimeException {
    /**
    ...
    @JsonProperty("_links")
    private ListSettlementChargebacksLinks links;
    ...
    public ListSettlementChargebacksResponseBody(
            ...
            @JsonProperty("_links") ListSettlementChargebacksLinks links,
    ...
    public ListSettlementChargebacksResponseBody(
            ...
            String title,
            String detail,
            ListSettlementChargebacksLinks links) {
    ...
    @JsonIgnore
    public ListSettlementChargebacksLinks links() {
        return links;
    }
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListSettlementChargebacksResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListSettlementChargebacksResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListSettlementChargebacksResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSettlementChargebacksResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSettlementChargebacksResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
