...
import com.mollie.mollie.models.errors.ListChargebacksLinks;
...
public class ListChargebacksResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListChargebacksLinks links;
    ...
    public ListChargebacksResponseBody(
            ...
            @JsonProperty("_links") ListChargebacksLinks links,
    ...
    @JsonIgnore
    public ListChargebacksLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListChargebacksResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListChargebacksResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListChargebacksResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
