...
import com.mollie.mollie.models.errors.GetOrganizationLinks;
...
public class GetOrganizationResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private GetOrganizationLinks links;
    ...
    public GetOrganizationResponseBody(
            ...
            @JsonProperty("_links") GetOrganizationLinks links,
    ...
    @JsonIgnore
    public GetOrganizationLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public GetOrganizationResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetOrganizationResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetOrganizationResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
