...
import com.mollie.mollie.models.errors.ListSettlementsLinks;
...
public class ListSettlementsResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListSettlementsLinks links;
    ...
    public ListSettlementsResponseBody(
            ...
            @JsonProperty("_links") ListSettlementsLinks links,
    ...
    @JsonIgnore
    public ListSettlementsLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListSettlementsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSettlementsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSettlementsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
