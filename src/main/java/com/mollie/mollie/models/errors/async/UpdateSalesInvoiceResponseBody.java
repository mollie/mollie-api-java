...
import com.mollie.mollie.models.errors.UpdateSalesInvoiceLinks;
...
public class UpdateSalesInvoiceResponseBody extends RuntimeException {
    /**
    ...
    @JsonProperty("_links")
    private UpdateSalesInvoiceLinks links;
    ...
    public UpdateSalesInvoiceResponseBody(
            ...
            @JsonProperty("_links") UpdateSalesInvoiceLinks links,
    ...
    @JsonIgnore
    public UpdateSalesInvoiceLinks links() {
        return links;
    }
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public UpdateSalesInvoiceResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public UpdateSalesInvoiceResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public UpdateSalesInvoiceResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public UpdateSalesInvoiceResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public UpdateSalesInvoiceResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateSalesInvoiceResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateSalesInvoiceResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
