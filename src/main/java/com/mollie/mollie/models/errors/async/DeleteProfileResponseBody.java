...
import com.mollie.mollie.models.errors.DeleteProfileLinks;
...
public class DeleteProfileResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private DeleteProfileLinks links;
    ...
    public DeleteProfileResponseBody(
            ...
            @JsonProperty("_links") DeleteProfileLinks links,
    ...
    @JsonIgnore
    public DeleteProfileLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public DeleteProfileResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteProfileResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteProfileResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
