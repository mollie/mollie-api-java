...
import com.mollie.mollie.models.errors.ListCustomersLinks;
...
public class ListCustomersResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListCustomersLinks links;
    ...
    public ListCustomersResponseBody(
            ...
            @JsonProperty("_links") ListCustomersLinks links,
    ...
    @JsonIgnore
    public ListCustomersLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListCustomersResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListCustomersResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListCustomersResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
