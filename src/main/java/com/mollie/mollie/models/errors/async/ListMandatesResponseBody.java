...
import com.mollie.mollie.models.errors.ListMandatesLinks;
...
public class ListMandatesResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListMandatesLinks links;
    ...
    public ListMandatesResponseBody(
            ...
            @JsonProperty("_links") ListMandatesLinks links,
    ...
    @JsonIgnore
    public ListMandatesLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListMandatesResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListMandatesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListMandatesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
