...
import com.mollie.mollie.models.errors.CreatePaymentPaymentsLinks;
...
public class CreatePaymentPaymentsResponseBody extends RuntimeException {
     ...
     * of the field that caused the issue.
     */
    public CreatePaymentPaymentsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentPaymentsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentPaymentsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
