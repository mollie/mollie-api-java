...
import com.mollie.mollie.models.errors.CreatePaymentLinkLinks;
...
public class CreatePaymentLinkResponseBody extends RuntimeException {
     ...
     * of the field that caused the issue.
     */
    public CreatePaymentLinkResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentLinkResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentLinkResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
