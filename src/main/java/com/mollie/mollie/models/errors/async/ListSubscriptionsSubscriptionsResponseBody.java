...
import com.mollie.mollie.models.errors.ListSubscriptionsSubscriptionsLinks;
...
public class ListSubscriptionsSubscriptionsResponseBody extends RuntimeException {
     ...
     * of the field that caused the issue.
     */
    public ListSubscriptionsSubscriptionsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionsSubscriptionsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionsSubscriptionsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
