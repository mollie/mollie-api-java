...
/**
 * ListPaymentLinksResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class ListPaymentLinksResponseBody extends RuntimeException {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListPaymentLinksLinks> links;
    ...
    @JsonCreator
    public ListPaymentLinksResponseBody(
            ...
            @JsonProperty("_links") Optional<? extends ListPaymentLinksLinks> links,
    ...
    public Optional<ListPaymentLinksLinks> links(){
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListPaymentLinksResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListPaymentLinksResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListPaymentLinksResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListPaymentLinksResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListPaymentLinksResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListPaymentLinksResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public ListPaymentLinksResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public ListPaymentLinksResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public ListPaymentLinksResponseBody withLinks(ListPaymentLinksLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }
    
    public ListPaymentLinksResponseBody withLinks(Optional<? extends ListPaymentLinksLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentLinksResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentLinksResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentLinksResponseBody other = (ListPaymentLinksResponseBody) o;
        return
    ...
    public String toString() {
        return Utils.toString(ListPaymentLinksResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public Builder links(ListPaymentLinksLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
        
        public Builder links(Optional<? extends ListPaymentLinksLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
