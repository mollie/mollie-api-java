...
import com.mollie.mollie.models.errors.CreateCaptureCapturesLinks;
...
public class CreateCaptureCapturesResponseBody extends RuntimeException {
    ...
    @JsonIgnore
    public CreateCaptureCapturesLinks links() {
        return links;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateCaptureCapturesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateCaptureCapturesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
