...
import com.mollie.mollie.models.errors.ListCapturesLinks;
...
public class ListCapturesResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListCapturesLinks links;
    ...
    public ListCapturesResponseBody(
            ...
            @JsonProperty("_links") ListCapturesLinks links,
    ...
    @JsonIgnore
    public ListCapturesLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListCapturesResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListCapturesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListCapturesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
