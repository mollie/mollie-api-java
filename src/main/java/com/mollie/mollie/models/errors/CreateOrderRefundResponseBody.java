...
public class CreateOrderRefundResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private CreateOrderRefundLinks links;
    ...
    @JsonIgnore
    public CreateOrderRefundLinks links() {
        return links;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public CreateOrderRefundResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
