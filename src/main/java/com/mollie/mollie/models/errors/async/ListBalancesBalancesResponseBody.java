...
import com.mollie.mollie.models.errors.ListBalancesLinks;
...
public class ListBalancesBalancesResponseBody extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalancesBalancesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalancesBalancesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
