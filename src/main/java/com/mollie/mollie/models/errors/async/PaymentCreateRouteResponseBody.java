...
import com.mollie.mollie.models.errors.PaymentCreateRouteLinks;
...
public class PaymentCreateRouteResponseBody extends RuntimeException {
     ...
     * of the field that caused the issue.
     */
    public PaymentCreateRouteResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PaymentCreateRouteResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PaymentCreateRouteResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
