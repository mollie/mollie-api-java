...
import com.mollie.mollie.models.errors.ListPermissionsLinks;
...
public class ListPermissionsResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListPermissionsLinks links;
    ...
    public ListPermissionsResponseBody(
            ...
            @JsonProperty("_links") ListPermissionsLinks links,
    ...
    @JsonIgnore
    public ListPermissionsLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListPermissionsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPermissionsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPermissionsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
