...
/**
 * RequestApplePayPaymentSessionResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class RequestApplePayPaymentSessionResponseBody extends RuntimeException {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends RequestApplePayPaymentSessionLinks> links;
    ...
    public RequestApplePayPaymentSessionResponseBody(
            ...
            @JsonProperty("_links") Optional<? extends RequestApplePayPaymentSessionLinks> links,
    ...
    public Optional<RequestApplePayPaymentSessionLinks> links(){
        return (Optional<RequestApplePayPaymentSessionLinks>) links;
    }
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public RequestApplePayPaymentSessionResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public RequestApplePayPaymentSessionResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public RequestApplePayPaymentSessionResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public RequestApplePayPaymentSessionResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public RequestApplePayPaymentSessionResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public RequestApplePayPaymentSessionResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public RequestApplePayPaymentSessionResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public RequestApplePayPaymentSessionResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public RequestApplePayPaymentSessionResponseBody withLinks(RequestApplePayPaymentSessionLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }
    
    public RequestApplePayPaymentSessionResponseBody withLinks(Optional<? extends RequestApplePayPaymentSessionLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RequestApplePayPaymentSessionResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RequestApplePayPaymentSessionResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends RequestApplePayPaymentSessionLinks> links = Optional.empty();
        ...
        public Builder links(RequestApplePayPaymentSessionLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = Optional.ofNullable(links);
            return this;
        }
        
        public Builder links(Optional<? extends RequestApplePayPaymentSessionLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
