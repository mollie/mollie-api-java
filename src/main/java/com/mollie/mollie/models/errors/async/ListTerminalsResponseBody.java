...
import com.mollie.mollie.models.errors.ListTerminalsLinks;
...
public class ListTerminalsResponseBody extends RuntimeException {
    ...
    public ListTerminalsResponseBody(
            ...
            @JsonProperty("_links") ListTerminalsLinks links,
    ...
    @JsonIgnore
    public ListTerminalsLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListTerminalsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListTerminalsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListTerminalsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
