...
import com.mollie.mollie.models.errors.GetRefundLinks;
...
public class GetRefundResponseBody extends RuntimeException {
    ...
    public GetRefundResponseBody(
            ...
            @JsonProperty("_links") GetRefundLinks links,
     ...
     * of the field that caused the issue.
     */
    public GetRefundResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRefundResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRefundResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
