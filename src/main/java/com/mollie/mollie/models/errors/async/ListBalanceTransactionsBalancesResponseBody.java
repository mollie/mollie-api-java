...
import com.mollie.mollie.models.errors.ListBalanceTransactionsBalancesLinks;
...
public class ListBalanceTransactionsBalancesResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListBalanceTransactionsBalancesLinks links;
    ...
    public ListBalanceTransactionsBalancesResponseBody(
            ...
            @JsonProperty("_links") ListBalanceTransactionsBalancesLinks links,
    ...
    public ListBalanceTransactionsBalancesResponseBody(
            ...
            String title,
            String detail,
            ListBalanceTransactionsBalancesLinks links) {
    ...
    @JsonIgnore
    public ListBalanceTransactionsBalancesLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListBalanceTransactionsBalancesResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalanceTransactionsBalancesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalanceTransactionsBalancesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
