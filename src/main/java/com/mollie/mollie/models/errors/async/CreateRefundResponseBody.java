...
import com.mollie.mollie.models.errors.CreateRefundLinks;
...
public class CreateRefundResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private CreateRefundLinks links;
    ...
    public CreateRefundResponseBody(
            ...
            @JsonProperty("_links") CreateRefundLinks links,
    ...
    @JsonIgnore
    public CreateRefundLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public CreateRefundResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateRefundResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateRefundResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
