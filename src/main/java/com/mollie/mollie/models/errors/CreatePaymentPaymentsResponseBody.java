...
/**
 * CreatePaymentPaymentsResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class CreatePaymentPaymentsResponseBody extends RuntimeException {
    ...
    @JsonCreator
    public CreatePaymentPaymentsResponseBody(
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public CreatePaymentPaymentsResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public CreatePaymentPaymentsResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public CreatePaymentPaymentsResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public CreatePaymentPaymentsResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public CreatePaymentPaymentsResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public CreatePaymentPaymentsResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public CreatePaymentPaymentsResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public CreatePaymentPaymentsResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
    ...
    public CreatePaymentPaymentsResponseBody withLinks(Optional<? extends CreatePaymentPaymentsLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentPaymentsResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePaymentPaymentsResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePaymentPaymentsResponseBody other = (CreatePaymentPaymentsResponseBody) o;
        return
    ...
    public String toString() {
        return Utils.toString(CreatePaymentPaymentsResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public CreatePaymentPaymentsResponseBody build() {
            return new CreatePaymentPaymentsResponseBody(
                status,
                title,
                detail,
                field,
