...
/**
 * CreateRefundRefundsDocumentation - The URL to the generic Mollie API error handling guide.
 */
...
public class CreateRefundRefundsDocumentation {
    ...
    public CreateRefundRefundsDocumentation withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }
    ...
    public CreateRefundRefundsDocumentation withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
