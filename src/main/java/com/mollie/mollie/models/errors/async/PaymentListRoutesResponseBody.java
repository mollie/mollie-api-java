...
import com.mollie.mollie.models.errors.PaymentListRoutesLinks;
...
public class PaymentListRoutesResponseBody extends RuntimeException {
    ...
    @JsonIgnore
    public PaymentListRoutesLinks links() {
        return links;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PaymentListRoutesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PaymentListRoutesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
