...
import com.mollie.mollie.models.errors.ListPaymentLinksLinks;
...
public class ListPaymentLinksResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListPaymentLinksLinks links;
    ...
    public ListPaymentLinksResponseBody(
            ...
            @JsonProperty("_links") ListPaymentLinksLinks links,
    ...
    @JsonIgnore
    public ListPaymentLinksLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListPaymentLinksResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentLinksResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentLinksResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
