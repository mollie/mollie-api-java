...
import com.mollie.mollie.models.errors.ListProfilesLinks;
...
public class ListProfilesResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListProfilesLinks links;
    ...
    public ListProfilesResponseBody(
            ...
            @JsonProperty("_links") ListProfilesLinks links,
    ...
    @JsonIgnore
    public ListProfilesLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListProfilesResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListProfilesResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListProfilesResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
