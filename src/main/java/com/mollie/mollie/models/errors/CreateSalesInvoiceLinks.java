...
public class CreateSalesInvoiceLinks {
    ...
    private CreateSalesInvoiceDocumentation documentation;

    @JsonCreator
    public CreateSalesInvoiceLinks(
            @JsonProperty("documentation") CreateSalesInvoiceDocumentation documentation) {
     ...
     */
    @JsonIgnore
    public CreateSalesInvoiceDocumentation documentation() {
