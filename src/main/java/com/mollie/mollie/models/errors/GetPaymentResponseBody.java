...
/**
 * GetPaymentResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class GetPaymentResponseBody extends RuntimeException {
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public GetPaymentResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public GetPaymentResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public GetPaymentResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public GetPaymentResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public GetPaymentResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public GetPaymentResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public GetPaymentResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public GetPaymentResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPaymentResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPaymentResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
