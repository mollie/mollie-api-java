...
import com.mollie.mollie.models.errors.TestWebhookLinks;
...
public class TestWebhookResponseBody extends RuntimeException {
    /**
    ...
    @JsonProperty("_links")
    private TestWebhookLinks links;
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public TestWebhookResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public TestWebhookResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public TestWebhookResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public TestWebhookResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public TestWebhookResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public TestWebhookResponseBody withLinks(TestWebhookLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public TestWebhookResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public TestWebhookResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TestWebhookResponseBody other = (TestWebhookResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TestWebhookResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public Builder links(TestWebhookLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        public TestWebhookResponseBody build() {

            return new TestWebhookResponseBody(
                status, title, detail,
                field, links, rawResponse);
        }
