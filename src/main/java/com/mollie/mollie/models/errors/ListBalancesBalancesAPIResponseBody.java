...
/**
 * ListBalancesBalancesAPIResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class ListBalancesBalancesAPIResponseBody extends RuntimeException {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    private Optional<? extends ListBalancesLinks> links;
    ...
    @JsonCreator
    public ListBalancesBalancesAPIResponseBody(
    ...
    public Optional<ListBalancesLinks> links(){
        return (Optional<ListBalancesLinks>) links;
    }
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListBalancesBalancesAPIResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListBalancesBalancesAPIResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListBalancesBalancesAPIResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListBalancesBalancesAPIResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListBalancesBalancesAPIResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListBalancesBalancesAPIResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public ListBalancesBalancesAPIResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public ListBalancesBalancesAPIResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public ListBalancesBalancesAPIResponseBody withLinks(ListBalancesLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }
    
    public ListBalancesBalancesAPIResponseBody withLinks(Optional<? extends ListBalancesLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalancesBalancesAPIResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBalancesBalancesAPIResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListBalancesBalancesAPIResponseBody other = (ListBalancesBalancesAPIResponseBody) o;
        return
    ...
    public String toString() {
        return Utils.toString(ListBalancesBalancesAPIResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public Builder links(Optional<? extends ListBalancesLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        public ListBalancesBalancesAPIResponseBody build() {
            return new ListBalancesBalancesAPIResponseBody(
                status,
                title,
                detail,
                field,
