...
/**
 * ListRefundsRefundsResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class ListRefundsRefundsResponseBody extends RuntimeException {
    ...
    @JsonCreator
    public ListRefundsRefundsResponseBody(
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListRefundsRefundsResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public ListRefundsRefundsResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListRefundsRefundsResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public ListRefundsRefundsResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListRefundsRefundsResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public ListRefundsRefundsResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public ListRefundsRefundsResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue.
     */
    public ListRefundsRefundsResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public ListRefundsRefundsResponseBody withLinks(ListRefundsRefundsLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }
    
    public ListRefundsRefundsResponseBody withLinks(Optional<? extends ListRefundsRefundsLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListRefundsRefundsResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListRefundsRefundsResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListRefundsRefundsResponseBody other = (ListRefundsRefundsResponseBody) o;
        return
    ...
    public String toString() {
        return Utils.toString(ListRefundsRefundsResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public ListRefundsRefundsResponseBody build() {
            return new ListRefundsRefundsResponseBody(
                status,
                title,
                detail,
                field,
