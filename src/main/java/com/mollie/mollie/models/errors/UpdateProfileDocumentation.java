...
/**
 * UpdateProfileDocumentation - The URL to the generic Mollie API error handling guide.
 */
...
public class UpdateProfileDocumentation {
    ...
    @JsonCreator
    public UpdateProfileDocumentation(
    ...
    public UpdateProfileDocumentation withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }

    public UpdateProfileDocumentation withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public UpdateProfileDocumentation withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateProfileDocumentation other = (UpdateProfileDocumentation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateProfileDocumentation.class,
                "href", href,
                "type", type);
    }
