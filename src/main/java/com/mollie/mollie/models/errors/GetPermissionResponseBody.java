...
/**
 * GetPermissionResponseBody - An error response object.
 */
...
public class GetPermissionResponseBody extends RuntimeException {
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public GetPermissionResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public GetPermissionResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public GetPermissionResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public GetPermissionResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public GetPermissionResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
