...
import com.mollie.mollie.models.errors.ListSubscriptionPaymentsLinks;
...
public class ListSubscriptionPaymentsResponseBody extends RuntimeException {
    ...
    public ListSubscriptionPaymentsResponseBody(
            ...
            String title,
            String detail,
            ListSubscriptionPaymentsLinks links) {
     ...
     * of the field that caused the issue.
     */
    public ListSubscriptionPaymentsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionPaymentsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionPaymentsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
