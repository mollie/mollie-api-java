...
/**
 * GetSettlementResponseBody - An error response object.
 */
@SuppressWarnings("serial")
public class GetSettlementResponseBody extends RuntimeException {
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public GetSettlementResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public GetSettlementResponseBody withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public GetSettlementResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public GetSettlementResponseBody withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public GetSettlementResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public GetSettlementResponseBody withDetail(Optional<String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public GetSettlementResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public GetSettlementResponseBody withField(JsonNullable<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSettlementResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSettlementResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
