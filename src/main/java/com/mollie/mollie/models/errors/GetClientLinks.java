...
public class GetClientLinks {
    ...
    private GetClientDocumentation documentation;

    @JsonCreator
    public GetClientLinks(
            @JsonProperty("documentation") GetClientDocumentation documentation) {
     ...
     */
    @JsonIgnore
    public GetClientDocumentation documentation() {
