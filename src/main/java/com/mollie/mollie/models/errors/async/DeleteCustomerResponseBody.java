...
import com.mollie.mollie.models.errors.DeleteCustomerLinks;
...
public class DeleteCustomerResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private DeleteCustomerLinks links;
    ...
    public DeleteCustomerResponseBody(
            ...
            @JsonProperty("_links") DeleteCustomerLinks links,
    ...
    @JsonIgnore
    public DeleteCustomerLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public DeleteCustomerResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteCustomerResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteCustomerResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
