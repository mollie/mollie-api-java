...
import com.mollie.mollie.models.errors.UpdateProfileLinks;
...
public class UpdateProfileResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private UpdateProfileLinks links;
    ...
    public UpdateProfileResponseBody(
            ...
            @JsonProperty("_links") UpdateProfileLinks links,
    ...
    @JsonIgnore
    public UpdateProfileLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public UpdateProfileResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateProfileResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateProfileResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
