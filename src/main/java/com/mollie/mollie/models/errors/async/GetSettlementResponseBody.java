...
import com.mollie.mollie.models.errors.GetSettlementLinks;
...
public class GetSettlementResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private GetSettlementLinks links;
    ...
    public GetSettlementResponseBody(
            ...
            @JsonProperty("_links") GetSettlementLinks links,
    ...
    @JsonIgnore
    public GetSettlementLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public GetSettlementResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSettlementResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSettlementResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
