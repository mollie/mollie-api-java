...
import com.mollie.mollie.models.errors.ListSubscriptionsLinks;
...
public class ListSubscriptionsResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private ListSubscriptionsLinks links;
    ...
    public ListSubscriptionsResponseBody(
            ...
            @JsonProperty("_links") ListSubscriptionsLinks links,
    ...
    @JsonIgnore
    public ListSubscriptionsLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public ListSubscriptionsResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionsResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSubscriptionsResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
