...
import com.mollie.mollie.models.errors.RevokeMandateLinks;
...
public class RevokeMandateResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private RevokeMandateLinks links;
    ...
    public RevokeMandateResponseBody(
            ...
            @JsonProperty("_links") RevokeMandateLinks links,
    ...
    @JsonIgnore
    public RevokeMandateLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public RevokeMandateResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RevokeMandateResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RevokeMandateResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
