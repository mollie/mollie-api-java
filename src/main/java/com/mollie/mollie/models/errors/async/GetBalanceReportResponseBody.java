...
import com.mollie.mollie.models.errors.GetBalanceReportLinks;
...
public class GetBalanceReportResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private GetBalanceReportLinks links;
    ...
    public GetBalanceReportResponseBody(
            ...
            @JsonProperty("_links") GetBalanceReportLinks links,
    ...
    @JsonIgnore
    public GetBalanceReportLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public GetBalanceReportResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBalanceReportResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBalanceReportResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
