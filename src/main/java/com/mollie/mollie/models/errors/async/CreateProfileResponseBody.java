...
import com.mollie.mollie.models.errors.CreateProfileLinks;
...
public class CreateProfileResponseBody extends RuntimeException {
    ...
    @JsonProperty("_links")
    private CreateProfileLinks links;
    ...
    public CreateProfileResponseBody(
            ...
            @JsonProperty("_links") CreateProfileLinks links,
    ...
    @JsonIgnore
    public CreateProfileLinks links() {
        return links;
    }
     ...
     * of the field that caused the issue.
     */
    public CreateProfileResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateProfileResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateProfileResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
