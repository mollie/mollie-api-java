...
import com.mollie.mollie.models.errors.DeleteWebhookLinks;
...
public class DeleteWebhookResponseBody extends RuntimeException {
    /**
    ...
    @JsonProperty("_links")
    private DeleteWebhookLinks links;
    ...
    @JsonIgnore
    public DeleteWebhookLinks links() {
        return links;
    }
     ...
     * The status code of the error message. This is always the same code as the status code of the HTTP message itself.
     */
    public DeleteWebhookResponseBody withStatus(long status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The HTTP reason phrase of the error. For example, for a `404` error, the `title` will be `Not Found`.
     */
    public DeleteWebhookResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A detailed human-readable description of the error that occurred.
     */
    public DeleteWebhookResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * of the field that caused the issue.
     */
    public DeleteWebhookResponseBody withField(String field) {
        Utils.checkNotNull(field, "field");
     ...
     * of the field that caused the issue.
     */
    public DeleteWebhookResponseBody withField(Optional<String> field) {
        Utils.checkNotNull(field, "field");
        this.field = field;
        return this;
    }

    public DeleteWebhookResponseBody withLinks(DeleteWebhookLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteWebhookResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteWebhookResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteWebhookResponseBody other = (DeleteWebhookResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteWebhookResponseBody.class,
                "status", status,
                "title", title,
                "detail", detail,
                "field", field,
    ...
    public final static class Builder {
        ...
        public Builder links(DeleteWebhookLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        ...
        public DeleteWebhookResponseBody build() {

            return new DeleteWebhookResponseBody(
                status, title, detail,
                field, links, rawResponse);
        }
