...
public class CancelRefundDocumentation {
    ...
    @JsonCreator
    public CancelRefundDocumentation(
    ...
    public CancelRefundDocumentation withHref(String href) {
        Utils.checkNotNull(href, "href");
        this.href = Optional.ofNullable(href);
        return this;
    }

    public CancelRefundDocumentation withHref(Optional<String> href) {
        Utils.checkNotNull(href, "href");
        this.href = href;
        return this;
    }

    public CancelRefundDocumentation withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public CancelRefundDocumentation withType(Optional<String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CancelRefundDocumentation other = (CancelRefundDocumentation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CancelRefundDocumentation.class,
                "href", href,
                "type", type);
    }
    ...
    public final static class Builder {
        ...
        public CancelRefundDocumentation build() {
            if (href == null) {
            ...
            return new CancelRefundDocumentation(
                href,
                type);
        }
