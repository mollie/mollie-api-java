...
public class CustomersAPI implements
    ...
    CustomersAPI(SDKConfiguration sdkConfiguration) {
    ...
    public ListCustomersResponse listCustomers(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "404")) {
            if (Utils.contentTypeMatches(_contentType, "application/hal+json")) {
                ListCustomersCustomersAPIResponseBody _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ListCustomersCustomersAPIResponseBody>() {});
                    _out.withRawResponse(Optional.ofNullable(_httpRes));
