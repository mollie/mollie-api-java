...
public class Methods implements
     ...
     * @throws Exception if the API call fails
     */
    public ListAllMethodsResponse listAllDirect() throws Exception {
        return listAll(Optional.empty(), Optional.empty(), JsonNullable.undefined(), Optional.empty());
    }
    ...
    * `pricing`: Include pricing for each payment method.
    ...
    public EnableMethodResponse enableMethod(
        ...
        return enableMethod(profileId, id, Optional.empty());
    }
    ...
    public DisableMethodResponse disableMethod(
            String profileId,
            String id) throws Exception {
        return disableMethod(profileId, id, Optional.empty());
    }
    ...
    public EnableMethodIssuerResponse enableMethodIssuer(
            ...
            String methodId,
            String id) throws Exception {
        return enableMethodIssuer(profileId, methodId, id, Optional.empty(), Optional.empty());
    }
    ...
    public DisableMethodIssuerResponse disableMethodIssuer(
            ...
            String methodId,
            String id) throws Exception {
        return disableMethodIssuer(profileId, methodId, id, Optional.empty());
    }
