...
import com.mollie.mollie.models.operations.GetSalesInvoiceResponseBody;
...
public class GetSalesInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSalesInvoiceRequest, GetSalesInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetSalesInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSalesInvoiceRequest.class);
        ...
        @Override
        public GetSalesInvoiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSalesInvoiceResponse.Builder resBuilder =
            ...
            GetSalesInvoiceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetSalesInvoiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetSalesInvoiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSalesInvoiceRequest, com.mollie.mollie.models.operations.async.GetSalesInvoiceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSalesInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSalesInvoiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSalesInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetSalesInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetSalesInvoiceResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetSalesInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetSalesInvoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetSalesInvoiceResponseBody out;
                        try {
