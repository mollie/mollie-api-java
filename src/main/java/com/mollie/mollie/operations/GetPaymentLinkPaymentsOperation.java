...
public class GetPaymentLinkPaymentsOperation implements RequestOperation<GetPaymentLinkPaymentsRequest, GetPaymentLinkPaymentsResponse> {
    ...
    public GetPaymentLinkPaymentsOperation(
    ...
    public HttpRequest buildRequest(GetPaymentLinkPaymentsRequest request) throws Exception {
