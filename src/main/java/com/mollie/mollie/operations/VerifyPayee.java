...
public class VerifyPayee {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyPayeeRequest, VerifyPayeeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VerifyPayeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VerifyPayeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyPayeeRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "422", "429", "4XX", "503", "5XX")) {
        ...
        @Override
        public VerifyPayeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyPayeeResponse.Builder resBuilder =
                    VerifyPayeeResponse
                            .builder()
            ...
            VerifyPayeeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withVerificationOfPayeeResponse(Utils.unmarshal(response, new TypeReference<VerificationOfPayeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VerifyPayeeRequest, com.mollie.mollie.models.operations.async.VerifyPayeeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VerifyPayeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VerifyPayeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VerifyPayeeRequest request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "422", "429", "4XX", "503", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.VerifyPayeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.VerifyPayeeResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.VerifyPayeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.VerifyPayeeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VerificationOfPayeeResponse>() {})
                            .thenApply(res::withVerificationOfPayeeResponse);
                } else {
