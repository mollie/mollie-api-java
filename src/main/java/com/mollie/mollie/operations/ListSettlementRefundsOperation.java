...
public class ListSettlementRefundsOperation implements RequestOperation<ListSettlementRefundsRequest, ListSettlementRefundsResponse> {
    ...
    public ListSettlementRefundsOperation(
    ...
    public HttpRequest buildRequest(ListSettlementRefundsRequest request) throws Exception {
