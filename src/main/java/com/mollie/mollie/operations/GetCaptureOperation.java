...
public class GetCaptureOperation implements RequestOperation<GetCaptureRequest, GetCaptureResponse> {
    ...
    public HttpRequest buildRequest(GetCaptureRequest request) throws Exception {
