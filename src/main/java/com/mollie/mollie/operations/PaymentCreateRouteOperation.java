...
public class PaymentCreateRouteOperation implements RequestOperation<PaymentCreateRouteRequest, PaymentCreateRouteResponse> {
    ...
    public PaymentCreateRouteOperation(
    ...
    public HttpRequest buildRequest(PaymentCreateRouteRequest request) throws Exception {
