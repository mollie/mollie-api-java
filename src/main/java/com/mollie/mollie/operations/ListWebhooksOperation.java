...
public class ListWebhooksOperation implements RequestOperation<ListWebhooksRequest, ListWebhooksResponse> {
    ...
    public HttpRequest buildRequest(ListWebhooksRequest request) throws Exception {
