...
public class CreateClientLinkOperation implements RequestOperation<Optional<? extends CreateClientLinkRequestBody>, CreateClientLinkResponse> {
    ...
    public CreateClientLinkOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateClientLinkRequestBody> request) throws Exception {
