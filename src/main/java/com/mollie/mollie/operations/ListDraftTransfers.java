...
import com.mollie.mollie.models.operations.ListDraftTransfersResponseBody;
...
public class ListDraftTransfers {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/v2/business-accounts/draft-transfers");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDraftTransfersRequest, ListDraftTransfersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDraftTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDraftTransfersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDraftTransfersRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListDraftTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListDraftTransfersRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListDraftTransfersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDraftTransfersResponse.Builder resBuilder =
            ...
            ListDraftTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListDraftTransfersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDraftTransfersRequest, com.mollie.mollie.models.operations.async.ListDraftTransfersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDraftTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDraftTransfersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDraftTransfersRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDraftTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListDraftTransfersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListDraftTransfersResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListDraftTransfersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListDraftTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDraftTransfersResponseBody>() {})
