...
public class ReturnUnmatchedCreditTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReturnUnmatchedCreditTransferRequest, ReturnUnmatchedCreditTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReturnUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReturnUnmatchedCreditTransferRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReturnUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public ReturnUnmatchedCreditTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReturnUnmatchedCreditTransferResponse.Builder resBuilder =
            ...
            ReturnUnmatchedCreditTransferResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReturnUnmatchedCreditTransferRequest, com.mollie.mollie.models.operations.async.ReturnUnmatchedCreditTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ReturnUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReturnUnmatchedCreditTransferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReturnUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ReturnUnmatchedCreditTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ReturnUnmatchedCreditTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ReturnUnmatchedCreditTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ReturnUnmatchedCreditTransferResponse res = resBuilder.build();
