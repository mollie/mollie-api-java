...
public class GetPayout {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPayoutRequest, com.mollie.mollie.models.operations.async.GetPayoutResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetPayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetPayoutResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetPayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetPayoutResponse res = resBuilder.build();
