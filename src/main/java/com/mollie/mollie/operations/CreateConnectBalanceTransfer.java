...
public class CreateConnectBalanceTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateConnectBalanceTransferRequest, CreateConnectBalanceTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateConnectBalanceTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateConnectBalanceTransferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateConnectBalanceTransferRequest request) {
        ...
        @Override
        public CreateConnectBalanceTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateConnectBalanceTransferResponse.Builder resBuilder =
            ...
            CreateConnectBalanceTransferResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateConnectBalanceTransferRequest, com.mollie.mollie.models.operations.async.CreateConnectBalanceTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateConnectBalanceTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateConnectBalanceTransferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateConnectBalanceTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateConnectBalanceTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateConnectBalanceTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateConnectBalanceTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateConnectBalanceTransferResponse res = resBuilder.build();
