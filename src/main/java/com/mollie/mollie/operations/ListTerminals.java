...
public class ListTerminals {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTerminalsRequest, ListTerminalsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTerminalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTerminalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTerminalsRequest request) {
        ...
        @Override
        public ListTerminalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTerminalsResponse.Builder resBuilder =
            ...
            ListTerminalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListTerminalsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTerminalsRequest, com.mollie.mollie.models.operations.async.ListTerminalsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTerminalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTerminalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTerminalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListTerminalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListTerminalsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListTerminalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListTerminalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListTerminalsResponseBody>() {})
