...
public class GetSettlementOperation implements RequestOperation<GetSettlementRequest, GetSettlementResponse> {
    ...
    public HttpRequest buildRequest(GetSettlementRequest request) throws Exception {
