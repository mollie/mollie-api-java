...
public class UpdateSalesInvoiceOperation implements RequestOperation<UpdateSalesInvoiceRequest, UpdateSalesInvoiceResponse> {
    ...
    public UpdateSalesInvoiceOperation(
    ...
    public HttpRequest buildRequest(UpdateSalesInvoiceRequest request) throws Exception {
