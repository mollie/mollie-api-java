...
public class ListAllSubscriptionsOperation implements RequestOperation<ListAllSubscriptionsRequest, ListAllSubscriptionsResponse> {
    ...
    public ListAllSubscriptionsOperation(
    ...
    public HttpRequest buildRequest(ListAllSubscriptionsRequest request) throws Exception {
