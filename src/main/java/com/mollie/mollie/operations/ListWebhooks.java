...
public class ListWebhooks {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListWebhooksRequest request) throws Exception {
        ...
        @Override
        public ListWebhooksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    ListWebhooksResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.ListWebhooksResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListWebhooksResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.ListWebhooksResponseBody out;
                        try {
