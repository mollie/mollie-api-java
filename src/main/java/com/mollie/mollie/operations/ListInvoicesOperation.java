...
public class ListInvoicesOperation implements RequestOperation<ListInvoicesRequest, ListInvoicesResponse> {
    ...
    public HttpRequest buildRequest(ListInvoicesRequest request) throws Exception {
