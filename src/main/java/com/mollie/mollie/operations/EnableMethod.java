...
public class EnableMethod {
    ...
    public static class Sync extends Base
            implements RequestOperation<EnableMethodRequest, EnableMethodResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EnableMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableMethodRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EnableMethodRequest request) {
        ...
        @Override
        public EnableMethodResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EnableMethodResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnableMethodRequest, com.mollie.mollie.models.operations.async.EnableMethodResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EnableMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableMethodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EnableMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.EnableMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.EnableMethodResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.EnableMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
