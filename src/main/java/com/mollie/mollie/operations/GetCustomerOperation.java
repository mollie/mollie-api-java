...
public class GetCustomerOperation implements RequestOperation<GetCustomerRequest, GetCustomerResponse> {
    ...
    public HttpRequest buildRequest(GetCustomerRequest request) throws Exception {
