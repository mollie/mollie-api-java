...
public class CreateTransfer {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTransferRequest, com.mollie.mollie.models.operations.async.CreateTransferResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransferResponse>() {})
                            .thenApply(res::withTransferResponse);
                } else {
