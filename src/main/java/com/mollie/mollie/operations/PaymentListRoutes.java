...
public class PaymentListRoutes {
    ...
    public static class Sync extends Base
            implements RequestOperation<PaymentListRoutesRequest, PaymentListRoutesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PaymentListRoutesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PaymentListRoutesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PaymentListRoutesRequest request) {
        ...
        @Override
        public PaymentListRoutesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PaymentListRoutesResponse.Builder resBuilder =
            ...
            PaymentListRoutesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<PaymentListRoutesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PaymentListRoutesRequest, com.mollie.mollie.models.operations.async.PaymentListRoutesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PaymentListRoutesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PaymentListRoutesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PaymentListRoutesRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.PaymentListRoutesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.PaymentListRoutesResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.PaymentListRoutesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.PaymentListRoutesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentListRoutesResponseBody>() {})
