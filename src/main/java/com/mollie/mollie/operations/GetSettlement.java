...
public class GetSettlement {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSettlementRequest, GetSettlementResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSettlementRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSettlementRequest request) throws Exception {
        ...
        @Override
        public GetSettlementResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSettlementResponse.Builder resBuilder =
            ...
            GetSettlementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetSettlementResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetSettlementResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSettlementRequest, com.mollie.mollie.models.operations.async.GetSettlementResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSettlementRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSettlementRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetSettlementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetSettlementResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetSettlementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetSettlementResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetSettlementResponseBody out;
                        try {
