...
public class UpdateProfile {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateProfileRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "403", "404", "410", "422", "4XX", "5XX")) {
        ...
        @Override
        public UpdateProfileResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "403", "404", "410", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateProfileRequest request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "403", "404", "410", "422", "4XX", "5XX")) {
