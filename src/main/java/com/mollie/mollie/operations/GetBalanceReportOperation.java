...
public class GetBalanceReportOperation implements RequestOperation<GetBalanceReportRequest, GetBalanceReportResponse> {
    ...
    public GetBalanceReportOperation(
    ...
    public HttpRequest buildRequest(GetBalanceReportRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetBalanceReportRequest request) throws Exception {
    ...
    @Override
    public GetBalanceReportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetBalanceReportResponse.Builder resBuilder = 
        ...
        GetBalanceReportResponse res = resBuilder.build();
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "404")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.GetBalanceReportResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetBalanceReportBalancesResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                    out.withRawResponse(response);
