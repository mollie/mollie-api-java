...
public class GetProfileOperation implements RequestOperation<GetProfileRequest, GetProfileResponse> {
    ...
    public HttpRequest buildRequest(GetProfileRequest request) throws Exception {
