...
public class ListChargebacksOperation implements RequestOperation<ListChargebacksRequest, ListChargebacksResponse> {
    ...
    public ListChargebacksOperation(
    ...
    public HttpRequest buildRequest(ListChargebacksRequest request) throws Exception {
