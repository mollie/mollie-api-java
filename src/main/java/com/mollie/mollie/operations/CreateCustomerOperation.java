...
public class CreateCustomerOperation implements RequestOperation<Optional<? extends CreateCustomerRequestBody>, CreateCustomerResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends CreateCustomerRequestBody> request) throws Exception {
