...
public class ListSubscriptions {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSubscriptionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSubscriptionsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSubscriptionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSubscriptionsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSubscriptionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSubscriptionsRequest, com.mollie.mollie.models.operations.async.ListSubscriptionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSubscriptionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSubscriptionsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSubscriptionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSubscriptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSubscriptionsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSubscriptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSubscriptionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSubscriptionsResponseBody>() {})
