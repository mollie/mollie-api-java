...
public class ListSettlementPaymentsOperation implements RequestOperation<ListSettlementPaymentsRequest, ListSettlementPaymentsResponse> {
    ...
    public ListSettlementPaymentsOperation(
    ...
    public HttpRequest buildRequest(ListSettlementPaymentsRequest request) throws Exception {
