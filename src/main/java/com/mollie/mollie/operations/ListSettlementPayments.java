...
import com.mollie.mollie.models.operations.ListSettlementPaymentsResponseBody;
...
public class ListSettlementPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSettlementPaymentsRequest, ListSettlementPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSettlementPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSettlementPaymentsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSettlementPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSettlementPaymentsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSettlementPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSettlementPaymentsResponse.Builder resBuilder =
            ...
            ListSettlementPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSettlementPaymentsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSettlementPaymentsRequest, com.mollie.mollie.models.operations.async.ListSettlementPaymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSettlementPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementPaymentsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSettlementPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSettlementPaymentsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSettlementPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSettlementPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSettlementPaymentsResponseBody>() {})
