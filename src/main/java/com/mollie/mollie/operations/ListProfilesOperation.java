...
public class ListProfilesOperation implements RequestOperation<ListProfilesRequest, ListProfilesResponse> {
    ...
    public HttpRequest buildRequest(ListProfilesRequest request) throws Exception {
