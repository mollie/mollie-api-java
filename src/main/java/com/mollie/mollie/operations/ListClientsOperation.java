...
public class ListClientsOperation implements RequestOperation<ListClientsRequest, ListClientsResponse> {
    ...
    public HttpRequest buildRequest(ListClientsRequest request) throws Exception {
