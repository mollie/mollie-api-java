...
public class GetSubscriptionOperation implements RequestOperation<GetSubscriptionRequest, GetSubscriptionResponse> {
    ...
    public GetSubscriptionOperation(
    ...
    public HttpRequest buildRequest(GetSubscriptionRequest request) throws Exception {
