...
public class GetOnboardingStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOnboardingStatusRequest, GetOnboardingStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOnboardingStatusRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOnboardingStatusRequest request) {
        ...
        @Override
        public GetOnboardingStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOnboardingStatusResponse.Builder resBuilder =
            ...
            GetOnboardingStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityOnboardingStatus(Utils.unmarshal(response, new TypeReference<EntityOnboardingStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOnboardingStatusRequest, com.mollie.mollie.models.operations.async.GetOnboardingStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetOnboardingStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOnboardingStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetOnboardingStatusResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetOnboardingStatusResponse res = resBuilder.build();
