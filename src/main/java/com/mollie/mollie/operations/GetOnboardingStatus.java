...
public class GetOnboardingStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOnboardingStatusRequest request) throws Exception {
        ...
        @Override
        public GetOnboardingStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    EntityOnboardingStatus out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEntityOnboardingStatus(out);
                    return res;
                } else {
