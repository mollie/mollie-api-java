...
public class CreateProfileOperation implements RequestOperation<CreateProfileRequestBody, CreateProfileResponse> {
    ...
    public HttpRequest buildRequest(CreateProfileRequestBody request) throws Exception {
