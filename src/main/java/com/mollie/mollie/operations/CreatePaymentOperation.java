...
public class CreatePaymentOperation implements RequestOperation<CreatePaymentRequest, CreatePaymentResponse> {
    ...
    public HttpRequest buildRequest(CreatePaymentRequest request) throws Exception {
