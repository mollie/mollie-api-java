...
public class ListSubscriptionsOperation implements RequestOperation<ListSubscriptionsRequest, ListSubscriptionsResponse> {
    ...
    public ListSubscriptionsOperation(
    ...
    public HttpRequest buildRequest(ListSubscriptionsRequest request) throws Exception {
