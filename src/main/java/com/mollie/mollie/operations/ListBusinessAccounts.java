...
import com.mollie.mollie.models.operations.ListBusinessAccountsResponseBody;
...
public class ListBusinessAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBusinessAccountsRequest, ListBusinessAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListBusinessAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBusinessAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBusinessAccountsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListBusinessAccountsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListBusinessAccountsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListBusinessAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBusinessAccountsResponse.Builder resBuilder =
            ...
            ListBusinessAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListBusinessAccountsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBusinessAccountsRequest, com.mollie.mollie.models.operations.async.ListBusinessAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBusinessAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBusinessAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBusinessAccountsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBusinessAccountsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListBusinessAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListBusinessAccountsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListBusinessAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListBusinessAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListBusinessAccountsResponseBody>() {})
