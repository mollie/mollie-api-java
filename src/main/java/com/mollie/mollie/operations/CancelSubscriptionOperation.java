...
public class CancelSubscriptionOperation implements RequestOperation<CancelSubscriptionRequest, CancelSubscriptionResponse> {
    ...
    public CancelSubscriptionOperation(
    ...
    public HttpRequest buildRequest(CancelSubscriptionRequest request) throws Exception {
