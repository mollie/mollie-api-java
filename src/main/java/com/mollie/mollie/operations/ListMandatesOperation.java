...
public class ListMandatesOperation implements RequestOperation<ListMandatesRequest, ListMandatesResponse> {
    ...
    public HttpRequest buildRequest(ListMandatesRequest request) throws Exception {
