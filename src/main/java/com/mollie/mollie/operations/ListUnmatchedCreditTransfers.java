...
import com.mollie.mollie.models.operations.ListUnmatchedCreditTransfersResponseBody;
...
public class ListUnmatchedCreditTransfers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnmatchedCreditTransfersRequest, ListUnmatchedCreditTransfersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListUnmatchedCreditTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnmatchedCreditTransfersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnmatchedCreditTransfersRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListUnmatchedCreditTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListUnmatchedCreditTransfersRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListUnmatchedCreditTransfersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnmatchedCreditTransfersResponse.Builder resBuilder =
            ...
            ListUnmatchedCreditTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListUnmatchedCreditTransfersResponseBody>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnmatchedCreditTransfersRequest, com.mollie.mollie.models.operations.async.ListUnmatchedCreditTransfersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListUnmatchedCreditTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnmatchedCreditTransfersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnmatchedCreditTransfersRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnmatchedCreditTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListUnmatchedCreditTransfersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListUnmatchedCreditTransfersResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListUnmatchedCreditTransfersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListUnmatchedCreditTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListUnmatchedCreditTransfersResponseBody>() {})
