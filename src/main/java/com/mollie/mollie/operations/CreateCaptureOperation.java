...
public class CreateCaptureOperation implements RequestOperation<CreateCaptureRequest, CreateCaptureResponse> {
    ...
    public HttpRequest buildRequest(CreateCaptureRequest request) throws Exception {
