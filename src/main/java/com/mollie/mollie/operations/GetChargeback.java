...
public class GetChargeback {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChargebackRequest, GetChargebackResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetChargebackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChargebackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChargebackRequest request) throws Exception {
        ...
        @Override
        public GetChargebackResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetChargebackResponse.Builder resBuilder =
            ...
            GetChargebackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetChargebackResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetChargebackResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChargebackRequest, com.mollie.mollie.models.operations.async.GetChargebackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetChargebackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChargebackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChargebackRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetChargebackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetChargebackResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetChargebackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetChargebackResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetChargebackResponseBody out;
                        try {
