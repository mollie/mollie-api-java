...
public class DeleteSalesInvoiceOperation implements RequestOperation<DeleteSalesInvoiceRequest, DeleteSalesInvoiceResponse> {
    ...
    public DeleteSalesInvoiceOperation(
    ...
    public HttpRequest buildRequest(DeleteSalesInvoiceRequest request) throws Exception {
