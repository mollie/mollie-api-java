...
public class CreateSubscription {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSubscriptionRequest.class, new TypeReference<CreateSubscriptionRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSubscriptionRequest, com.mollie.mollie.models.operations.async.CreateSubscriptionResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateSubscriptionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateSubscriptionResponse res = resBuilder.build();
