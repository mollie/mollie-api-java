...
public class ListSettlementsOperation implements RequestOperation<ListSettlementsRequest, ListSettlementsResponse> {
    ...
    public ListSettlementsOperation(
    ...
    public HttpRequest buildRequest(ListSettlementsRequest request) throws Exception {
