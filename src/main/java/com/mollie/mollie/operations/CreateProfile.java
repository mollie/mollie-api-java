...
public class CreateProfile {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateProfileRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "403", "422", "4XX", "5XX")) {
        ...
        @Override
        public CreateProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateProfileResponse.Builder resBuilder =
            ...
            CreateProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateProfileRequest request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "403", "422", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateProfileResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateProfileResponse res = resBuilder.build();
