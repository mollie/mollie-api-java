...
public class GetPaymentOperation implements RequestOperation<GetPaymentRequest, GetPaymentResponse> {
    ...
    public HttpRequest buildRequest(GetPaymentRequest request) throws Exception {
