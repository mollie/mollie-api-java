...
public class ListBalanceTransactionsOperation implements RequestOperation<ListBalanceTransactionsRequest, ListBalanceTransactionsResponse> {
    ...
    public ListBalanceTransactionsOperation(
    ...
    public HttpRequest buildRequest(ListBalanceTransactionsRequest request) throws Exception {
