...
public class ListChargebacks {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v2/payments/{paymentId}/chargebacks",
    ...
    public static class Sync extends Base
            implements RequestOperation<ListChargebacksRequest, ListChargebacksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListChargebacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListChargebacksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListChargebacksRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListChargebacksRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListChargebacksRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListChargebacksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListChargebacksResponse.Builder resBuilder =
            ...
            ListChargebacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListChargebacksResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListChargebacksRequest, com.mollie.mollie.models.operations.async.ListChargebacksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListChargebacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListChargebacksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListChargebacksRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListChargebacksRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListChargebacksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListChargebacksResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListChargebacksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListChargebacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListChargebacksResponseBody>() {})
