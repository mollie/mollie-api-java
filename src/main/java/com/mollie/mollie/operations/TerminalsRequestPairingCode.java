...
public class TerminalsRequestPairingCode {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "terminals-request-pairing-code",
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            Utils.configureSecurity(req, this.sdkConfiguration.securitySource().getSecurity(), "apiKey", "oAuth");
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminalsRequestPairingCodeRequest, TerminalsRequestPairingCodeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TerminalsRequestPairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsRequestPairingCodeRequest.class, new TypeReference<TerminalsRequestPairingCodeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminalsRequestPairingCodeRequest request) {
        ...
        @Override
        public TerminalsRequestPairingCodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminalsRequestPairingCodeResponse.Builder resBuilder =
            ...
            TerminalsRequestPairingCodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityPairingCode(Utils.unmarshal(response, new TypeReference<EntityPairingCode>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminalsRequestPairingCodeRequest, com.mollie.mollie.models.operations.async.TerminalsRequestPairingCodeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TerminalsRequestPairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsRequestPairingCodeRequest.class, new TypeReference<TerminalsRequestPairingCodeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminalsRequestPairingCodeRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.TerminalsRequestPairingCodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.TerminalsRequestPairingCodeResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.TerminalsRequestPairingCodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.TerminalsRequestPairingCodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityPairingCode>() {})
                            .thenApply(res::withEntityPairingCode);
                } else {
