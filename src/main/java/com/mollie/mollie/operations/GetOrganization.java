...
public class GetOrganization {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrganizationRequest, com.mollie.mollie.models.operations.async.GetOrganizationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetOrganizationResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetOrganizationResponse res = resBuilder.build();
