...
public class CreateSalesInvoiceOperation implements RequestOperation<Optional<? extends CreateSalesInvoiceRequestBody>, CreateSalesInvoiceResponse> {
    ...
    public CreateSalesInvoiceOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreateSalesInvoiceRequestBody> request) throws Exception {
