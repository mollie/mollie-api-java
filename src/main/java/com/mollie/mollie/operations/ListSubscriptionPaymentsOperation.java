...
public class ListSubscriptionPaymentsOperation implements RequestOperation<ListSubscriptionPaymentsRequest, ListSubscriptionPaymentsResponse> {
    ...
    public ListSubscriptionPaymentsOperation(
    ...
    public HttpRequest buildRequest(ListSubscriptionPaymentsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListSubscriptionPaymentsRequest request) throws Exception {
    ...
    @Override
    public ListSubscriptionPaymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.ListSubscriptionPaymentsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
