...
public class CreateSubscriptionOperation implements RequestOperation<CreateSubscriptionRequest, CreateSubscriptionResponse> {
    ...
    public HttpRequest buildRequest(CreateSubscriptionRequest request) throws Exception {
