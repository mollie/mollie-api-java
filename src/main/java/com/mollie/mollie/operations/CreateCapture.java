...
public class CreateCapture {
        ...
        public CreateCaptureResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withCaptureResponse(Utils.unmarshal(response, new TypeReference<CaptureResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateCaptureResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CaptureResponse>() {})
                            .thenApply(res::withCaptureResponse);
                } else {
