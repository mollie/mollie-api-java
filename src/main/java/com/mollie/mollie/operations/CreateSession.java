...
public class CreateSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSessionRequest, CreateSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSessionRequest request) {
        ...
        public CreateSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withSessionResponse(Utils.unmarshal(response, new TypeReference<SessionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSessionRequest, com.mollie.mollie.models.operations.async.CreateSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateSessionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionResponse>() {})
                            .thenApply(res::withSessionResponse);
                } else {
