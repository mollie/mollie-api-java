...
public class DisableMethodIssuer {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableMethodIssuerRequest, DisableMethodIssuerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DisableMethodIssuerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableMethodIssuerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableMethodIssuerRequest request) {
        ...
        @Override
        public DisableMethodIssuerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableMethodIssuerResponse.Builder resBuilder =
            ...
            DisableMethodIssuerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DisableMethodIssuerRequest, com.mollie.mollie.models.operations.async.DisableMethodIssuerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DisableMethodIssuerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableMethodIssuerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisableMethodIssuerRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.DisableMethodIssuerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.DisableMethodIssuerResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.DisableMethodIssuerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.DisableMethodIssuerResponse res = resBuilder.build();
