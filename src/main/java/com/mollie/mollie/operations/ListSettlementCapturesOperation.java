...
public class ListSettlementCapturesOperation implements RequestOperation<ListSettlementCapturesRequest, ListSettlementCapturesResponse> {
    ...
    public ListSettlementCapturesOperation(
    ...
    public HttpRequest buildRequest(ListSettlementCapturesRequest request) throws Exception {
