...
public class ListSalesInvoicesOperation implements RequestOperation<ListSalesInvoicesRequest, ListSalesInvoicesResponse> {
    ...
    public ListSalesInvoicesOperation(
    ...
    public HttpRequest buildRequest(ListSalesInvoicesRequest request) throws Exception {
