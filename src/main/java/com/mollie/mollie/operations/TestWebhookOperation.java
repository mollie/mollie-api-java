...
public class TestWebhookOperation implements RequestOperation<TestWebhookRequest, TestWebhookResponse> {
    ...
    public HttpRequest buildRequest(TestWebhookRequest request) throws Exception {
