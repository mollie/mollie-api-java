...
public class CreateCustomerPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCustomerPaymentRequest, CreateCustomerPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CreateCustomerPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomerPaymentRequest.class, new TypeReference<CreateCustomerPaymentRequest>() {});
            ...
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "422", "4XX", "503", "5XX")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCustomerPaymentRequest, com.mollie.mollie.models.operations.async.CreateCustomerPaymentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateCustomerPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomerPaymentRequest.class, new TypeReference<CreateCustomerPaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCustomerPaymentRequest request) {
            ...
            return retries.retry(() -> Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "422", "4XX", "503", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateCustomerPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateCustomerPaymentResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateCustomerPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateCustomerPaymentResponse res = resBuilder.build();
