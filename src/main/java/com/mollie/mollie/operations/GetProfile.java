...
public class GetProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProfileRequest, GetProfileResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProfileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProfileRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "404", "410", "4XX", "5XX")) {
        ...
        @Override
        public GetProfileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProfileResponse.Builder resBuilder =
                    GetProfileResponse
                            .builder()
            ...
            GetProfileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetProfileResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetProfileResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "410")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetProfileProfilesResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProfileRequest, com.mollie.mollie.models.operations.async.GetProfileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProfileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProfileRequest request) {
            ...
            return retries.retry(() -> Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "404", "410", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetProfileResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetProfileResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetProfileResponseBody out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "410")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetProfileProfilesResponseBody out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
