...
public class GetCurrentOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCurrentOrganizationRequest, GetCurrentOrganizationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCurrentOrganizationRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCurrentOrganizationRequest request) {
        ...
        @Override
        public GetCurrentOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCurrentOrganizationResponse.Builder resBuilder =
            ...
            GetCurrentOrganizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityOrganization(Utils.unmarshal(response, new TypeReference<EntityOrganization>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCurrentOrganizationRequest, com.mollie.mollie.models.operations.async.GetCurrentOrganizationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCurrentOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCurrentOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetCurrentOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetCurrentOrganizationResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetCurrentOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetCurrentOrganizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityOrganization>() {})
                            .thenApply(res::withEntityOrganization);
                } else {
