...
public class ListAllRefunds {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllRefundsRequest, ListAllRefundsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAllRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllRefundsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllRefundsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListAllRefundsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListAllRefundsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListAllRefundsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllRefundsResponse.Builder resBuilder =
            ...
            ListAllRefundsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListAllRefundsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAllRefundsRequest, com.mollie.mollie.models.operations.async.ListAllRefundsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAllRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllRefundsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllRefundsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllRefundsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListAllRefundsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListAllRefundsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListAllRefundsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListAllRefundsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListAllRefundsResponseBody>() {})
