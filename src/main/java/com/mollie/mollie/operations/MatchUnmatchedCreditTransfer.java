...
public class MatchUnmatchedCreditTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<MatchUnmatchedCreditTransferRequest, MatchUnmatchedCreditTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MatchUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchUnmatchedCreditTransferRequest.class, new TypeReference<MatchUnmatchedCreditTransferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MatchUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public MatchUnmatchedCreditTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MatchUnmatchedCreditTransferResponse.Builder resBuilder =
            ...
            MatchUnmatchedCreditTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withUnmatchedCreditTransferActionResponse(Utils.unmarshal(response, new TypeReference<UnmatchedCreditTransferActionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MatchUnmatchedCreditTransferRequest, com.mollie.mollie.models.operations.async.MatchUnmatchedCreditTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MatchUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchUnmatchedCreditTransferRequest.class, new TypeReference<MatchUnmatchedCreditTransferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MatchUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.MatchUnmatchedCreditTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.MatchUnmatchedCreditTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.MatchUnmatchedCreditTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.MatchUnmatchedCreditTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UnmatchedCreditTransferActionResponse>() {})
                            .thenApply(res::withUnmatchedCreditTransferActionResponse);
                } else {
