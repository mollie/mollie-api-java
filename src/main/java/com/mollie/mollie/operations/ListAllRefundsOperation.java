...
public class ListAllRefundsOperation implements RequestOperation<ListAllRefundsRequest, ListAllRefundsResponse> {
    ...
    public ListAllRefundsOperation(
    ...
    public HttpRequest buildRequest(ListAllRefundsRequest request) throws Exception {
