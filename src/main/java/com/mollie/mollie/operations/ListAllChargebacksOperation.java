...
public class ListAllChargebacksOperation implements RequestOperation<ListAllChargebacksRequest, ListAllChargebacksResponse> {
    ...
    public ListAllChargebacksOperation(
    ...
    public HttpRequest buildRequest(ListAllChargebacksRequest request) throws Exception {
