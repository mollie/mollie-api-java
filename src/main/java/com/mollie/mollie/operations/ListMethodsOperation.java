...
public class ListMethodsOperation implements RequestOperation<ListMethodsRequest, ListMethodsResponse> {
    ...
    public HttpRequest buildRequest(ListMethodsRequest request) throws Exception {
