...
public class ListCustomersOperation implements RequestOperation<ListCustomersRequest, ListCustomersResponse> {
    ...
    public HttpRequest buildRequest(ListCustomersRequest request) throws Exception {
