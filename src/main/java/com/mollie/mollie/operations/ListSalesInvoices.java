...
import com.mollie.mollie.models.operations.ListSalesInvoicesResponseBody;
...
public class ListSalesInvoices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSalesInvoicesRequest, ListSalesInvoicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSalesInvoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSalesInvoicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSalesInvoicesRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSalesInvoicesRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSalesInvoicesRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSalesInvoicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSalesInvoicesResponse.Builder resBuilder =
            ...
            ListSalesInvoicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSalesInvoicesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSalesInvoicesRequest, com.mollie.mollie.models.operations.async.ListSalesInvoicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSalesInvoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSalesInvoicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSalesInvoicesRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSalesInvoicesRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSalesInvoicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSalesInvoicesResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSalesInvoicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSalesInvoicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSalesInvoicesResponseBody>() {})
