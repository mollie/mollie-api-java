...
public class GetSettlementRefundsOperation implements RequestOperation<GetSettlementRefundsRequest, GetSettlementRefundsResponse> {
    ...
    public GetSettlementRefundsOperation(
    ...
    public HttpRequest buildRequest(GetSettlementRefundsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetSettlementRefundsRequest request) throws Exception {
    ...
    @Override
    public GetSettlementRefundsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetSettlementRefundsResponse.Builder resBuilder = 
        ...
        GetSettlementRefundsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetSettlementRefundsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.GetSettlementRefundsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "404")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetSettlementRefundsSettlementsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                    out.withRawResponse(response);
