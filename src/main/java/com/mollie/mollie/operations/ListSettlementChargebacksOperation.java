...
public class ListSettlementChargebacksOperation implements RequestOperation<ListSettlementChargebacksRequest, ListSettlementChargebacksResponse> {
    ...
    public ListSettlementChargebacksOperation(
    ...
    public HttpRequest buildRequest(ListSettlementChargebacksRequest request) throws Exception {
