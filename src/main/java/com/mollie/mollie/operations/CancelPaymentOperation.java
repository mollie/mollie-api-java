...
public class CancelPaymentOperation implements RequestOperation<CancelPaymentRequest, CancelPaymentResponse> {
    ...
    public HttpRequest buildRequest(CancelPaymentRequest request) throws Exception {
