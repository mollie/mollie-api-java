...
public class ListSettlementCaptures {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSettlementCapturesRequest, ListSettlementCapturesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSettlementCapturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementCapturesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSettlementCapturesRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSettlementCapturesRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSettlementCapturesRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSettlementCapturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSettlementCapturesResponse.Builder resBuilder =
            ...
            ListSettlementCapturesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSettlementCapturesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSettlementCapturesRequest, com.mollie.mollie.models.operations.async.ListSettlementCapturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSettlementCapturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementCapturesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementCapturesRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementCapturesRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSettlementCapturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSettlementCapturesResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSettlementCapturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSettlementCapturesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSettlementCapturesResponseBody>() {})
