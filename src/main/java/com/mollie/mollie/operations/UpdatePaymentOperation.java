...
public class UpdatePaymentOperation implements RequestOperation<UpdatePaymentRequest, UpdatePaymentResponse> {
    ...
    public HttpRequest buildRequest(UpdatePaymentRequest request) throws Exception {
