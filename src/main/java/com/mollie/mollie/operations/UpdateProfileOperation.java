...
public class UpdateProfileOperation implements RequestOperation<UpdateProfileRequest, UpdateProfileResponse> {
    ...
    public HttpRequest buildRequest(UpdateProfileRequest request) throws Exception {
