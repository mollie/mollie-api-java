...
public class GetBusinessAccountTransaction {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "get-business-account-transaction",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBusinessAccountTransactionRequest, GetBusinessAccountTransactionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBusinessAccountTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBusinessAccountTransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBusinessAccountTransactionRequest request) {
        ...
        @Override
        public GetBusinessAccountTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBusinessAccountTransactionResponse.Builder resBuilder =
            ...
            GetBusinessAccountTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBusinessAccountTransactionRequest, com.mollie.mollie.models.operations.async.GetBusinessAccountTransactionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBusinessAccountTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBusinessAccountTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBusinessAccountTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetBusinessAccountTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetBusinessAccountTransactionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetBusinessAccountTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetBusinessAccountTransactionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionResponse>() {})
                            .thenApply(res::withTransactionResponse);
                } else {
