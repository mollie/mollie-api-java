...
public class EnableMethodIssuer {
    ...
    public static class Sync extends Base
            implements RequestOperation<EnableMethodIssuerRequest, EnableMethodIssuerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EnableMethodIssuerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableMethodIssuerRequest.class, new TypeReference<EnableMethodIssuerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EnableMethodIssuerRequest request) {
        ...
        @Override
        public EnableMethodIssuerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EnableMethodIssuerResponse.Builder resBuilder =
            ...
            EnableMethodIssuerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withOneOf(Utils.unmarshal(response, new TypeReference<EnableMethodIssuerResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnableMethodIssuerRequest, com.mollie.mollie.models.operations.async.EnableMethodIssuerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EnableMethodIssuerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableMethodIssuerRequest.class, new TypeReference<EnableMethodIssuerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EnableMethodIssuerRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.EnableMethodIssuerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.EnableMethodIssuerResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.EnableMethodIssuerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.EnableMethodIssuerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EnableMethodIssuerResponseBody>() {})
