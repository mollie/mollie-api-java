...
public class CancelRefundOperation implements RequestOperation<CancelRefundRequest, CancelRefundResponse> {
    ...
    public HttpRequest buildRequest(CancelRefundRequest request) throws Exception {
