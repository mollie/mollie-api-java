...
public class RevokeMandate {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeMandateRequest, RevokeMandateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevokeMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeMandateRequest.class, new TypeReference<RevokeMandateRequest>() {});
        ...
        @Override
        public RevokeMandateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeMandateResponse.Builder resBuilder =
            ...
            RevokeMandateResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    RevokeMandateResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RevokeMandateRequest, com.mollie.mollie.models.operations.async.RevokeMandateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RevokeMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeMandateRequest.class, new TypeReference<RevokeMandateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RevokeMandateRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.RevokeMandateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.RevokeMandateResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.RevokeMandateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.RevokeMandateResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.RevokeMandateResponseBody out;
                        try {
