...
public class GetTerminal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTerminalRequest, GetTerminalResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetTerminalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTerminalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTerminalRequest request) throws Exception {
        ...
        @Override
        public GetTerminalResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTerminalResponse.Builder resBuilder =
                    GetTerminalResponse
                            .builder()
            ...
            GetTerminalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetTerminalResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetTerminalResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTerminalRequest, com.mollie.mollie.models.operations.async.GetTerminalResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTerminalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTerminalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTerminalRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetTerminalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetTerminalResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetTerminalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetTerminalResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetTerminalResponseBody out;
                        try {
