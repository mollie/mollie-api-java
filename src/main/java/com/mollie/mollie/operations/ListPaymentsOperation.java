...
public class ListPaymentsOperation implements RequestOperation<ListPaymentsRequest, ListPaymentsResponse> {
    ...
    public HttpRequest buildRequest(ListPaymentsRequest request) throws Exception {
