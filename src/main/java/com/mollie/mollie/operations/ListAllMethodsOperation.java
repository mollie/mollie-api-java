...
public class ListAllMethodsOperation implements RequestOperation<ListAllMethodsRequest, ListAllMethodsResponse> {
    ...
    public ListAllMethodsOperation(
    ...
    public HttpRequest buildRequest(ListAllMethodsRequest request) throws Exception {
