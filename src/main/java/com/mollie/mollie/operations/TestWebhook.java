...
public class TestWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<TestWebhookRequest, TestWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(TestWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TestWebhookRequest.class, new TypeReference<TestWebhookRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TestWebhookRequest request) throws Exception {
        ...
        @Override
        public TestWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TestWebhookResponse.Builder resBuilder =
                    TestWebhookResponse
                            .builder()
            ...
            TestWebhookResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    TestWebhookResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    TestWebhookWebhooksResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TestWebhookRequest, com.mollie.mollie.models.operations.async.TestWebhookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TestWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TestWebhookRequest.class, new TypeReference<TestWebhookRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TestWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.TestWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.TestWebhookResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.TestWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.TestWebhookResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.TestWebhookResponseBody out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.TestWebhookWebhooksResponseBody out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
