...
public class GetNextSettlement {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNextSettlementRequest request) {
        ...
        @Override
        public GetNextSettlementResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNextSettlementResponse.Builder resBuilder =
            ...
            GetNextSettlementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetNextSettlementResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetNextSettlementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetNextSettlementResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetNextSettlementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetNextSettlementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetNextSettlementResponseBody>() {})
