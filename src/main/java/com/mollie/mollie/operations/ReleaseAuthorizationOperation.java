...
public class ReleaseAuthorizationOperation implements RequestOperation<ReleaseAuthorizationRequest, ReleaseAuthorizationResponse> {
    ...
    public ReleaseAuthorizationOperation(
    ...
    public HttpRequest buildRequest(ReleaseAuthorizationRequest request) throws Exception {
