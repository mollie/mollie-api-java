...
import com.mollie.mollie.models.operations.CreateMandateResponseBody;
...
public class CreateMandate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMandateRequest, CreateMandateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CreateMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMandateRequest.class, new TypeReference<CreateMandateRequest>() {});
        ...
        @Override
        public CreateMandateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMandateResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.CreateMandateResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMandateRequest, com.mollie.mollie.models.operations.async.CreateMandateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMandateRequest.class, new TypeReference<CreateMandateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMandateRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateMandateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateMandateResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateMandateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateMandateResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.CreateMandateResponseBody out;
                        try {
