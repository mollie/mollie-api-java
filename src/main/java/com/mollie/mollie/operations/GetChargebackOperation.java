...
public class GetChargebackOperation implements RequestOperation<GetChargebackRequest, GetChargebackResponse> {
    ...
    public HttpRequest buildRequest(GetChargebackRequest request) throws Exception {
