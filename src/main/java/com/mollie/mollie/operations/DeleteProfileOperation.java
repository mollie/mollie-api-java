...
public class DeleteProfileOperation implements RequestOperation<DeleteProfileRequest, DeleteProfileResponse> {
    ...
    public HttpRequest buildRequest(DeleteProfileRequest request) throws Exception {
