...
public class CreateWebhookOperation implements RequestOperation<Optional<? extends CreateWebhookRequestBody>, CreateWebhookResponse> {
    ...
    public HttpRequest buildRequest(Optional<? extends CreateWebhookRequestBody> request) throws Exception {
