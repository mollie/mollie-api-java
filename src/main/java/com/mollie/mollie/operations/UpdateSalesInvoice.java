...
public class UpdateSalesInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSalesInvoiceRequest, UpdateSalesInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(UpdateSalesInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSalesInvoiceRequest.class, new TypeReference<UpdateSalesInvoiceRequest>() {});
        ...
        @Override
        public UpdateSalesInvoiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSalesInvoiceResponse.Builder resBuilder =
            ...
            UpdateSalesInvoiceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    UpdateSalesInvoiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.UpdateSalesInvoiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    UpdateSalesInvoiceSalesInvoicesResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSalesInvoiceRequest, com.mollie.mollie.models.operations.async.UpdateSalesInvoiceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSalesInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSalesInvoiceRequest.class, new TypeReference<UpdateSalesInvoiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSalesInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.UpdateSalesInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.UpdateSalesInvoiceResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.UpdateSalesInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.UpdateSalesInvoiceResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.UpdateSalesInvoiceResponseBody out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.UpdateSalesInvoiceSalesInvoicesResponseBody out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
