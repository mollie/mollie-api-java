...
public class GetMandateOperation implements RequestOperation<GetMandateRequest, GetMandateResponse> {
    ...
    public HttpRequest buildRequest(GetMandateRequest request) throws Exception {
