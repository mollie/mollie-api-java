...
public class RequestApplePayPaymentSessionOperation implements RequestOperation<Optional<? extends RequestApplePayPaymentSessionRequestBody>, RequestApplePayPaymentSessionResponse> {
    ...
    public RequestApplePayPaymentSessionOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends RequestApplePayPaymentSessionRequestBody> request) throws Exception {
