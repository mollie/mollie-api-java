...
public class RevokeMandateOperation implements RequestOperation<RevokeMandateRequest, RevokeMandateResponse> {
    ...
    public HttpRequest buildRequest(RevokeMandateRequest request) throws Exception {
