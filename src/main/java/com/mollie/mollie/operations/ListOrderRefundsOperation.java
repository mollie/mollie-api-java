...
public class ListOrderRefundsOperation implements RequestOperation<ListOrderRefundsRequest, ListOrderRefundsResponse> {
    ...
    public ListOrderRefundsOperation(
    ...
    public HttpRequest buildRequest(ListOrderRefundsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ListOrderRefundsRequest request) throws Exception {
    ...
    @Override
    public ListOrderRefundsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListOrderRefundsResponse.Builder resBuilder = 
        ...
        ListOrderRefundsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                ListOrderRefundsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.ListOrderRefundsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
