...
public class GetMethodOperation implements RequestOperation<GetMethodRequest, GetMethodResponse> {
    ...
    public HttpRequest buildRequest(GetMethodRequest request) throws Exception {
