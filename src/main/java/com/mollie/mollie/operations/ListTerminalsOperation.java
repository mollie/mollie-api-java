...
public class ListTerminalsOperation implements RequestOperation<ListTerminalsRequest, ListTerminalsResponse> {
    ...
    public HttpRequest buildRequest(ListTerminalsRequest request) throws Exception {
