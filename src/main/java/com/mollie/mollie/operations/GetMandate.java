...
public class GetMandate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMandateRequest, GetMandateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMandateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMandateRequest request) throws Exception {
        ...
        @Override
        public GetMandateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMandateResponse.Builder resBuilder =
                    GetMandateResponse
                            .builder()
            ...
            GetMandateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetMandateResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetMandateResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMandateRequest, com.mollie.mollie.models.operations.async.GetMandateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMandateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMandateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMandateRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetMandateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetMandateResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetMandateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetMandateResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetMandateResponseBody out;
                        try {
