...
public class DeletePaymentLinkOperation implements RequestOperation<DeletePaymentLinkRequest, DeletePaymentLinkResponse> {
    ...
    public DeletePaymentLinkOperation(
    ...
    public HttpRequest buildRequest(DeletePaymentLinkRequest request) throws Exception {
