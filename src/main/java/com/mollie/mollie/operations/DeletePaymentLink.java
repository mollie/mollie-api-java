...
public class DeletePaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePaymentLinkRequest, DeletePaymentLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeletePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentLinkRequest.class, new TypeReference<DeletePaymentLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePaymentLinkRequest request) throws Exception {
        ...
        @Override
        public DeletePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePaymentLinkResponse.Builder resBuilder =
            ...
            DeletePaymentLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePaymentLinkRequest, com.mollie.mollie.models.operations.async.DeletePaymentLinkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentLinkRequest.class, new TypeReference<DeletePaymentLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.DeletePaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.DeletePaymentLinkResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.DeletePaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.DeletePaymentLinkResponse res = resBuilder.build();
