...
public class ListCustomerPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCustomerPaymentsRequest, ListCustomerPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListCustomerPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCustomerPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCustomerPaymentsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListCustomerPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListCustomerPaymentsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListCustomerPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListCustomerPaymentsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCustomerPaymentsRequest, com.mollie.mollie.models.operations.async.ListCustomerPaymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListCustomerPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCustomerPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCustomerPaymentsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCustomerPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListCustomerPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListCustomerPaymentsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListCustomerPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListCustomerPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListCustomerPaymentsResponseBody>() {})
