...
public class UpdateSubscriptionOperation implements RequestOperation<UpdateSubscriptionRequest, UpdateSubscriptionResponse> {
    ...
    public HttpRequest buildRequest(UpdateSubscriptionRequest request) throws Exception {
