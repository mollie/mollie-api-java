...
public class UpdateCustomerOperation implements RequestOperation<UpdateCustomerRequest, UpdateCustomerResponse> {
    ...
    public UpdateCustomerOperation(
    ...
    public HttpRequest buildRequest(UpdateCustomerRequest request) throws Exception {
