...
public class GetOpenSettlement {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOpenSettlementRequest, GetOpenSettlementResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetOpenSettlementRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOpenSettlementRequest request) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOpenSettlementRequest, com.mollie.mollie.models.operations.async.GetOpenSettlementResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetOpenSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOpenSettlementRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetOpenSettlementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetOpenSettlementResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetOpenSettlementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetOpenSettlementResponse res = resBuilder.build();
