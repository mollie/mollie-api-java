...
public class ListCapturesOperation implements RequestOperation<ListCapturesRequest, ListCapturesResponse> {
    ...
    public HttpRequest buildRequest(ListCapturesRequest request) throws Exception {
