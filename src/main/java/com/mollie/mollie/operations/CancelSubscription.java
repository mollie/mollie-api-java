...
public class CancelSubscription {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelSubscriptionRequest request) {
        ...
        @Override
        public CancelSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withSubscriptionResponse(Utils.unmarshal(response, new TypeReference<SubscriptionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.CancelSubscriptionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SubscriptionResponse>() {})
                            .thenApply(res::withSubscriptionResponse);
                } else {
