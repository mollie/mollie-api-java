...
public class CancelSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelSubscriptionRequest, CancelSubscriptionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CancelSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelSubscriptionRequest.class, new TypeReference<CancelSubscriptionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelSubscriptionRequest request) throws Exception {
        ...
        @Override
        public CancelSubscriptionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelSubscriptionResponse.Builder resBuilder =
            ...
            CancelSubscriptionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    CancelSubscriptionResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.CancelSubscriptionResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelSubscriptionRequest, com.mollie.mollie.models.operations.async.CancelSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelSubscriptionRequest.class, new TypeReference<CancelSubscriptionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CancelSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CancelSubscriptionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CancelSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CancelSubscriptionResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.CancelSubscriptionResponseBody out;
                        try {
