...
public class CreatePaymentLinkOperation implements RequestOperation<Optional<? extends CreatePaymentLinkRequestBody>, CreatePaymentLinkResponse> {
    ...
    public CreatePaymentLinkOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends CreatePaymentLinkRequestBody> request) throws Exception {
