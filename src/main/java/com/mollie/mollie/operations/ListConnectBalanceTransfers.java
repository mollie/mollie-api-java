...
import com.mollie.mollie.models.operations.ListConnectBalanceTransfersResponseBody;
...
public class ListConnectBalanceTransfers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListConnectBalanceTransfersRequest, ListConnectBalanceTransfersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListConnectBalanceTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectBalanceTransfersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectBalanceTransfersRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListConnectBalanceTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListConnectBalanceTransfersRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListConnectBalanceTransfersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListConnectBalanceTransfersResponse.Builder resBuilder =
            ...
            ListConnectBalanceTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListConnectBalanceTransfersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListConnectBalanceTransfersRequest, com.mollie.mollie.models.operations.async.ListConnectBalanceTransfersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListConnectBalanceTransfersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectBalanceTransfersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListConnectBalanceTransfersRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListConnectBalanceTransfersRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListConnectBalanceTransfersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListConnectBalanceTransfersResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListConnectBalanceTransfersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListConnectBalanceTransfersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListConnectBalanceTransfersResponseBody>() {})
