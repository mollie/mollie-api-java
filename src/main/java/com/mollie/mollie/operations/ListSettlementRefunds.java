...
import com.mollie.mollie.models.operations.ListSettlementRefundsResponseBody;
...
public class ListSettlementRefunds {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSettlementRefundsRequest, ListSettlementRefundsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSettlementRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementRefundsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSettlementRefundsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSettlementRefundsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSettlementRefundsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSettlementRefundsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSettlementRefundsResponse.Builder resBuilder =
            ...
            ListSettlementRefundsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSettlementRefundsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSettlementRefundsRequest, com.mollie.mollie.models.operations.async.ListSettlementRefundsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSettlementRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementRefundsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementRefundsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementRefundsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSettlementRefundsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSettlementRefundsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSettlementRefundsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSettlementRefundsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSettlementRefundsResponseBody>() {})
