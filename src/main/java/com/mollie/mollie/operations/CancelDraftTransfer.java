...
public class CancelDraftTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelDraftTransferRequest, CancelDraftTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelDraftTransferRequest.class, new TypeReference<CancelDraftTransferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelDraftTransferRequest request) {
        ...
        @Override
        public CancelDraftTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelDraftTransferResponse.Builder resBuilder =
            ...
            CancelDraftTransferResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelDraftTransferRequest, com.mollie.mollie.models.operations.async.CancelDraftTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelDraftTransferRequest.class, new TypeReference<CancelDraftTransferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelDraftTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CancelDraftTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CancelDraftTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CancelDraftTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CancelDraftTransferResponse res = resBuilder.build();
