...
public class ReleaseAuthorization {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReleaseAuthorizationRequest, ReleaseAuthorizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ReleaseAuthorizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReleaseAuthorizationRequest.class, new TypeReference<ReleaseAuthorizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReleaseAuthorizationRequest request) throws Exception {
        ...
        @Override
        public ReleaseAuthorizationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReleaseAuthorizationResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    ReleaseAuthorizationResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    ReleaseAuthorizationPaymentsResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReleaseAuthorizationRequest, com.mollie.mollie.models.operations.async.ReleaseAuthorizationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ReleaseAuthorizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReleaseAuthorizationRequest.class, new TypeReference<ReleaseAuthorizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReleaseAuthorizationRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ReleaseAuthorizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ReleaseAuthorizationResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ReleaseAuthorizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.ReleaseAuthorizationResponseBody out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.ReleaseAuthorizationPaymentsResponseBody out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
