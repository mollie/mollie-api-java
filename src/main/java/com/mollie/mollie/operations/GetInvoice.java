...
public class GetInvoice {
        ...
        public GetInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityInvoice(Utils.unmarshal(response, new TypeReference<EntityInvoice>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetInvoiceResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityInvoice>() {})
                            .thenApply(res::withEntityInvoice);
                } else {
