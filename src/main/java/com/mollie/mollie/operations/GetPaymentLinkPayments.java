...
public class GetPaymentLinkPayments {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetPaymentLinkPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentLinkPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentLinkPaymentsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(GetPaymentLinkPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, GetPaymentLinkPaymentsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public GetPaymentLinkPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetPaymentLinkPaymentsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentLinkPaymentsRequest, com.mollie.mollie.models.operations.async.GetPaymentLinkPaymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentLinkPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentLinkPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentLinkPaymentsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentLinkPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetPaymentLinkPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetPaymentLinkPaymentsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetPaymentLinkPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetPaymentLinkPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPaymentLinkPaymentsResponseBody>() {})
