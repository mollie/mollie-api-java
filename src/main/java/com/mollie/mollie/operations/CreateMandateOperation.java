...
public class CreateMandateOperation implements RequestOperation<CreateMandateRequest, CreateMandateResponse> {
    ...
    public HttpRequest buildRequest(CreateMandateRequest request) throws Exception {
