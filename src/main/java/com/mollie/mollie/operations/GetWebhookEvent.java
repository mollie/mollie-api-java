...
public class GetWebhookEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWebhookEventRequest, GetWebhookEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWebhookEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebhookEventRequest request) throws Exception {
        ...
        @Override
        public GetWebhookEventResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWebhookEventResponse.Builder resBuilder =
            ...
            GetWebhookEventResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    GetWebhookEventResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    com.mollie.mollie.models.errors.GetWebhookEventResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebhookEventRequest, com.mollie.mollie.models.operations.async.GetWebhookEventResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetWebhookEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebhookEventRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetWebhookEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetWebhookEventResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetWebhookEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetWebhookEventResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.mollie.mollie.models.errors.async.GetWebhookEventResponseBody out;
                        try {
