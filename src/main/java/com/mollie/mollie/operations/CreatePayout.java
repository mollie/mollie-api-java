...
public class CreatePayout {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePayoutRequest, com.mollie.mollie.models.operations.async.CreatePayoutResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreatePayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreatePayoutResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreatePayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreatePayoutResponse res = resBuilder.build();
