...
import com.mollie.mollie.models.operations.ListBusinessAccountTransactionsResponseBody;
...
public class ListBusinessAccountTransactions {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "list-business-account-transactions",
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBusinessAccountTransactionsRequest, ListBusinessAccountTransactionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListBusinessAccountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBusinessAccountTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBusinessAccountTransactionsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListBusinessAccountTransactionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListBusinessAccountTransactionsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListBusinessAccountTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBusinessAccountTransactionsResponse.Builder resBuilder =
            ...
            ListBusinessAccountTransactionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListBusinessAccountTransactionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBusinessAccountTransactionsRequest, com.mollie.mollie.models.operations.async.ListBusinessAccountTransactionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBusinessAccountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBusinessAccountTransactionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBusinessAccountTransactionsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBusinessAccountTransactionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListBusinessAccountTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListBusinessAccountTransactionsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListBusinessAccountTransactionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListBusinessAccountTransactionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListBusinessAccountTransactionsResponseBody>() {})
