...
import com.mollie.mollie.models.operations.CreateDraftTransferRequest;
...
public class CreateDraftTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDraftTransferRequest, CreateDraftTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateDraftTransferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDraftTransferRequest request) {
        ...
        @Override
        public CreateDraftTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDraftTransferResponse.Builder resBuilder =
            ...
            CreateDraftTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withDraftTransferResponse(Utils.unmarshal(response, new TypeReference<DraftTransferResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDraftTransferRequest, com.mollie.mollie.models.operations.async.CreateDraftTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateDraftTransferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDraftTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateDraftTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateDraftTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateDraftTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateDraftTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DraftTransferResponse>() {})
                            .thenApply(res::withDraftTransferResponse);
                } else {
