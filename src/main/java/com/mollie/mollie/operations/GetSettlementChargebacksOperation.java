...
public class GetSettlementChargebacksOperation implements RequestOperation<GetSettlementChargebacksRequest, GetSettlementChargebacksResponse> {
    ...
    public GetSettlementChargebacksOperation(
    ...
    public HttpRequest buildRequest(GetSettlementChargebacksRequest request) throws Exception {
    ...
    @Override
    public GetSettlementChargebacksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetSettlementChargebacksResponse.Builder resBuilder = 
        ...
        GetSettlementChargebacksResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetSettlementChargebacksResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.GetSettlementChargebacksResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "404")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetSettlementChargebacksSettlementsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                    out.withRawResponse(response);
