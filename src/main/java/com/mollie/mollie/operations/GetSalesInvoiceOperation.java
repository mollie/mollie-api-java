...
public class GetSalesInvoiceOperation implements RequestOperation<GetSalesInvoiceRequest, GetSalesInvoiceResponse> {
    ...
    public GetSalesInvoiceOperation(
    ...
    public HttpRequest buildRequest(GetSalesInvoiceRequest request) throws Exception {
