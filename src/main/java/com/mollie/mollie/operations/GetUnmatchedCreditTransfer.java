...
public class GetUnmatchedCreditTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnmatchedCreditTransferRequest, GetUnmatchedCreditTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnmatchedCreditTransferRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public GetUnmatchedCreditTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnmatchedCreditTransferResponse.Builder resBuilder =
            ...
            GetUnmatchedCreditTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityUnmatchedCreditTransfer(Utils.unmarshal(response, new TypeReference<EntityUnmatchedCreditTransfer>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnmatchedCreditTransferRequest, com.mollie.mollie.models.operations.async.GetUnmatchedCreditTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetUnmatchedCreditTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnmatchedCreditTransferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnmatchedCreditTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetUnmatchedCreditTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetUnmatchedCreditTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetUnmatchedCreditTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetUnmatchedCreditTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityUnmatchedCreditTransfer>() {})
                            .thenApply(res::withEntityUnmatchedCreditTransfer);
                } else {
