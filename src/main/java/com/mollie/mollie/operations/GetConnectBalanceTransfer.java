...
public class GetConnectBalanceTransfer {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v2/connect/balance-transfers/{balanceTransferId}",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConnectBalanceTransferRequest, GetConnectBalanceTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetConnectBalanceTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectBalanceTransferRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectBalanceTransferRequest request) {
        ...
        @Override
        public GetConnectBalanceTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConnectBalanceTransferResponse.Builder resBuilder =
                    GetConnectBalanceTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetConnectBalanceTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityBalanceTransferResponse(Utils.unmarshal(response, new TypeReference<EntityBalanceTransferResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetConnectBalanceTransferRequest, com.mollie.mollie.models.operations.async.GetConnectBalanceTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetConnectBalanceTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectBalanceTransferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectBalanceTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetConnectBalanceTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetConnectBalanceTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetConnectBalanceTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetConnectBalanceTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityBalanceTransferResponse>() {})
                            .thenApply(res::withEntityBalanceTransferResponse);
                } else {
