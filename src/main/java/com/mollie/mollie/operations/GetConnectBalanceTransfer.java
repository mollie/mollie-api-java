...
public class GetConnectBalanceTransfer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectBalanceTransferRequest request) throws Exception {
        ...
        @Override
        public GetConnectBalanceTransferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    EntityBalanceTransferResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEntityBalanceTransferResponse(out);
                    return res;
                } else {
