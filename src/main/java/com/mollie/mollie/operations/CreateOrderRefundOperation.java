...
public class CreateOrderRefundOperation implements RequestOperation<CreateOrderRefundRequest, CreateOrderRefundResponse> {
    ...
    public CreateOrderRefundOperation(
    ...
    public HttpRequest buildRequest(CreateOrderRefundRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreateOrderRefundRequest request) throws Exception {
    ...
    @Override
    public CreateOrderRefundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CreateOrderRefundResponse.Builder resBuilder = 
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "404")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.CreateOrderRefundResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "422")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                CreateOrderRefundRefundsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                    out.withRawResponse(response);
