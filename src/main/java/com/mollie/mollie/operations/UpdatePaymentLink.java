...
public class UpdatePaymentLink {
        ...
        public UpdatePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withPaymentLinkResponse(Utils.unmarshal(response, new TypeReference<PaymentLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.UpdatePaymentLinkResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentLinkResponse>() {})
                            .thenApply(res::withPaymentLinkResponse);
                } else {
