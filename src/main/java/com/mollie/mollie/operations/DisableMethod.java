...
public class DisableMethod {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v2/profiles/{profileId}/methods/{methodId}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableMethodRequest, DisableMethodResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DisableMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableMethodRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableMethodRequest request) {
        ...
        @Override
        public DisableMethodResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableMethodResponse.Builder resBuilder =
            ...
            DisableMethodResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DisableMethodRequest, com.mollie.mollie.models.operations.async.DisableMethodResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DisableMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableMethodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisableMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.DisableMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.DisableMethodResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.DisableMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.DisableMethodResponse res = resBuilder.build();
