...
public class CreateCustomer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CreateCustomerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CreateCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CreateCustomerResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CreateCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CreateCustomerResponse res = resBuilder.build();
