...
public class TerminalsRevokePairingCode {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v2/terminals/pairing-codes/{pairingCodeId}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminalsRevokePairingCodeRequest, TerminalsRevokePairingCodeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TerminalsRevokePairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsRevokePairingCodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminalsRevokePairingCodeRequest request) {
        ...
        @Override
        public TerminalsRevokePairingCodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminalsRevokePairingCodeResponse.Builder resBuilder =
            ...
            TerminalsRevokePairingCodeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminalsRevokePairingCodeRequest, com.mollie.mollie.models.operations.async.TerminalsRevokePairingCodeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TerminalsRevokePairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsRevokePairingCodeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminalsRevokePairingCodeRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.TerminalsRevokePairingCodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.TerminalsRevokePairingCodeResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.TerminalsRevokePairingCodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.TerminalsRevokePairingCodeResponse res = resBuilder.build();
