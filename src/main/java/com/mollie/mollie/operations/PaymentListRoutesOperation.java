...
public class PaymentListRoutesOperation implements RequestOperation<PaymentListRoutesRequest, PaymentListRoutesResponse> {
    ...
    public PaymentListRoutesOperation(
    ...
    public HttpRequest buildRequest(PaymentListRoutesRequest request) throws Exception {
