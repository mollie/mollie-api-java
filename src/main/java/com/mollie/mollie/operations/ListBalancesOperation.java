...
public class ListBalancesOperation implements RequestOperation<ListBalancesRequest, ListBalancesResponse> {
    ...
    public HttpRequest buildRequest(ListBalancesRequest request) throws Exception {
