...
public class DeleteCustomerOperation implements RequestOperation<DeleteCustomerRequest, DeleteCustomerResponse> {
    ...
    public HttpRequest buildRequest(DeleteCustomerRequest request) throws Exception {
