...
public class GetCurrentProfile {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request) throws Exception {
            ...
            Utils.configureSecurity(req, this.sdkConfiguration.securitySource().getSecurity(), "apiKey");
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCurrentProfileRequest request) {
        ...
        @Override
        public GetCurrentProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCurrentProfileResponse.Builder resBuilder =
            ...
            GetCurrentProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetCurrentProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetCurrentProfileResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetCurrentProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetCurrentProfileResponse res = resBuilder.build();
