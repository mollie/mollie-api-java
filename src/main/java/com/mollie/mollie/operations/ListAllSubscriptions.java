...
public class ListAllSubscriptions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllSubscriptionsRequest, ListAllSubscriptionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAllSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllSubscriptionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllSubscriptionsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListAllSubscriptionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListAllSubscriptionsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListAllSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllSubscriptionsResponse.Builder resBuilder =
            ...
            ListAllSubscriptionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListAllSubscriptionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAllSubscriptionsRequest, com.mollie.mollie.models.operations.async.ListAllSubscriptionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAllSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllSubscriptionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllSubscriptionsRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllSubscriptionsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListAllSubscriptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListAllSubscriptionsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListAllSubscriptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListAllSubscriptionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListAllSubscriptionsResponseBody>() {})
