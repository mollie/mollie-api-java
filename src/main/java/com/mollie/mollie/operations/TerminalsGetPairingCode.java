...
public class TerminalsGetPairingCode {
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminalsGetPairingCodeRequest, TerminalsGetPairingCodeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TerminalsGetPairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsGetPairingCodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminalsGetPairingCodeRequest request) {
        ...
        @Override
        public TerminalsGetPairingCodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminalsGetPairingCodeResponse.Builder resBuilder =
            ...
            TerminalsGetPairingCodeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminalsGetPairingCodeRequest, com.mollie.mollie.models.operations.async.TerminalsGetPairingCodeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TerminalsGetPairingCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsGetPairingCodeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminalsGetPairingCodeRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.TerminalsGetPairingCodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.TerminalsGetPairingCodeResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.TerminalsGetPairingCodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.TerminalsGetPairingCodeResponse res = resBuilder.build();
