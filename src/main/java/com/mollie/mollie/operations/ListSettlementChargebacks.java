...
import com.mollie.mollie.models.operations.ListSettlementChargebacksResponseBody;
...
public class ListSettlementChargebacks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSettlementChargebacksRequest, ListSettlementChargebacksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSettlementChargebacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementChargebacksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSettlementChargebacksRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSettlementChargebacksRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSettlementChargebacksRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSettlementChargebacksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSettlementChargebacksResponse.Builder resBuilder =
            ...
            ListSettlementChargebacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSettlementChargebacksResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSettlementChargebacksRequest, com.mollie.mollie.models.operations.async.ListSettlementChargebacksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSettlementChargebacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSettlementChargebacksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementChargebacksRequest request) {
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSettlementChargebacksRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSettlementChargebacksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListSettlementChargebacksResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListSettlementChargebacksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListSettlementChargebacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSettlementChargebacksResponseBody>() {})
