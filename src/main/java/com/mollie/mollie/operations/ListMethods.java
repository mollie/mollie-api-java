...
public class ListMethods {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMethodsRequest, ListMethodsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMethodsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMethodsRequest request) {
        ...
        @Override
        public ListMethodsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMethodsResponse.Builder resBuilder =
                    ListMethodsResponse
                            .builder()
            ...
            ListMethodsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListMethodsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMethodsRequest, com.mollie.mollie.models.operations.async.ListMethodsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMethodsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMethodsRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListMethodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListMethodsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListMethodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListMethodsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListMethodsResponseBody>() {})
