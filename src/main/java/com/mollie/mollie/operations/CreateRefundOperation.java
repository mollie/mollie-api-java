...
public class CreateRefundOperation implements RequestOperation<CreateRefundRequest, CreateRefundResponse> {
    ...
    public HttpRequest buildRequest(CreateRefundRequest request) throws Exception {
