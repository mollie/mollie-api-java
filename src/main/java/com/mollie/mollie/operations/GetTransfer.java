...
public class GetTransfer {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransferRequest, com.mollie.mollie.models.operations.async.GetTransferResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetTransferResponse res = resBuilder.build();
