...
public class GetDraftTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDraftTransferRequest, GetDraftTransferResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDraftTransferRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDraftTransferRequest request) {
        ...
        @Override
        public GetDraftTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDraftTransferResponse.Builder resBuilder =
            ...
            GetDraftTransferResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDraftTransferRequest, com.mollie.mollie.models.operations.async.GetDraftTransferResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDraftTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDraftTransferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDraftTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetDraftTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetDraftTransferResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetDraftTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetDraftTransferResponse res = resBuilder.build();
