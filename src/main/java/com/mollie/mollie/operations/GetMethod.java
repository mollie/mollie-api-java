...
public class GetMethod {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMethodRequest, GetMethodResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMethodRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMethodRequest request) {
        ...
        @Override
        public GetMethodResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMethodResponse.Builder resBuilder =
                    GetMethodResponse
                            .builder()
            ...
            GetMethodResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMethodRequest, com.mollie.mollie.models.operations.async.GetMethodResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMethodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetMethodResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetMethodResponse res = resBuilder.build();
