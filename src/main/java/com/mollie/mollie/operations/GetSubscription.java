...
public class GetSubscription {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSubscriptionRequest, com.mollie.mollie.models.operations.async.GetSubscriptionResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetSubscriptionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetSubscriptionResponse res = resBuilder.build();
