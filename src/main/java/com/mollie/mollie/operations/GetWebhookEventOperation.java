...
public class GetWebhookEventOperation implements RequestOperation<GetWebhookEventRequest, GetWebhookEventResponse> {
    ...
    public GetWebhookEventOperation(
    ...
    public HttpRequest buildRequest(GetWebhookEventRequest request) throws Exception {
