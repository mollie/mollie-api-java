...
public class CancelPayout {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelPayoutRequest, CancelPayoutResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelPayoutRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelPayoutRequest request) {
        ...
        @Override
        public CancelPayoutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelPayoutResponse.Builder resBuilder =
            ...
            CancelPayoutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityPayoutResponse(Utils.unmarshal(response, new TypeReference<EntityPayoutResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404", "409", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelPayoutRequest, com.mollie.mollie.models.operations.async.CancelPayoutResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelPayoutRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelPayoutRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.CancelPayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.CancelPayoutResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.CancelPayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.CancelPayoutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityPayoutResponse>() {})
                            .thenApply(res::withEntityPayoutResponse);
                } else {
