...
public class GetBusinessAccount {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v2/business-accounts/accounts/{businessAccountId}",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBusinessAccountRequest, GetBusinessAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBusinessAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBusinessAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBusinessAccountRequest request) {
        ...
        @Override
        public GetBusinessAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBusinessAccountResponse.Builder resBuilder =
            ...
            GetBusinessAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withBusinessAccountResponse(Utils.unmarshal(response, new TypeReference<BusinessAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBusinessAccountRequest, com.mollie.mollie.models.operations.async.GetBusinessAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBusinessAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBusinessAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBusinessAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetBusinessAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetBusinessAccountResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetBusinessAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetBusinessAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BusinessAccountResponse>() {})
                            .thenApply(res::withBusinessAccountResponse);
                } else {
