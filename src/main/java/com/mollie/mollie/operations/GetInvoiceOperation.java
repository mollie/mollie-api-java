...
public class GetInvoiceOperation implements RequestOperation<GetInvoiceRequest, GetInvoiceResponse> {
    ...
    public HttpRequest buildRequest(GetInvoiceRequest request) throws Exception {
