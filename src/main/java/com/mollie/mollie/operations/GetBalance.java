...
public class GetBalance {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBalanceRequest, com.mollie.mollie.models.operations.async.GetBalanceResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetBalanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetBalanceResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetBalanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetBalanceResponse res = resBuilder.build();
