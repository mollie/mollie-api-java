...
public class UpdateSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSubscriptionRequest, UpdateSubscriptionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSubscriptionRequest.class, new TypeReference<UpdateSubscriptionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSubscriptionRequest request) {
        ...
        @Override
        public UpdateSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSubscriptionResponse.Builder resBuilder =
            ...
            UpdateSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSubscriptionRequest, com.mollie.mollie.models.operations.async.UpdateSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSubscriptionRequest.class, new TypeReference<UpdateSubscriptionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.UpdateSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.UpdateSubscriptionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.UpdateSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.UpdateSubscriptionResponse res = resBuilder.build();
