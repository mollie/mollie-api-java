...
public class ListSubscriptionPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSubscriptionPaymentsRequest, ListSubscriptionPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSubscriptionPaymentsRequest request) {
         ...
         */
        public HttpResponse<InputStream> doRequest(ListSubscriptionPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            HttpRequest r = unchecked(() -> {
                HttpRequest req = buildRequest(request, ListSubscriptionPaymentsRequest.class, urlOverride);
                return sdkConfiguration.hooks().beforeRequest(createBeforeRequestContext(), req);
            }).get();
        ...
        @Override
        public ListSubscriptionPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSubscriptionPaymentsResponse.Builder resBuilder =
            ...
            ListSubscriptionPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListSubscriptionPaymentsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
         ...
         * @param urlOverride the full URL to use instead of the default, or null for the default URL
         */
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSubscriptionPaymentsRequest request, String urlOverride) {
            if (urlOverride == null) {
                return doRequest(request);
            }
            return unchecked(() -> {
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListSubscriptionPaymentsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListSubscriptionPaymentsResponseBody>() {})
