...
public class GetPrimaryBalance {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPrimaryBalanceRequest, GetPrimaryBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPrimaryBalanceRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPrimaryBalanceRequest request) {
        ...
        @Override
        public GetPrimaryBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPrimaryBalanceResponse.Builder resBuilder =
            ...
            GetPrimaryBalanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityBalance(Utils.unmarshal(response, new TypeReference<EntityBalance>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPrimaryBalanceRequest, com.mollie.mollie.models.operations.async.GetPrimaryBalanceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPrimaryBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPrimaryBalanceRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetPrimaryBalanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetPrimaryBalanceResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetPrimaryBalanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetPrimaryBalanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityBalance>() {})
                            .thenApply(res::withEntityBalance);
                } else {
