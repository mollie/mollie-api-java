...
public class GetSettlementPaymentsOperation implements RequestOperation<GetSettlementPaymentsRequest, GetSettlementPaymentsResponse> {
    ...
    public GetSettlementPaymentsOperation(
    ...
    public HttpRequest buildRequest(GetSettlementPaymentsRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetSettlementPaymentsRequest request) throws Exception {
    ...
    @Override
    public GetSettlementPaymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetSettlementPaymentsResponse.Builder resBuilder = 
        ...
        GetSettlementPaymentsResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                GetSettlementPaymentsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "400")) {
            if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                com.mollie.mollie.models.errors.GetSettlementPaymentsResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
