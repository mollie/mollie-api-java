...
public class GetPaymentLink {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentLinkRequest, com.mollie.mollie.models.operations.async.GetPaymentLinkResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetPaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetPaymentLinkResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetPaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetPaymentLinkResponse res = resBuilder.build();
