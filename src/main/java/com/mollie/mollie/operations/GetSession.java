...
public class GetSession {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionRequest, com.mollie.mollie.models.operations.async.GetSessionResponse> {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.GetSessionResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.GetSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.GetSessionResponse res = resBuilder.build();
