...
public class GetBalanceReport {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBalanceReportRequest, GetBalanceReportResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalanceReportRequest request) {
        ...
        @Override
        public GetBalanceReportResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withEntityBalanceReport(Utils.unmarshal(response, new TypeReference<EntityBalanceReport>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.mollie.mollie.models.operations.async.GetBalanceReportResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EntityBalanceReport>() {})
                            .thenApply(res::withEntityBalanceReport);
                } else {
