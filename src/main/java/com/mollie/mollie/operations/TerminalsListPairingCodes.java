...
import com.mollie.mollie.models.operations.TerminalsListPairingCodesResponseBody;
...
public class TerminalsListPairingCodes {
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminalsListPairingCodesRequest, TerminalsListPairingCodesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TerminalsListPairingCodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsListPairingCodesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminalsListPairingCodesRequest request) {
        ...
        @Override
        public TerminalsListPairingCodesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminalsListPairingCodesResponse.Builder resBuilder =
            ...
            TerminalsListPairingCodesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<TerminalsListPairingCodesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminalsListPairingCodesRequest, com.mollie.mollie.models.operations.async.TerminalsListPairingCodesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TerminalsListPairingCodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminalsListPairingCodesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminalsListPairingCodesRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.TerminalsListPairingCodesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.TerminalsListPairingCodesResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.TerminalsListPairingCodesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.TerminalsListPairingCodesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TerminalsListPairingCodesResponseBody>() {})
