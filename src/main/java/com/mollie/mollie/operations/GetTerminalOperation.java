...
public class GetTerminalOperation implements RequestOperation<GetTerminalRequest, GetTerminalResponse> {
    ...
    public HttpRequest buildRequest(GetTerminalRequest request) throws Exception {
