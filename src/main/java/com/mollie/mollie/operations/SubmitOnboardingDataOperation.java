...
public class SubmitOnboardingDataOperation implements RequestOperation<Optional<? extends SubmitOnboardingDataRequestBody>, SubmitOnboardingDataResponse> {
    ...
    public SubmitOnboardingDataOperation(
    ...
    public HttpRequest buildRequest(Optional<? extends SubmitOnboardingDataRequestBody> request) throws Exception {
