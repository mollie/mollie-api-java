...
public class ListAllMethods {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllMethodsRequest, ListAllMethodsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAllMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllMethodsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllMethodsRequest request) {
        ...
        @Override
        public ListAllMethodsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllMethodsResponse.Builder resBuilder =
            ...
            ListAllMethodsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListAllMethodsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAllMethodsRequest, com.mollie.mollie.models.operations.async.ListAllMethodsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAllMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllMethodsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllMethodsRequest request) {
        ...
        @Override
        public CompletableFuture<com.mollie.mollie.models.operations.async.ListAllMethodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.mollie.mollie.models.operations.async.ListAllMethodsResponse.Builder resBuilder =
                    com.mollie.mollie.models.operations.async.ListAllMethodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.mollie.mollie.models.operations.async.ListAllMethodsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/hal+json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListAllMethodsResponseBody>() {})
