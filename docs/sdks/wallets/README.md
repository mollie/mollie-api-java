...
<!-- UsageSnippet language="java" operationID="request-apple-pay-payment-session" method="post" path="/v2/wallets/applepay/sessions" example="request-apple-pay-payment-session-201-1" -->
```java
package hello.world;
