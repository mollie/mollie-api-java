...
* [listBalances](#listbalances) - List balances
* [getBalance](#getbalance) - Get balance
* [getPrimaryBalance](#getprimarybalance) - Get primary balance
* [getBalanceReport](#getbalancereport) - Get balance report
...
public class Application {
    ...
    public static void main(String[] args) throws GetBalanceResponseBody, Exception {
        ...
        GetBalanceResponse res = sdk.balancesAPI().getBalance()
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetPrimaryBalanceResponse res = sdk.balancesAPI().getPrimaryBalance()
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws GetBalanceReportResponseBody, Exception {
        ...
        GetBalanceReportResponse res = sdk.balancesAPI().getBalanceReport()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws ListBalanceTransactionsResponseBody, ListBalanceTransactionsBalancesAPIResponseBody, Exception {
        ...
        ListBalanceTransactionsResponse res = sdk.balancesAPI().listBalanceTransactions()
                .balanceId("bal_gVMhHKqSSRYJyPsuoPNFH")
