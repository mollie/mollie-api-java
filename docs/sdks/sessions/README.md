...
<!-- UsageSnippet language="java" operationID="create-session" method="post" path="/sessions" example="create-session-201-1" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="get-session" method="get" path="/sessions/{sessionId}" example="get-session-200-1" -->
```java
package hello.world;
