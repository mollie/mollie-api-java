    ...
    public static void main(String[] args) throws ErrorResponse, Exception {
        ...
        CreateDraftTransferResponse res = sdk.draftTransfers().create()
                ...
                .createDraftTransferRequest(CreateDraftTransferRequest.builder()
                    ...
                    .scheduledExecutionDate(LocalDate.parse("2025-03-01"))
                    .testmode(false)
                    .build())
                .call();
...
<!-- UsageSnippet language="java" operationID="get-draft-transfer" method="get" path="/v2/business-accounts/draft-transfers/{draftTransferId}" example="approved-draft-transfer" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="get-draft-transfer" method="get" path="/v2/business-accounts/draft-transfers/{draftTransferId}" example="declined-by-initiator-draft-transfer" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, Exception {
        ...
        CancelDraftTransferResponse res = sdk.draftTransfers().cancel()
                .draftTransferId("badrt_87GByBuj4UCcUTEbs6aGJ")
                .idempotencyKey("123e4567-e89b-12d3-a456-426")
                .requestBody(CancelDraftTransferRequestBody.builder()
                    .testmode(false)
                    .build())
                .call();
