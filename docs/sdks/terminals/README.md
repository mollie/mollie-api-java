...
public class Application {
    ...
    public static void main(String[] args) throws ListTerminalsResponseBody, Exception {
        ...
        ListTerminalsResponse res = sdk.terminals().list()
                ...
                .limit(50L)
                .sort(ListTerminalsQueryParamSort.DESC)
                .testmode(false)
                .call();
...
| `sort`                                                                                                                                                                                                                                                                                                                                                                                 | [JsonNullable\<ListTerminalsQueryParamSort>](../../models/operations/ListTerminalsQueryParamSort.md)                                                                                                                                                                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                     | Used for setting the direction of the result set. Defaults to descending order, meaning the results are ordered from<br/>newest to oldest.                                                                                                                                                                                                                                             | desc                                                                                                                                                                                                                                                                                                                                                                                   |
