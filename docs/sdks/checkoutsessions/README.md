...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, Exception {
        ...
        CreateSessionResponse res = sdk.checkoutSessions().create()
...
<!-- UsageSnippet language="java" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-2" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-3" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-4" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, Exception {
        ...
        GetSessionResponse res = sdk.checkoutSessions().get()
