...
| `shipment`                                                                                 | [JsonNullable\<UrlNullable>](../../models/components/UrlNullable.md)                       | :heavy_minus_sign:                                                                         | In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field. |